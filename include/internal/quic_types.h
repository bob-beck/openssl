...
static ossl_unused ossl_inline QUIC_PN
ossl_quic_pn_max(QUIC_PN a, QUIC_PN b)
{
  return a > b ? a : b;
}

static ossl_unused ossl_inline QUIC_PN
ossl_quic_pn_min(QUIC_PN a, QUIC_PN b)
{
  return a < b ? a : b;
}

static ossl_unused ossl_inline int
ossl_quic_pn_valid(QUIC_PN pn)
{
...
static ossl_unused ossl_inline int
ossl_quic_conn_id_eq(const QUIC_CONN_ID* a, const QUIC_CONN_ID* b)
{
 ...
 */
int
ossl_quic_gen_rand_conn_id(OSSL_LIB_CTX* libctx, size_t len, QUIC_CONN_ID* cid);
