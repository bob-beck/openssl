...
#define DEFINE_PRIORITY_QUEUE_OF_INTERNAL(type, ctype)                                                                 \
    ...
    {                                                                                                                  \
        return (PRIORITY_QUEUE_OF(type) *)ossl_pqueue_new((int (*)(const void *, const void *))compare);               \
    }                                                                                                                  \
    static ossl_unused ossl_inline void ossl_pqueue_##type##_free(PRIORITY_QUEUE_OF(type) * pq)                        \
    {                                                                                                                  \
        ossl_pqueue_free((OSSL_PQUEUE *)pq);                                                                           \
    }                                                                                                                  \
    static ossl_unused ossl_inline void ossl_pqueue_##type##_pop_free(PRIORITY_QUEUE_OF(type) * pq,                    \
                                                                      void (*freefunc)(ctype *))                       \
    {                                                                                                                  \
        ossl_pqueue_pop_free((OSSL_PQUEUE *)pq, (void (*)(void *))freefunc);                                           \
    }                                                                                                                  \
    static ossl_unused ossl_inline int ossl_pqueue_##type##_reserve(PRIORITY_QUEUE_OF(type) * pq, size_t n)            \
    {                                                                                                                  \
        return ossl_pqueue_reserve((OSSL_PQUEUE *)pq, n);                                                              \
    }                                                                                                                  \
    static ossl_unused ossl_inline size_t ossl_pqueue_##type##_num(const PRIORITY_QUEUE_OF(type) * pq)                 \
    {                                                                                                                  \
        return ossl_pqueue_num((OSSL_PQUEUE *)pq);                                                                     \
    }                                                                                                                  \
    static ossl_unused ossl_inline int ossl_pqueue_##type##_push(PRIORITY_QUEUE_OF(type) * pq, ctype * data,           \
                                                                 size_t *elem)                                         \
    {                                                                                                                  \
        return ossl_pqueue_push((OSSL_PQUEUE *)pq, (void *)data, elem);                                                \
    }                                                                                                                  \
    static ossl_unused ossl_inline ctype *ossl_pqueue_##type##_peek(const PRIORITY_QUEUE_OF(type) * pq)                \
    {                                                                                                                  \
    ...
    static ossl_unused ossl_inline ctype *ossl_pqueue_##type##_remove(PRIORITY_QUEUE_OF(type) * pq, size_t elem)       \
    {                                                                                                                  \
