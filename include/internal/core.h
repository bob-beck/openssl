...
void*
ossl_method_construct(OSSL_LIB_CTX* ctx,
                      int operation_id,
...
void
ossl_algorithm_do_all(OSSL_LIB_CTX* libctx,
                      int operation_id,
                      OSSL_PROVIDER* provider,
                      int (*pre)(OSSL_PROVIDER*,
                                 int operation_id,
                                 int no_store,
                                 void* data,
                                 int* result),
                      ...
                      void* data);
char*
ossl_algorithm_get1_first_name(const OSSL_ALGORITHM* algo);
