 ...
 */
__owur static ossl_inline int PACKET_equal(const PACKET* pkt,
                                           const void* ptr,
                                           size_t num) {
 ...
 */
int WPACKET_init_static_len(WPACKET* pkt,
                            unsigned char* buf,
                            size_t len,
                            size_t lenbytes);
 ...
 * change its location.
 */
int WPACKET_allocate_bytes(WPACKET* pkt,
                           size_t len,
 ...
 */
int WPACKET_sub_allocate_bytes__(WPACKET* pkt,
                                 size_t len,
                                 unsigned char** allocbytes,
                                 size_t lenbytes);
 ...
 */
int WPACKET_sub_reserve_bytes__(WPACKET* pkt,
                                size_t len,
                                unsigned char** allocbytes,
                                size_t lenbytes);
 ...
 * directly. Use the convenience macros below instead.
 */
int WPACKET_sub_memcpy__(WPACKET* pkt,
                         const void* src,
                         size_t len,
                         size_t lenbytes);
