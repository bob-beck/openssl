...
#define HAS_CASE_SUFFIX(str, suffix)                                                                                   \
    (strlen(str) < sizeof(suffix) - 1 ? 0 : OPENSSL_strcasecmp(str + strlen(str) - sizeof(suffix) + 1, suffix "") == 0)
...
#define n2l8(c, l)                                                                                                     \
    (l = ((uint64_t)(*((c)++))) << 56, l |= ((uint64_t)(*((c)++))) << 48, l |= ((uint64_t)(*((c)++))) << 40,           \
     l |= ((uint64_t)(*((c)++))) << 32, l |= ((uint64_t)(*((c)++))) << 24, l |= ((uint64_t)(*((c)++))) << 16,          \
...
#define l2n8(l, c)                                                                                                     \
    (*((c)++) = (unsigned char)(((l) >> 56) & 0xff), *((c)++) = (unsigned char)(((l) >> 48) & 0xff),                   \
     *((c)++) = (unsigned char)(((l) >> 40) & 0xff), *((c)++) = (unsigned char)(((l) >> 32) & 0xff),                   \
     *((c)++) = (unsigned char)(((l) >> 24) & 0xff), *((c)++) = (unsigned char)(((l) >> 16) & 0xff),                   \
     *((c)++) = (unsigned char)(((l) >> 8) & 0xff), *((c)++) = (unsigned char)(((l)) & 0xff))
...
#define n2l3(c, l)                                                                                                     \
    ((l = (((unsigned long)((c)[0])) << 16) | (((unsigned long)((c)[1])) << 8) | (((unsigned long)((c)[2])))), (c) += 3)

#define l2n3(l, c)                                                                                                     \
    (((c)[0] = (unsigned char)(((l) >> 16) & 0xff), (c)[1] = (unsigned char)(((l) >> 8) & 0xff),                       \
