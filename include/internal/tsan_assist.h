...
#define tsan_load(ptr)                                                                                                 \
    (sizeof(*(ptr)) == 8 ? __iso_volatile_load64((void *)(ptr)) : __iso_volatile_load32((void *)(ptr)))
#define tsan_store(ptr, val)                                                                                           \
    (sizeof(*(ptr)) == 8 ? __iso_volatile_store64(((void *)(ptr)), (val))                                              \
...
#define tsan_add(ptr, n)                                                                                               \
    (sizeof(*(ptr)) == 8 ? _InterlockedExchangeAdd64((void *)(ptr), (n)) : _InterlockedExchangeAdd((void *)(ptr), (n)))
#else
