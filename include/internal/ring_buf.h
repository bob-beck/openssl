...
ring_buf_write_at(struct ring_buf *r, uint64_t logical_offset, const unsigned char *buf, size_t buf_len)
{
    size_t         avail, idx, l;
...
ring_buf_get_ptr(const struct ring_buf *r, uint64_t logical_offset, size_t *max_len)
{
    unsigned char *start = r->start;
    size_t         idx;
 ...
 */
static ossl_inline int
ring_buf_get_buf_at(const struct ring_buf *r, uint64_t logical_offset, const unsigned char **buf, size_t *buf_len)
{
