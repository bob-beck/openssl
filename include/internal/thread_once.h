 ...
 * of an alternative initialiser function MUST occur AFTER the definition of
 * the primary initialiser function.
 *
 ...
 *           DEFINE_RUN_ONCE_STATIC.  This function must return 1 for success
 * or 0 for failure.
 *
 * The return value is 1 on success (*) or 0 in case of error.
 *
