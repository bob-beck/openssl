 ...
 * BIO_FLAGS_KTLS_TX_ZEROCOPY_SENDFILE means we are using the zerocopy mode
 * with this BIO for sending using sendfile.
 */
...
int ossl_core_bio_vprintf (OSSL_CORE_BIO *cb, const char *format,
                           va_list args);
