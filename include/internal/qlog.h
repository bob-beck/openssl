...
#define QLOG_EVENT_BEGIN(qlog, cat, name)                                                                              \
    {                                                                                                                  \
        ...
        uint32_t qlog_event_type = QLOG_EVENT_TYPE_##cat##_##name;                                                     \
                                                                                                                       \
        if (ossl_qlog_event_try_begin(qlog_instance, qlog_event_type, #cat, #name, #cat ":" #name))                    \
        {
...
#define QLOG_STR_LEN(name, value, value_len) ossl_qlog_str_len(qlog_instance, (name), (value), (value_len))
...
#define QLOG_BIN(name, value, value_len) ossl_qlog_bin(qlog_instance, (name), (value), (value_len))
