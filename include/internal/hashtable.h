 ...
 */
#define HT_DEF_KEY_FIELD_CHAR_ARRAY(name, size) HT_DEF_KEY_FIELD(name[size], char)

/*
 * Defines a uint8_t (blob) field in a hash table key
 */
#define HT_DEF_KEY_FIELD_UINT8T_ARRAY(name, size) HT_DEF_KEY_FIELD(name[size], uint8_t)
...
#define IMPLEMENT_HT_VALUE_TYPE_FNS(vtype, name, pfx)                                                                  \
    ...
    {                                                                                                                  \
        ...
        return (vtype *)v->value;                                                                                      \
                                                                                                                       ...
                                                                                                                       \
    pfx ossl_unused vtype *ossl_unused ossl_ht_##name##_##vtype##_get(HT *h, HT_KEY *key, HT_VALUE **v)                \
    {                                                                                                                  \
        HT_VALUE *vv;                                                                                                  \
...
#define DECLARE_HT_VALUE_TYPE_FNS(vtype, name)                                                                         \
    ...
    vtype *ossl_unused ossl_ht_##name##_##vtype##_get(HT *h, HT_KEY *key, HT_VALUE **v);                               \
