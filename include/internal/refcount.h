...
static inline int
CRYPTO_UP_REF (CRYPTO_REF_COUNT *refcnt, int *ret)
{
 ...
 */
static inline int
CRYPTO_DOWN_REF (CRYPTO_REF_COUNT *refcnt, int *ret)
{
...
static inline int
CRYPTO_GET_REF (CRYPTO_REF_COUNT *refcnt, int *ret)
{
...
static ossl_unused ossl_inline int
CRYPTO_NEW_REF (CRYPTO_REF_COUNT *refcnt, int n)
{
  refcnt->val = n;
...
CRYPTO_FREE_REF (CRYPTO_REF_COUNT *refcnt)
{
  if (refcnt != NULL)
