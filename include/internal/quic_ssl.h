...
__owur int ossl_quic_write_flags(SSL* s,
                                 const void* buf,
                                 size_t len,
                                 uint64_t flags,
                                 size_t* written);
__owur int ossl_quic_write(SSL* s,
                           const void* buf,
                           size_t len,
                           size_t* written);
...
__owur long ossl_quic_ctx_callback_ctrl(SSL_CTX* ctx,
                                        int cmd,
                                        void (*fp)(void));
...
__owur int ossl_quic_get_event_timeout(SSL* s,
                                       struct timeval* tv,
                                       int* is_infinite);
...
__owur int ossl_quic_conn_shutdown(SSL* s,
                                   uint64_t flags,
...
__owur int ossl_quic_set_incoming_stream_policy(SSL* s,
                                                int policy,
                                                uint64_t aec);
__owur SSL* ossl_quic_accept_stream(SSL* s, uint64_t flags);
__owur size_t ossl_quic_get_accept_stream_queue_len(SSL* s);
__owur int ossl_quic_get_value_uint(SSL* s,
                                    uint32_t class_,
                                    uint32_t id,
                                    uint64_t* value);
__owur int ossl_quic_set_value_uint(SSL* s,
                                    uint32_t class_,
                                    uint32_t id,
                                    uint64_t value);
