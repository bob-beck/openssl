...
int ossl_quic_hkdf_extract (OSSL_LIB_CTX *libctx, const char *propq,
                            ...
                            size_t ikm_len, unsigned char *out,
                            size_t out_len);
 ...
 *
 * If both qrx and qtx are NULL, this is a no-op. This function is equivalent
 * to making the appropriate calls to ossl_qrx_provide_secret() and
