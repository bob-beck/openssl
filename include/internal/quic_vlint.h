...
ossl_quic_vlint_encode_len(uint64_t v)
{
 ...
 */
void
ossl_quic_vlint_encode(unsigned char* buf, uint64_t v);
 ...
 */
void
ossl_quic_vlint_encode_n(unsigned char* buf, uint64_t v, int n);
 ...
 */
uint64_t
ossl_quic_vlint_decode_unchecked(const unsigned char* buf);
 ...
 */
int
ossl_quic_vlint_decode(const unsigned char* buf, size_t buf_len, uint64_t* v);
