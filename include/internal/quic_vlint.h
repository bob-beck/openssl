 ...
 * QUIC variable-length integer at the start of the buffer and writes the
 * result to *v. If buf_len is inadequate, suggesting a truncated encoded
 * integer, the function fails and 0 is returned. Otherwise, returns the number
 * of bytes consumed.
 *
