 ...
 * case the integer set is in a valid but undefined state. Otherwise,
 * returns 1. Ranges can overlap existing ranges without limitation. If a range
 * is a subset of an existing range in the set, this is a no-op and returns 1.
 */
