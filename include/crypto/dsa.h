...
int ossl_dsa_generate_ffc_parameters(DSA* dsa,
                                     int type,
                                     int pbits,
                                     int qbits,
                                     BN_GENCB* cb);

int ossl_dsa_sign_int(int type,
...
int ossl_dsa_key_fromdata(DSA* dsa,
...
int ossl_dsa_generate_public_key(BN_CTX* ctx,
                                 const DSA* dsa,
                                 const BIGNUM* priv_key,
                                 BIGNUM* pub_key);
int ossl_dsa_check_params(const DSA* dsa, int checktype, int* ret);
int ossl_dsa_check_pub_key(const DSA* dsa, const BIGNUM* pub_key, int* ret);
int ossl_dsa_check_pub_key_partial(const DSA* dsa,
