 ...
 * getentropy(2) should be used instead.
 */
...
void ossl_rand_cleanup_nonce (OSSL_LIB_CTX *ctx, unsigned char *buf,
                              size_t len);
 ...
 */
uint32_t ossl_rand_uniform_uint32 (OSSL_LIB_CTX *ctx, uint32_t upper,
                                   int *err);
