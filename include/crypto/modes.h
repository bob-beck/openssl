...
__inline u32
_bswap4(u32 val){ _asm mov eax, val _asm bswap eax }
...
typedef void (*gcm_ghash_fn)(u64 Xi[2],
...
int
ossl_crypto_xts128gb_encrypt(const XTS128_CONTEXT* ctx,
