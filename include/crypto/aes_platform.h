...
#define AES_GCM_ASM(gctx)                                                                                              \
    (((gctx)->ctr == aes_v8_ctr32_encrypt_blocks_unroll12_eor3 || (gctx)->ctr == aes_v8_ctr32_encrypt_blocks) &&       \
...
void ossl_aes_cfb128_vaes_enc(const unsigned char *in, unsigned char *out, size_t len, const AES_KEY *ks,
                              const unsigned char ivec[16], ossl_ssize_t *num);
void ossl_aes_cfb128_vaes_dec(const unsigned char *in, unsigned char *out, size_t len, const AES_KEY *ks,
                              const unsigned char ivec[16], ossl_ssize_t *num);
