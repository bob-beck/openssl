 ...
 * w: Is one of {1,2,4,8}
 */
static ossl_unused ossl_inline uint8_t lms_ots_coef(const unsigned char* S,
                                                    uint16_t i, uint8_t w) {
...
static ossl_unused ossl_inline int lms_evp_md_ctx_init(
    EVP_MD_CTX* ctx, const EVP_MD* md, const LMS_PARAMS* lms_params) {
