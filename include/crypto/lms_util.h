 ...
 */
#define HASH_NOT_MATCHED(a, b) (a)->n != (b)->n || (strcmp((a)->digestname, (b)->digestname) != 0)
...
static ossl_unused ossl_inline int lms_evp_md_ctx_init(EVP_MD_CTX *ctx, const EVP_MD *md, const LMS_PARAMS *lms_params)
{
    ...
    {
        params[0] = OSSL_PARAM_construct_uint32(OSSL_DIGEST_PARAM_XOFLEN, (uint32_t *)&lms_params->n);
        p = params;
    }
