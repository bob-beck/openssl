...
__owur SLH_DSA_KEY *ossl_slh_dsa_key_dup (const SLH_DSA_KEY *src,
                                          int selection);
...
__owur int ossl_slh_dsa_key_fromdata (SLH_DSA_KEY *key,
...
__owur int ossl_slh_dsa_sign (SLH_DSA_HASH_CTX *slh_ctx, const uint8_t *msg,
                              ...
                              size_t ctx_len, const uint8_t *add_rand,
                              int encode, unsigned char *sig, size_t *siglen,
                              size_t sigsize);
