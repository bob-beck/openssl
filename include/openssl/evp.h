...
#define EVP_MD_CTX_FLAG_FINALISE 0x0200
  ...
  OSSL_DEPRECATEDIN_3_0 int (*EVP_CIPHER_meth_get_init(
  ...
  OSSL_DEPRECATEDIN_3_0 int (*EVP_CIPHER_meth_get_get_asn1_params(
    const EVP_CIPHER* cipher))(EVP_CIPHER_CTX*, ASN1_TYPE*);
  OSSL_DEPRECATEDIN_3_0 int (*EVP_CIPHER_meth_get_ctrl(
    const EVP_CIPHER* cipher))(EVP_CIPHER_CTX*, int type, int arg, void* ptr);
#endif
...
#define EVP_CIPHER_type EVP_CIPHER_get_type
  EVP_CIPHER* EVP_CIPHER_fetch(OSSL_LIB_CTX* ctx,
...
#define EVP_CIPHER_CTX_tag_length EVP_CIPHER_CTX_get_tag_length
  ...
  OSSL_DEPRECATEDIN_3_0 const unsigned char* EVP_CIPHER_CTX_iv(
    const EVP_CIPHER_CTX* ctx);
  OSSL_DEPRECATEDIN_3_0 const unsigned char* EVP_CIPHER_CTX_original_iv(
    const EVP_CIPHER_CTX* ctx);
  OSSL_DEPRECATEDIN_3_0 unsigned char* EVP_CIPHER_CTX_iv_noconst(
    EVP_CIPHER_CTX* ctx);
#endif
  int EVP_CIPHER_CTX_get_updated_iv(EVP_CIPHER_CTX* ctx, void* buf, size_t len);
  int EVP_CIPHER_CTX_get_original_iv(EVP_CIPHER_CTX* ctx,
                                     void* buf,
                                     size_t len);
#ifndef OPENSSL_NO_DEPRECATED_3_0
  OSSL_DEPRECATEDIN_3_0
...
#define EVP_MD_CTX_destroy(ctx) EVP_MD_CTX_free((ctx))
  ...
  __owur int EVP_DigestFinalXOF(EVP_MD_CTX* ctx,
                                unsigned char* out,
                                size_t outlen);
  __owur int EVP_DigestSqueeze(EVP_MD_CTX* ctx,
                               unsigned char* out,
                               size_t outlen);

  __owur EVP_MD* EVP_MD_fetch(OSSL_LIB_CTX* ctx,
                              const char* algorithm,
                              const char* properties);
  ...
  __owur int EVP_EncryptUpdate(EVP_CIPHER_CTX* ctx,
                               ...
                               const unsigned char* in,
                               int inl);
  __owur int EVP_EncryptFinal_ex(EVP_CIPHER_CTX* ctx,
                                 unsigned char* out,
                                 int* outl);
  __owur int EVP_EncryptFinal(EVP_CIPHER_CTX* ctx,
                              unsigned char* out,
                              int* outl);
  ...
  __owur int EVP_DecryptFinal(EVP_CIPHER_CTX* ctx,
                              unsigned char* outm,
                              int* outl);
  __owur int EVP_DecryptFinal_ex(EVP_CIPHER_CTX* ctx,
                                 unsigned char* outm,
                                 int* outl);
...
#define EVP_cleanup()                                                          \
  ...
  int EVP_MAC_init(EVP_MAC_CTX* ctx,
                   ...
                   size_t keylen,
                   const OSSL_PARAM params[]);
  int EVP_MAC_init_SKEY(EVP_MAC_CTX* ctx,
                        EVP_SKEY* skey,
                        const OSSL_PARAM params[]);
  int EVP_MAC_update(EVP_MAC_CTX* ctx,
                     const unsigned char* data,
                     size_t datalen);
  ...
  int EVP_RAND_reseed(EVP_RAND_CTX* ctx,
                      ...
                      const unsigned char* addin,
                      size_t addin_len);
  __owur int EVP_RAND_nonce(EVP_RAND_CTX* ctx,
                            unsigned char* out,
                            size_t outlen);
...
#define EVP_PKEY_size EVP_PKEY_get_size
  ...
  OSSL_DEPRECATEDIN_3_0 const struct dh_st* EVP_PKEY_get0_DH(
    const EVP_PKEY* pkey);
  ...
  EVP_PKEY* d2i_KeyParams(int type,
                          EVP_PKEY** a,
                          const unsigned char** pp,
                          long length);
  ...
  int EVP_PKEY_print_params(BIO* out,
                            ...
                            ASN1_PCTX* pctx);
#ifndef OPENSSL_NO_STDIO
  int EVP_PKEY_print_public_fp(FILE* fp,
                               const EVP_PKEY* pkey,
                               int indent,
                               ASN1_PCTX* pctx);
  int EVP_PKEY_print_private_fp(FILE* fp,
                                const EVP_PKEY* pkey,
                                int indent,
                                ASN1_PCTX* pctx);
  int EVP_PKEY_print_params_fp(FILE* fp,
                               const EVP_PKEY* pkey,
                               int indent,
                               ASN1_PCTX* pctx);
#endif
  ...
  int EVP_PKEY_get_default_digest_name(EVP_PKEY* pkey,
                                       char* mdname,
                                       size_t mdname_sz);
  int EVP_PKEY_digestsign_supports_digest(EVP_PKEY* pkey,
                                          OSSL_LIB_CTX* libctx,
                                          const char* name,
                                          const char* propq);
...
#define ASN1_PKEY_CTRL_CMS_IS_RI_TYPE_SUPPORTED 0xb
  ...
  const EVP_PKEY_ASN1_METHOD* EVP_PKEY_asn1_find_str(ENGINE** pe,
                                                     const char* str,
                                                     int len);
  OSSL_DEPRECATEDIN_3_6 int EVP_PKEY_asn1_add0(
  ...
  OSSL_DEPRECATEDIN_3_6 const EVP_PKEY_ASN1_METHOD* EVP_PKEY_get0_asn1(
    const EVP_PKEY* pkey);
  OSSL_DEPRECATEDIN_3_6 EVP_PKEY_ASN1_METHOD*
  EVP_PKEY_asn1_new(int id, int flags, const char* pem_str, const char* info);
  OSSL_DEPRECATEDIN_3_6 void EVP_PKEY_asn1_copy(
  ...
  void EVP_PKEY_asn1_set_public(
    ...
    int (
      *pub_print)(BIO* out, const EVP_PKEY* pkey, int indent, ASN1_PCTX* pctx),
...
#define EVP_PKEY_OP_TYPE_NOGEN (EVP_PKEY_OP_ALL & ~EVP_PKEY_OP_TYPE_GEN)
  ...
  int EVP_PKEY_CTX_set_mac_key(EVP_PKEY_CTX* ctx,
                               const unsigned char* key,
                               int keylen);
...
#define EVP_PKEY_FLAG_SIGCTX_CUSTOM 4
  ...
  OSSL_DEPRECATEDIN_3_0 void EVP_PKEY_meth_get0_info(
    int* ppkey_id,
    int* pflags,
  ...
  int EVP_SKEYMGMT_names_do_all(const EVP_SKEYMGMT* keymgmt,
                                void (*fn)(const char* name, void* data),
                                void* data);
  const OSSL_PARAM* EVP_SKEYMGMT_get0_gen_settable_params(
    const EVP_SKEYMGMT* skeymgmt);
  const OSSL_PARAM* EVP_SKEYMGMT_get0_imp_settable_params(
    const EVP_SKEYMGMT* skeymgmt);
  ...
  int EVP_ASYM_CIPHER_names_do_all(const EVP_ASYM_CIPHER* cipher,
                                   void (*fn)(const char* name, void* data),
                                   void* data);
  const OSSL_PARAM* EVP_ASYM_CIPHER_gettable_ctx_params(
    const EVP_ASYM_CIPHER* ciph);
  const OSSL_PARAM* EVP_ASYM_CIPHER_settable_ctx_params(
    const EVP_ASYM_CIPHER* ciph);
  ...
  int EVP_PKEY_derive_set_peer_ex(EVP_PKEY_CTX* ctx,
                                  EVP_PKEY* peer,
                                  int validate_peer);
  ...
  int EVP_PKEY_fromdata(EVP_PKEY_CTX* ctx,
                        ...
                        int selection,
                        OSSL_PARAM param[]);
  const OSSL_PARAM* EVP_PKEY_fromdata_settable(EVP_PKEY_CTX* ctx,
                                               int selection);

  int EVP_PKEY_todata(const EVP_PKEY* pkey, int selection, OSSL_PARAM** params);
  int EVP_PKEY_export(const EVP_PKEY* pkey,
                      int selection,
  ...
  int EVP_PKEY_get_int_param(const EVP_PKEY* pkey,
                             const char* key_name,
                             int* out);
  int EVP_PKEY_get_size_t_param(const EVP_PKEY* pkey,
                                const char* key_name,
                                size_t* out);
  int EVP_PKEY_get_bn_param(const EVP_PKEY* pkey,
                            const char* key_name,
                            BIGNUM** bn);
...
#define EVP_PKEY_get_ex_new_index(l, p, newf, dupf, freef)                     \
  ...
  int EVP_PKEY_CTX_get_group_name(EVP_PKEY_CTX* ctx,
                                  char* name,
                                  size_t namelen);
  int EVP_PKEY_get_group_name(const EVP_PKEY* pkey,
                              char* name,
                              size_t name_sz,
                              size_t* gname_len);
  ...
  EVP_SKEY* EVP_SKEY_import_raw_key(OSSL_LIB_CTX* libctx,
                                    ...
                                    size_t keylen,
                                    const char* propquery);
  int EVP_SKEY_get0_raw_key(const EVP_SKEY* skey,
                            const unsigned char** key,
                            size_t* len);
  const char* EVP_SKEY_get0_key_id(const EVP_SKEY* skey);
  int EVP_SKEY_export(const EVP_SKEY* skey,
                      int selection,
                      OSSL_CALLBACK* export_cb,
                      void* export_cbarg);
  ...
  EVP_SKEY* EVP_SKEY_to_provider(EVP_SKEY* skey,
                                 OSSL_LIB_CTX* libctx,
                                 OSSL_PROVIDER* prov,
                                 const char* propquery);
