...
#define EVP_MD_CTX_FLAG_FINALISE 0x0200
...
#ifndef OPENSSL_NO_DEPRECATED_3_0
  OSSL_DEPRECATEDIN_3_0
  EVP_CIPHER *EVP_CIPHER_meth_new (int cipher_type, int block_size,
                                   int key_len);
  OSSL_DEPRECATEDIN_3_0
  ...
  OSSL_DEPRECATEDIN_3_0 int (*EVP_CIPHER_meth_get_ctrl (
      const EVP_CIPHER *cipher)) (EVP_CIPHER_CTX *, int type, int arg,
                                  void *ptr);
#endif
...
#endif
  int EVP_CIPHER_CTX_get_updated_iv (EVP_CIPHER_CTX *ctx, void *buf,
                                     size_t len);
  int EVP_CIPHER_CTX_get_original_iv (EVP_CIPHER_CTX *ctx, void *buf,
                                      size_t len);
#ifndef OPENSSL_NO_DEPRECATED_3_0
  OSSL_DEPRECATEDIN_3_0
...
#define EVP_MD_CTX_destroy(ctx) EVP_MD_CTX_free ((ctx))
  ...
  __owur int EVP_CipherInit_SKEY (EVP_CIPHER_CTX *ctx,
                                  const EVP_CIPHER *cipher, EVP_SKEY *skey,
  ...
  __owur int EVP_SignFinal (EVP_MD_CTX *ctx, unsigned char *md,
                            unsigned int *s, EVP_PKEY *pkey);
  __owur int EVP_SignFinal_ex (EVP_MD_CTX *ctx, unsigned char *md,
                               unsigned int *s, EVP_PKEY *pkey,
  ...
  __owur int EVP_OpenFinal (EVP_CIPHER_CTX *ctx, unsigned char *out,
                            int *outl);

  __owur int EVP_SealInit (EVP_CIPHER_CTX *ctx, const EVP_CIPHER *type,
                           unsigned char **ek, int *ekl, unsigned char *iv,
                           EVP_PKEY **pubk, int npubk);
  __owur int EVP_SealFinal (EVP_CIPHER_CTX *ctx, unsigned char *out,
                            int *outl);
...
#define EVP_CIPHER_CTX_cleanup(c) EVP_CIPHER_CTX_reset (c)
  ...
  int EVP_CIPHER_CTX_set_params (EVP_CIPHER_CTX *ctx,
                                 const OSSL_PARAM params[]);
  ...
  __owur int BIO_set_cipher (BIO *b, const EVP_CIPHER *c,
                             const unsigned char *k, const unsigned char *i,
                             int enc);
...
#define EVP_cleanup()                                                         \
  ...
  int EVP_RAND_reseed (EVP_RAND_CTX *ctx, int prediction_resistance,
                       ...
                       const unsigned char *addin, size_t addin_len);
  __owur int EVP_RAND_nonce (EVP_RAND_CTX *ctx, unsigned char *out,
                             size_t outlen);
...
#define EVP_PKEY_size EVP_PKEY_get_size
  ...
  EVP_PKEY *d2i_PrivateKey_ex (int type, EVP_PKEY **a,
...
#define EVP_PKEY_get1_tls_encodedpoint(pkey, ppt)                             \
  ...
  int PKCS5_PBE_keyivgen_ex (EVP_CIPHER_CTX *cctx, const char *pass,
                             int passlen, ASN1_TYPE *param,
                             const EVP_CIPHER *cipher, const EVP_MD *md,
                             int en_de, OSSL_LIB_CTX *libctx,
                             const char *propq);
  ...
  int PKCS5_v2_PBE_keyivgen (EVP_CIPHER_CTX *ctx, const char *pass,
                             int passlen, ASN1_TYPE *param,
                             const EVP_CIPHER *cipher, const EVP_MD *md,
                             int en_de);
  int PKCS5_v2_PBE_keyivgen_ex (EVP_CIPHER_CTX *ctx, const char *pass,
                                int passlen, ASN1_TYPE *param,
                                const EVP_CIPHER *cipher, const EVP_MD *md,
                                int en_de, OSSL_LIB_CTX *libctx,
                                const char *propq);
  ...
  int EVP_PBE_CipherInit_ex (ASN1_OBJECT *pbe_obj, const char *pass,
                             int passlen, ASN1_TYPE *param,
...
#define ASN1_PKEY_CTRL_CMS_IS_RI_TYPE_SUPPORTED 0xb
  ...
  OSSL_DEPRECATEDIN_3_6 void
  EVP_PKEY_asn1_copy (EVP_PKEY_ASN1_METHOD *dst,
...
#define EVP_PKEY_FLAG_SIGCTX_CUSTOM 4
  ...
  const OSSL_PROVIDER *
  EVP_SKEYMGMT_get0_provider (const EVP_SKEYMGMT *keymgmt);
  ...
  int EVP_SIGNATURE_names_do_all (const EVP_SIGNATURE *signature,
                                  ...
                                  void *data);
  const OSSL_PARAM *
  EVP_SIGNATURE_gettable_ctx_params (const EVP_SIGNATURE *sig);
  const OSSL_PARAM *
  EVP_SIGNATURE_settable_ctx_params (const EVP_SIGNATURE *sig);
  ...
  int EVP_PKEY_todata (const EVP_PKEY *pkey, int selection,
                       OSSL_PARAM **params);
  ...
  int EVP_PKEY_set_size_t_param (EVP_PKEY *pkey, const char *key_name,
                                 size_t in);
...
#define EVP_PKEY_get_ex_new_index(l, p, newf, dupf, freef)                    \
  ...
  OSSL_DEPRECATEDIN_3_0 void EVP_PKEY_meth_set_digestverify (
      ...
      int (*digestverify) (EVP_MD_CTX *ctx, const unsigned char *sig,
                           ...
                           size_t tbslen));
  OSSL_DEPRECATEDIN_3_0 void
  EVP_PKEY_meth_set_check (EVP_PKEY_METHOD *pmeth,
  ...
  int EVP_KEYEXCH_names_do_all (const EVP_KEYEXCH *keyexch,
                                ...
                                void *data);
  const OSSL_PARAM *
  EVP_KEYEXCH_gettable_ctx_params (const EVP_KEYEXCH *keyexch);
  const OSSL_PARAM *
  EVP_KEYEXCH_settable_ctx_params (const EVP_KEYEXCH *keyexch);

  void EVP_add_alg_module (void);

  int EVP_PKEY_CTX_set_group_name (EVP_PKEY_CTX *ctx, const char *name);
  int EVP_PKEY_CTX_get_group_name (EVP_PKEY_CTX *ctx, char *name,
                                   size_t namelen);
  int EVP_PKEY_get_group_name (const EVP_PKEY *pkey, char *name,
                               size_t name_sz, size_t *gname_len);
