...
#define EVP_MD_CTX_destroy(ctx) EVP_MD_CTX_free((ctx))
    ...
    __owur int EVP_CipherInit_ex(EVP_CIPHER_CTX *ctx, const EVP_CIPHER *cipher, ENGINE *impl, const unsigned char *key,
                                 const unsigned char *iv, int enc);
    __owur int EVP_CipherInit_SKEY(EVP_CIPHER_CTX *ctx, const EVP_CIPHER *cipher, EVP_SKEY *skey,
...
#define ASN1_PKEY_CTRL_CMS_IS_RI_TYPE_SUPPORTED 0xb
    ...
    OSSL_DEPRECATEDIN_3_6 EVP_PKEY_ASN1_METHOD *EVP_PKEY_asn1_new(int id, int flags, const char *pem_str,
                                                                  const char *info);
    OSSL_DEPRECATEDIN_3_6 void EVP_PKEY_asn1_copy(EVP_PKEY_ASN1_METHOD *dst, const EVP_PKEY_ASN1_METHOD *src);
...
#define EVP_PKEY_OP_TYPE_SIG                                                                                           \
    (EVP_PKEY_OP_SIGN | EVP_PKEY_OP_SIGNMSG | EVP_PKEY_OP_VERIFY | EVP_PKEY_OP_VERIFYMSG | EVP_PKEY_OP_VERIFYRECOVER | \
...
#define EVP_PKEY_FLAG_SIGCTX_CUSTOM 4
    ...
    void EVP_SIGNATURE_do_all_provided(OSSL_LIB_CTX *libctx, void (*fn)(EVP_SIGNATURE *signature, void *data),
                                       void *data);
    int EVP_SIGNATURE_names_do_all(const EVP_SIGNATURE *signature, void (*fn)(const char *name, void *data),
                                   void *data);
    ...
    void EVP_ASYM_CIPHER_do_all_provided(OSSL_LIB_CTX *libctx, void (*fn)(EVP_ASYM_CIPHER *cipher, void *arg),
                                         void *arg);
    int EVP_ASYM_CIPHER_names_do_all(const EVP_ASYM_CIPHER *cipher, void (*fn)(const char *name, void *data),
                                     void *data);
...
#define EVP_PKEY_get_ex_new_index(l, p, newf, dupf, freef)                                                             \
    ...
    OSSL_DEPRECATEDIN_3_0 void EVP_PKEY_meth_set_verify_recover(
        ...
        int (*verify_recover)(EVP_PKEY_CTX *ctx, unsigned char *sig, size_t *siglen, const unsigned char *tbs,
                              size_t tbslen));
    OSSL_DEPRECATEDIN_3_0 void EVP_PKEY_meth_set_signctx(EVP_PKEY_METHOD *pmeth,
    ...
    OSSL_DEPRECATEDIN_3_0 void EVP_PKEY_meth_set_derive(EVP_PKEY_METHOD *pmeth, int (*derive_init)(EVP_PKEY_CTX *ctx),
                                                        int (*derive)(EVP_PKEY_CTX *ctx, unsigned char *key,
                                                                      size_t *keylen));
    OSSL_DEPRECATEDIN_3_0 void EVP_PKEY_meth_set_ctrl(EVP_PKEY_METHOD *pmeth,
    ...
    OSSL_DEPRECATEDIN_3_0 void EVP_PKEY_meth_get_verify_recover(
        ...
        int (**pverify_recover)(EVP_PKEY_CTX *ctx, unsigned char *sig, size_t *siglen, const unsigned char *tbs,
                                size_t tbslen));
    OSSL_DEPRECATEDIN_3_0 void EVP_PKEY_meth_get_signctx(const EVP_PKEY_METHOD *pmeth,
                                                         ...
                                                         int (**psignctx)(EVP_PKEY_CTX *ctx, unsigned char *sig,
                                                                          size_t *siglen, EVP_MD_CTX *mctx));
    ...
    OSSL_DEPRECATEDIN_3_0 void EVP_PKEY_meth_get_encrypt(const EVP_PKEY_METHOD *pmeth,
    ...
    OSSL_DEPRECATEDIN_3_0 void EVP_PKEY_meth_get_derive(const EVP_PKEY_METHOD *pmeth,
                                                        int (**pderive_init)(EVP_PKEY_CTX *ctx),
                                                        int (**pderive)(EVP_PKEY_CTX *ctx, unsigned char *key,
                                                                        size_t *keylen));
    ...
    OSSL_DEPRECATEDIN_3_0 void EVP_PKEY_meth_get_digestverify(
        const EVP_PKEY_METHOD *pmeth, int (**digestverify)(EVP_MD_CTX *ctx, const unsigned char *sig, size_t siglen,
                                                           const unsigned char *tbs, size_t tbslen));
