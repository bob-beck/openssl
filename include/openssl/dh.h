...
#define DH_PARAMGEN_TYPE_GROUP 3      /* Use a named safe prime group */
  ...
  int EVP_PKEY_CTX_set0_dh_kdf_ukm(EVP_PKEY_CTX* ctx,
                                   unsigned char* ukm,
                                   int len);
#ifndef OPENSSL_NO_DEPRECATED_3_0
...
#define DH_get_ex_new_index(l, p, newf, dupf, freef)                           \
  ...
  OSSL_DEPRECATEDIN_3_0 int DH_generate_parameters_ex(DH* dh,
                                                      int prime_len,
                                                      int generator,
                                                      BN_GENCB* cb);
  ...
  OSSL_DEPRECATEDIN_3_0 int DH_check_pub_key(const DH* dh,
                                             const BIGNUM* pub_key,
                                             int* codes);
  ...
  OSSL_DEPRECATEDIN_3_0 void DH_get0_pqg(const DH* dh,
                                         const BIGNUM** p,
                                         const BIGNUM** q,
                                         const BIGNUM** g);
  OSSL_DEPRECATEDIN_3_0 int DH_set0_pqg(DH* dh,
                                        BIGNUM* p,
                                        BIGNUM* q,
                                        BIGNUM* g);
  OSSL_DEPRECATEDIN_3_0 void DH_get0_key(const DH* dh,
                                         const BIGNUM** pub_key,
                                         const BIGNUM** priv_key);
  OSSL_DEPRECATEDIN_3_0 int DH_set0_key(DH* dh,
                                        BIGNUM* pub_key,
                                        BIGNUM* priv_key);
  ...
  OSSL_DEPRECATEDIN_3_0 int DH_meth_set_generate_key(DH_METHOD* dhm,
                                                     int (*generate_key)(DH*));
  OSSL_DEPRECATEDIN_3_0 int (*DH_meth_get_compute_key(
    const DH_METHOD* dhm))(unsigned char* key, const BIGNUM* pub_key, DH* dh);
  ...
  OSSL_DEPRECATEDIN_3_0 int DH_meth_set_finish(DH_METHOD* dhm,
                                               int (*finish)(DH*));
  OSSL_DEPRECATEDIN_3_0 int (*DH_meth_get_generate_params(
    const DH_METHOD* dhm))(DH*, int, int, BN_GENCB*);
  OSSL_DEPRECATEDIN_3_0 int DH_meth_set_generate_params(
    DH_METHOD* dhm,
    int (*generate_params)(DH*, int, int, BN_GENCB*));
#endif /* OPENSSL_NO_DEPRECATED_3_0 */

#ifndef OPENSSL_NO_DEPRECATED_0_9_8
  OSSL_DEPRECATEDIN_0_9_8 DH* DH_generate_parameters(int prime_len,
                                                     int generator,
                                                     void (*callback)(int,
                                                                      int,
                                                                      void*),
