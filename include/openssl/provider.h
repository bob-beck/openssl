...
extern "C"
{
  ...
  OSSL_PROVIDER* OSSL_PROVIDER_load_ex(OSSL_LIB_CTX*,
                                       const char* name,
                                       OSSL_PARAM* params);
  OSSL_PROVIDER* OSSL_PROVIDER_try_load(OSSL_LIB_CTX*,
                                        const char* name,
                                        int retain_fallbacks);
  OSSL_PROVIDER* OSSL_PROVIDER_try_load_ex(OSSL_LIB_CTX*,
                                           const char* name,
                                           OSSL_PARAM* params,
                                           int retain_fallbacks);
  ...
  /*-
   * Provider configuration parameters are normally set in the configuration
   * file, but can also be set early in the main program before a provider is in
  ...
  int OSSL_PROVIDER_add_builtin(OSSL_LIB_CTX*,
                                const char* name,
