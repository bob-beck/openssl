...
extern "C"
{
  ...
  /*
   * Generic function pointer for provider method arrays, or other contexts
   * where functions of various signatures must occupy a common slot in an array
   * of structures.
   */
...
#define OSSL_FUNC_CORE_GET_LIBCTX 4
  OSSL_CORE_MAKE_FUNC(OPENSSL_CORE_CTX*,
                      core_get_libctx,
                      (const OSSL_CORE_HANDLE* prov))
...
#define OSSL_FUNC_BIO_CTRL 50
  ...
  OSSL_CORE_MAKE_FUNC(OSSL_CORE_BIO*,
                      BIO_new_file,
  ...
  OSSL_CORE_MAKE_FUNC(
    int,
    BIO_read_ex,
    (OSSL_CORE_BIO * bio, void* data, size_t data_len, size_t* bytes_read))
  OSSL_CORE_MAKE_FUNC(
    int,
    BIO_write_ex,
    (OSSL_CORE_BIO * bio, const void* data, size_t data_len, size_t* written))
...
#define OSSL_FUNC_PROVIDER_FREE 111
  ...
  OSSL_CORE_MAKE_FUNC(void,
                      ...
                      (const OSSL_CORE_HANDLE* handle))
  OSSL_CORE_MAKE_FUNC(const char*,
                      provider_name,
                      (const OSSL_CORE_HANDLE* prov))
  OSSL_CORE_MAKE_FUNC(void*,
                      provider_get0_provider_ctx,
                      (const OSSL_CORE_HANDLE* prov))
  OSSL_CORE_MAKE_FUNC(const OSSL_DISPATCH*,
                      provider_get0_dispatch,
                      (const OSSL_CORE_HANDLE* prov))
  OSSL_CORE_MAKE_FUNC(int,
                      provider_up_ref,
...
#define OSSL_FUNC_PROVIDER_QUERY_OPERATION 1027
  OSSL_CORE_MAKE_FUNC(const OSSL_ALGORITHM*,
...
#define OSSL_FUNC_PROVIDER_RANDOM_BYTES 1032
  OSSL_CORE_MAKE_FUNC(
    int,
    provider_random_bytes,
    (void* provctx, int which, void* buf, size_t n, unsigned int strength))
...
#define OSSL_FUNC_SSL_QUIC_TLS_CRYPTO_RELEASE_RCD 2003
  OSSL_CORE_MAKE_FUNC(int,
                      SSL_QUIC_TLS_crypto_release_rcd,
...
#define OSSL_FUNC_DIGEST_COPYCTX 15
  ...
  OSSL_CORE_MAKE_FUNC(
    int,
    digest_final,
    (void* dctx, unsigned char* out, size_t* outl, size_t outsz))
  OSSL_CORE_MAKE_FUNC(
    int,
    digest_squeeze,
    (void* dctx, unsigned char* out, size_t* outl, size_t outsz))
  ...
  OSSL_CORE_MAKE_FUNC(int,
                      digest_set_ctx_params,
                      (void* vctx, const OSSL_PARAM params[]))
  OSSL_CORE_MAKE_FUNC(int,
                      digest_get_ctx_params,
...
#define OSSL_FUNC_CIPHER_DECRYPT_SKEY_INIT 20
  ...
  OSSL_CORE_MAKE_FUNC(int,
                      cipher_get_ctx_params,
                      (void* cctx, OSSL_PARAM params[]))
  OSSL_CORE_MAKE_FUNC(int,
                      cipher_set_ctx_params,
...
#define OSSL_FUNC_KDF_SET_CTX_PARAMS 11
  ...
  OSSL_CORE_MAKE_FUNC(
    int,
    kdf_derive,
    (void* kctx, unsigned char* key, size_t keylen, const OSSL_PARAM params[]))
...
#define OSSL_FUNC_KEYMGMT_EXPORT_TYPES_EX 46
  OSSL_CORE_MAKE_FUNC(const OSSL_PARAM*,
                      keymgmt_import_types_ex,
                      (void* provctx, int selection))
  OSSL_CORE_MAKE_FUNC(const OSSL_PARAM*,
                      keymgmt_export_types_ex,
                      (void* provctx, int selection))
...
#define OSSL_FUNC_SIGNATURE_VERIFY_MESSAGE_FINAL 32
  ...
  OSSL_CORE_MAKE_FUNC(int,
                      ...
                      (void* ctx,
                       ...
                       size_t tbslen))
  OSSL_CORE_MAKE_FUNC(int,
                      signature_sign_message_init,
                      (void* ctx, void* provkey, const OSSL_PARAM params[]))
  OSSL_CORE_MAKE_FUNC(int,
                      signature_sign_message_update,
                      (void* ctx, const unsigned char* in, size_t inlen))
  OSSL_CORE_MAKE_FUNC(
    int,
    signature_sign_message_final,
  ...
  OSSL_CORE_MAKE_FUNC(int,
                      ...
                      (void* ctx,
                       ...
                       size_t tbslen))
  OSSL_CORE_MAKE_FUNC(int,
                      signature_verify_message_init,
                      (void* ctx, void* provkey, const OSSL_PARAM params[]))
  OSSL_CORE_MAKE_FUNC(int,
                      signature_verify_message_update,
                      (void* ctx, const unsigned char* in, size_t inlen))
  /*
  ...
  OSSL_CORE_MAKE_FUNC(const OSSL_PARAM*,
                      ...
                      (void* ctx, void* provctx))
  OSSL_CORE_MAKE_FUNC(int,
                      signature_get_ctx_md_params,
                      (void* ctx, OSSL_PARAM params[]))
  OSSL_CORE_MAKE_FUNC(const OSSL_PARAM*,
                      signature_gettable_ctx_md_params,
                      (void* ctx))
  OSSL_CORE_MAKE_FUNC(int,
                      signature_set_ctx_md_params,
                      (void* ctx, const OSSL_PARAM params[]))
  OSSL_CORE_MAKE_FUNC(const OSSL_PARAM*,
...
#define OSSL_FUNC_ASYM_CIPHER_SETTABLE_CTX_PARAMS 11
  ...
  OSSL_CORE_MAKE_FUNC(int,
                      asym_cipher_get_ctx_params,
                      (void* ctx, OSSL_PARAM params[]))
  OSSL_CORE_MAKE_FUNC(const OSSL_PARAM*,
                      asym_cipher_gettable_ctx_params,
                      (void* ctx, void* provctx))
  OSSL_CORE_MAKE_FUNC(int,
                      asym_cipher_set_ctx_params,
                      (void* ctx, const OSSL_PARAM params[]))
  OSSL_CORE_MAKE_FUNC(const OSSL_PARAM*,
