...
extern "C"
{
   ...
   * where functions of various signatures must occupy a common slot in an
   * array of structures.
   */
...
#define OSSL_FUNC_CORE_SET_ERROR_DEBUG 6
  OSSL_CORE_MAKE_FUNC (void, core_set_error_debug,
                       (const OSSL_CORE_HANDLE *prov, const char *file,
...
#define OSSL_FUNC_CORE_SET_ERROR_MARK 8
  OSSL_CORE_MAKE_FUNC (int, core_set_error_mark,
                       (const OSSL_CORE_HANDLE *prov))
...
#define OSSL_FUNC_CORE_POP_ERROR_TO_MARK 10
  OSSL_CORE_MAKE_FUNC (int, core_pop_error_to_mark,
                       (const OSSL_CORE_HANDLE *prov))
...
#define OSSL_FUNC_CRYPTO_FREE 22
  OSSL_CORE_MAKE_FUNC (void, CRYPTO_free,
...
#define OSSL_FUNC_CRYPTO_CLEAR_REALLOC 25
  OSSL_CORE_MAKE_FUNC (void *, CRYPTO_clear_realloc,
                       (void *addr, size_t old_num, size_t num,
...
#define OSSL_FUNC_BIO_CTRL 50
  ...
  OSSL_CORE_MAKE_FUNC (OSSL_CORE_BIO *, BIO_new_membuf,
  ...
  OSSL_CORE_MAKE_FUNC (int, BIO_write_ex,
                       (OSSL_CORE_BIO * bio, const void *data, size_t data_len,
                        size_t *written))
  OSSL_CORE_MAKE_FUNC (int, BIO_gets,
                       (OSSL_CORE_BIO * bio, char *buf, int size))
...
#define OSSL_FUNC_SELF_TEST_CB 100
  OSSL_CORE_MAKE_FUNC (void, self_test_cb,
                       (OPENSSL_CORE_CTX * ctx, OSSL_CALLBACK **cb,
                        void **cbarg))
...
#define OSSL_FUNC_PROVIDER_GET_CAPABILITIES 1030
  OSSL_CORE_MAKE_FUNC (int, provider_get_capabilities,
                       (void *provctx, const char *capability,
...
#define OSSL_FUNC_SSL_QUIC_TLS_GOT_TRANSPORT_PARAMS 2005
  OSSL_CORE_MAKE_FUNC (int, SSL_QUIC_TLS_got_transport_params,
                       (SSL * s, const unsigned char *params,
...
#define OSSL_FUNC_DIGEST_COPYCTX 15
  ...
  OSSL_CORE_MAKE_FUNC (int, digest_init,
...
#define OSSL_FUNC_MAC_INIT_SKEY 13
  ...
  OSSL_CORE_MAKE_FUNC (int, mac_final,
                       (void *mctx, unsigned char *out, size_t *outl,
                        size_t outsize))
  OSSL_CORE_MAKE_FUNC (const OSSL_PARAM *, mac_gettable_params,
                       (void *provctx))
...
#define OSSL_FUNC_KDF_SET_CTX_PARAMS 11
  ...
  OSSL_CORE_MAKE_FUNC (int, kdf_derive,
                       (void *kctx, unsigned char *key, size_t keylen,
                        const OSSL_PARAM params[]))
  OSSL_CORE_MAKE_FUNC (const OSSL_PARAM *, kdf_gettable_params,
                       (void *provctx))
...
#define OSSL_FUNC_RAND_CLEAR_SEED 19
  ...
  OSSL_CORE_MAKE_FUNC (const OSSL_PARAM *, rand_gettable_params,
                       (void *provctx))
...
#define OSSL_FUNC_SIGNATURE_VERIFY_MESSAGE_FINAL 32
  ...
  OSSL_CORE_MAKE_FUNC (int, signature_verify_recover,
                       (void *ctx, unsigned char *rout, size_t *routlen,
                        size_t routsize, const unsigned char *sig,
                        size_t siglen))
...
#define OSSL_FUNC_KEM_AUTH_DECAPSULATE_INIT 13
  ...
  OSSL_CORE_MAKE_FUNC (int, kem_get_ctx_params,
                       (void *ctx, OSSL_PARAM params[]))
...
#define OSSL_FUNC_STORE_OPEN_EX 10
  ...
  OSSL_CORE_MAKE_FUNC (void *, store_attach,
                       (void *provctx, OSSL_CORE_BIO *in))
