...
#define OSSL_FUNC_CLEANUP_NONCE 104
    OSSL_CORE_MAKE_FUNC(size_t, get_entropy,
                        (const OSSL_CORE_HANDLE *handle, unsigned char **pout, int entropy, size_t min_len,
                         size_t max_len))
...
#define OSSL_FUNC_CIPHER_DECRYPT_SKEY_INIT 20
    ...
    OSSL_CORE_MAKE_FUNC(int, cipher_update,
                        (void *cctx, unsigned char *out, size_t *outl, size_t outsize, const unsigned char *in,
                         size_t inl))
...
#define OSSL_FUNC_RAND_CLEAR_SEED 19
    ...
    OSSL_CORE_MAKE_FUNC(size_t, rand_nonce,
                        (void *vctx, unsigned char *out, unsigned int strength, size_t min_noncelen,
                         size_t max_noncelen))
...
/* Key data subset selection - combinations */
#define OSSL_SKEYMGMT_SELECT_ALL (OSSL_SKEYMGMT_SELECT_PARAMETERS | OSSL_SKEYMGMT_SELECT_SECRET_KEY)
