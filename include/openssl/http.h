...
#define OPENSSL_HTTPS_PROXY "HTTPS_PROXY"
  ...
  int OSSL_parse_url (const char *url, char **pscheme, char **puser,
                      char **phost, char **pport, int *pport_num, char **ppath,
...
#define OSSL_HTTP_DEFAULT_MAX_RESP_HDR_LINES 256
  ...
  int OSSL_HTTP_REQ_CTX_set_request_line (OSSL_HTTP_REQ_CTX *rctx,
                                          int method_POST, const char *server,
  ...
  BIO *OSSL_HTTP_transfer (OSSL_HTTP_REQ_CTX **prctx, const char *server,
                           ...
                           BIO *rbio, OSSL_HTTP_bio_cb_t bio_update_fn,
                           void *arg, int buf_size,
                           const STACK_OF (CONF_VALUE) *headers,
                           const char *content_type, BIO *req,
                           const char *expected_content_type, int expect_asn1,
  ...
  /* Auxiliary functions */
  int OSSL_HTTP_parse_url (const char *url, int *pssl, char **puser,
                           char **phost, char **pport, int *pport_num,
