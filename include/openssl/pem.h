...
#define PEM_read_cb_ex_fnsig(name, type, INTYPE, readname)                                                             \
    type *PEM_##readname##_##name##_ex(INTYPE *out, type **x, pem_password_cb *cb, void *u, OSSL_LIB_CTX *libctx,      \
                                       const char *propq)
...
#define PEM_write_cb_fnsig(name, type, OUTTYPE, writename)                                                             \
    int PEM_##writename##_##name(OUTTYPE *out, const type *x, const EVP_CIPHER *enc, const unsigned char *kstr,        \
...
#define PEM_write_cb_ex_fnsig(name, type, OUTTYPE, writename)                                                          \
    int PEM_##writename##_##name##_ex(OUTTYPE *out, const type *x, const EVP_CIPHER *enc, const unsigned char *kstr,   \
                                      int klen, pem_password_cb *cb, void *u, OSSL_LIB_CTX *libctx, const char *propq)
...
#define PEM_FLAG_ONLY_B64 0x4
    ...
    int PEM_ASN1_write_bio_ctx(OSSL_i2d_of_void_ctx *i2d, void *vctx, const char *name, BIO *bp, const void *x,
                               const EVP_CIPHER *enc, const unsigned char *kstr, int klen, pem_password_cb *cb,
                               void *u);
