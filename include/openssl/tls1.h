...
#define TLSEXT_MAXLEN_host_name 255
   ...
   * and optional context. (Since a zero length context is allowed, the
   * |use_context| flag controls whether a context is included.) It returns 1
   * on success and 0 or -1 otherwise.
   */
  __owur int SSL_export_keying_material (SSL *s, unsigned char *out,
  ...
  int SSL_get_sigalgs (SSL *s, int idx, int *psign, int *phash,
...
#define TLS1_RFC_ECDHE_ECDSA_WITH_AES_128_CCM                                 \
  "TLS_ECDHE_ECDSA_WITH_AES_128_CCM"
#define TLS1_RFC_ECDHE_ECDSA_WITH_AES_256_CCM                                 \
...
#define TLS1_RFC_DHE_PSK_WITH_AES_128_CBC_SHA                                 \
  "TLS_DHE_PSK_WITH_AES_128_CBC_SHA"
#define TLS1_RFC_DHE_PSK_WITH_AES_256_CBC_SHA                                 \
...
#define TLS1_RFC_ECDHE_ECDSA_WITH_RC4_128_SHA                                 \
...
#define TLS1_RFC_RSA_WITH_ARIA_128_GCM_SHA256                                 \
  "TLS_RSA_WITH_ARIA_128_GCM_SHA256"
#define TLS1_RFC_RSA_WITH_ARIA_256_GCM_SHA384                                 \
...
#define TLS1_RFC_PSK_WITH_ARIA_128_GCM_SHA256                                 \
  "TLS_PSK_WITH_ARIA_128_GCM_SHA256"
#define TLS1_RFC_PSK_WITH_ARIA_256_GCM_SHA384                                 \
...
#define TLS1_TXT_DH_DSS_WITH_CAMELLIA_128_CBC_SHA256                          \
...
#define TLS1_TXT_DH_DSS_WITH_CAMELLIA_256_CBC_SHA256                          \
  "DH-DSS-CAMELLIA256-SHA256"
#define TLS1_TXT_DH_RSA_WITH_CAMELLIA_256_CBC_SHA256                          \
...
#define TLS1_TXT_ECDHE_PSK_WITH_AES_128_CBC_SHA256                            \
  "ECDHE-PSK-AES128-CBC-SHA256"
#define TLS1_TXT_ECDHE_PSK_WITH_AES_256_CBC_SHA384                            \
