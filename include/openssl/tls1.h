...
#define TLSEXT_MAXLEN_host_name 255
   ...
   * optional context. (Since a zero length context is allowed, the
   * |use_context| flag controls whether a context is included.) It returns 1 on
   * success and 0 or -1 otherwise.
   */
...
#define SSL_set_tlsext_host_name(s, name)                                      \
  SSL_ctrl(                                                                    \
    s, SSL_CTRL_SET_TLSEXT_HOSTNAME, TLSEXT_NAMETYPE_host_name, (void*)name)
