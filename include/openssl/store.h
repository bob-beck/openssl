 ...
 */
#ifndef OPENSSL_NO_DEPRECATED_3_0
  OSSL_DEPRECATEDIN_3_0 int OSSL_STORE_ctrl(OSSL_STORE_CTX* ctx,
                                            int cmd,
                                            ... /* args */);
  OSSL_DEPRECATEDIN_3_0 int OSSL_STORE_vctrl(OSSL_STORE_CTX* ctx,
                                             int cmd,
                                             va_list args);
#endif
...
#define OSSL_STORE_INFO_CRL 6    /* X509_CRL * */
  ...
  const char* OSSL_STORE_INFO_get0_NAME_description(
...
#define OSSL_STORE_SEARCH_BY_ALIAS 4
  ...
  const char* OSSL_STORE_LOADER_get0_properties(
    const OSSL_STORE_LOADER* loader);
  ...
  typedef OSSL_STORE_LOADER_CTX* (*OSSL_STORE_attach_fn)(
    ...
    const UI_METHOD* ui_method,
    void* ui_data);
  typedef int (*OSSL_STORE_ctrl_fn)(OSSL_STORE_LOADER_CTX* ctx,
                                    int cmd,
                                    va_list args);
