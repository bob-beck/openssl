...
#define DSA_is_prime(n, callback, cb_arg)                                     \
  ...
  OSSL_DEPRECATEDIN_3_0 int DSA_set0_pqg (DSA *d, BIGNUM *p, BIGNUM *q,
                                          BIGNUM *g);
  ...
  OSSL_DEPRECATEDIN_3_0 int (*DSA_meth_get_bn_mod_exp (
      const DSA_METHOD *dsam)) (DSA *, BIGNUM *, const BIGNUM *,
  ...
  OSSL_DEPRECATEDIN_3_0 int (*DSA_meth_get_init (const DSA_METHOD *dsam)) (
      DSA *);
