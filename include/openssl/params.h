...
#define OSSL_PARAM_uint(key, addr)                                             \
  OSSL_PARAM_DEFN(                                                             \
    (key), OSSL_PARAM_UNSIGNED_INTEGER, (addr), sizeof(unsigned int))
...
#define OSSL_PARAM_ulong(key, addr)                                            \
  OSSL_PARAM_DEFN(                                                             \
    (key), OSSL_PARAM_UNSIGNED_INTEGER, (addr), sizeof(unsigned long int))
...
#define OSSL_PARAM_octet_ptr(key, addr, sz)                                    \
  ...
  OSSL_PARAM OSSL_PARAM_construct_ulong(const char* key,
  ...
  int OSSL_PARAM_print_to_bio(const OSSL_PARAM* params,
                              BIO* bio,
                              int print_values);
