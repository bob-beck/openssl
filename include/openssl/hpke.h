...
#define OSSL_HPKE_SUITE_DEFAULT                                               \
  ...
  int OSSL_HPKE_keygen (OSSL_HPKE_SUITE suite, unsigned char *pub,
                        size_t *publen, EVP_PKEY **priv,
                        const unsigned char *ikm, size_t ikmlen,
                        OSSL_LIB_CTX *libctx, const char *propq);
  int OSSL_HPKE_decap (OSSL_HPKE_CTX *ctx, const unsigned char *enc,
                       size_t enclen, EVP_PKEY *recippriv,
                       const unsigned char *info, size_t infolen);
  ...
  int OSSL_HPKE_get_grease_value (const OSSL_HPKE_SUITE *suite_in,
                                  ...
                                  size_t *enclen, unsigned char *ct,
                                  size_t ctlen, OSSL_LIB_CTX *libctx,
                                  const char *propq);
