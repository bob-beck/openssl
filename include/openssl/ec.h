...
#include <openssl/params.h>
   ...
   */
  OSSL_PARAM* EC_GROUP_to_params(const EC_GROUP* group,
                                 OSSL_LIB_CTX* libctx,
                                 const char* propq,
                                 BN_CTX* bnctx);
  ...
  int EC_GROUP_check_named_curve(const EC_GROUP* group,
                                 int nist_only,
                                 BN_CTX* ctx);
...
/* other interfaces to point2oct/oct2point: */
   ...
   */
  OSSL_DEPRECATEDIN_3_0 int EC_GROUP_have_precompute_mult(
    const EC_GROUP* group);
#endif /* OPENSSL_NO_DEPRECATED_3_0 */
...
#define d2i_ECPKParameters_fp(fp, x)                                           \
  (EC_GROUP*)ASN1_d2i_fp(                                                      \
    NULL, (d2i_of_void*)d2i_ECPKParameters, (fp), (void**)(x))
#define i2d_ECPKParameters_fp(fp, x)                                           \
  ASN1_i2d_fp((i2d_of_void*)i2d_ECPKParameters, (fp), (void*)(x))

#ifndef OPENSSL_NO_DEPRECATED_3_0
  OSSL_DEPRECATEDIN_3_0 int ECPKParameters_print(BIO* bp,
                                                 const EC_GROUP* x,
                                                 int off);
#ifndef OPENSSL_NO_STDIO
  OSSL_DEPRECATEDIN_3_0 int ECPKParameters_print_fp(FILE* fp,
                                                    const EC_GROUP* x,
                                                    int off);
#endif
#endif /* OPENSSL_NO_DEPRECATED_3_0 */
...
#define EC_FLAG_FIPS_CHECKED 0x0000
   ...
   */
  OSSL_DEPRECATEDIN_3_0 const BIGNUM* EC_KEY_get0_private_key(
    const EC_KEY* key);
   ...
   */
  OSSL_DEPRECATEDIN_3_0 const EC_POINT* EC_KEY_get0_public_key(
    const EC_KEY* key);
  ...
  OSSL_DEPRECATEDIN_3_0 void EC_KEY_set_conv_form(
    EC_KEY* eckey,
...
#define EC_KEY_get_ex_new_index(l, p, newf, dupf, freef)                       \
   ...
   *  \return 1 on success and 0 if an error occurred
   */
  OSSL_DEPRECATEDIN_3_0 int EC_KEY_print_fp(FILE* fp,
                                            const EC_KEY* key,
                                            int off);
  ...
  OSSL_DEPRECATEDIN_3_0 void EC_KEY_set_default_method(
    const EC_KEY_METHOD* meth);
  OSSL_DEPRECATEDIN_3_0 const EC_KEY_METHOD* EC_KEY_get_method(
    const EC_KEY* key);
   ...
   *  \return 1 on success and 0 otherwise
   */
  OSSL_DEPRECATEDIN_3_0 int ECDSA_sign_setup(EC_KEY* eckey,
                                             BN_CTX* ctx,
                                             BIGNUM** kinv,
                                             BIGNUM** rp);
   ...
   *  \return 1 on success and 0 otherwise
   */
  OSSL_DEPRECATEDIN_3_0 int ECDSA_sign(int type,
   ...
   *          and -1 on error
   */
  OSSL_DEPRECATEDIN_3_0 int ECDSA_verify(int type,
                                         const unsigned char* dgst,
                                         int dgstlen,
  ...
  OSSL_DEPRECATEDIN_3_0 void EC_KEY_METHOD_set_keygen(
    EC_KEY_METHOD* meth,
  ...
  OSSL_DEPRECATEDIN_3_0 void EC_KEY_METHOD_set_sign(
    ...
    int (*sign)(int type,
                ...
                EC_KEY* eckey),
    int (
      *sign_setup)(EC_KEY* eckey, BN_CTX* ctx_in, BIGNUM** kinvp, BIGNUM** rp),
