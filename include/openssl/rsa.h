...
#define RSA_get_app_data(s) RSA_get_ex_data (s, 0)
  ...
  OSSL_DEPRECATEDIN_3_0 int RSA_set0_key (RSA *r, BIGNUM *n, BIGNUM *e,
                                          BIGNUM *d);
  ...
  OSSL_DEPRECATEDIN_3_0 const RSA_PSS_PARAMS *
...
/* Deprecated version */
  ...
  RSA_generate_key (int bits, unsigned long e,
...
/* New version */
  ...
  int RSA_X931_derive_ex (RSA *rsa, BIGNUM *p1, BIGNUM *p2, BIGNUM *q1,
                          ...
                          const BIGNUM *Xq2, const BIGNUM *Xq, const BIGNUM *e,
                          BN_GENCB *cb);
  OSSL_DEPRECATEDIN_3_0 int
  ...
  OSSL_DEPRECATEDIN_3_0 BN_BLINDING *RSA_setup_blinding (RSA *rsa,
                                                         BN_CTX *ctx);
...
#define RSA_FLAG_CHECKED 0x0800
  ...
  int RSA_meth_set_mod_exp (RSA_METHOD *rsa,
                            int (*mod_exp) (BIGNUM *r0, const BIGNUM *i,
                                            RSA *rsa, BN_CTX *ctx));
  OSSL_DEPRECATEDIN_3_0
