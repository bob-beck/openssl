...
static int
sslcon_undefined_function_1 (SSL_CONNECTION *sc, unsigned char *r, size_t s,
 ...
 */
const SSL_CIPHER *
ssl3_choose_cipher (SSL_CONNECTION *s, STACK_OF (SSL_CIPHER) *clnt,
 ...
 * should do a renegotiation now and sets up the state machine for it.
 * Otherwise returns 0.
 */
int
 ...
 */
int
ssl_fill_hello_random (SSL_CONNECTION *s, int server, unsigned char *result,
...
int
ssl_generate_master_secret (SSL_CONNECTION *s, unsigned char *pms,
...
int
ssl_derive (SSL_CONNECTION *s, EVP_PKEY *privkey, EVP_PKEY *pubkey,
            int gensecret)
{
  int rv = 0;
...
int
ssl_decapsulate (SSL_CONNECTION *s, EVP_PKEY *privkey, const unsigned char *ct,
                 size_t ctlen, int gensecret)
{
  int rv = 0;
  unsigned char *pms = NULL;
  size_t pmslen = 0;
...
int
ssl_encapsulate (SSL_CONNECTION *s, EVP_PKEY *pubkey, unsigned char **ctp,
