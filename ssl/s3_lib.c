...
static int ssl3_read_internal(SSL* s,
                              void* buf,
                              size_t len,
                              int peek,
                              size_t* readbytes) {
 ...
 */
int ssl_fill_hello_random(SSL_CONNECTION* s,
                          int server,
...
int ssl_generate_master_secret(SSL_CONNECTION* s,
                               unsigned char* pms,
                               size_t pmslen,
                               int free_pms) {
...
int ssl_derive(SSL_CONNECTION* s,
               EVP_PKEY* privkey,
               EVP_PKEY* pubkey,
               int gensecret) {
  int rv = 0;
...
int ssl_decapsulate(SSL_CONNECTION* s,
                    EVP_PKEY* privkey,
...
int ssl_encapsulate(SSL_CONNECTION* s,
                    EVP_PKEY* pubkey,
                    unsigned char** ctp,
                    size_t* ctlenp,
                    int gensecret) {
