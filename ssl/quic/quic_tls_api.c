...
static int
crypto_send_cb (const unsigned char *buf, size_t buf_len, size_t *consumed,
                void *arg)
{
  SSL *s = (SSL *)arg;
...
static int
crypto_recv_rcd_cb (const unsigned char **buf, size_t *bytes_read, void *arg)
{
  SSL *s = (SSL *)arg;
  SSL_CONNECTION *sc = SSL_CONNECTION_FROM_SSL (s);
...
static int
crypto_release_rcd_cb (size_t bytes_read, void *arg)
{
  SSL *s = (SSL *)arg;
  SSL_CONNECTION *sc = SSL_CONNECTION_FROM_SSL (s);
...
static int
yield_secret_cb (uint32_t prot_level, int direction, uint32_t suite_id,
                 EVP_MD *md, const unsigned char *secret, size_t secret_len,
                 void *arg)
{
  SSL *s = (SSL *)arg;
  SSL_CONNECTION *sc = SSL_CONNECTION_FROM_SSL (s);
...
static int
got_transport_params_cb (const unsigned char *params, size_t params_len,
                         void *arg)
{
  SSL *s = (SSL *)arg;
  SSL_CONNECTION *sc = SSL_CONNECTION_FROM_SSL (s);
...
static int
alert_cb (void *arg, unsigned char alert_code)
{
  SSL *s = (SSL *)arg;
  SSL_CONNECTION *sc = SSL_CONNECTION_FROM_SSL (s);
...
static int
tls_callbacks_from_dispatch (OSSL_QUIC_TLS_CALLBACKS *qtcb,
...
int
SSL_set_quic_tls_cbs (SSL *s, const OSSL_DISPATCH *qtdis, void *arg)
{
  SSL_CONNECTION *sc = SSL_CONNECTION_FROM_SSL (s);
...
int
SSL_set_quic_tls_transport_params (SSL *s, const unsigned char *params,
                                   size_t params_len)
{
  SSL_CONNECTION *sc = SSL_CONNECTION_FROM_SSL (s);
...
int
SSL_set_quic_tls_early_data_enabled (SSL *s, int enabled)
{
  SSL_CONNECTION *sc = SSL_CONNECTION_FROM_SSL (s);
