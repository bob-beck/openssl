...
int
ossl_quic_thread_assist_init_start (QUIC_THREAD_ASSIST *qta, QUIC_CHANNEL *ch)
{
...
int
ossl_quic_thread_assist_stop_async (QUIC_THREAD_ASSIST *qta)
{
  if (!qta->teardown)
    {
      qta->teardown = 1;
...
int
ossl_quic_thread_assist_wait_stopped (QUIC_THREAD_ASSIST *qta)
{
...
int
ossl_quic_thread_assist_cleanup (QUIC_THREAD_ASSIST *qta)
{
...
int
ossl_quic_thread_assist_notify_deadline_changed (QUIC_THREAD_ASSIST *qta)
{
  if (qta->teardown)
    return 0;
