...
int
ossl_quic_hdr_protector_init (QUIC_HDR_PROTECTOR *hpr, OSSL_LIB_CTX *libctx,
...
static int
hdr_generate_mask (QUIC_HDR_PROTECTOR *hpr, const unsigned char *sample,
                   size_t sample_len, unsigned char *mask)
{
  int l = 0;
...
int
ossl_quic_wire_decode_pkt_hdr (PACKET *pkt, size_t short_conn_id_len,
...
int
ossl_quic_wire_encode_pkt_hdr (WPACKET *pkt, size_t short_conn_id_len,
...
int
ossl_quic_wire_encode_pkt_hdr_pn (QUIC_PN pn, unsigned char *enc_pn,
                                  size_t enc_pn_len)
{
  switch (enc_pn_len)
    {
