                          ...
                          void                 *arg)
{
    ...
    if (SSL_select_next_proto((unsigned char **)out, outlen, alpn, (unsigned int)alpnlen, in, inlen)
...
void ossl_quic_tserver_set_msg_callback(
    QUIC_TSERVER *srv,
    void (*f)(int write_p, int version, int content_type, const void *buf, size_t len, SSL *ssl, void *arg),
    void *arg)
{
