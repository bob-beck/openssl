...
QUIC_TSERVER *
ossl_quic_tserver_new (const QUIC_TSERVER_ARGS *args, const char *certfile,
                       const char *keyfile)
{
...
int
ossl_quic_tserver_read (QUIC_TSERVER *srv, uint64_t stream_id,
...
int
ossl_quic_tserver_write (QUIC_TSERVER *srv, uint64_t stream_id,
...
int
ossl_quic_tserver_stream_new (QUIC_TSERVER *srv, int is_uni,
                              uint64_t *stream_id)
{
  QUIC_STREAM *qs;
...
int
ossl_quic_tserver_is_stream_totally_acked (QUIC_TSERVER *srv,
                                           uint64_t stream_id)
{
  QUIC_STREAM *qs;
...
int
ossl_quic_tserver_set_max_early_data (QUIC_TSERVER *srv,
