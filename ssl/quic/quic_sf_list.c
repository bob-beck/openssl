...
static STREAM_FRAME* stream_frame_new(UINT_RANGE* range,
                                      OSSL_QRX_PKT* pkt,
                                      const unsigned char* data) {
...
static int append_frame(SFRAME_LIST* fl,
                        UINT_RANGE* range,
                        OSSL_QRX_PKT* pkt,
                        const unsigned char* data) {
...
int ossl_sframe_list_insert(SFRAME_LIST* fl,
                            UINT_RANGE* range,
                            OSSL_QRX_PKT* pkt,
                            const unsigned char* data,
                            int fin) {
...
int ossl_sframe_list_peek(const SFRAME_LIST* fl,
                          void** iter,
                          UINT_RANGE* range,
                          const unsigned char** data,
                          int* fin) {
...
int ossl_sframe_list_lock_head(SFRAME_LIST* fl,
                               UINT_RANGE* range,
                               const unsigned char** data,
                               int* fin) {
  int ret;
