...
OSSL_QRL_ENC_LEVEL*
ossl_qrl_enc_level_set_get(OSSL_QRL_ENC_LEVEL_SET* els,
                           uint32_t enc_level,
                           int require_prov)
{
...
int
ossl_qrl_enc_level_set_have_el(OSSL_QRL_ENC_LEVEL_SET* els, uint32_t enc_level)
{
...
int
ossl_qrl_enc_level_set_has_keyslot(OSSL_QRL_ENC_LEVEL_SET* els,
                                   uint32_t enc_level,
...
static void
el_teardown_keyslot(OSSL_QRL_ENC_LEVEL_SET* els,
                    uint32_t enc_level,
                    size_t keyslot)
{
  OSSL_QRL_ENC_LEVEL* el = ossl_qrl_enc_level_set_get(els, enc_level, 0);
...
static int
el_setup_keyslot(OSSL_QRL_ENC_LEVEL_SET* els,
                 uint32_t enc_level,
                 unsigned char tgt_state,
                 size_t keyslot,
                 ...
                 size_t secret_len)
{
  ...
  /* Derive "quic iv" key. */
  if (!tls13_hkdf_expand_ex(el->libctx,
                            el->propq,
                            el->md,
                            secret,
                            quic_v1_iv_label,
...
int
ossl_qrl_enc_level_set_provide_secret(OSSL_QRL_ENC_LEVEL_SET* els,
                                      OSSL_LIB_CTX* libctx,
                                      const char* propq,
                                      uint32_t enc_level,
                                      uint32_t suite_id,
                                      ...
                                      int is_tx)
{
  ...
  /* Derive "quic hp" key. */
  if (!tls13_hkdf_expand_ex(libctx,
                            propq,
                            md,
                            secret,
                            quic_v1_hp_label,
...
int
ossl_qrl_enc_level_set_key_update(OSSL_QRL_ENC_LEVEL_SET* els,
                                  uint32_t enc_level)
{
  OSSL_QRL_ENC_LEVEL* el = ossl_qrl_enc_level_set_get(els, enc_level, 0);
  size_t secret_len;
  ...
  if (!el_setup_keyslot(
        els, enc_level, QRL_EL_STATE_PROV_NORMAL, 0, el->ku, secret_len))
    return 0;
...
int
ossl_qrl_enc_level_set_key_update_done(OSSL_QRL_ENC_LEVEL_SET* els,
                                       uint32_t enc_level)
{
  OSSL_QRL_ENC_LEVEL* el = ossl_qrl_enc_level_set_get(els, enc_level, 0);
 ...
 */
int
ossl_qrl_enc_level_set_key_cooldown_done(OSSL_QRL_ENC_LEVEL_SET* els,
                                         uint32_t enc_level)
{
  OSSL_QRL_ENC_LEVEL* el = ossl_qrl_enc_level_set_get(els, enc_level, 0);
  size_t secret_len;
 ...
 */
void
ossl_qrl_enc_level_set_discard(OSSL_QRL_ENC_LEVEL_SET* els, uint32_t enc_level)
{
  OSSL_QRL_ENC_LEVEL* el = ossl_qrl_enc_level_set_get(els, enc_level, 0);
