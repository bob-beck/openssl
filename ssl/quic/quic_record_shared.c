...
OSSL_QRL_ENC_LEVEL *
ossl_qrl_enc_level_set_get (OSSL_QRL_ENC_LEVEL_SET *els, uint32_t enc_level,
                            int require_prov)
{
...
int
ossl_qrl_enc_level_set_have_el (OSSL_QRL_ENC_LEVEL_SET *els,
                                uint32_t enc_level)
{
...
static void
el_teardown_keyslot (OSSL_QRL_ENC_LEVEL_SET *els, uint32_t enc_level,
                     size_t keyslot)
{
  OSSL_QRL_ENC_LEVEL *el = ossl_qrl_enc_level_set_get (els, enc_level, 0);
...
static int
el_setup_keyslot (OSSL_QRL_ENC_LEVEL_SET *els, uint32_t enc_level,
                  unsigned char tgt_state, size_t keyslot,
...
ossl_qrl_enc_level_set_provide_secret (OSSL_QRL_ENC_LEVEL_SET *els,
                                       ...
                                       uint32_t enc_level, uint32_t suite_id,
 ...
 */
void
ossl_qrl_enc_level_set_discard (OSSL_QRL_ENC_LEVEL_SET *els,
                                uint32_t enc_level)
{
  OSSL_QRL_ENC_LEVEL *el = ossl_qrl_enc_level_set_get (els, enc_level, 0);
