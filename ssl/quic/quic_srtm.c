 ...
 * the first item.
 */
static SRTM_ITEM* srtm_find(QUIC_SRTM* srtm,
                            void* opaque,
                            uint64_t seq_num,
                            SRTM_ITEM** head_p,
                            SRTM_ITEM** prev_p) {
 ...
 * unchanged).
 */
static void sorted_insert_seq_num(SRTM_ITEM* head,
                                  SRTM_ITEM* item,
                                  SRTM_ITEM** new_head) {
 ...
 * unchanged).
 */
static void sorted_insert_srt(SRTM_ITEM* head,
                              SRTM_ITEM* item,
                              SRTM_ITEM** new_head) {
 ...
 * is formed.
 */
static int srtm_compute_blinded(QUIC_SRTM* srtm,
                                SRTM_ITEM* item,
...
int ossl_quic_srtm_add(QUIC_SRTM* srtm,
                       void* opaque,
                       uint64_t seq_num,
                       const QUIC_STATELESS_RESET_TOKEN* token) {
