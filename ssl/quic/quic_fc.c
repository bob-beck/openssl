...
int ossl_quic_rxfc_init(QUIC_RXFC* rxfc,
                        QUIC_RXFC* conn_rxfc,
...
static void rxfc_adjust_window_size(QUIC_RXFC* rxfc,
...
static void rxfc_update_cwm(QUIC_RXFC* rxfc,
                            uint64_t min_window_size,
                            OSSL_TIME rtt) {
  uint64_t new_cwm;
...
static int rxfc_on_retire(QUIC_RXFC* rxfc,
                          uint64_t num_bytes,
                          uint64_t min_window_size,
                          OSSL_TIME rtt) {
