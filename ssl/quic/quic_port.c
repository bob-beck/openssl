...
static void port_default_packet_handler(QUIC_URXE* e,
                                        void* arg,
...
static QUIC_CHANNEL* port_make_channel(QUIC_PORT* port,
                                       SSL* tls,
                                       OSSL_QRX* qrx,
                                       int is_server,
                                       int is_tserver) {
 ...
 */
void ossl_quic_port_subtick(QUIC_PORT* port,
 ...
 */
static int generate_token(BIO_ADDR* peer,
                          QUIC_CONN_ID odcid,
                          QUIC_CONN_ID rscid,
 ...
 */
static void port_send_version_negotiation(QUIC_PORT* port,
                                          BIO_ADDR* peer,
                                          QUIC_PKT_HDR* client_hdr) {
  BIO_MSG msg[1];
