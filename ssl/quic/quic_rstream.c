...
int ossl_quic_rstream_queue_data(QUIC_RSTREAM* qrs,
                                 OSSL_QRX_PKT* pkt,
                                 uint64_t offset,
...
static int read_internal(QUIC_RSTREAM* qrs,
                         unsigned char* buf,
                         size_t size,
                         size_t* readbytes,
                         int* fin,
...
int ossl_quic_rstream_read(QUIC_RSTREAM* qrs,
                           unsigned char* buf,
                           size_t size,
                           size_t* readbytes,
                           int* fin) {
...
int ossl_quic_rstream_peek(QUIC_RSTREAM* qrs,
                           unsigned char* buf,
                           size_t size,
                           size_t* readbytes,
                           int* fin) {
