...
int
ossl_quic_rstream_queue_data (QUIC_RSTREAM *qrs, OSSL_QRX_PKT *pkt,
...
static int
read_internal (QUIC_RSTREAM *qrs, unsigned char *buf, size_t size,
...
int
ossl_quic_rstream_read (QUIC_RSTREAM *qrs, unsigned char *buf, size_t size,
...
int
ossl_quic_rstream_peek (QUIC_RSTREAM *qrs, unsigned char *buf, size_t size,
                        size_t *readbytes, int *fin)
{
...
int
ossl_quic_rstream_get_record (QUIC_RSTREAM *qrs, const unsigned char **record,
...
static int
write_at_ring_buf_cb (uint64_t logical_offset, const unsigned char *buf,
