...
static int qrx_validate_hdr_early(OSSL_QRX* qrx,
                                  RXE* rxe,
                                  const QUIC_CONN_ID* first_dcid);
static int qrx_relocate_buffer(OSSL_QRX* qrx,
                               RXE** prxe,
                               size_t* pi,
 ...
 */
static int qrx_validate_initial_pkt(OSSL_QRX* qrx,
                                    QUIC_URXE* urxe,
                                    const QUIC_CONN_ID* first_dcid,
                                    size_t datagram_len) {
  PACKET pkt, orig_pkt;
...
int ossl_qrx_validate_initial_packet(OSSL_QRX* qrx,
                                     QUIC_URXE* urxe,
...
static int qrx_process_datagram(OSSL_QRX* qrx,
                                QUIC_URXE* e,
...
void ossl_qrx_set_msg_callback(OSSL_QRX* qrx,
                               ossl_msg_cb msg_callback,
                               SSL* msg_callback_ssl) {
