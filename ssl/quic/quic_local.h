...
/*
 * QUIC stream SSL object (QSSO) type. This implements the API personality
 * layer for QSSO objects, wrapping the QUIC-native QUIC_STREAM object and
 * tracking state required by the libssl API personality.
 */
struct quic_xso_st
{
...
/*
 * QUIC domain SSL object (QDSO) type. This implements the API personality
 * layer for QDSO objects, wrapping the QUIC-native QUIC_ENGINE object.
 */
