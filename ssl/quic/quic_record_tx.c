...
void ossl_qtx_set_qlog_cb(OSSL_QTX* qtx,
                          QLOG* (*get_qlog_cb)(void* arg),
                          void* get_qlog_cb_arg) {
...
static int qtx_write_hdr(OSSL_QTX* qtx,
...
static int qtx_mutate_write(OSSL_QTX* qtx,
                            const OSSL_QTX_PKT* pkt,
                            TXE* txe,
                            uint32_t enc_level) {
  int ret;
...
void ossl_qtx_set_msg_callback(OSSL_QTX* qtx,
                               ossl_msg_cb msg_callback,
                               SSL* msg_callback_ssl) {
