...
static int depack_do_frame_ping(PACKET* pkt,
                                QUIC_CHANNEL* ch,
                                uint32_t enc_level,
...
static int depack_do_frame_new_token(PACKET* pkt,
                                     QUIC_CHANNEL* ch,
                                     OSSL_ACKM_RX_PKT* ackm_data) {
  const uint8_t* token;
  size_t token_len;
...
static int depack_do_frame_max_data(PACKET* pkt,
                                    QUIC_CHANNEL* ch,
                                    OSSL_ACKM_RX_PKT* ackm_data) {
  uint64_t max_data = 0;
...
static int depack_do_frame_conn_close(PACKET* pkt,
                                      QUIC_CHANNEL* ch,
                                      uint64_t frame_type) {
