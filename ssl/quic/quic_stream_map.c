...
#define accept_head(l)                                                        \
  list_next ((l), (l), offsetof (QUIC_STREAM, accept_node))
...
int
ossl_quic_stream_map_ensure_send_part_id (QUIC_STREAM_MAP *qsm,
                                          QUIC_STREAM *qs)
{
  switch (qs->send_state)
    {
...
int
ossl_quic_stream_map_notify_all_data_sent (QUIC_STREAM_MAP *qsm,
                                           QUIC_STREAM *qs)
{
  switch (qs->send_state)
    {
...
int
ossl_quic_stream_map_notify_totally_acked (QUIC_STREAM_MAP *qsm,
                                           QUIC_STREAM *qs)
{
  switch (qs->send_state)
    {
...
int
ossl_quic_stream_map_notify_totally_read (QUIC_STREAM_MAP *qsm,
                                          QUIC_STREAM *qs)
{
  switch (qs->recv_state)
    {
 ...
 */
void
ossl_quic_stream_iter_init (QUIC_STREAM_ITER *it, QUIC_STREAM_MAP *qsm,
                            int advance_rr)
{
  it->qsm = qsm;
