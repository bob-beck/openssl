...
int
ossl_quic_wire_encode_frame_ack (WPACKET *pkt, uint32_t ack_delay_exponent,
...
int
ossl_quic_wire_encode_frame_max_stream_data (WPACKET *pkt, uint64_t stream_id,
                                             uint64_t max_data)
{
...
int
ossl_quic_wire_encode_frame_max_streams (WPACKET *pkt, char is_uni,
...
int
ossl_quic_wire_encode_frame_streams_blocked (WPACKET *pkt, char is_uni,
                                             uint64_t max_streams)
{
...
unsigned char *
ossl_quic_wire_encode_transport_param_bytes (WPACKET *pkt, uint64_t id,
...
int
ossl_quic_wire_encode_transport_param_int (WPACKET *pkt, uint64_t id,
                                           uint64_t value)
{
  if (!WPACKET_quic_write_vlint (pkt, id)
...
int
ossl_quic_wire_encode_transport_param_cid (WPACKET *wpkt, uint64_t id,
 ...
 */
int
ossl_quic_wire_peek_frame_header (PACKET *pkt, uint64_t *type,
                                  int *was_minimal)
{
...
static int
expect_frame_header_mask (PACKET *pkt, uint64_t expected_frame_type,
                          uint64_t mask_bits, uint64_t *actual_frame_type)
{
...
int
ossl_quic_wire_decode_frame_ack (PACKET *pkt, uint32_t ack_delay_exponent,
...
int
ossl_quic_wire_decode_frame_crypto (PACKET *pkt, int nodata,
...
int
ossl_quic_wire_decode_frame_stream (PACKET *pkt, int nodata,
...
int
ossl_quic_wire_decode_frame_max_stream_data (PACKET *pkt, uint64_t *stream_id,
                                             uint64_t *max_stream_data)
{
...
int
ossl_quic_wire_decode_frame_streams_blocked (PACKET *pkt,
                                             uint64_t *max_streams)
{
...
const unsigned char *
ossl_quic_wire_decode_transport_param_bytes (PACKET *pkt, uint64_t *id,
                                             size_t *len)
{
  uint64_t len_;
...
int
ossl_quic_wire_decode_transport_param_int (PACKET *pkt, uint64_t *id,
                                           uint64_t *value)
{
  PACKET sub;
...
int
ossl_quic_wire_decode_transport_param_cid (PACKET *pkt, uint64_t *id,
                                           QUIC_CONN_ID *cid)
{
