...
int
ossl_quic_sstream_get_stream_frame (QUIC_SSTREAM *qss, size_t skip,
...
int
ossl_quic_sstream_mark_transmitted (QUIC_SSTREAM *qss, uint64_t start,
                                    uint64_t end)
{
  UINT_RANGE r;
...
int
ossl_quic_sstream_append (QUIC_SSTREAM *qss, const unsigned char *buf,
