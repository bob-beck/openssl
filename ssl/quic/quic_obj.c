...
int
ossl_quic_obj_init (QUIC_OBJ *obj, SSL_CTX *ctx, int type, SSL *parent_obj,
...
SSL_CONNECTION *
ossl_quic_obj_get0_handshake_layer (QUIC_OBJ *obj)
{
...
int
ossl_quic_obj_can_support_blocking (const QUIC_OBJ *obj)
{
  QUIC_REACTOR *rtor;
...
int
ossl_quic_obj_desires_blocking (const QUIC_OBJ *obj)
{
...
int
ossl_quic_obj_blocking (const QUIC_OBJ *obj)
{
  assert (obj != NULL);
...
void
ossl_quic_obj_set_blocking_mode (QUIC_OBJ *obj, unsigned int mode)
{
  assert (obj != NULL);
