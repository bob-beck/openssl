...
static ossl_unused ossl_inline void bit_set(size_t* p,
                                            uint32_t bit_no,
                                            int enable) {
...
int ossl_qlog_set_event_type_enabled(QLOG* qlog,
                                     uint32_t event_type,
                                     int enabled) {
...
void ossl_qlog_str_len(QLOG* qlog,
                       const char* name,
                       const char* value,
                       size_t value_len) {
  if (name != NULL)
...
static int lex_extract_to(struct lexer* lex,
                          char c,
                          const char** str,
                          size_t* str_l) {
 ...
 *        NULL to match any.
 */
static void filter_apply(size_t* enabled,
                         int add,
                         const char* cat,
                         size_t cat_l,
                         const char* event,
