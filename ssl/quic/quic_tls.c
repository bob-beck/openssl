...
static int quic_new_record_layer(OSSL_LIB_CTX* libctx,
                                 const char* propq,
                                 int vers,
                                 int role,
                                 int direction,
...
static size_t quic_get_max_records(OSSL_RECORD_LAYER* rl,
                                   uint8_t type,
                                   size_t len,
                                   size_t maxfrag,
                                   size_t* preffrag) {
...
static int quic_read_record(OSSL_RECORD_LAYER* rl,
                            void** rechandle,
                            int* rversion,
                            uint8_t* type,
...
static int quic_release_record(OSSL_RECORD_LAYER* rl,
                               void* rechandle,
                               size_t length) {
...
static void quic_get_state(OSSL_RECORD_LAYER* rl,
                           const char** shortstr,
                           const char** longstr) {
  /*
...
static int add_transport_params_cb(SSL* s,
...
static void free_transport_params_cb(SSL* s,
                                     unsigned int ext_type,
                                     unsigned int context,
                                     const unsigned char* out,
                                     void* add_arg) {}

static int parse_transport_params_cb(SSL* s,
                                     unsigned int ext_type,
                                     unsigned int context,
...
static int raise_error(QUIC_TLS* qtls,
                       uint64_t error_code,
                       const char* error_msg,
                       const char* src_file,
                       int src_line,
