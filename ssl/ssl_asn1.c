...
ASN1_SEQUENCE (SSL_SESSION_ASN1)
    = { ASN1_EMBED (SSL_SESSION_ASN1, version, UINT32),
        ...
        ASN1_EXP_OPT (SSL_SESSION_ASN1, session_id_context, ASN1_OCTET_STRING,
                      4),
...
#ifndef OPENSSL_NO_PSK
        ASN1_EXP_OPT (SSL_SESSION_ASN1, psk_identity_hint, ASN1_OCTET_STRING,
                      7),
        ASN1_EXP_OPT (SSL_SESSION_ASN1, psk_identity, ASN1_OCTET_STRING, 8),
#endif
        ASN1_EXP_OPT_EMBED (SSL_SESSION_ASN1, tlsext_tick_lifetime_hint,
                            ZUINT64, 9),
        ...
        ASN1_EXP_OPT_EMBED (SSL_SESSION_ASN1, tlsext_tick_age_add, ZUINT32,
                            14),
...
static void
ssl_session_sinit (ASN1_OCTET_STRING **dest, ASN1_OCTET_STRING *os,
                   const char *data)
{
  if (data != NULL)
...
static int
ssl_session_memcpy (unsigned char *dst, size_t *pdstlen,
...
SSL_SESSION *
d2i_SSL_SESSION_ex (SSL_SESSION **a, const unsigned char **pp, long length,
