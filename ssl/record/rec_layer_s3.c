...
static int ossl_early_data_count_ok(SSL_CONNECTION* s,
                                    size_t length,
                                    size_t overhead,
                                    int send) {
  uint32_t max_early_data;
...
static int tls_write_check_pending(SSL_CONNECTION* s,
                                   uint8_t type,
...
int ossl_tls_handle_rlayer_return(SSL_CONNECTION* s,
                                  int writing,
                                  int ret,
                                  char* file,
                                  int line) {
...
static void rlayer_msg_callback_wrapper(int write_p,
                                        int version,
                                        int content_type,
                                        const void* buf,
                                        size_t len,
...
static int rlayer_security_wrapper(void* cbarg,
                                   int op,
                                   int bits,
                                   int nid,
                                   void* other) {
