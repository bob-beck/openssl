...
#define HANDLE_RLAYER_READ_RETURN(s, ret) ossl_tls_handle_rlayer_return(s, 0, ret, OPENSSL_FILE, OPENSSL_LINE)

#define HANDLE_RLAYER_WRITE_RETURN(s, ret) ossl_tls_handle_rlayer_return(s, 1, ret, OPENSSL_FILE, OPENSSL_LINE)
