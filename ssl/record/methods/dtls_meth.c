...
static DTLS_BITMAP *
dtls_get_bitmap (OSSL_RECORD_LAYER *rl, TLS_RL_RECORD *rr,
...
static int
dtls_rlayer_buffer_record (OSSL_RECORD_LAYER *rl, struct pqueue_st *queue,
...
int
dtls_prepare_record_header (OSSL_RECORD_LAYER *rl, WPACKET *thispkt,
...
int
dtls_post_encryption_processing (OSSL_RECORD_LAYER *rl, size_t mac_size,
