...
static int tls1_set_crypto_state(OSSL_RECORD_LAYER *rl,
                                 int                level,
                                 unsigned char     *key,
                                 size_t             keylen,
                                 unsigned char     *iv,
 ...
 */
static int
tls1_cipher(OSSL_RECORD_LAYER *rl, TLS_RL_RECORD *recs, size_t n_recs, int sending, SSL_MAC_BUF *macs, size_t macsize)
{
    EVP_CIPHER_CTX   *ds;
...
const struct record_functions_st dtls_1_funcs = {tls1_set_crypto_state,
                                                 tls1_cipher,
                                                 tls1_mac,
                                                 tls_default_set_protocol_version,
                                                 tls_default_read_n,
