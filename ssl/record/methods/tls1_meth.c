...
static int
tls1_set_crypto_state (OSSL_RECORD_LAYER *rl, int level, unsigned char *key,
 ...
 */
static int
tls1_cipher (OSSL_RECORD_LAYER *rl, TLS_RL_RECORD *recs, size_t n_recs,
...
static int
tls1_mac (OSSL_RECORD_LAYER *rl, TLS_RL_RECORD *rec, unsigned char *md,
          int sending)
{
...
const struct record_functions_st dtls_1_funcs
    = { tls1_set_crypto_state, tls1_cipher, tls1_mac,
        ...
        /*
         * Don't use tls1_allocate_write_buffers since that handles empty
         * fragment records which aren't needed in DTLS. We just use the
         * default allocation instead.
         */
