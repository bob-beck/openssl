...
void ossl_rlayer_fatal(OSSL_RECORD_LAYER* rl,
                       int al,
                       int reason,
                       const char* fmt,
                       ...);
...
int tls_default_read_n(OSSL_RECORD_LAYER* rl,
                       size_t n,
                       size_t max,
                       int extend,
                       int clearold,
...
size_t tls_get_max_records(OSSL_RECORD_LAYER* rl,
                           ...
                           size_t maxfrag,
                           size_t* preffrag);
int tls_write_records(OSSL_RECORD_LAYER* rl,
                      OSSL_RECORD_TEMPLATE* templates,
                      size_t numtempl);
...
void tls_get_state(OSSL_RECORD_LAYER* rl,
                   const char** shortstr,
                   const char** longstr);
...
int tls_setup_write_buffer(OSSL_RECORD_LAYER* rl,
                           size_t numwpipes,
                           size_t firstlen,
                           size_t nextlen);
...
size_t tls_get_max_records_default(OSSL_RECORD_LAYER* rl,
                                   ...
                                   size_t maxfrag,
                                   size_t* preffrag);
size_t tls_get_max_records_multiblock(OSSL_RECORD_LAYER* rl,
                                      uint8_t type,
                                      size_t len,
                                      size_t maxfrag,
                                      size_t* preffrag);
