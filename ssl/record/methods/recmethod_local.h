...
int tls_default_read_n (OSSL_RECORD_LAYER *rl, size_t n, size_t max,
                        int extend, int clearold, size_t *readbytes);
...
int tls_default_post_process_record (OSSL_RECORD_LAYER *rl,
                                     TLS_RL_RECORD *rec);
