...
#define RLAYERfatal_data (ERR_new(), ERR_set_debug(OPENSSL_FILE, OPENSSL_LINE, OPENSSL_FUNC), ossl_rlayer_fatal)

#define RLAYER_USE_EXPLICIT_IV(rl)                                                                                     \
    ((rl)->version == TLS1_1_VERSION || (rl)->version == TLS1_2_VERSION || (rl)->version == DTLS1_BAD_VER ||           \
     (rl)->version == DTLS1_VERSION || (rl)->version == DTLS1_2_VERSION)
