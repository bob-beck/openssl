...
struct record_functions_st
{
   ...
   */
  int (*set_crypto_state)(OSSL_RECORD_LAYER* rl,
                          int level,
                          unsigned char* key,
                          size_t keylen,
                          unsigned char* iv,
   ...
   */
  int (*cipher)(OSSL_RECORD_LAYER* rl,
                TLS_RL_RECORD* recs,
                size_t n_recs,
                int sending,
                SSL_MAC_BUF* macs,
  ...
  int (*read_n)(OSSL_RECORD_LAYER* rl,
                size_t n,
                size_t max,
                int extend,
                int clearold,
  ...
  int (*prepare_record_header)(OSSL_RECORD_LAYER* rl,
                               WPACKET* thispkt,
...
int
dtls_get_more_records(OSSL_RECORD_LAYER* rl);

int
dtls_prepare_record_header(OSSL_RECORD_LAYER* rl,
                           WPACKET* thispkt,
                           OSSL_RECORD_TEMPLATE* templ,
                           uint8_t rectype,
                           unsigned char** recdata);
int
dtls_post_encryption_processing(OSSL_RECORD_LAYER* rl,
                                size_t mac_size,
                                OSSL_RECORD_TEMPLATE* thistempl,
                                WPACKET* thispkt,
                                TLS_RL_RECORD* thiswr);
...
int
tls_default_validate_record_header(OSSL_RECORD_LAYER* rl, TLS_RL_RECORD* re);
int
...
int
tls_write_records_multiblock(OSSL_RECORD_LAYER* rl,
                             OSSL_RECORD_TEMPLATE* templates,
                             size_t numtempl);
...
tls_get_max_records_default(OSSL_RECORD_LAYER* rl,
                            ...
                            size_t* preffrag);
size_t
tls_get_max_records_multiblock(OSSL_RECORD_LAYER* rl,
                               uint8_t type,
                               size_t len,
                               size_t maxfrag,
                               size_t* preffrag);
...
tls_initialise_write_packets_default(OSSL_RECORD_LAYER* rl,
                                     ...
                                     size_t* wpinited);
int
tls1_allocate_write_buffers(OSSL_RECORD_LAYER* rl,
                            OSSL_RECORD_TEMPLATE* templates,
                            size_t numtempl,
                            size_t* prefix);
int
tls1_initialise_write_packets(OSSL_RECORD_LAYER* rl,
                              OSSL_RECORD_TEMPLATE* templates,
                              size_t numtempl,
                              OSSL_RECORD_TEMPLATE* prefixtempl,
                              WPACKET* pkt,
