...
static int ktls_configure_crypto(OSSL_LIB_CTX       *libctx,
                                 int                 version,
                                 const EVP_CIPHER   *c,
                                 EVP_MD             *md,
                                 void               *rl_sequence,
...
static int ktls_set_crypto_state(OSSL_RECORD_LAYER *rl,
                                 int                level,
                                 unsigned char     *key,
                                 size_t             keylen,
                                 unsigned char     *iv,
...
static int
ktls_cipher(OSSL_RECORD_LAYER *rl, TLS_RL_RECORD *inrecs, size_t n_recs, int sending, SSL_MAC_BUF *mac, size_t macsize)
{
    return 1;
}
...
static int ktls_new_record_layer(OSSL_LIB_CTX        *libctx,
                                 const char          *propq,
                                 int                  vers,
                                 int                  role,
                                 int                  direction,
...
static int
ktls_allocate_write_buffers(OSSL_RECORD_LAYER *rl, OSSL_RECORD_TEMPLATE *templates, size_t numtempl, size_t *prefix)
{
