 ...
 */
static int
ktls_int_check_supported_cipher (OSSL_RECORD_LAYER *rl, const EVP_CIPHER *c,
...
static int
ktls_configure_crypto (OSSL_LIB_CTX *libctx, int version, const EVP_CIPHER *c,
...
static int
ktls_set_crypto_state (OSSL_RECORD_LAYER *rl, int level, unsigned char *key,
...
static int
ktls_read_n (OSSL_RECORD_LAYER *rl, size_t n, size_t max, int extend,
...
static int
ktls_cipher (OSSL_RECORD_LAYER *rl, TLS_RL_RECORD *inrecs, size_t n_recs,
...
static int
ktls_validate_record_header (OSSL_RECORD_LAYER *rl, TLS_RL_RECORD *rec)
{
...
static int
ktls_post_process_record (OSSL_RECORD_LAYER *rl, TLS_RL_RECORD *rec)
{
...
static int
ktls_allocate_write_buffers (OSSL_RECORD_LAYER *rl,
...
static int
ktls_initialise_write_packets (OSSL_RECORD_LAYER *rl,
                               OSSL_RECORD_TEMPLATE *templates,
                               size_t numtempl,
                               OSSL_RECORD_TEMPLATE *prefixtempl, WPACKET *pkt,
                               TLS_BUFFER *bufs, size_t *wpinited)
{
  TLS_BUFFER *wb;
...
static int
ktls_prepare_record_header (OSSL_RECORD_LAYER *rl, WPACKET *thispkt,
...
static int
ktls_prepare_for_encryption (OSSL_RECORD_LAYER *rl, size_t mac_size,
...
static int
ktls_post_encryption_processing (OSSL_RECORD_LAYER *rl, size_t mac_size,
                                 OSSL_RECORD_TEMPLATE *templ, WPACKET *thispkt,
...
static int
ktls_prepare_write_bio (OSSL_RECORD_LAYER *rl, int type)
{
  /*
...
static int
ktls_alloc_buffers (OSSL_RECORD_LAYER *rl)
{
...
static int
ktls_free_buffers (OSSL_RECORD_LAYER *rl)
{
  /* We use the application buffer directly for writing */
  if (rl->direction == OSSL_RECORD_DIRECTION_WRITE)
    return 1;
