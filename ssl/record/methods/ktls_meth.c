 ...
 */
static int
ktls_int_check_supported_cipher(OSSL_RECORD_LAYER* rl,
                                const EVP_CIPHER* c,
                                const EVP_MD* md,
                                size_t taglen)
{
...
static int
ktls_configure_crypto(OSSL_LIB_CTX* libctx,
                      int version,
                      const EVP_CIPHER* c,
                      EVP_MD* md,
                      void* rl_sequence,
                      ...
                      size_t mac_secret_size)
{
  ...
  switch (EVP_CIPHER_get_nid(c)) {
    ...
    case NID_aes_128_gcm:
      ...
      memcpy(crypto_info->gcm128.rec_seq,
             rl_sequence,
    ...
    case NID_aes_256_gcm:
      ...
      memcpy(crypto_info->gcm256.rec_seq,
             rl_sequence,
    ...
    case NID_aes_128_ccm:
      ...
      memcpy(crypto_info->ccm128.rec_seq,
             rl_sequence,
    ...
    case NID_chacha20_poly1305:
      ...
      memcpy(crypto_info->chacha20poly1305.rec_seq,
             rl_sequence,
...
static int
ktls_set_crypto_state(OSSL_RECORD_LAYER* rl,
                      int level,
                      unsigned char* key,
                      size_t keylen,
                      unsigned char* iv,
                      ...
                      COMP_METHOD* comp)
{
  ...
  if (!ktls_configure_crypto(rl->libctx,
                             rl->version,
                             ciph,
                             md,
                             rl->sequence,
...
static int
ktls_read_n(OSSL_RECORD_LAYER* rl,
            size_t n,
            size_t max,
            int extend,
            int clearold,
...
static int
ktls_cipher(OSSL_RECORD_LAYER* rl,
            TLS_RL_RECORD* inrecs,
            size_t n_recs,
            int sending,
            SSL_MAC_BUF* mac,
            size_t macsize)
...
static int
ktls_new_record_layer(OSSL_LIB_CTX* libctx,
                      const char* propq,
                      int vers,
                      int role,
                      int direction,
...
static int
ktls_prepare_record_header(OSSL_RECORD_LAYER* rl,
                           WPACKET* thispkt,
...
static int
ktls_prepare_for_encryption(OSSL_RECORD_LAYER* rl,
                            size_t mac_size,
                            WPACKET* thispkt,
...
static int
ktls_post_encryption_processing(OSSL_RECORD_LAYER* rl,
                                size_t mac_size,
                                OSSL_RECORD_TEMPLATE* templ,
                                WPACKET* thispkt,
                                TLS_RL_RECORD* thiswr)
