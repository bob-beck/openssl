...
void
ossl_rlayer_fatal (OSSL_RECORD_LAYER *rl, int al, int reason, const char *fmt,
                   ...)
{
  va_list args;
...
int
ossl_set_tls_provider_parameters (OSSL_RECORD_LAYER *rl, EVP_CIPHER_CTX *ctx,
...
int
tls_setup_write_buffer (OSSL_RECORD_LAYER *rl, size_t numwpipes,
 ...
 */
int
tls_default_read_n (OSSL_RECORD_LAYER *rl, size_t n, size_t max, int extend,
...
static int
rlayer_early_data_count_ok (OSSL_RECORD_LAYER *rl, size_t length,
...
int
tls_read_record (OSSL_RECORD_LAYER *rl, void **rechandle, int *rversion,
...
size_t
tls_get_max_records_default (OSSL_RECORD_LAYER *rl, uint8_t type, size_t len,
...
size_t
tls_get_max_records (OSSL_RECORD_LAYER *rl, uint8_t type, size_t len,
                     size_t maxfrag, size_t *preffrag)
{
...
int
tls_prepare_record_header_default (OSSL_RECORD_LAYER *rl, WPACKET *thispkt,
...
int
tls_prepare_for_encryption_default (OSSL_RECORD_LAYER *rl, size_t mac_size,
...
int
tls_post_encryption_processing_default (OSSL_RECORD_LAYER *rl, size_t mac_size,
...
int
tls_write_records (OSSL_RECORD_LAYER *rl, OSSL_RECORD_TEMPLATE *templates,
                   size_t numtempl)
{
...
void
tls_get_state (OSSL_RECORD_LAYER *rl, const char **shortstr,
               const char **longstr)
{
  const char *shrt, *lng;
