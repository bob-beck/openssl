...
static int
tls_any_set_crypto_state (OSSL_RECORD_LAYER *rl, int level, unsigned char *key,
...
static int
tls_any_cipher (OSSL_RECORD_LAYER *rl, TLS_RL_RECORD *recs, size_t n_recs,
...
static int
tls_validate_record_header (OSSL_RECORD_LAYER *rl, TLS_RL_RECORD *rec)
{
...
static int
tls_any_set_protocol_version (OSSL_RECORD_LAYER *rl, int vers)
{
...
static int
tls_any_prepare_for_encryption (OSSL_RECORD_LAYER *rl, size_t mac_size,
...
static int
dtls_any_set_protocol_version (OSSL_RECORD_LAYER *rl, int vers)
{
