...
static int tls_any_set_crypto_state(OSSL_RECORD_LAYER *rl,
                                    int                level,
                                    unsigned char     *key,
                                    size_t             keylen,
                                    unsigned char     *iv,
...
static int tls_any_cipher(OSSL_RECORD_LAYER *rl,
                          TLS_RL_RECORD     *recs,
                          size_t             n_recs,
                          int                sending,
                          SSL_MAC_BUF       *macs,
...
static int
tls_any_prepare_for_encryption(OSSL_RECORD_LAYER *rl, size_t mac_size, WPACKET *thispkt, TLS_RL_RECORD *thiswr)
{
