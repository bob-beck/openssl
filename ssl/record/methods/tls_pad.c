...
static int
ssl3_cbc_copy_mac(size_t* reclen,
                  size_t origreclen,
 ...
 */
int
ssl3_cbc_remove_padding_and_mac(size_t* reclen,
                                size_t origreclen,
                                unsigned char* recdata,
                                unsigned char** mac,
                                int* alloced,
                                ...
                                OSSL_LIB_CTX* libctx)
{
  ...
  *reclen -= good & (padding_length + 1);
  ...
  return ssl3_cbc_copy_mac(reclen,
                           origreclen,
                           recdata,
                           mac,
                           alloced,
 ...
 */
int
tls1_cbc_remove_padding_and_mac(size_t* reclen,
                                size_t origreclen,
                                unsigned char* recdata,
                                unsigned char** mac,
                                int* alloced,
