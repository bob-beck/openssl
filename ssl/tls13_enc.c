 ...
 */
int
tls13_hkdf_expand_ex (OSSL_LIB_CTX *libctx, const char *propq,
...
int
tls13_hkdf_expand (SSL_CONNECTION *s, const EVP_MD *md,
                   const unsigned char *secret, const unsigned char *label,
                   size_t labellen, const unsigned char *data, size_t datalen,
 ...
 */
int
tls13_derive_key (SSL_CONNECTION *s, const EVP_MD *md,
 ...
 */
int
tls13_derive_iv (SSL_CONNECTION *s, const EVP_MD *md,
                 const unsigned char *secret, unsigned char *iv, size_t ivlen)
{
...
int
tls13_derive_finishedkey (SSL_CONNECTION *s, const EVP_MD *md,
 ...
 */
int
tls13_generate_secret (SSL_CONNECTION *s, const EVP_MD *md,
 ...
 */
int
tls13_generate_master_secret (SSL_CONNECTION *s, unsigned char *out,
 ...
 */
size_t
tls13_final_finish_mac (SSL_CONNECTION *s, const char *str, size_t slen,
                        unsigned char *out)
{
  const EVP_MD *md = ssl_handshake_md (s);
  const char *mdname = EVP_MD_get0_name (md);
...
static int
derive_secret_key_and_iv (SSL_CONNECTION *s, const EVP_MD *md,
                          const EVP_CIPHER *ciph, int mac_type,
...
int
tls13_export_keying_material (SSL_CONNECTION *s, unsigned char *out,
...
int
tls13_export_keying_material_early (SSL_CONNECTION *s, unsigned char *out,
                                    size_t olen, const char *label,
                                    size_t llen, const unsigned char *context,
                                    size_t contextlen)
{
  /* ASCII: "exporter", in hex for EBCDIC compatibility */
  static const unsigned char exporterlabel[]
