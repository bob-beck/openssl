...
static size_t
ssl_get_compressed_cert (SSL *ssl, CERT_PKEY *cpk, int alg,
...
static int
ossl_set1_compressed_cert (CERT *cert, int algorithm, unsigned char *comp_data,
...
size_t
SSL_get1_compressed_cert (SSL *ssl, int alg, unsigned char **data,
                          size_t *orig_len)
{
#ifndef OPENSSL_NO_COMP_ALG
  SSL_CONNECTION *sc = SSL_CONNECTION_FROM_SSL (ssl);
...
size_t
SSL_CTX_get1_compressed_cert (SSL_CTX *ctx, int alg, unsigned char **data,
                              size_t *orig_len)
{
#ifndef OPENSSL_NO_COMP_ALG
  size_t ret;
...
int
SSL_CTX_set1_compressed_cert (SSL_CTX *ctx, int algorithm,
...
int
SSL_set1_compressed_cert (SSL *ssl, int algorithm, unsigned char *comp_data,
                          size_t comp_length, size_t orig_length)
{
#ifndef OPENSSL_NO_COMP_ALG
  SSL_CONNECTION *sc = SSL_CONNECTION_FROM_SSL (ssl);
