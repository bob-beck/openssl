...
static int
serverinfoex_srv_parse_cb (SSL *s, unsigned int ext_type, unsigned int context,
                           const unsigned char *in, size_t inlen, X509 *x,
                           size_t chainidx, int *al, void *arg)
{
...
static int
serverinfo_srv_parse_cb (SSL *s, unsigned int ext_type,
...
static int
serverinfoex_srv_add_cb (SSL *s, unsigned int ext_type, unsigned int context,
...
static int
serverinfo_srv_add_cb (SSL *s, unsigned int ext_type,
...
static void
extension_append (unsigned int version, const unsigned char *extension,
                  const size_t extension_length, unsigned char *serverinfo)
{
...
int
SSL_CTX_use_serverinfo_ex (SSL_CTX *ctx, unsigned int version,
                           const unsigned char *serverinfo,
                           size_t serverinfo_length)
{
...
static int
ssl_set_cert_and_key (SSL *ssl, SSL_CTX *ctx, X509 *x509, EVP_PKEY *privatekey,
...
int
SSL_use_cert_and_key (SSL *ssl, X509 *x509, EVP_PKEY *privatekey,
                      STACK_OF (X509) *chain, int override)
{
...
int
SSL_CTX_use_cert_and_key (SSL_CTX *ctx, X509 *x509, EVP_PKEY *privatekey,
                          STACK_OF (X509) *chain, int override)
{
