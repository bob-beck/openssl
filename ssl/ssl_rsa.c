 ...
 */
static int use_certificate_chain_file(SSL_CTX* ctx,
                                      SSL* ssl,
                                      const char* file) {
  BIO* in = NULL;
  int ret = 0;
...
static int serverinfo_srv_parse_cb(SSL* s,
                                   unsigned int ext_type,
                                   const unsigned char* in,
                                   size_t inlen,
                                   int* al,
...
static int serverinfo_srv_add_cb(SSL* s,
                                 unsigned int ext_type,
                                 const unsigned char** out,
                                 size_t* outlen,
                                 int* al,
...
int SSL_CTX_use_serverinfo(SSL_CTX* ctx,
                           const unsigned char* serverinfo,
                           size_t serverinfo_length) {
...
static int ssl_set_cert_and_key(SSL* ssl,
                                SSL_CTX* ctx,
                                X509* x509,
                                EVP_PKEY* privatekey,
                                STACK_OF(X509)* chain,
...
int SSL_use_cert_and_key(SSL* ssl,
                         X509* x509,
                         EVP_PKEY* privatekey,
                         STACK_OF(X509)* chain,
                         int override) {
