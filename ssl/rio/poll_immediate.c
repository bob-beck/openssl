...
static int
poll_translate_ssl_quic (SSL *ssl, QUIC_REACTOR_WAIT_CTX *wctx,
...
static void
postpoll_translation_cleanup_ssl_quic (SSL *ssl, QUIC_REACTOR_WAIT_CTX *wctx)
{
...
static void
postpoll_translation_cleanup (SSL_POLL_ITEM *items, size_t num_items,
                              size_t stride, QUIC_REACTOR_WAIT_CTX *wctx)
{
  SSL_POLL_ITEM *item;
  SSL *ssl;
  size_t i;
...
static int
poll_translate (SSL_POLL_ITEM *items, size_t num_items, size_t stride,
                QUIC_REACTOR_WAIT_CTX *wctx, RIO_POLL_BUILDER *rpb,
                OSSL_TIME *p_earliest_wakeup_deadline, int *abort_blocking,
...
static int
poll_block (SSL_POLL_ITEM *items, size_t num_items, size_t stride,
...
static int
poll_readout (SSL_POLL_ITEM *items, size_t num_items, size_t stride,
...
int
SSL_poll (SSL_POLL_ITEM *items, size_t num_items, size_t stride,
