 ...
 * providing minimal overhead (over the OS APIs themselves) for small numbers
 * of FDs.
 */
...
/*
 * TODO(RIO): No support currently for readout of what was readable/writeable
 * as it is currently not needed.
 */
