...
int
ossl_rio_poll_builder_init (RIO_POLL_BUILDER *rpb)
{
...
void
ossl_rio_poll_builder_cleanup (RIO_POLL_BUILDER *rpb)
{
  if (rpb == NULL)
    return;
...
#if RIO_POLL_METHOD == RIO_POLL_METHOD_POLL
static int
rpb_ensure_alloc (RIO_POLL_BUILDER *rpb, size_t alloc)
{
...
int
ossl_rio_poll_builder_add_fd (RIO_POLL_BUILDER *rpb, int fd, int want_read,
                              int want_write)
{
#if RIO_POLL_METHOD == RIO_POLL_METHOD_POLL
  size_t i;
...
int
ossl_rio_poll_builder_poll (RIO_POLL_BUILDER *rpb, OSSL_TIME deadline)
{
  int rc;
