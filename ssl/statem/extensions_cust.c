...
/*
 * Provide thin wrapper callbacks which convert new style arguments to old
 * style
 */
static int
custom_ext_add_old_cb_wrap (SSL *s, unsigned int ext_type,
...
static void
custom_ext_free_old_cb_wrap (SSL *s, unsigned int ext_type,
                             unsigned int context, const unsigned char *out,
                             void *add_arg)
{
  custom_ext_add_cb_wrap *add_cb_wrap = (custom_ext_add_cb_wrap *)add_arg;
...
static int
custom_ext_parse_old_cb_wrap (SSL *s, unsigned int ext_type,
 ...
 */
custom_ext_method *
custom_ext_find (const custom_ext_methods *exts, ENDPOINT role,
...
int
custom_ext_parse (SSL_CONNECTION *s, unsigned int context,
 ...
 */
int
custom_ext_add (SSL_CONNECTION *s, int context, WPACKET *pkt, X509 *x,
...
static int
add_old_custom_ext (SSL_CTX *ctx, ENDPOINT role, unsigned int ext_type,
                    unsigned int context, custom_ext_add_cb add_cb,
