 ...
 */
static int
custom_ext_add_old_cb_wrap(SSL* s,
                           ...
                           void* add_arg)
{
  ...
  return add_cb_wrap->add_cb(
    s, ext_type, out, outlen, al, add_cb_wrap->add_arg);
}

static void
custom_ext_free_old_cb_wrap(SSL* s,
                            unsigned int ext_type,
                            unsigned int context,
                            const unsigned char* out,
                            void* add_arg)
...
static int
custom_ext_parse_old_cb_wrap(SSL* s,
                             unsigned int ext_type,
                             unsigned int context,
                             ...
                             void* parse_arg)
{
  ...
  return parse_cb_wrap->parse_cb(
    s, ext_type, in, inlen, al, parse_cb_wrap->parse_arg);
}
 ...
 */
void
custom_ext_init(custom_ext_methods* exts)
{
  size_t i;
  custom_ext_method* meth = exts->meths;
                 ...
                 size_t chainidx)
{
  ...
  if (meth->parse_cb(SSL_CONNECTION_GET_USER_SSL(s),
                     ext_type,
                     context,
                     ext_data,
                     ext_size,
...
static void
custom_ext_copy_old_cb(custom_ext_method* methdst,
...
int
SSL_CTX_has_client_custom_ext(const SSL_CTX* ctx, unsigned int ext_type)
{
  return custom_ext_find(
           &ctx->cert->custext, ENDPOINT_CLIENT, ext_type, NULL) != NULL;
}
...
static int
add_old_custom_ext(SSL_CTX* ctx,
                   ENDPOINT role,
                   unsigned int ext_type,
                   unsigned int context,
                   custom_ext_add_cb add_cb,
...
int
SSL_CTX_add_client_custom_ext(SSL_CTX* ctx,
                              unsigned int ext_type,
                              custom_ext_add_cb add_cb,
                              custom_ext_free_cb free_cb,
                              void* add_arg,
...
int
SSL_CTX_add_server_custom_ext(SSL_CTX* ctx,
                              unsigned int ext_type,
                              custom_ext_add_cb add_cb,
                              custom_ext_free_cb free_cb,
                              void* add_arg,
...
int
SSL_CTX_add_custom_ext(SSL_CTX* ctx,
                       unsigned int ext_type,
                       unsigned int context,
                       SSL_custom_ext_add_cb_ex add_cb,
                       SSL_custom_ext_free_cb_ex free_cb,
