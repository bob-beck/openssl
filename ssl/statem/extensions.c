...
static int final_ec_pt_formats(SSL_CONNECTION* s,
...
static EXT_RETURN tls_construct_certificate_authorities(SSL_CONNECTION* s,
                                                        ...
                                                        X509* x,
                                                        size_t chainidx);
static int tls_parse_certificate_authorities(SSL_CONNECTION* s,
                                             PACKET* pkt,
                                             unsigned int context,
                                             X509* x,
                                             size_t chainidx);
...
static int final_supported_versions(SSL_CONNECTION* s,
                                    unsigned int context,
                                    int sent);
static int final_early_data(SSL_CONNECTION* s, unsigned int context, int sent);
static int final_maxfragmentlen(SSL_CONNECTION* s,
                                unsigned int context,
                                int sent);
...
static EXT_RETURN tls_construct_compress_certificate(SSL_CONNECTION* sc,
                                                     ...
                                                     X509* x,
                                                     size_t chainidx);
static int tls_parse_compress_certificate(SSL_CONNECTION* sc,
                                          PACKET* pkt,
                                          unsigned int context,
                                          X509* x,
                                          size_t chainidx);
...
static int validate_context(SSL_CONNECTION* s,
                            unsigned int extctx,
...
int tls_validate_all_contexts(SSL_CONNECTION* s,
                              unsigned int thisctx,
                              RAW_EXTENSION* exts) {
 ...
 */
int extension_is_relevant(SSL_CONNECTION* s,
                          unsigned int extctx,
                          unsigned int thisctx) {
  int is_tls13;
 ...
 */
int tls_parse_extension(SSL_CONNECTION* s,
                        TLSEXT_INDEX idx,
                        int context,
                        RAW_EXTENSION* exts,
                        X509* x,
 ...
 */
int tls_parse_all_extensions(SSL_CONNECTION* s,
                             int context,
                             RAW_EXTENSION* exts,
                             X509* x,
                             size_t chainidx,
...
int should_add_extension(SSL_CONNECTION* s,
                         unsigned int extctx,
                         unsigned int thisctx,
                         int max_version) {
 ...
 */
int tls_construct_extensions(SSL_CONNECTION* s,
                             WPACKET* pkt,
                             unsigned int context,
                             X509* x,
                             size_t chainidx) {
...
static int final_renegotiate(SSL_CONNECTION* s,
                             unsigned int context,
                             int sent) {
  if (!s->server) {
    /*
...
static int final_server_name(SSL_CONNECTION* s,
                             unsigned int context,
                             int sent) {
...
int tls_parse_compress_certificate(SSL_CONNECTION* sc,
                                   PACKET* pkt,
                                   unsigned int context,
                                   X509* x,
                                   size_t chainidx) {
