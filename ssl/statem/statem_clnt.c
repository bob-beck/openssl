...
static int tls_process_ske_srp(SSL_CONNECTION* s,
                               PACKET* pkt,
                               EVP_PKEY** pkey) {
...
static int tls_process_ske_dhe(SSL_CONNECTION* s,
                               PACKET* pkt,
                               EVP_PKEY** pkey) {
...
static int tls_process_ske_ecdhe(SSL_CONNECTION* s,
                                 PACKET* pkt,
                                 EVP_PKEY** pkey) {
  PACKET encoded_pt;
 ...
 */
int tls_process_cert_status_body(SSL_CONNECTION* s,
                                 size_t chainidx,
                                 PACKET* pkt) {
  unsigned int type;
...
int ssl_cipher_list_to_bytes(SSL_CONNECTION* s,
                             STACK_OF(SSL_CIPHER)* sk,
                             WPACKET* pkt) {
  int i;
