...
EXT_RETURN
tls_construct_ctos_renegotiate (SSL_CONNECTION *s, WPACKET *pkt,
...
EXT_RETURN
tls_construct_ctos_server_name (SSL_CONNECTION *s, WPACKET *pkt,
                                unsigned int context, X509 *x, size_t chainidx)
{
...
EXT_RETURN
tls_construct_ctos_maxfragmentlen (SSL_CONNECTION *s, WPACKET *pkt,
...
EXT_RETURN
tls_construct_ctos_srp (SSL_CONNECTION *s, WPACKET *pkt, unsigned int context,
...
static int
use_ecc (SSL_CONNECTION *s, int min_version, int max_version)
{
  int i, end, ret = 0;
...
EXT_RETURN
tls_construct_ctos_ec_pt_formats (SSL_CONNECTION *s, WPACKET *pkt,
                                  unsigned int context, X509 *x,
                                  size_t chainidx)
{
...
EXT_RETURN
tls_construct_ctos_supported_groups (SSL_CONNECTION *s, WPACKET *pkt,
                                     unsigned int context, X509 *x,
                                     size_t chainidx)
{
  const uint16_t *pgroups = NULL;
...
EXT_RETURN
tls_construct_ctos_session_ticket (SSL_CONNECTION *s, WPACKET *pkt,
                                   unsigned int context, X509 *x,
                                   size_t chainidx)
{
  size_t ticklen;
...
EXT_RETURN
tls_construct_ctos_sig_algs (SSL_CONNECTION *s, WPACKET *pkt,
                             unsigned int context, X509 *x, size_t chainidx)
{
  size_t salglen;
  const uint16_t *salg;
...
EXT_RETURN
tls_construct_ctos_status_request (SSL_CONNECTION *s, WPACKET *pkt,
                                   unsigned int context, X509 *x,
                                   size_t chainidx)
{
  int i;
...
EXT_RETURN
tls_construct_ctos_npn (SSL_CONNECTION *s, WPACKET *pkt, unsigned int context,
                        X509 *x, size_t chainidx)
{
...
EXT_RETURN
tls_construct_ctos_alpn (SSL_CONNECTION *s, WPACKET *pkt, unsigned int context,
                         X509 *x, size_t chainidx)
{
  s->s3.alpn_sent = 0;
...
EXT_RETURN
tls_construct_ctos_use_srtp (SSL_CONNECTION *s, WPACKET *pkt,
                             unsigned int context, X509 *x, size_t chainidx)
{
  SSL *ssl = SSL_CONNECTION_GET_SSL (s);
...
EXT_RETURN
tls_construct_ctos_etm (SSL_CONNECTION *s, WPACKET *pkt, unsigned int context,
                        X509 *x, size_t chainidx)
{
...
EXT_RETURN
tls_construct_ctos_sct (SSL_CONNECTION *s, WPACKET *pkt, unsigned int context,
                        X509 *x, size_t chainidx)
{
...
EXT_RETURN
tls_construct_ctos_ems (SSL_CONNECTION *s, WPACKET *pkt, unsigned int context,
                        X509 *x, size_t chainidx)
{
...
EXT_RETURN
tls_construct_ctos_supported_versions (SSL_CONNECTION *s, WPACKET *pkt,
                                       unsigned int context, X509 *x,
                                       size_t chainidx)
{
 ...
 */
EXT_RETURN
tls_construct_ctos_psk_kex_modes (SSL_CONNECTION *s, WPACKET *pkt,
                                  unsigned int context, X509 *x,
                                  size_t chainidx)
{
...
#ifndef OPENSSL_NO_TLS1_3
static int
add_key_share (SSL_CONNECTION *s, WPACKET *pkt, unsigned int group_id,
               size_t loop_num)
{
...
EXT_RETURN
tls_construct_ctos_key_share (SSL_CONNECTION *s, WPACKET *pkt,
                              unsigned int context, X509 *x, size_t chainidx)
{
#ifndef OPENSSL_NO_TLS1_3
  ...
  if (num_groups == 1 && pgroups[0] == 0)
    { /* Indication that no * prefix was used */
      tls1_get_supported_groups (s, &pgroups, &num_groups);
      add_only_one = 1;
    }
...
EXT_RETURN
tls_construct_ctos_cookie (SSL_CONNECTION *s, WPACKET *pkt,
                           unsigned int context, X509 *x, size_t chainidx)
{
...
EXT_RETURN
tls_construct_ctos_early_data (SSL_CONNECTION *s, WPACKET *pkt,
                               unsigned int context, X509 *x, size_t chainidx)
{
  ...
  if (psksess == NULL && s->psk_client_callback != NULL)
    {
      ...
      psklen = s->psk_client_callback (
          ussl, NULL, identity, sizeof (identity) - 1, psk, sizeof (psk));
...
EXT_RETURN
tls_construct_ctos_padding (SSL_CONNECTION *s, WPACKET *pkt,
                            unsigned int context, X509 *x, size_t chainidx)
{
   ...
   */
  if (s->session->ssl_version == TLS1_3_VERSION && s->session->ext.ticklen != 0
 ...
 */
EXT_RETURN
tls_construct_ctos_psk (SSL_CONNECTION *s, WPACKET *pkt, unsigned int context,
                        X509 *x, size_t chainidx)
{
#ifndef OPENSSL_NO_TLS1_3
...
EXT_RETURN
tls_construct_ctos_post_handshake_auth (SSL_CONNECTION *s, WPACKET *pkt,
 ...
 */
int
tls_parse_stoc_renegotiate (SSL_CONNECTION *s, PACKET *pkt,
                            unsigned int context, X509 *x, size_t chainidx)
{
...
int
tls_parse_stoc_maxfragmentlen (SSL_CONNECTION *s, PACKET *pkt,
                               unsigned int context, X509 *x, size_t chainidx)
{
  unsigned int value;
...
int
tls_parse_stoc_server_name (SSL_CONNECTION *s, PACKET *pkt,
                            unsigned int context, X509 *x, size_t chainidx)
{
  if (s->ext.hostname == NULL)
    {
...
int
tls_parse_stoc_ec_pt_formats (SSL_CONNECTION *s, PACKET *pkt,
                              unsigned int context, X509 *x, size_t chainidx)
{
...
int
tls_parse_stoc_session_ticket (SSL_CONNECTION *s, PACKET *pkt,
                               unsigned int context, X509 *x, size_t chainidx)
{
...
#ifndef OPENSSL_NO_OCSP
int
tls_parse_stoc_status_request (SSL_CONNECTION *s, PACKET *pkt,
                               unsigned int context, X509 *x, size_t chainidx)
{
...
#ifndef OPENSSL_NO_CT
int
tls_parse_stoc_sct (SSL_CONNECTION *s, PACKET *pkt, unsigned int context,
                    X509 *x, size_t chainidx)
{
  if (context == SSL_EXT_TLS1_3_CERTIFICATE_REQUEST)
    {
 ...
 */
static int
ssl_next_proto_validate (SSL_CONNECTION *s, PACKET *pkt)
{
  PACKET tmp_protocol;
...
int
tls_parse_stoc_npn (SSL_CONNECTION *s, PACKET *pkt, unsigned int context,
                    X509 *x, size_t chainidx)
{
...
int
tls_parse_stoc_alpn (SSL_CONNECTION *s, PACKET *pkt, unsigned int context,
                     X509 *x, size_t chainidx)
{
  size_t len;
...
#ifndef OPENSSL_NO_SRTP
int
tls_parse_stoc_use_srtp (SSL_CONNECTION *s, PACKET *pkt, unsigned int context,
                         X509 *x, size_t chainidx)
{
...
int
tls_parse_stoc_etm (SSL_CONNECTION *s, PACKET *pkt, unsigned int context,
                    X509 *x, size_t chainidx)
{
...
int
tls_parse_stoc_ems (SSL_CONNECTION *s, PACKET *pkt, unsigned int context,
                    X509 *x, size_t chainidx)
{
  if (s->options & SSL_OP_NO_EXTENDED_MASTER_SECRET)
    return 1;
...
int
tls_parse_stoc_supported_versions (SSL_CONNECTION *s, PACKET *pkt,
                                   unsigned int context, X509 *x,
                                   size_t chainidx)
{
...
int
tls_parse_stoc_key_share (SSL_CONNECTION *s, PACKET *pkt, unsigned int context,
                          X509 *x, size_t chainidx)
{
#ifndef OPENSSL_NO_TLS1_3
...
int
tls_parse_stoc_cookie (SSL_CONNECTION *s, PACKET *pkt, unsigned int context,
                       X509 *x, size_t chainidx)
{
  PACKET cookie;
...
int
tls_parse_stoc_early_data (SSL_CONNECTION *s, PACKET *pkt,
                           unsigned int context, X509 *x, size_t chainidx)
{
...
int
tls_parse_stoc_psk (SSL_CONNECTION *s, PACKET *pkt, unsigned int context,
                    X509 *x, size_t chainidx)
{
#ifndef OPENSSL_NO_TLS1_3
...
EXT_RETURN
tls_construct_ctos_client_cert_type (SSL_CONNECTION *sc, WPACKET *pkt,
                                     unsigned int context, X509 *x,
                                     size_t chainidx)
{
...
int
tls_parse_stoc_client_cert_type (SSL_CONNECTION *sc, PACKET *pkt,
                                 unsigned int context, X509 *x,
                                 size_t chainidx)
{
  unsigned int type;
...
EXT_RETURN
tls_construct_ctos_server_cert_type (SSL_CONNECTION *sc, WPACKET *pkt,
                                     unsigned int context, X509 *x,
                                     size_t chainidx)
{
...
int
tls_parse_stoc_server_cert_type (SSL_CONNECTION *sc, PACKET *pkt,
                                 unsigned int context, X509 *x,
                                 size_t chainidx)
{
  unsigned int type;
