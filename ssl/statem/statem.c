...
int
SSL_is_init_finished (const SSL *s)
{
  const SSL_CONNECTION *sc = SSL_CONNECTION_FROM_CONST_SSL (s);
...
OSSL_HANDSHAKE_STATE
ossl_statem_get_state (SSL_CONNECTION *s)
{
 ...
 */
void
ossl_statem_clear (SSL_CONNECTION *s)
{
 ...
 */
void
ossl_statem_set_renegotiate (SSL_CONNECTION *s)
{
  ossl_statem_set_in_init (s, 1);
...
void
ossl_statem_send_fatal (SSL_CONNECTION *s, int al)
{
 ...
 */
void
ossl_statem_fatal (SSL_CONNECTION *s, int al, int reason, const char *fmt, ...)
{
  va_list args;
 ...
 */
int
ossl_statem_in_error (const SSL_CONNECTION *s)
{
...
void
ossl_statem_set_in_init (SSL_CONNECTION *s, int init)
{
...
int
ossl_statem_get_in_handshake (SSL_CONNECTION *s)
{
  return s->statem.in_handshake;
}

void
ossl_statem_set_in_handshake (SSL_CONNECTION *s, int inhand)
{
  if (inhand)
...
int
ossl_statem_skip_early_data (SSL_CONNECTION *s)
{
 ...
 */
int
ossl_statem_check_finish_init (SSL_CONNECTION *s, int sending)
{
  if (sending == -1)
    {
...
void
ossl_statem_set_hello_verify_done (SSL_CONNECTION *s)
{
  s->statem.state = MSG_FLOW_UNINITED;
  ossl_statem_set_in_init (s, 1);
  /*
 ...
 * into that state at any point in the event that an irrecoverable error
 * occurs.
 *
 * Valid return values are:
 *   1: Success
 ...
 */
static int
state_machine (SSL_CONNECTION *s, int server)
{
  BUF_MEM *buf = NULL;
 ...
 */
static void
init_read_state_machine (SSL_CONNECTION *s)
{
  OSSL_STATEM *st = &s->statem;
...
static int
grow_init_buf (SSL_CONNECTION *s, size_t size)
{
 ...
 *
 * Any of the above states could result in an NBIO event occurring in which
 * case control returns to the calling application. When this function is
 * recalled we will resume in the same state where we left off.
 */
static SUB_STATE_RETURN
read_state_machine (SSL_CONNECTION *s)
{
  OSSL_STATEM *st = &s->statem;
  int ret, mt;
  size_t len = 0;
 ...
 */
static int
statem_do_write (SSL_CONNECTION *s)
{
  OSSL_STATEM *st = &s->statem;
 ...
 */
static void
init_write_state_machine (SSL_CONNECTION *s)
{
  OSSL_STATEM *st = &s->statem;
 ...
 */
static SUB_STATE_RETURN
write_state_machine (SSL_CONNECTION *s)
{
  OSSL_STATEM *st = &s->statem;
  int ret;
 ...
 */
int
ossl_statem_app_data_allowed (SSL_CONNECTION *s)
{
  OSSL_STATEM *st = &s->statem;
 ...
 */
int
ossl_statem_export_allowed (SSL_CONNECTION *s)
{
 ...
 */
int
ossl_statem_export_early_allowed (SSL_CONNECTION *s)
{
  /*
