...
static int create_ticket_prequel(SSL_CONNECTION* s,
                                 WPACKET* pkt,
                                 uint32_t age_add,
...
static int construct_stateful_ticket(SSL_CONNECTION* s,
                                     WPACKET* pkt,
                                     uint32_t age_add,
                                     unsigned char* tick_nonce) {
  if (!create_ticket_prequel(s, pkt, age_add, tick_nonce)) {
 ...
 */
int tls_construct_cert_status_body(SSL_CONNECTION* s,
                                   size_t chainidx,
                                   WPACKET* pkt) {
