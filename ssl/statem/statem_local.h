...
int check_in_list (SSL_CONNECTION *s, uint16_t group_id,
                   const uint16_t *groups, size_t num_groups, int checkallow,
                   size_t *pos);
...
__owur MSG_PROCESS_RETURN tls_process_change_cipher_spec (SSL_CONNECTION *s,
                                                          PACKET *pkt);
__owur MSG_PROCESS_RETURN tls_process_finished (SSL_CONNECTION *s,
                                                PACKET *pkt);
...
__owur CON_FUNC_RETURN tls_construct_finished (SSL_CONNECTION *s,
                                               WPACKET *pkt);
...
__owur MSG_PROCESS_RETURN tls_process_new_session_ticket (SSL_CONNECTION *s,
                                                          PACKET *pkt);
__owur int tls_process_cert_status_body (SSL_CONNECTION *s, size_t chainidx,
                                         PACKET *pkt);
...
__owur int tls_construct_cert_status_body (SSL_CONNECTION *s, size_t chainidx,
                                           WPACKET *pkt);
...
__owur CON_FUNC_RETURN tls_construct_next_proto (SSL_CONNECTION *s,
                                                 WPACKET *pkt);
#endif
__owur MSG_PROCESS_RETURN tls_process_hello_req (SSL_CONNECTION *s,
                                                 PACKET *pkt);
...
__owur int tls_collect_extensions (SSL_CONNECTION *s, PACKET *packet,
                                   ...
                                   size_t *len, int init);
__owur int tls_parse_extension (SSL_CONNECTION *s, TLSEXT_INDEX idx,
                                int context, RAW_EXTENSION *exts, X509 *x,
                                size_t chainidx);
...
int tls_parse_ctos_key_share (SSL_CONNECTION *s, PACKET *pkt,
                              unsigned int context, X509 *x, size_t chainidx);
int tls_parse_ctos_cookie (SSL_CONNECTION *s, PACKET *pkt,
                           unsigned int context, X509 *x, size_t chainidx);
...
int tls_parse_stoc_key_share (SSL_CONNECTION *s, PACKET *pkt,
                              unsigned int context, X509 *x, size_t chainidx);
int tls_parse_stoc_cookie (SSL_CONNECTION *s, PACKET *pkt,
                           unsigned int context, X509 *x, size_t chainidx);
