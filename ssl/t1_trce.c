...
static int
do_ssl_trace_list (BIO *bio, int indent, const unsigned char *msg,
                   size_t msglen, size_t vlen, const ssl_trace_tbl *tbl,
                   size_t ntbl)
{
  int val;
...
static const ssl_trace_tbl ssl_comp_tbl[]
    = { { 0x0000, "No Compression" }, { 0x0001, "Zlib Compression" } };
...
static void
ssl_print_hex (BIO *bio, int indent, const char *name,
...
static int
ssl_print_hexbuf (BIO *bio, int indent, const char *name, size_t nlen,
...
static int
ssl_print_version (BIO *bio, int indent, const char *name,
                   const unsigned char **pmsg, size_t *pmsglen,
...
static int
ssl_print_random (BIO *bio, int indent, const unsigned char **pmsg,
                  size_t *pmsglen)
{
  unsigned int tm;
  const unsigned char *p = *pmsg;
...
static int
ssl_print_signature (BIO *bio, int indent, const SSL_CONNECTION *sc,
                     const unsigned char **pmsg, size_t *pmsglen)
{
  if (*pmsglen < 2)
    return 0;
...
static int
ssl_print_extension (BIO *bio, int indent, int server, unsigned char mt,
                     int extype, const unsigned char *ext, size_t extlen)
{
...
static int
ssl_print_extensions (BIO *bio, int indent, int server, unsigned char mt,
...
static int
ssl_print_client_hello (BIO *bio, const SSL_CONNECTION *sc, int indent,
                        const unsigned char *msg, size_t msglen)
{
  size_t len;
  unsigned int cs;
...
static int
dtls_print_hello_vfyrequest (BIO *bio, int indent, const unsigned char *msg,
                             size_t msglen)
{
...
static int
ssl_print_server_hello (BIO *bio, int indent, const unsigned char *msg,
                        size_t msglen)
{
  unsigned int cs;
  unsigned int vers;
...
static int
ssl_print_client_keyex (BIO *bio, int indent, const SSL_CONNECTION *sc,
                        const unsigned char *msg, size_t msglen)
{
  const char *algname;
...
static int
ssl_print_server_keyex (BIO *bio, int indent, const SSL_CONNECTION *sc,
                        const unsigned char *msg, size_t msglen)
{
  const char *algname;
  int id = ssl_get_keyex (&algname, sc);
...
static int
ssl_print_certificate (BIO *bio, const SSL_CONNECTION *sc, int indent,
                       const unsigned char **pmsg, size_t *pmsglen)
{
...
static int
ssl_print_raw_public_key (BIO *bio, const SSL *ssl, int server, int indent,
                          const unsigned char **pmsg, size_t *pmsglen)
{
  EVP_PKEY *pkey;
  size_t clen;
  ...
  pkey = d2i_PUBKEY_ex (NULL, &msg, (long)clen, ssl->ctx->libctx,
                        ssl->ctx->propq);
  if (pkey == NULL)
    return 0;
...
static int
ssl_print_certificates (BIO *bio, const SSL_CONNECTION *sc, int server,
                        int indent, const unsigned char *msg, size_t msglen)
{
  size_t clen;
...
static int
ssl_print_compressed_certificates (BIO *bio, const SSL_CONNECTION *sc,
                                   ...
                                   const unsigned char *msg, size_t msglen)
{
  ...
  if ((comp = COMP_CTX_new (method)) == NULL
      || COMP_expand_block (comp, ucdata, (int)uclen, (unsigned char *)msg,
                            (int)clen)
             != (int)uclen)
    goto err;
...
static int
ssl_print_cert_request (BIO *bio, int indent, const SSL_CONNECTION *sc,
                        const unsigned char *msg, size_t msglen)
{
  size_t xlen;
  unsigned int sigalg;
...
static int
ssl_print_ticket (BIO *bio, int indent, const SSL_CONNECTION *sc,
                  const unsigned char *msg, size_t msglen)
{
...
static int
ssl_print_handshake (BIO *bio, const SSL_CONNECTION *sc, int server,
                     const unsigned char *msg, size_t msglen, int indent)
{
  size_t hlen;
  unsigned char htype;
...
void
SSL_trace (int write_p, int version, int content_type, const void *buf,
