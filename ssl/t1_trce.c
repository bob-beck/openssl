...
static const char* do_ssl_trace_str(int val,
...
static void ssl_print_hex(BIO* bio,
                          int indent,
                          const char* name,
                          const unsigned char* msg,
                          size_t msglen) {
...
static int ssl_print_hexbuf(BIO* bio,
                            int indent,
                            const char* name,
                            size_t nlen,
...
static int ssl_print_random(BIO* bio,
                            int indent,
                            const unsigned char** pmsg,
                            size_t* pmsglen) {
  unsigned int tm;
...
static int ssl_print_signature(BIO* bio,
                               int indent,
...
static int ssl_print_extensions(BIO* bio,
                                int indent,
                                int server,
                                unsigned char mt,
...
static int ssl_print_client_hello(BIO* bio,
                                  const SSL_CONNECTION* sc,
                                  int indent,
                                  const unsigned char* msg,
                                  size_t msglen) {
...
static int dtls_print_hello_vfyrequest(BIO* bio,
                                       int indent,
                                       const unsigned char* msg,
                                       size_t msglen) {
...
static int ssl_print_server_hello(BIO* bio,
                                  int indent,
                                  const unsigned char* msg,
                                  size_t msglen) {
  unsigned int cs;
...
static int ssl_print_client_keyex(BIO* bio,
                                  int indent,
                                  const SSL_CONNECTION* sc,
                                  const unsigned char* msg,
                                  size_t msglen) {
...
static int ssl_print_server_keyex(BIO* bio,
                                  int indent,
                                  const SSL_CONNECTION* sc,
                                  const unsigned char* msg,
                                  size_t msglen) {
...
static int ssl_print_certificate(BIO* bio,
                                 const SSL_CONNECTION* sc,
                                 int indent,
                                 const unsigned char** pmsg,
                                 size_t* pmsglen) {
...
static int ssl_print_raw_public_key(BIO* bio,
                                    const SSL* ssl,
                                    int server,
                                    int indent,
                                    const unsigned char** pmsg,
...
static int ssl_print_cert_request(BIO* bio,
                                  int indent,
                                  const SSL_CONNECTION* sc,
                                  const unsigned char* msg,
                                  size_t msglen) {
...
static int ssl_print_ticket(BIO* bio,
                            int indent,
                            const SSL_CONNECTION* sc,
                            const unsigned char* msg,
                            size_t msglen) {
