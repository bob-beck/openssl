...
static int do_ssl_trace_list(BIO                 *bio,
                             int                  indent,
...
static int
ssl_print_hexbuf(BIO *bio, int indent, const char *name, size_t nlen, const unsigned char **pmsg, size_t *pmsglen)
{
    size_t               blen;
...
static int ssl_print_version(BIO                  *bio,
                             int                   indent,
                             const char           *name,
...
static int
ssl_print_signature(BIO *bio, int indent, const SSL_CONNECTION *sc, const unsigned char **pmsg, size_t *pmsglen)
{
    if (*pmsglen < 2)
        return 0;
...
static int ssl_print_extension(BIO                 *bio,
                               int                  indent,
                               int                  server,
                               unsigned char        mt,
                               int                  extype,
...
static int
ssl_print_extensions(BIO *bio, int indent, int server, unsigned char mt, const unsigned char **msgin, size_t *msginlen)
{
...
static int
ssl_print_client_hello(BIO *bio, const SSL_CONNECTION *sc, int indent, const unsigned char *msg, size_t msglen)
{
    size_t       len;
    unsigned int cs;
...
static int
ssl_print_client_keyex(BIO *bio, int indent, const SSL_CONNECTION *sc, const unsigned char *msg, size_t msglen)
{
    const char *algname;
...
static int
ssl_print_server_keyex(BIO *bio, int indent, const SSL_CONNECTION *sc, const unsigned char *msg, size_t msglen)
{
    const char *algname;
    int         id = ssl_get_keyex(&algname, sc);
...
static int
ssl_print_certificate(BIO *bio, const SSL_CONNECTION *sc, int indent, const unsigned char **pmsg, size_t *pmsglen)
{
...
static int
ssl_print_raw_public_key(BIO *bio, const SSL *ssl, int server, int indent, const unsigned char **pmsg, size_t *pmsglen)
{
    EVP_PKEY            *pkey;
    size_t               clen;
...
static int ssl_print_certificates(BIO                  *bio,
...
static int ssl_print_compressed_certificates(BIO                  *bio,
                                             const SSL_CONNECTION *sc,
                                             int                   server,
                                             int                   indent,
                                             const unsigned char  *msg,
...
# ifndef OPENSSL_NO_COMP_ALG
    ...
    if ((comp = COMP_CTX_new(method)) == NULL
        || COMP_expand_block(comp, ucdata, (int)uclen, (unsigned char *)msg, (int)clen) != (int)uclen)
        goto err;
...
static int
ssl_print_cert_request(BIO *bio, int indent, const SSL_CONNECTION *sc, const unsigned char *msg, size_t msglen)
{
    size_t       xlen;
    unsigned int sigalg;
...
static int
ssl_print_handshake(BIO *bio, const SSL_CONNECTION *sc, int server, const unsigned char *msg, size_t msglen, int indent)
{
    size_t        hlen;
    unsigned char htype;
