...
static int cipher_do_cipher(EVP_CIPHER_CTX* ctx,
                            unsigned char* out,
...
static int ctr_do_cipher(EVP_CIPHER_CTX* ctx,
                         unsigned char* out,
                         const unsigned char* in,
                         size_t inl) {
  struct cipher_ctx* cipher_ctx =
...
static int devcrypto_ciphers(ENGINE* e,
...
static int digest_op(struct digest_ctx* ctx,
                     const void* src,
                     size_t srclen,
                     void* res,
                     unsigned int flags) {
...
static int devcrypto_digests(ENGINE* e,
                             const EVP_MD** digest,
                             const int** nids,
                             int nid) {
  if (digest == NULL)
...
static int devcrypto_ctrl(ENGINE* e,
                          int cmd,
                          long i,
                          void* p,
                          void (*f)(void)) {
