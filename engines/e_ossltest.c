...
/* Set up digests */
static int ossltest_digests(ENGINE* e,
                            const EVP_MD** digest,
                            const int** nids,
                            int nid);
...
static int digest_sha256_update(EVP_MD_CTX* ctx,
                                const void* data,
                                size_t count);
...
static int digest_sha384_update(EVP_MD_CTX* ctx,
                                const void* data,
                                size_t count);
static int digest_sha384_final(EVP_MD_CTX* ctx, unsigned char* md);

static int digest_sha512_init(EVP_MD_CTX* ctx);
static int digest_sha512_update(EVP_MD_CTX* ctx,
                                const void* data,
                                size_t count);
...
static int ossltest_aes128_init_key(EVP_CIPHER_CTX* ctx,
                                    ...
                                    int enc);
static int ossltest_aes128_cbc_cipher(EVP_CIPHER_CTX* ctx,
                                      unsigned char* out,
...
static int ossltest_aes128_gcm_init_key(EVP_CIPHER_CTX* ctx,
                                        ...
                                        const unsigned char* iv,
                                        int enc);
static int ossltest_aes128_gcm_cipher(EVP_CIPHER_CTX* ctx,
                                      unsigned char* out,
                                      const unsigned char* in,
                                      size_t inl);
static int ossltest_aes128_gcm_ctrl(EVP_CIPHER_CTX* ctx,
                                    int type,
                                    int arg,
                                    void* ptr);
...
static int ossltest_aes128_cbc_hmac_sha1_cipher(EVP_CIPHER_CTX* ctx,
                                                ...
                                                const unsigned char* in,
                                                size_t inl);
static int ossltest_aes128_cbc_hmac_sha1_ctrl(EVP_CIPHER_CTX* ctx,
                                              int type,
                                              int arg,
                                              void* ptr);
...
/* Key loading */
static EVP_PKEY* load_key(ENGINE* eng,
                          const char* key_id,
                          int pub,
                          UI_METHOD* ui_method,
                          void* ui_data) {
...
static EVP_PKEY* ossltest_load_privkey(ENGINE* eng,
                                       const char* key_id,
                                       UI_METHOD* ui_method,
                                       void* ui_data) {
...
static EVP_PKEY* ossltest_load_pubkey(ENGINE* eng,
                                      const char* key_id,
                                      UI_METHOD* ui_method,
                                      void* ui_data) {
...
static int ossltest_ciphers(ENGINE* e,
