...
static int
ossltest_digest_nids (const int **nids)
{
...
static int ossltest_cipher_nids[]
    = { NID_aes_128_cbc, NID_aes_128_gcm, NID_aes_128_cbc_hmac_sha1, 0 };
...
/* Key loading */
static EVP_PKEY *
load_key (ENGINE *eng, const char *key_id, int pub, UI_METHOD *ui_method,
          void *ui_data)
{
  BIO *in;
  EVP_PKEY *key;
...
static EVP_PKEY *
ossltest_load_privkey (ENGINE *eng, const char *key_id, UI_METHOD *ui_method,
                       void *ui_data)
{
...
static EVP_PKEY *
ossltest_load_pubkey (ENGINE *eng, const char *key_id, UI_METHOD *ui_method,
                      void *ui_data)
{
...
static int
ossltest_init (ENGINE *e)
{
  return 1;
}

static int
ossltest_finish (ENGINE *e)
{
  return 1;
}

static int
ossltest_destroy (ENGINE *e)
{
  destroy_digests ();
  destroy_ciphers ();
...
static int
ossltest_digests (ENGINE *e, const EVP_MD **digest, const int **nids, int nid)
{
  int ok = 1;
  if (!digest)
    {
...
static int
ossltest_ciphers (ENGINE *e, const EVP_CIPHER **cipher, const int **nids,
                  int nid)
{
  int ok = 1;
  if (!cipher)
...
static void
fill_known_data (unsigned char *md, unsigned int len)
{
  unsigned int i;
 ...
 * the standard implementation. Then we overwrite the result with a will
 * defined value, so that all "MD5" digests using the test engine always end up
 * with the same value.
 */
static int
digest_md5_init (EVP_MD_CTX *ctx)
{
  return EVP_MD_meth_get_init (EVP_md5 ()) (ctx);
}

static int
digest_md5_update (EVP_MD_CTX *ctx, const void *data, size_t count)
{
  return EVP_MD_meth_get_update (EVP_md5 ()) (ctx, data, count);
}

static int
digest_md5_final (EVP_MD_CTX *ctx, unsigned char *md)
{
 ...
 */
static int
digest_sha1_init (EVP_MD_CTX *ctx)
{
  return EVP_MD_meth_get_init (EVP_sha1 ()) (ctx);
}

static int
digest_sha1_update (EVP_MD_CTX *ctx, const void *data, size_t count)
{
  return EVP_MD_meth_get_update (EVP_sha1 ()) (ctx, data, count);
}

static int
digest_sha1_final (EVP_MD_CTX *ctx, unsigned char *md)
{
 ...
 */
static int
digest_sha256_init (EVP_MD_CTX *ctx)
{
  return EVP_MD_meth_get_init (EVP_sha256 ()) (ctx);
}

static int
digest_sha256_update (EVP_MD_CTX *ctx, const void *data, size_t count)
{
  return EVP_MD_meth_get_update (EVP_sha256 ()) (ctx, data, count);
}

static int
digest_sha256_final (EVP_MD_CTX *ctx, unsigned char *md)
{
 ...
 */
static int
digest_sha384_init (EVP_MD_CTX *ctx)
{
  return EVP_MD_meth_get_init (EVP_sha384 ()) (ctx);
}

static int
digest_sha384_update (EVP_MD_CTX *ctx, const void *data, size_t count)
{
  return EVP_MD_meth_get_update (EVP_sha384 ()) (ctx, data, count);
}

static int
digest_sha384_final (EVP_MD_CTX *ctx, unsigned char *md)
{
 ...
 */
static int
digest_sha512_init (EVP_MD_CTX *ctx)
{
  return EVP_MD_meth_get_init (EVP_sha512 ()) (ctx);
}

static int
digest_sha512_update (EVP_MD_CTX *ctx, const void *data, size_t count)
{
  return EVP_MD_meth_get_update (EVP_sha512 ()) (ctx, data, count);
}

static int
digest_sha512_final (EVP_MD_CTX *ctx, unsigned char *md)
{
...
static int
ossltest_aes128_init_key (EVP_CIPHER_CTX *ctx, const unsigned char *key,
                          const unsigned char *iv, int enc)
{
...
static int
ossltest_aes128_cbc_cipher (EVP_CIPHER_CTX *ctx, unsigned char *out,
                            const unsigned char *in, size_t inl)
{
...
static int
ossltest_aes128_gcm_init_key (EVP_CIPHER_CTX *ctx, const unsigned char *key,
                              const unsigned char *iv, int enc)
{
...
static int
ossltest_aes128_gcm_cipher (EVP_CIPHER_CTX *ctx, unsigned char *out,
                            const unsigned char *in, size_t inl)
{
...
static int
ossltest_aes128_gcm_ctrl (EVP_CIPHER_CTX *ctx, int type, int arg, void *ptr)
{
  /* Pass the ctrl down */
  int ret
      = EVP_CIPHER_meth_get_ctrl (EVP_aes_128_gcm ()) (ctx, type, arg, ptr);
...
static int
ossltest_aes128_cbc_hmac_sha1_init_key (EVP_CIPHER_CTX *ctx,
...
static int
ossltest_aes128_cbc_hmac_sha1_cipher (EVP_CIPHER_CTX *ctx, unsigned char *out,
...
static int
ossltest_aes128_cbc_hmac_sha1_ctrl (EVP_CIPHER_CTX *ctx, int type, int arg,
                                    void *ptr)
{
  EVP_AES_HMAC_SHA1 *key = data (ctx);
...
static int
ossltest_rand_bytes (unsigned char *buf, int num)
{
  unsigned char val = 1;
...
static int
ossltest_rand_status (void)
{
  return 1;
}

static const RAND_METHOD *
