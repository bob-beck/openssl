...
static int dasync_digests(ENGINE* e,
                          const EVP_MD** digest,
                          const int** nids,
                          int nid);
...
/* RSA */
static int dasync_pkey(ENGINE* e,
...
static int dasync_rsa_encrypt(EVP_PKEY_CTX* ctx,
                              unsigned char* out,
                              size_t* outlen,
                              const unsigned char* in,
                              size_t inlen);
static int dasync_rsa_decrypt_init(EVP_PKEY_CTX* ctx);
static int dasync_rsa_decrypt(EVP_PKEY_CTX* ctx,
                              unsigned char* out,
                              size_t* outlen,
                              const unsigned char* in,
                              size_t inlen);
static int dasync_rsa_ctrl(EVP_PKEY_CTX* ctx, int type, int p1, void* p2);
static int dasync_rsa_ctrl_str(EVP_PKEY_CTX* ctx,
                               const char* type,
                               const char* value);
...
static int dasync_aes128_cbc_ctrl(EVP_CIPHER_CTX* ctx,
                                  int type,
                                  int arg,
                                  void* ptr);
static int dasync_aes128_init_key(EVP_CIPHER_CTX* ctx,
                                  ...
                                  int enc);
static int dasync_aes128_cbc_cipher(EVP_CIPHER_CTX* ctx,
                                    unsigned char* out,
                                    const unsigned char* in,
                                    size_t inl);
static int dasync_aes128_cbc_cleanup(EVP_CIPHER_CTX* ctx);

static int dasync_aes256_ctr_ctrl(EVP_CIPHER_CTX* ctx,
                                  int type,
                                  int arg,
                                  void* ptr);
static int dasync_aes256_init_key(EVP_CIPHER_CTX* ctx,
                                  ...
                                  const unsigned char* iv,
                                  int enc);
static int dasync_aes256_ctr_cipher(EVP_CIPHER_CTX* ctx,
                                    unsigned char* out,
                                    const unsigned char* in,
                                    size_t inl);
static int dasync_aes256_ctr_cleanup(EVP_CIPHER_CTX* ctx);

static int dasync_aes128_cbc_hmac_sha1_ctrl(EVP_CIPHER_CTX* ctx,
                                            int type,
                                            int arg,
                                            void* ptr);
...
static int dasync_ciphers(ENGINE* e,
...
static int bind_dasync(ENGINE* e) {
  ...
  _hidden_aes_256_ctr = EVP_CIPHER_meth_new(NID_aes_256_ctr, 1 /* block size */,
                                            32 /* key len */);
...
static void wait_cleanup(ASYNC_WAIT_CTX* ctx,
                         const void* key,
...
static int dasync_cipher_ctrl_helper(EVP_CIPHER_CTX* ctx,
                                     int type,
                                     int arg,
                                     void* ptr,
                                     int aeadcapable,
