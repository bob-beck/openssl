          ...
          if (in == NULL)
            {
              if (EVP_read_pw_string (
                      passwd_malloc, (int)passwd_malloc_size,
 ...
 */
static char *
shacrypt (const char *passwd, const char *magic, const char *salt)
{
...
static int
do_passwd (int passed_salt, char **salt_p, char **salt_malloc_p, char *passwd,
