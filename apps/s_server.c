...
static int generate_session_id(SSL* ssl,
                               unsigned char* id,
                               unsigned int* id_len);
...
static int psk_find_session_cb(SSL* ssl,
 ...
 */
static int get_ocsp_resp_from_responder_single(SSL* s,
                                               X509* x,
 ...
 */
static int get_ocsp_resp_from_files(SSL* s,
                                    tlsextstatusctx* srctx,
                                    STACK_OF(OCSP_RESPONSE)** sk_resp) {
 ...
 */
static int get_ocsp_resp_from_responder(SSL* s,
                                        tlsextstatusctx* srctx,
                                        STACK_OF(OCSP_RESPONSE)** sk_resp) {
  X509* ssl_cert = NULL;
  int i, num = 0;
...
static long int count_reads_callback(BIO* bio,
                                     int cmd,
                                     const char* argp,
                                     size_t len,
                                     int argi,
...
static SSL_SESSION* get_session(SSL* ssl,
