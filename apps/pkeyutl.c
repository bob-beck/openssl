...
static EVP_PKEY* get_pkey(const char* kdfalg,
                          ...
                          int pkey_op,
                          ENGINE* e);
static EVP_PKEY_CTX* init_ctx(const char* kdfalg,
                              int* pkeysize,
                              int pkey_op,
                              ENGINE* e,
...
static int setup_peer(EVP_PKEY_CTX* ctx,
                      int peerform,
                      const char* file,
                      ENGINE* e);

static int do_keyop(EVP_PKEY_CTX* ctx,
                    int pkey_op,
                    unsigned char* out,
                    size_t* poutlen,
...
static int do_raw_keyop(int pkey_op,
                        EVP_MD_CTX* mctx,
                        EVP_PKEY* pkey,
                        BIO* in,
                        int filesize,
