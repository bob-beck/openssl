...
static void
legacy_cipher_fn (const EVP_CIPHER *c, const char *from, const char *to,
                  void *arg)
{
  if (select_name != NULL
      && (c == NULL
...
static int
asymcipher_cmp (const EVP_ASYM_CIPHER *const *a,
...
static int
store_cmp (const OSSL_STORE_LOADER *const *a,
