...
#define IS_PROT_FLAG(o)                                                                                                \
    (o == OPT_SSL3 || o == OPT_TLS1 || o == OPT_TLS1_1 || o == OPT_TLS1_2 || o == OPT_TLS1_3 || o == OPT_DTLS ||       \
     o == OPT_DTLS1 || o == OPT_DTLS1_2 || o == OPT_QUIC)
...
re_start:
    ...
    case PROTO_FTP: {
        ...
        {
            mbuf_len = BIO_gets(fbio, mbuf, BUFSIZZ);
        } while (mbuf_len > 3 && (!isdigit((unsigned char)mbuf[0]) || !isdigit((unsigned char)mbuf[1]) ||
    ...
    else if (user_data->mode == USER_DATA_MODE_ADVANCED)
    {
        ...
        if (cmd_start == buf_start)
        {
            ...
            *cmd_end = '\0';
            ...
            if (user_data->buf + 1 == cmd_start && user_data->buflen == 1 && user_data->buf[user_data->bufoff] == '\n')
            {
                /*
