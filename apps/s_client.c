...
static void user_data_init(struct user_data_st* user_data,
                           SSL* con,
                           char* buf,
                           size_t bufmax,
                           int mode);
static int user_data_add(struct user_data_st* user_data, size_t i);
static int user_data_process(struct user_data_st* user_data,
                             size_t* len,
                             size_t* off);
...
static int psk_use_session_cb(SSL* s,
                              const EVP_MD* md,
...
static int user_data_execute(struct user_data_st* user_data,
                             int cmd,
                             char* arg) {
  switch (cmd) {
