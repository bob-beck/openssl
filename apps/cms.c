...
int cms_main(int argc, char **argv) {
  ...
  if (operation & SMIME_SIGNERS) {
    ...
    BIO_printf(bio_err, "No operation option "
                        "(-encrypt|-decrypt|-sign|-verify|...) specified.\n");
    goto opthelp;
  }
  ...
  if (operation != SMIME_ENCRYPT && recip_first != NULL)
    BIO_printf(bio_err, "Warning: -recip_kdf and -recip_ukm parameters ignored "
                        "for operation other than -encrypt\n");
