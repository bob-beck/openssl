...
char *app_conf_try_string (const CONF *cnf, const char *group,
                           const char *name);
...
int app_passwd (const char *arg1, const char *arg2, char **pass1,
                char **pass2);
...
#define load_cert(uri, format, desc)                                          \
  load_cert_pass (uri, format, 1, NULL, desc)
...
EVP_PKEY *load_keyparams_suppress (const char *uri, int format,
                                   int maybe_stdin, const char *keytype,
                                   const char *desc,
...
#define setup_engine(e, debug)                                                \
  setup_engine_methods (e, (unsigned int)-1, debug)
