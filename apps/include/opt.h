 ...
 */
#define OPT_V_ENUM                                                                                                     \
    OPT_V__FIRST = 2000, OPT_V_POLICY, OPT_V_PURPOSE, OPT_V_VERIFY_NAME, OPT_V_VERIFY_DEPTH, OPT_V_ATTIME,             \
    OPT_V_VERIFY_HOSTNAME, OPT_V_VERIFY_EMAIL, OPT_V_VERIFY_IP, OPT_V_IGNORE_CRITICAL, OPT_V_ISSUER_CHECKS,            \
    OPT_V_CRL_CHECK, OPT_V_CRL_CHECK_ALL, OPT_V_POLICY_CHECK, OPT_V_EXPLICIT_POLICY, OPT_V_INHIBIT_ANY,                \
    OPT_V_INHIBIT_MAP, OPT_V_X509_STRICT, OPT_V_EXTENDED_CRL, OPT_V_USE_DELTAS, OPT_V_POLICY_PRINT,                    \
    OPT_V_CHECK_SS_SIG, OPT_V_TRUSTED_FIRST, OPT_V_SUITEB_128_ONLY, OPT_V_SUITEB_128, OPT_V_SUITEB_192,                \
    OPT_V_PARTIAL_CHAIN, OPT_V_NO_ALT_CHAINS, OPT_V_NO_CHECK_TIME, OPT_V_VERIFY_AUTH_LEVEL, OPT_V_ALLOW_PROXY_CERTS,   \
    OPT_V__LAST
 ...
 */
#define OPT_X_ENUM                                                                                                     \
    OPT_X__FIRST = 1000, OPT_X_KEY, OPT_X_CERT, OPT_X_CHAIN, OPT_X_CHAIN_BUILD, OPT_X_CERTFORM, OPT_X_KEYFORM,         \
    OPT_X__LAST
 ...
 */
#define OPT_S_ENUM                                                                                                     \
    OPT_S__FIRST = 3000, OPT_S_NOSSL3, OPT_S_NOTLS1, OPT_S_NOTLS1_1, OPT_S_NOTLS1_2, OPT_S_NOTLS1_3, OPT_S_BUGS,       \
    OPT_S_NO_COMP, OPT_S_NOTICKET, OPT_S_SERVERPREF, OPT_S_LEGACYRENEG, OPT_S_CLIENTRENEG, OPT_S_LEGACYCONN,           \
    OPT_S_ONRESUMP, OPT_S_NOLEGACYCONN, OPT_S_ALLOW_NO_DHE_KEX, OPT_S_PREFER_NO_DHE_KEX, OPT_S_PRIORITIZE_CHACHA,      \
    OPT_S_STRICT, OPT_S_SIGALGS, OPT_S_CLIENTSIGALGS, OPT_S_GROUPS, OPT_S_CURVES, OPT_S_NAMEDCURVE, OPT_S_CIPHER,      \
    OPT_S_CIPHERSUITES, OPT_S_RECORD_PADDING, OPT_S_DEBUGBROKE, OPT_S_COMP, OPT_S_MINPROTO, OPT_S_MAXPROTO,            \
    OPT_S_NO_RENEGOTIATION, OPT_S_NO_MIDDLEBOX, OPT_S_NO_ETM, OPT_S_NO_EMS, OPT_S_NO_TX_CERT_COMP,                     \
    OPT_S_NO_RX_CERT_COMP, OPT_S__LAST

#define OPT_S_OPTIONS                                                                                                  \
    OPT_SECTION("TLS/SSL"), {"no_ssl3", OPT_S_NOSSL3, '-', "Just disable SSLv3"},                                      \
...
#define IS_NO_PROT_FLAG(o)                                                                                             \
    (o == OPT_S_NOSSL3 || o == OPT_S_NOTLS1 || o == OPT_S_NOTLS1_1 || o == OPT_S_NOTLS1_2 || o == OPT_S_NOTLS1_3)
...
#define OPT_PROV_ENUM                                                                                                  \
    OPT_PROV__FIRST = 1600, OPT_PROV_PROVIDER, OPT_PROV_PROVIDER_PATH, OPT_PROV_PROPQUERY, OPT_PROV_PARAM,             \
    OPT_PROV__LAST

#define OPT_CONFIG_OPTION {"config", OPT_CONFIG, '<', "Load a configuration file (this may load modules)"}
