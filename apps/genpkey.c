...
static const char *
param_datatype_2name (unsigned int type, int *ishex)
{
  *ishex = 0;
...
static void
show_gen_pkeyopt (const char *algname, OSSL_LIB_CTX *libctx, const char *propq)
{
...
static int
init_keygen_file (EVP_PKEY_CTX **pctx, const char *file, ENGINE *e,
                  OSSL_LIB_CTX *libctx, const char *propq)
{
  BIO *pbio;
  EVP_PKEY *pkey = NULL;
...
int
init_gen_str (EVP_PKEY_CTX **pctx, const char *algname, ENGINE *e,
