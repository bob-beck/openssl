...
static SSL*
doConnection(SSL* scon, const char* host, SSL_CTX* ctx);
...
doConnection(SSL* scon, const char* host, SSL_CTX* ctx)
{
...
#if defined(SOL_SOCKET) && defined(SO_LINGER)
  {
    ...
    if (fd >= 0)
      (void)setsockopt(
        fd, SOL_SOCKET, SO_LINGER, (char*)&no_linger, sizeof(no_linger));
  }
#endif
