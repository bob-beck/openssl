...
static void
make_ocsp_response (BIO *err, OCSP_RESPONSE **resp, OCSP_REQUEST *req,
...
#ifndef OPENSSL_NO_SOCK
OCSP_RESPONSE *
process_responder (OCSP_REQUEST *req, const char *host, const char *port,
                   const char *path, const char *proxy, const char *no_proxy,
