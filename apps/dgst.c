...
do_fp(BIO* out,
      ...
      const char* file);
static void
show_digests(const OBJ_NAME* name, void* bio_);
...
const OPTIONS dgst_options[] = {
  ...
  { "xoflen",
    ...
    "set this to 32 (or greater) for SHAKE128, and 64 (or greater) for "
    "SHAKE256" },
...
dgst_main(int argc, char** argv)
{
  ...
  if (sigkey != NULL) {
    ...
    if (do_verify)
      if (impl == NULL)
        res = EVP_DigestVerifyInit_ex(mctx,
                                      &pctx,
                                      digestname,
                                      app_get0_libctx(),
                                      app_get0_propq(),
      ...
      res = EVP_DigestSignInit_ex(mctx,
                                  &pctx,
                                  digestname,
                                  app_get0_libctx(),
                                  app_get0_propq(),
