...
int
http_server_get_asn1_req (const ASN1_ITEM *it, ASN1_VALUE **preq, char **ppath,
                          BIO **pcbio, BIO *acbio, int *found_keep_alive,
...
int
http_server_send_asn1_resp (const char *prog, BIO *cbio, int keep_alive,
...
int
http_server_send_status (const char *prog, BIO *cbio, int status,
                         const char *reason)
{
  char buf[200];
