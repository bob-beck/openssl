...
mk_octet_string (void *value, size_t value_n)
{
...
static int
x509_ctrl (void *object, int cmd, void *value, size_t value_n)
{
  switch (cmd)
    {
#ifdef EVP_PKEY_CTRL_SET1_ID
...
static int
x509_req_ctrl (void *object, int cmd, void *value, size_t value_n)
{
  switch (cmd)
    {
#ifdef EVP_PKEY_CTRL_SET1_ID
    case EVP_PKEY_CTRL_SET1_ID:
      {
        ...
        if (v == NULL)
          {
            BIO_printf (bio_err, "error: setting distinguishing ID in "
...
static int
do_x509_ctrl_string (int (*ctrl) (void *object, int cmd, void *value,
                                  size_t value_n),
