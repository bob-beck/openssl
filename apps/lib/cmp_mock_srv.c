...
int
ossl_cmp_mock_srv_set_statusInfo(OSSL_CMP_SRV_CTX* srv_ctx,
                                 int status,
                                 int fail_info,
                                 const char* text)
{
...
static int
refcert_cmp(const X509* refcert,
...
process_cert_request(OSSL_CMP_SRV_CTX* srv_ctx,
...
static OSSL_CMP_PKISI*
process_rr(OSSL_CMP_SRV_CTX* srv_ctx,
           ...
           const ASN1_INTEGER* serial)
{
  ...
  if ((issuer != NULL || serial != NULL)
    ...
    ERR_raise_data(
      ERR_LIB_CMP, CMP_R_REQUEST_NOT_ACCEPTED, "wrong certificate to revoke");
    return NULL;
  }
...
static int
process_genm(OSSL_CMP_SRV_CTX* srv_ctx,
...
static void
process_error(OSSL_CMP_SRV_CTX* srv_ctx,
...
static int
process_certConf(OSSL_CMP_SRV_CTX* srv_ctx,
...
static int
process_pollReq(OSSL_CMP_SRV_CTX* srv_ctx,
