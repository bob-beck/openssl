...
long bio_dump_callback(BIO* bio,
                       int cmd,
                       const char* argp,
                       size_t len,
                       int argi,
...
#ifndef OPENSSL_NO_SOCK
int generate_stateless_cookie_callback(SSL* ssl,
...
int verify_stateless_cookie_callback(SSL* ssl,
...
int generate_cookie_callback(SSL* ssl,
                             unsigned char* cookie,
...
int verify_cookie_callback(SSL* ssl,
                           const unsigned char* cookie,
                           unsigned int cookie_len) {
...
int config_ctx(SSL_CONF_CTX* cctx,
...
static int security_callback_debug(const SSL* s,
                                   const SSL_CTX* ctx,
                                   int op,
                                   int bits,
                                   int nid,
