...
static int
CreateSocketPair(int, int, int, int*);
static void
SocketPairTimeoutAst(int);
static int
TerminalDeviceAst(int);
static void
LogMessage(char*, ...);
...
/*----------------------------------------------------------------------------*/
int
TerminalSocket(int FunctionCode, int* ReturnSocket)
{
  int status;
...
/*----------------------------------------------------------------------------*/
static int
CreateSocketPair(int SocketFamily,
                 int SocketType,
                 int SocketProtocol,
                 int* SocketPair)
{
...
/*----------------------------------------------------------------------------*/
static void
SocketPairTimeoutAst(int astparm)
{
...
TerminalDeviceAst(int astparm)
{
  ...
  */
  send(TerminalSocketPair[0],
       TerminalDeviceBuff,
       TerminalDeviceIosb.iosb$w_bcnt + 1,
       0);
