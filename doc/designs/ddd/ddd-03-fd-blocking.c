 ...
 * =============================================
 *
 * This is an example of (part of) an application which uses libssl in a
 * simple, synchronous, blocking fashion. The client is responsible for
 * creating the socket and passing it to libssl. The functions show all
 ...
 */
int
tx (SSL *ssl, const void *buf, int buf_len)
{
 ...
 */
int
rx (SSL *ssl, void *buf, int buf_len)
{
