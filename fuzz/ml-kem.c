 ...
 */
static void
create_mlkem_raw_key (uint8_t **buf, size_t *len, void **key1, void **key2)
{
  EVP_PKEY *pubkey;
  char *keytype = NULL;
  size_t keylen = 0;
 ...
 */
static void
keygen_mlkem_real_key (uint8_t **buf, size_t *len, void **key1, void **key2)
{
  char *keytype = NULL;
  size_t keylen = 0;
 ...
 */
static void
mlkem_encap_decap (uint8_t **buf, size_t *len, void *key1, void *in2,
                   void **out1, void **out2)
{
 ...
 */
static void
do_derive (EVP_PKEY *key, EVP_PKEY *peer, uint8_t **shared, size_t *shared_len)
{
  EVP_PKEY_CTX *ctx = NULL;
 ...
 */
static void
mlkem_kex (uint8_t **buf, size_t *len, void *key1, void *key2, void **out1,
           void **out2)
{
 ...
 */
static void
mlkem_export_import (uint8_t **buf, size_t *len, void *key1, void *key2,
                     void **out1, void **out2)
{
  EVP_PKEY *alice = (EVP_PKEY *)key1;
  EVP_PKEY *new = NULL;
 ...
 */
static void
mlkem_compare (uint8_t **buf, size_t *len, void *key1, void *key2, void **out1,
               void **out2)
{
  EVP_PKEY *alice = (EVP_PKEY *)key1;
  EVP_PKEY *bob = (EVP_PKEY *)key2;
 ...
 */
static void
cleanup_mlkem_keys (void *key1, void *key2, void *key3, void *key4)
{
