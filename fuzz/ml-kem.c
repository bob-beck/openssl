                  ...
                  void** out2)
{
  ...
  if (EVP_PKEY_decapsulate(
        ctx, unwrappedkey, &unwrappedkey_len, wrapkey, wrapkey_len) <= 0) {
 ...
 */
static void
mlkem_export_import(uint8_t** buf,
                    size_t* len,
                    void* key1,
                    void* key2,
                    void** out1,
