 ...
 */
static int
select_keytype_and_size(uint8_t** buf,
                        size_t* len,
                        char** keytype,
                        size_t* keylen,
                        int only_valid)
 ...
 */
static void
ml_dsa_sign_verify(uint8_t** buf,
                   size_t* len,
                   void* key1,
                   void* in2,
                   void** out1,
                   void** out2)
{
  ...
  const OSSL_PARAM params[] = {
    OSSL_PARAM_octet_string(
      "context-string", (unsigned char*)"A context string", 16),
    OSSL_PARAM_END
  };
 ...
 */
static void
ml_dsa_digest_sign_verify(uint8_t** buf,
                          size_t* len,
                          void* key1,
                          void* in2,
                          void** out1,
                          void** out2)
{
  ...
  if (!EVP_DigestSignInit_ex(
        ctx, NULL, NULL, NULL, "?fips=true", key, params) ||
  ...
  if ((ctx = EVP_MD_CTX_new()) == NULL ||
      EVP_DigestVerifyInit_ex(
        ctx, NULL, NULL, NULL, "?fips=true", key, params) <= 0 ||
 ...
 */
static void
ml_dsa_export_import(uint8_t** buf,
                     size_t* len,
                     void* key1,
                     void* key2,
                     void** out1,
