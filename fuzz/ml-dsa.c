 ...
 */
static uint8_t *
consume_uint8_t (const uint8_t *buf, size_t *len, uint8_t *val)
{
 ...
 */
static uint8_t *
consume_size_t (const uint8_t *buf, size_t *len, size_t *val)
{
 ...
 */
static int
select_keytype_and_size (uint8_t **buf, size_t *len, char **keytype,
 ...
 *
 * This function selects a key type and size from the buffer, generates a
 * random key of the appropriate length, and creates either a public or private
 * ML-DSA key using OpenSSL's EVP_PKEY interface.
 *
 * @param buf   Pointer to the buffer pointer; updated after reading.
 * @param len   Pointer to the remaining buffer size; updated accordingly.
 * @param key1  Pointer to store the generated EVP_PKEY key (public or
 * private).
 ...
 */
static void
create_ml_dsa_raw_key (uint8_t **buf, size_t *len, void **key1, void **key2)
{
  EVP_PKEY *pubkey;
  char *keytype = NULL;
  size_t keylen = 0;
...
static int
keygen_ml_dsa_real_key_helper (uint8_t **buf, size_t *len, EVP_PKEY **key)
{
  char *keytype = NULL;
  size_t keylen = 0;
 ...
 */
static void
keygen_ml_dsa_real_key (uint8_t **buf, size_t *len, void **key1, void **key2)
{
 ...
 */
static void
ml_dsa_sign_verify (uint8_t **buf, size_t *len, void *key1, void *in2,
                    void **out1, void **out2)
{
 ...
 */
static void
ml_dsa_digest_sign_verify (uint8_t **buf, size_t *len, void *key1, void *in2,
                           void **out1, void **out2)
{
  EVP_PKEY *key = (EVP_PKEY *)key1;
 ...
 */
static void
ml_dsa_export_import (uint8_t **buf, size_t *len, void *key1, void *key2,
                      void **out1, void **out2)
{
 ...
 */
static void
ml_dsa_compare (uint8_t **buf, size_t *len, void *key1, void *key2,
                void **out1, void **out2)
{
  EVP_PKEY *alice = (EVP_PKEY *)key1;
 ...
 */
static void
cleanup_ml_dsa_keys (void *key1, void *key2, void *key3, void *key4)
{
 ...
 * setting up, executing, and cleaning up cryptographic operations, along with
