 ...
 */
static int select_keytype_and_size(uint8_t** buf,
                                   size_t* len,
                                   char** keytype,
                                   size_t* keylen,
                                   int only_valid) {
 ...
 */
static void create_ml_dsa_raw_key(uint8_t** buf,
                                  size_t* len,
                                  void** key1,
                                  void** key2) {
  EVP_PKEY* pubkey;
...
static int keygen_ml_dsa_real_key_helper(uint8_t** buf,
                                         size_t* len,
                                         EVP_PKEY** key) {
  char* keytype = NULL;
  size_t keylen = 0;
 ...
 */
static void keygen_ml_dsa_real_key(uint8_t** buf,
                                   size_t* len,
                                   void** key1,
                                   void** key2) {
 ...
 */
static void ml_dsa_sign_verify(uint8_t** buf,
                               size_t* len,
                               void* key1,
                               void* in2,
                               void** out1,
 ...
 * @param[out] out2  Unused output parameter (reserved for future use).
 */
static void ml_dsa_digest_sign_verify(uint8_t** buf,
                                      size_t* len,
                                      void* key1,
                                      void* in2,
                                      void** out1,
 ...
 */
static void ml_dsa_export_import(uint8_t** buf,
                                 size_t* len,
                                 void* key1,
                                 void* key2,
                                 void** out1,
 ...
 */
static void ml_dsa_compare(uint8_t** buf,
                           size_t* len,
                           void* key1,
                           void* key2,
                           void** out1,
 ...
 */
static void cleanup_ml_dsa_keys(void* key1,
                                void* key2,
                                void* key3,
                                void* key4) {
