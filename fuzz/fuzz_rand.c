...
static int
fuzz_rand_instantiate(ossl_unused void* vrng,
...
static int
fuzz_rand_generate(ossl_unused void* vdrbg,
                   unsigned char* out,
                   size_t outlen,
                   ossl_unused unsigned int strength,
                   ossl_unused int prediction_resistance,
...
static int
fuzz_rand_provider_init(const OSSL_CORE_HANDLE* handle,
