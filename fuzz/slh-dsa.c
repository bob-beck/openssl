 ...
 */
static EVP_PKEY*
slh_dsa_gen_key(const char* name,
                uint32_t keysize,
                OSSL_PARAM params[],
 ...
 */
static void
slh_dsa_gen_key_with_params(uint8_t** buf,
                            size_t* len,
                            void** out1,
                            void** out2)
{
  ...
  *buf = consume_uint8t(*buf, len, &selector);
  ...
  params[0] = OSSL_PARAM_construct_octet_string(
    OSSL_PKEY_PARAM_PUB_KEY, (char*)bufptr, buflen);
  ...
  params[1] = OSSL_PARAM_construct_octet_string(
    OSSL_PKEY_PARAM_PRIV_KEY, (char*)bufptr, buflen);
 ...
 */
static void
slh_dsa_sign_verify(uint8_t** buf,
                    size_t* len,
                    void* key1,
                    void* key2,
                    void** out1,
 ...
 */
static void
slh_dsa_export_import(uint8_t** buf,
                      size_t* len,
                      void* key1,
                      void* key2,
                      void** out1,
