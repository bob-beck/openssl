 ...
 */
static EVP_PKEY *
slh_dsa_gen_key (const char *name, uint32_t keysize, OSSL_PARAM params[],
                 uint8_t *param_broken)
{
  EVP_PKEY_CTX *ctx;
  EVP_PKEY *new = NULL;
  int rc;
 ...
 */
static void
slh_dsa_gen_key_with_params (uint8_t **buf, size_t *len, void **out1,
                             void **out2)
{
  uint8_t selector = 0;
  const char *keytype = NULL;
 ...
 */
static void
slh_dsa_sign_verify (uint8_t **buf, size_t *len, void *key1, void *key2,
                     void **out1, void **out2)
{
 ...
 */
static void
slh_dsa_export_import (uint8_t **buf, size_t *len, void *key1, void *key2,
                       void **out1, void **out2)
{
  int rc;
