...
ASN1_SEQUENCE(
  CMS_OtherCertificateFormat) = { ASN1_SIMPLE(CMS_OtherCertificateFormat,
                                              otherCertFormat,
                                              ASN1_OBJECT),
                                  ASN1_OPT(
...
ASN1_CHOICE(
  CMS_SignerIdentifier) = { ASN1_SIMPLE(CMS_SignerIdentifier,
  ...
  ASN1_NDEF_SEQUENCE(
    CMS_EncapsulatedContentInfo) = { ASN1_SIMPLE(CMS_EncapsulatedContentInfo,
                                                 eContentType,
                                                 ASN1_OBJECT),
                                     ASN1_NDEF_EXP_OPT(
...
ASN1_SEQUENCE(
  CMS_OriginatorInfo) = { ASN1_IMP_SET_OF_OPT(CMS_OriginatorInfo,
                                              certificates,
...
ASN1_CHOICE(
  CMS_KeyAgreeRecipientIdentifier) = { ASN1_SIMPLE(CMS_KeyAgreeRecipientIdentifier,
                                                   d.issuerAndSerialNumber,
                                                   CMS_IssuerAndSerialNumber),
                                       ASN1_IMP(
...
ASN1_CHOICE(
  CMS_OriginatorIdentifierOrKey) = { ASN1_SIMPLE(CMS_OriginatorIdentifierOrKey,
                                                 d.issuerAndSerialNumber,
                                                 CMS_IssuerAndSerialNumber),
...
ASN1_SEQUENCE(
  CMS_KEKIdentifier) = { ASN1_SIMPLE(CMS_KEKIdentifier,
                                     keyIdentifier,
                                     ASN1_OCTET_STRING),
...
static int
cms_kemri_cb(int operation, ASN1_VALUE** pval, const ASN1_ITEM* it, void* exarg)
{
...
ASN1_ADB(CMS_OtherRecipientInfo) = {
  ADB_ENTRY(NID_id_smime_ori_kem,
            ASN1_SIMPLE(CMS_OtherRecipientInfo, d.kemri, CMS_KEMRecipientInfo))
...
ASN1_ADB(CMS_ContentInfo) = {
  ...
  ADB_ENTRY(
    ...
    ASN1_NDEF_EXP(CMS_ContentInfo, d.compressedData, CMS_CompressedData, 0)),
                                     ...
                                     ASN1_OCTET_STRING *ukm, int keylen)
{
  ...
  return ASN1_item_i2d((ASN1_VALUE*)&kem_otherinfo,
                       pder,
