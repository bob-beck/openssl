...
ASN1_SEQUENCE (CMS_OtherCertificateFormat)
    ...
    = { ASN1_SIMPLE (CMS_CertificateChoices, d.certificate, X509),
        ASN1_IMP (CMS_CertificateChoices, d.extendedCertificate, ASN1_SEQUENCE,
                  0),
...
ASN1_CHOICE (CMS_SignerIdentifier)
    = { ASN1_SIMPLE (CMS_SignerIdentifier, d.issuerAndSerialNumber,
        ...
        ASN1_IMP (CMS_SignerIdentifier, d.subjectKeyIdentifier,
                  ASN1_OCTET_STRING,
...
ASN1_SEQUENCE (CMS_OriginatorInfo)
    = { ASN1_IMP_SET_OF_OPT (CMS_OriginatorInfo, certificates,
        ...
        ASN1_IMP_SET_OF_OPT (CMS_OriginatorInfo, crls,
...
static int
cms_kemri_cb (int operation, ASN1_VALUE **pval, const ASN1_ITEM *it,
              void *exarg)
{
...
ASN1_ADB (CMS_OtherRecipientInfo) = {
  ADB_ENTRY (NID_id_smime_ori_kem, ASN1_SIMPLE (CMS_OtherRecipientInfo,
                                                d.kemri, CMS_KEMRecipientInfo))
...
ASN1_ITEM_TEMPLATE (CMS_Attributes_Sign)
    = ASN1_EX_TEMPLATE_TYPE (ASN1_TFLG_SET_ORDER, 0, CMS_ATTRIBUTES,
                             X509_ATTRIBUTE)
