...
ASN1_SEQUENCE(CMS_IssuerAndSerialNumber) = {
    ...
    ASN1_SIMPLE(CMS_IssuerAndSerialNumber,
                serialNumber,
...
ASN1_CHOICE(CMS_SignerIdentifier) =
    ...
    static int cms_si_cb(int operation,
                         ASN1_VALUE** pval,
                         const ASN1_ITEM* it,
                         void* exarg) {
...
ASN1_SEQUENCE(CMS_OtherRevocationInfoFormat) =
    {ASN1_SIMPLE(CMS_OtherRevocationInfoFormat,
                 otherRevInfoFormat,
                 ASN1_OBJECT),
...
ASN1_SEQUENCE(CMS_OriginatorInfo) =
    {ASN1_IMP_SET_OF_OPT(CMS_OriginatorInfo,
     ...
     ASN1_IMP_SET_OF_OPT(CMS_OriginatorInfo,
        ...
        static int cms_ec_cb(int operation,
                             ASN1_VALUE** pval,
                             const ASN1_ITEM* it,
                             void* exarg) {
...
ASN1_SEQUENCE(CMS_RecipientKeyIdentifier) = {
    ASN1_SIMPLE(CMS_RecipientKeyIdentifier,
...
ASN1_CHOICE(CMS_KeyAgreeRecipientIdentifier) =
    {ASN1_SIMPLE(CMS_KeyAgreeRecipientIdentifier,
     ...
     ASN1_IMP(CMS_KeyAgreeRecipientIdentifier,
        ...
        static int cms_rek_cb(int operation,
                              ASN1_VALUE** pval,
                              const ASN1_ITEM* it,
                              void* exarg) {
...
ASN1_CHOICE(CMS_OriginatorIdentifierOrKey) =
    {ASN1_SIMPLE(CMS_OriginatorIdentifierOrKey,
     ...
     ASN1_IMP(CMS_OriginatorIdentifierOrKey,
        ...
        static int cms_kari_cb(int operation,
                               ASN1_VALUE** pval,
                               const ASN1_ITEM* it,
                               void* exarg) {
...
ASN1_SEQUENCE_cb(CMS_KEMRecipientInfo, cms_kemri_cb) =
    {ASN1_EMBED(CMS_KEMRecipientInfo, version, INT32),
     ...
     ASN1_SIMPLE(CMS_KEMRecipientInfo,
                 encryptedKey,
                 ASN1_OCTET_STRING)} ASN1_SEQUENCE_END_cb(CMS_KEMRecipientInfo,
                                                          CMS_KEMRecipientInfo)

ASN1_ADB_TEMPLATE(ori_def) = ASN1_SIMPLE(CMS_OtherRecipientInfo,
                                         d.other,
                                         ASN1_ANY);
...
ASN1_NDEF_SEQUENCE(CMS_EnvelopedData) = {
    ...
    ASN1_SIMPLE(CMS_EnvelopedData,
                ...
                CMS_EncryptedContentInfo),
    ASN1_IMP_SET_OF_OPT(CMS_EnvelopedData,
                        unprotectedAttrs,
                        X509_ATTRIBUTE,
...
ASN1_NDEF_SEQUENCE(CMS_EncryptedData) = {
    ...
    ASN1_SIMPLE(CMS_EncryptedData,
                encryptedContentInfo,
                CMS_EncryptedContentInfo),
    ASN1_IMP_SET_OF_OPT(CMS_EncryptedData,
                        unprotectedAttrs,
                        X509_ATTRIBUTE,
...
ASN1_ADB_TEMPLATE(cms_default) = ASN1_EXP(CMS_ContentInfo,
                                          d.other,
                                          ASN1_ANY,
                                          0);
...
ASN1_ADB(CMS_ContentInfo) = {
    ...
    ADB_ENTRY(
        NID_pkcs7_enveloped,
        ASN1_NDEF_EXP(CMS_ContentInfo, d.envelopedData, CMS_EnvelopedData, 0)),
    ADB_ENTRY(
        NID_pkcs7_digest,
        ASN1_NDEF_EXP(CMS_ContentInfo, d.digestedData, CMS_DigestedData, 0)),
    ADB_ENTRY(
        NID_pkcs7_encrypted,
        ASN1_NDEF_EXP(CMS_ContentInfo, d.encryptedData, CMS_EncryptedData, 0)),
...
ASN1_SEQUENCE(CMS_CMSORIforKEMOtherInfo) =
    {
        ...
        int CMS_CMSORIforKEMOtherInfo_encode(unsigned char** pder,
                                             X509_ALGOR* wrap,
                                             ASN1_OCTET_STRING* ukm,
                                             int keylen) {
