...
CMS_ContentInfo *
CMS_data_create_ex (BIO *in, unsigned int flags, OSSL_LIB_CTX *libctx,
                    const char *propq)
{
...
CMS_ContentInfo *
CMS_digest_create_ex (BIO *in, const EVP_MD *md, unsigned int flags,
...
CMS_ContentInfo *
CMS_EncryptedData_encrypt_ex (BIO *in, const EVP_CIPHER *cipher,
...
cms_signerinfo_verify_cert (CMS_SignerInfo *si, X509_STORE *store,
                            ...
                            STACK_OF (X509_CRL) *crls, STACK_OF (X509) **chain,
...
CMS_ContentInfo *
CMS_sign_ex (X509 *signcert, EVP_PKEY *pkey, STACK_OF (X509) *certs, BIO *data,
...
static int
cms_kari_set1_pkey_and_peer (CMS_ContentInfo *cms, CMS_RecipientInfo *ri,
...
int
CMS_decrypt_set1_pkey_and_peer (CMS_ContentInfo *cms, EVP_PKEY *pk, X509 *cert,
                                X509 *peer)
{
...
int
CMS_final_digest (CMS_ContentInfo *cms, const unsigned char *md,
