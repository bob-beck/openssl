...
int
ossl_cms_set1_SignerIdentifier (CMS_SignerIdentifier *sid, X509 *cert,
  ...
  if (!verify)
    {
      ...
      if (hnid == NID_undef)
        return -1;
      if (pknid <= 0)
        { /* check whether a provider registered a NID */
...
static int
ossl_cms_add1_signing_cert_v2 (CMS_SignerInfo *si,
...
int
ossl_cms_SignedData_final (CMS_ContentInfo *cms, BIO *chain,
...
BIO *
CMS_SignedData_verify (CMS_SignedData *sd, BIO *detached_data,
