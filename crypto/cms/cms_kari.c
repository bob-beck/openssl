...
int
CMS_RecipientInfo_kari_get0_alg(CMS_RecipientInfo* ri,
                                X509_ALGOR** palg,
...
int
CMS_RecipientInfo_kari_get0_orig_id(CMS_RecipientInfo* ri,
                                    X509_ALGOR** pubalg,
...
int
CMS_RecipientInfo_kari_set0_pkey_and_peer(CMS_RecipientInfo* ri,
                                          EVP_PKEY* pk,
                                          X509* peer)
{
  EVP_PKEY_CTX* pctx;
...
int
CMS_RecipientInfo_kari_decrypt(CMS_ContentInfo* cms,
...
static int
cms_kari_set_originator_private_key(CMS_KeyAgreeRecipientInfo* kari,
