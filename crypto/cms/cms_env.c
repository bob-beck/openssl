...
BIO *
CMS_EnvelopedData_decrypt (CMS_EnvelopedData *env, BIO *detached_data,
...
CMS_RecipientInfo *
CMS_add1_recipient (CMS_ContentInfo *cms, X509 *recip,
                    EVP_PKEY *originatorPrivKey, X509 *originator,
                    unsigned int flags)
{
