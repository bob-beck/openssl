...
int ossl_cms_RecipientInfo_kemri_init(CMS_RecipientInfo *ri,
                                      X509              *recip,
...
static int
kdf_derive(unsigned char *kek, size_t keklen, const unsigned char *ss, size_t sslen, CMS_KEMRecipientInfo *kemri)
{
    EVP_KDF_CTX   *kctx = NULL;
    OSSL_PARAM     params[3];
