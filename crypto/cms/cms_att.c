...
void *
CMS_signed_get0_data_by_OBJ (const CMS_SignerInfo *si, const ASN1_OBJECT *oid,
...
static int
cms_check_attribute (int nid, int flags, int type,
                     const STACK_OF (X509_ATTRIBUTE) *attrs, int have_attrs)
{
  int lastpos = -1;
