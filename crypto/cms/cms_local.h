...
int ossl_cms_DataFinal(CMS_ContentInfo* cms,
                       BIO* cmsbio,
...
int ossl_cms_SignedData_final(CMS_ContentInfo* cms,
                              ...
                              const unsigned char* precomp_md,
                              unsigned int precomp_mdlen);
int ossl_cms_set1_SignerIdentifier(CMS_SignerIdentifier* sid,
                                   X509* cert,
                                   int type,
                                   const CMS_CTX* ctx);
...
BIO* ossl_cms_DigestAlgorithm_init_bio(X509_ALGOR* digestAlgorithm,
                                       const CMS_CTX* ctx);
int ossl_cms_DigestAlgorithm_find_ctx(EVP_MD_CTX* mctx,
                                      BIO* chain,
                                      X509_ALGOR* mdalg);
