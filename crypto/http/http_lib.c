...
static int
copy_substring (char **dest, const char *start, const char *end)
{
  return dest == NULL
...
int
OSSL_parse_url (const char *url, char **pscheme, char **puser, char **phost,
...
int
OSSL_HTTP_parse_url (const char *url, int *pssl, char **puser, char **phost,
                     char **pport, int *pport_num, char **ppath, char **pquery,
                     char **pfrag)
{
  char *scheme, *port;
...
static int
use_proxy (const char *no_proxy, const char *server)
{
  size_t sl;
...
const char *
OSSL_HTTP_adapt_proxy (const char *proxy, const char *no_proxy,
