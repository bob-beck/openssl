...
static OSSL_HTTP_REQ_CTX *http_req_ctx_new(int                free_wbio,
                                           BIO               *wbio,
                                           BIO               *rbio,
...
OSSL_HTTP_REQ_CTX *OSSL_HTTP_open(const char        *server,
                                  const char        *port,
                                  const char        *proxy,
                                  const char        *no_proxy,
                                  int                use_ssl,
...
int OSSL_HTTP_set1_request(OSSL_HTTP_REQ_CTX          *rctx,
                           const char                 *path,
...
BIO *OSSL_HTTP_get(const char                 *url,
                   const char                 *proxy,
                   const char                 *no_proxy,
                   BIO                        *bio,
                   BIO                        *rbio,
 ...
 */
int OSSL_HTTP_proxy_connect(BIO        *bio,
                            const char *server,
                            const char *port,
