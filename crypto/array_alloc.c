...
void* CRYPTO_malloc_array(size_t num, size_t size, const char* file, int line) {
  ...
  if (ossl_unlikely(!ossl_size_mul(num, size, &bytes, file, line))) return NULL;
...
void* CRYPTO_secure_malloc_array(size_t num, size_t size, const char* file,
                                 int line) {
  size_t bytes;
...
void* CRYPTO_secure_calloc(size_t num, size_t size, const char* file,
                           int line) {
  size_t bytes;
