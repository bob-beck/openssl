...
void*
CRYPTO_aligned_alloc_array(size_t num,
                           size_t size,
                           size_t align,
                           void** freeptr,
                           const char* file,
...
void*
CRYPTO_realloc_array(void* addr,
                     size_t num,
                     size_t size,
                     const char* file,
                     int line)
...
void*
CRYPTO_clear_realloc_array(void* addr,
                           size_t old_num,
                           size_t num,
                           size_t size,
                           const char* file,
...
void*
CRYPTO_secure_malloc_array(size_t num, size_t size, const char* file, int line)
{
  size_t bytes;
