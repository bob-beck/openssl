...
void *
CRYPTO_malloc_array (size_t num, size_t size, const char *file, int line)
{
  size_t bytes;
...
void *
CRYPTO_calloc (size_t num, size_t size, const char *file, int line)
{
  size_t bytes;
...
void *
CRYPTO_aligned_alloc_array (size_t num, size_t size, size_t align,
...
void *
CRYPTO_realloc_array (void *addr, size_t num, size_t size, const char *file,
                      int line)
{
  size_t bytes;
...
void *
CRYPTO_clear_realloc_array (void *addr, size_t old_num, size_t num,
...
void *
CRYPTO_secure_malloc_array (size_t num, size_t size, const char *file,
                            int line)
{
  size_t bytes;
...
void *
CRYPTO_secure_calloc (size_t num, size_t size, const char *file, int line)
{
  size_t bytes;
