...
int
WPACKET_sub_allocate_bytes__ (WPACKET *pkt, size_t len,
...
int
WPACKET_sub_reserve_bytes__ (WPACKET *pkt, size_t len,
                             unsigned char **allocbytes, size_t lenbytes)
{
...
int
WPACKET_sub_memcpy__ (WPACKET *pkt, const void *src, size_t len,
                      size_t lenbytes)
{
  if (!WPACKET_start_sub_packet_len__ (pkt, lenbytes)
...
int
WPACKET_quic_sub_allocate_bytes (WPACKET *pkt, size_t len,
