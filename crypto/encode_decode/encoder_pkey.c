...
int
OSSL_ENCODER_CTX_set_cipher (OSSL_ENCODER_CTX *ctx, const char *cipher_name,
 ...
 */
static int
ossl_encoder_ctx_setup_for_pkey (OSSL_ENCODER_CTX *ctx, const EVP_PKEY *pkey,
                                 int selection, const char *propquery)
{
  ...
  if (pkey->keymgmt != NULL)
    {
       ...
       * all encoder_data.names into namemap ids if it calls
