...
int
OSSL_ENCODER_to_bio (OSSL_ENCODER_CTX *ctx, BIO *out)
{
...
int
OSSL_ENCODER_to_fp (OSSL_ENCODER_CTX *ctx, FILE *fp)
{
...
int
OSSL_ENCODER_to_data (OSSL_ENCODER_CTX *ctx, unsigned char **pdata,
                      size_t *pdata_len)
{
  BIO *out;
  BUF_MEM *buf = NULL;
...
int
OSSL_ENCODER_CTX_set_selection (OSSL_ENCODER_CTX *ctx, int selection)
{
...
int
OSSL_ENCODER_CTX_set_output_type (OSSL_ENCODER_CTX *ctx,
...
int
OSSL_ENCODER_CTX_set_output_structure (OSSL_ENCODER_CTX *ctx,
...
ossl_encoder_instance_new (OSSL_ENCODER *encoder, void *encoderctx)
{
...
static int
ossl_encoder_ctx_add_encoder_inst (OSSL_ENCODER_CTX *ctx,
...
int
OSSL_ENCODER_CTX_add_encoder (OSSL_ENCODER_CTX *ctx, OSSL_ENCODER *encoder)
{
  OSSL_ENCODER_INSTANCE *encoder_inst = NULL;
...
int
OSSL_ENCODER_CTX_add_extra (OSSL_ENCODER_CTX *ctx, OSSL_LIB_CTX *libctx,
                            const char *propq)
{
  return 1;
}
...
int
OSSL_ENCODER_CTX_set_construct (OSSL_ENCODER_CTX *ctx,
...
int
OSSL_ENCODER_CTX_set_construct_data (OSSL_ENCODER_CTX *ctx,
                                     void *construct_data)
{
  if (!ossl_assert (ctx != NULL))
    {
...
int
OSSL_ENCODER_CTX_set_cleanup (OSSL_ENCODER_CTX *ctx,
...
static int
encoder_process (struct encoder_process_data_st *data)
{
...
int
ossl_bio_print_labeled_bignum (BIO *out, const char *label, const BIGNUM *bn)
{
  int ret = 0, use_sep = 0;
  char *hex_str = NULL, *p;
  const char spaces[] = "    ";
...
int
ossl_bio_print_ffc_params (BIO *out, const FFC_PARAMS *ffc)
{
