                       ...
                       void* construct_data)
{
  ...
  if (i < end) {
    ...
    if (!EVP_KEYMGMT_up_ref(keymgmt))
      return 0;
  } else if ((keymgmt = EVP_KEYMGMT_fetch(
                data->libctx, data->object_type, data->propq)) != NULL) {
    keymgmt_prov = EVP_KEYMGMT_get0_provider(keymgmt);
  }
 ...
 */
static int
collect_decoder_keymgmt(EVP_KEYMGMT* keymgmt,
 ...
 */
static int
ossl_decoder_ctx_setup_for_pkey(OSSL_DECODER_CTX* ctx,
                                const char* keytype,
                                OSSL_LIB_CTX* libctx,
                              ...
                              const char* propquery)
{
  ...
  OSSL_PARAM decoder_params[] = { OSSL_PARAM_END,
                                  OSSL_PARAM_END,
                                  OSSL_PARAM_END };
  DECODER_CACHE* cache =
    ossl_lib_ctx_get_data(libctx, OSSL_LIB_CTX_DECODER_CACHE_INDEX);
