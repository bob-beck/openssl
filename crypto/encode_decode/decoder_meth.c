...
static void
ossl_decoder_free (void *data)
{
  OSSL_DECODER_free (data);
}

static int
ossl_decoder_up_ref (void *data)
{
...
int
OSSL_DECODER_up_ref (OSSL_DECODER *decoder)
{
  int ref = 0;
...
void
OSSL_DECODER_free (OSSL_DECODER *decoder)
{
  int ref = 0;
...
static void *
get_tmp_decoder_store (void *data)
{
...
static void
dealloc_tmp_decoder_store (void *store)
{
  if (store != NULL)
...
get_decoder_store (OSSL_LIB_CTX *libctx)
{
  return ossl_lib_ctx_get_data (libctx, OSSL_LIB_CTX_DECODER_STORE_INDEX);
}

static int
reserve_decoder_store (void *store, void *data)
{
  struct decoder_data_st *methdata = data;
...
static int
unreserve_decoder_store (void *store, void *data)
{
  struct decoder_data_st *methdata = data;
...
static void *
get_decoder_from_store (void *store, const OSSL_PROVIDER **prov, void *data)
{
  struct decoder_data_st *methdata = data;
  void *method = NULL;
  int id;
...
static int
put_decoder_in_store (void *store, void *method, const OSSL_PROVIDER *prov,
...
void *
ossl_decoder_from_algorithm (int id, const OSSL_ALGORITHM *algodef,
                             OSSL_PROVIDER *prov)
{
  OSSL_DECODER *decoder = NULL;
 ...
 */
static void *
construct_decoder (const OSSL_ALGORITHM *algodef, OSSL_PROVIDER *prov,
                   void *data)
{
  /*
...
static void
destruct_decoder (void *method, void *data)
{
  OSSL_DECODER_free (method);
}

static int
up_ref_decoder (void *method)
{
  return OSSL_DECODER_up_ref (method);
}

static void
free_decoder (void *method)
{
  OSSL_DECODER_free (method);
}
...
static OSSL_DECODER *
inner_ossl_decoder_fetch (struct decoder_data_st *methdata, const char *name,
...
OSSL_DECODER *
OSSL_DECODER_fetch (OSSL_LIB_CTX *libctx, const char *name,
                    const char *properties)
{
...
int
ossl_decoder_store_cache_flush (OSSL_LIB_CTX *libctx)
{
...
int
ossl_decoder_store_remove_all_provided (const OSSL_PROVIDER *prov)
{
  OSSL_LIB_CTX *libctx = ossl_provider_libctx (prov);
  OSSL_METHOD_STORE *store = get_decoder_store (libctx);
...
const OSSL_PROVIDER *
OSSL_DECODER_get0_provider (const OSSL_DECODER *decoder)
{
...
const char *
OSSL_DECODER_get0_properties (const OSSL_DECODER *decoder)
{
  if (!ossl_assert (decoder != NULL))
    {
      ERR_raise (ERR_LIB_OSSL_DECODER, ERR_R_PASSED_NULL_PARAMETER);
...
int
ossl_decoder_get_number (const OSSL_DECODER *decoder)
{
  if (!ossl_assert (decoder != NULL))
    {
      ERR_raise (ERR_LIB_OSSL_DECODER, ERR_R_PASSED_NULL_PARAMETER);
...
const char *
OSSL_DECODER_get0_name (const OSSL_DECODER *decoder)
{
  return decoder->base.name;
}

const char *
OSSL_DECODER_get0_description (const OSSL_DECODER *decoder)
{
  return decoder->base.algodef->algorithm_description;
}

int
OSSL_DECODER_is_a (const OSSL_DECODER *decoder, const char *name)
{
...
static int
resolve_name (OSSL_DECODER *decoder, const char *name)
{
  OSSL_LIB_CTX *libctx = ossl_provider_libctx (decoder->base.prov);
  OSSL_NAMEMAP *namemap = ossl_namemap_stored (libctx);
...
int
ossl_decoder_fast_is_a (OSSL_DECODER *decoder, const char *name, int *id_cache)
{
  int id = *id_cache;
...
static void
do_one (ossl_unused int id, void *method, void *arg)
{
...
void
OSSL_DECODER_do_all_provided (OSSL_LIB_CTX *libctx,
...
int
OSSL_DECODER_names_do_all (const OSSL_DECODER *decoder,
...
int
OSSL_DECODER_get_params (OSSL_DECODER *decoder, OSSL_PARAM params[])
{
...
int
OSSL_DECODER_CTX_set_params (OSSL_DECODER_CTX *ctx, const OSSL_PARAM params[])
{
  int ok = 1;
  int i;
  int l;
...
void
OSSL_DECODER_CTX_free (OSSL_DECODER_CTX *ctx)
{
  if (ctx != NULL)
    {
      if (ctx->cleanup != NULL)
