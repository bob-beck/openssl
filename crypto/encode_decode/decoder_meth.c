...
static void* get_decoder_from_store(void* store,
...
static int put_decoder_in_store(void* store,
                                void* method,
                                const OSSL_PROVIDER* prov,
                                const char* names,
                                const char* propdef,
...
void* ossl_decoder_from_algorithm(int id,
...
OSSL_DECODER* OSSL_DECODER_fetch(OSSL_LIB_CTX* libctx,
                                 const char* name,
                                 const char* properties) {
