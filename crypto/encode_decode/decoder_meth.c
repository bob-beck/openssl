...
static int
put_decoder_in_store(void* store,
                     void* method,
                     ...
                     void* data)
{
  ...
  return ossl_method_store_add(
    store, prov, id, propdef, method, ossl_decoder_up_ref, ossl_decoder_free);
}

/* Create and populate a decoder method */
void*
ossl_decoder_from_algorithm(int id,
 ...
 */
static void*
construct_decoder(const OSSL_ALGORITHM* algodef,
                  OSSL_PROVIDER* prov,
                  void* data)
{
  /*
    ...
    if ((method = ossl_method_construct(methdata->libctx,
      ...
      if (id != 0)
        ossl_method_store_cache_set(
          store, prov, id, propq, method, up_ref_decoder, free_decoder);
    }
...
OSSL_DECODER*
OSSL_DECODER_fetch(OSSL_LIB_CTX* libctx,
                   const char* name,
                   const char* properties)
{
