 ...
 */
static int
bits2int (BIGNUM *out, int qlen_bits, const unsigned char *in, size_t inlen)
{
 ...
 */
static int
bits2int_consttime (BIGNUM *out, int qlen_bits, const unsigned char *in,
                    size_t inlen)
{
 ...
 */
static int
int2octets (unsigned char *out, const BIGNUM *num, int rlen)
{
 ...
 */
static int
bits2octets (unsigned char *out, const BIGNUM *q, int qlen_bits, int rlen,
 ...
 */
static EVP_KDF_CTX *
kdf_setup (const char *digestname, const unsigned char *entropy,
           size_t entropylen, const unsigned char *nonce, size_t noncelen,
 ...
 */
int
ossl_gen_deterministic_nonce_rfc6979 (BIGNUM *out, const BIGNUM *q,
                                      const BIGNUM *priv,
