          ...
          const char* propq)
{
  ...
  *p++ = OSSL_PARAM_construct_utf8_string(
    OSSL_KDF_PARAM_DIGEST, (char*)digestname, 0);
  if (propq != NULL)
    *p++ = OSSL_PARAM_construct_utf8_string(
  ...
  *p++ = OSSL_PARAM_construct_octet_string(
    OSSL_KDF_PARAM_HMACDRBG_NONCE, (void*)nonce, noncelen);
 ...
 */
int
ossl_gen_deterministic_nonce_rfc6979(BIGNUM* out,
                                     const BIGNUM* q,
                                     const BIGNUM* priv,
                                     const unsigned char* hm,
                                     size_t hmlen,
