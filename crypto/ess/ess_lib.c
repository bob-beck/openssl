...
ESS_SIGNING_CERT *
OSSL_ESS_signing_cert_new_init (const X509 *signcert,
...
static ESS_CERT_ID *
ESS_CERT_ID_new_init (const X509 *cert, int set_issuer_serial)
{
  ESS_CERT_ID *cid = NULL;
...
ESS_SIGNING_CERT_V2 *
OSSL_ESS_signing_cert_v2_new_init (const EVP_MD *hash_alg,
                                   const X509 *signcert,
                                   const STACK_OF (X509) *certs,
                                   int set_issuer_serial)
{
...
static ESS_CERT_ID_V2 *
ESS_CERT_ID_V2_new_init (const EVP_MD *hash_alg, const X509 *cert,
                         int set_issuer_serial)
{
  ESS_CERT_ID_V2 *cid;
  GENERAL_NAME *name = NULL;
...
static int
ess_issuer_serial_cmp (const ESS_ISSUER_SERIAL *is, const X509 *cert)
{
  GENERAL_NAME *issuer;
 ...
 */
static int
find (const ESS_CERT_ID *cid, const ESS_CERT_ID_V2 *cid_v2, int index,
      const STACK_OF (X509) *certs)
{
  const X509 *cert;
  EVP_MD *md = NULL;
...
int
OSSL_ESS_check_signing_certs (const ESS_SIGNING_CERT *ss,
