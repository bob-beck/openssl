...
void
OPENSSL_vx_probe(void);
#endif

static const char* env;
static int
parse_env(struct OPENSSL_s390xcap_st* cap, int* cex);

void
OPENSSL_s390x_facilities(void);
void
OPENSSL_s390x_functions(void);
...
parse_env(struct OPENSSL_s390xcap_st* cap, int* cex)
{
  ...
  static const struct OPENSSL_s390xcap_st z9 = {
    /*.stfle  = */ {
      S390X_CAPBIT(S390X_MSA) | S390X_CAPBIT(S390X_STCKF), 0ULL, 0ULL, 0ULL },
    /*.kimd   = */
