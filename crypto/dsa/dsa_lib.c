...
static DSA*
dsa_new_intern(ENGINE* engine, OSSL_LIB_CTX* libctx);
...
void*
DSA_get_ex_data(const DSA* d, int idx)
{
...
#ifndef FIPS_MODULE
  if (!ossl_crypto_new_ex_data_ex(
        libctx, CRYPTO_EX_INDEX_DSA, ret, &ret->ex_data))
    goto err;
#endif
