 ...
 */
static int
dsa_keygen_knownanswer_test(DSA* dsa,
                            BN_CTX* ctx,
                            OSSL_CALLBACK* cb,
                            void* cbarg)
{
  ...
  OSSL_SELF_TEST_onbegin(
    st, OSSL_SELF_TEST_TYPE_PCT_KAT, OSSL_SELF_TEST_DESC_PCT_DSA);
 ...
 */
static int
dsa_keygen_pairwise_test(DSA* dsa, OSSL_CALLBACK* cb, void* cbarg)
{
  int ret = 0;
  ...
  OSSL_SELF_TEST_onbegin(
    st, OSSL_SELF_TEST_TYPE_PCT, OSSL_SELF_TEST_DESC_PCT_DSA);
