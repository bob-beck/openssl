...
OSSL_PROVIDER *
OSSL_PROVIDER_try_load_ex (OSSL_LIB_CTX *libctx, const char *name,
...
OSSL_PROVIDER *
OSSL_PROVIDER_try_load (OSSL_LIB_CTX *libctx, const char *name,
...
OSSL_PROVIDER *
OSSL_PROVIDER_load_ex (OSSL_LIB_CTX *libctx, const char *name,
                       OSSL_PARAM *params)
{
...
void *
OSSL_PROVIDER_get0_provider_ctx (const OSSL_PROVIDER *prov)
{
...
int
OSSL_PROVIDER_add_builtin (OSSL_LIB_CTX *libctx, const char *name,
...
int
OSSL_PROVIDER_do_all (OSSL_LIB_CTX *ctx,
