...
OSSL_PROVIDER* OSSL_PROVIDER_try_load_ex(OSSL_LIB_CTX* libctx,
                                         const char* name,
                                         OSSL_PARAM* params,
...
OSSL_PROVIDER* OSSL_PROVIDER_load_ex(OSSL_LIB_CTX* libctx,
                                     const char* name,
                                     OSSL_PARAM* params) {
...
int OSSL_PROVIDER_add_builtin(OSSL_LIB_CTX* libctx,
                              const char* name,
