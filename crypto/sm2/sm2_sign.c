...
int
ossl_sm2_compute_z_digest (uint8_t *out, const EVP_MD *digest,
...
ECDSA_SIG *
ossl_sm2_do_sign (const EC_KEY *key, const EVP_MD *digest, const uint8_t *id,
...
int
ossl_sm2_do_verify (const EC_KEY *key, const EVP_MD *digest,
...
int
ossl_sm2_internal_sign (const unsigned char *dgst, int dgstlen,
...
int
ossl_sm2_internal_verify (const unsigned char *dgst, int dgstlen,
