...
int
ossl_sm2_plaintext_size (const unsigned char *ct, size_t ct_size,
                         size_t *pt_size)
{
...
int
ossl_sm2_ciphertext_size (const EC_KEY *key, const EVP_MD *digest,
...
int
ossl_sm2_encrypt (const EC_KEY *key, const EVP_MD *digest, const uint8_t *msg,
...
int
ossl_sm2_decrypt (const EC_KEY *key, const EVP_MD *digest,
