 ...
 */
int
ossl_encode_der_length (WPACKET *pkt, size_t cont_len)
{
  if (cont_len > 0xffff)
 ...
 */
int
ossl_encode_der_integer (WPACKET *pkt, const BIGNUM *n)
{
 ...
 */
int
ossl_encode_der_dsa_sig (WPACKET *pkt, const BIGNUM *r, const BIGNUM *s)
{
 ...
 */
int
ossl_decode_der_length (PACKET *pkt, PACKET *subpkt)
{
  unsigned int byte;
 ...
 */
size_t
ossl_decode_der_dsa_sig (BIGNUM *r, BIGNUM *s, const unsigned char **ppin,
                         size_t len)
{
  size_t consumed;
  PACKET pkt, contpkt;
