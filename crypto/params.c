...
static OSSL_PARAM
ossl_param_construct (const char *key, unsigned int data_type, void *data,
                      size_t data_size)
{
  OSSL_PARAM res;
 ...
 */
static int
copy_integer (unsigned char *dest, size_t dest_len, const unsigned char *src,
              size_t src_len, unsigned char pad, int signed_int)
{
  size_t n;
  DECLARE_IS_ENDIAN;
...
static int
signed_from_signed (void *dest, size_t dest_len, const void *src,
                    size_t src_len)
{
...
static int
signed_from_unsigned (void *dest, size_t dest_len, const void *src,
                      size_t src_len)
{
...
static int
unsigned_from_signed (void *dest, size_t dest_len, const void *src,
                      size_t src_len)
{
 ...
 */
static int
unsigned_from_unsigned (void *dest, size_t dest_len, const void *src,
                        size_t src_len)
{
  return copy_integer (dest, dest_len, src, src_len, 0, 0);
}
...
static int
get_string_internal (const OSSL_PARAM *p, void **val, size_t *max_len,
...
int
OSSL_PARAM_get_octet_string (const OSSL_PARAM *p, void **val, size_t max_len,
                             size_t *used_len)
{
...
static int
set_string_internal (OSSL_PARAM *p, const void *val, size_t len,
                     unsigned int type)
{
  if (p->data_type != type)
    {
...
static int
get_ptr_internal_skip_checks (const OSSL_PARAM *p, const void **val,
                              size_t *used_len)
{
  if (used_len != NULL)
...
static int
get_ptr_internal (const OSSL_PARAM *p, const void **val, size_t *used_len,
                  unsigned int type)
{
  if (val == NULL || p == NULL)
    {
...
int
OSSL_PARAM_get_octet_ptr (const OSSL_PARAM *p, const void **val,
                          size_t *used_len)
{
...
static int
set_ptr_internal (OSSL_PARAM *p, const void *val, unsigned int type,
                  size_t len)
{
  if (p->data_type != type)
    {
...
int
ossl_param_get1_octet_string (const OSSL_PARAM *params, const char *name,
                              unsigned char **out, size_t *out_len)
{
...
static int
setbuf_fromparams (size_t n, OSSL_PARAM *p[], unsigned char *out,
                   size_t *outlen)
{
  int ret = 0;
  WPACKET pkt;
...
int
ossl_param_get1_concat_octet_string (size_t n, OSSL_PARAM *params[],
                                     unsigned char **out, size_t *out_len)
{
  unsigned char *res;
  size_t sz = 0;
...
static int
get_string_ptr_internal (const OSSL_PARAM *p, const void **val,
...
int
OSSL_PARAM_get_octet_string_ptr (const OSSL_PARAM *p, const void **val,
                                 size_t *used_len)
{
