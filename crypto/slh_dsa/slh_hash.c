...
static int
slh_hmsg_shake(SLH_DSA_HASH_CTX* ctx,
               const uint8_t* r,
               ...
               size_t out_len)
{
  ...
  return xof_digest_4(
    ctx->md_ctx, r, n, pk_seed, n, pk_root, n, msg, msg_len, out, m);
}
              ...
              size_t out_len)
{
  ...
  return xof_digest_3(
    ctx->md_ctx, pk_seed, n, adrs, SLH_ADRS_SIZE, sk_seed, n, out, n);
}

static int
slh_prf_msg_shake(SLH_DSA_HASH_CTX* ctx,
                  ...
                  WPACKET* pkt)
{
  ...
  return xof_digest_3(
           ctx->md_ctx, sk_prf, n, opt_rand, n, msg, msg_len, out, n) &&
         WPACKET_memcpy(pkt, out, n);
}

static int
slh_f_shake(SLH_DSA_HASH_CTX* ctx,
            const uint8_t* pk_seed,
            const uint8_t* adrs,
            const uint8_t* m1,
            size_t m1_len,
            ...
            size_t out_len)
{
  ...
  return xof_digest_3(
    ctx->md_ctx, pk_seed, n, adrs, SLH_ADRS_SIZE, m1, m1_len, out, n);
}

static int
slh_h_shake(SLH_DSA_HASH_CTX* ctx,
            const uint8_t* pk_seed,
            const uint8_t* adrs,
            const uint8_t* m1,
            const uint8_t* m2,
            ...
            size_t out_len)
{
  ...
  return xof_digest_4(
    ctx->md_ctx, pk_seed, n, adrs, SLH_ADRS_SIZE, m1, n, m2, n, out, n);
}

static int
slh_t_shake(SLH_DSA_HASH_CTX* ctx,
            const uint8_t* pk_seed,
            const uint8_t* adrs,
            const uint8_t* ml,
            size_t ml_len,
            ...
            size_t out_len)
{
  ...
  return xof_digest_3(
    ctx->md_ctx, pk_seed, n, adrs, SLH_ADRS_SIZE, ml, ml_len, out, n);
}
...
static int
slh_hmsg_sha2(SLH_DSA_HASH_CTX* hctx,
              const uint8_t* r,
              const uint8_t* pk_seed,
              const uint8_t* pk_root,
              const uint8_t* msg,
              ...
              size_t out_len)
{
  ...
  return digest_4(hctx->md_big_ctx,
                  r,
                  n,
                  pk_seed,
                  n,
                 ...
                 WPACKET* pkt)
{
  ...
  if (hctx->hmac_digest_used == 0) {
    ...
    *p++ = OSSL_PARAM_construct_utf8_string(
    ...
    if (key->propq != NULL)
      *p++ = OSSL_PARAM_construct_utf8_string(
        OSSL_MAC_PARAM_PROPERTIES, (char*)key->propq, 0);
        ...
        size_t out_len)
{
  ...
  ret = digest_4(
    ctx, pk_seed, n, zeros, b - n, adrs, SLH_ADRSC_SIZE, m, m_len, digest);
...
static int
slh_prf_sha2(SLH_DSA_HASH_CTX* hctx,
             const uint8_t* pk_seed,
             const uint8_t* sk_seed,
             const uint8_t* adrs,
             uint8_t* out,
...
static int
slh_f_sha2(SLH_DSA_HASH_CTX* hctx,
           const uint8_t* pk_seed,
           const uint8_t* adrs,
           const uint8_t* m1,
           size_t m1_len,
...
static int
slh_h_sha2(SLH_DSA_HASH_CTX* hctx,
           const uint8_t* pk_seed,
           const uint8_t* adrs,
           const uint8_t* m1,
           const uint8_t* m2,
           ...
           size_t out_len)
{
  ...
  memcpy(m, m1, n);
  memcpy(m + n, m2, n);
  return do_hash(hctx->md_big_ctx,
                 n,
                 pk_seed,
                 adrs,
                 m,
...
static int
slh_t_sha2(SLH_DSA_HASH_CTX* hctx,
           const uint8_t* pk_seed,
           const uint8_t* adrs,
           const uint8_t* ml,
           size_t ml_len,
...
{
  static const SLH_HASH_FUNC methods[] = { { slh_hmsg_shake,
                                             slh_prf_shake,
                                             slh_prf_msg_shake,
                                             slh_f_shake,
                                             slh_h_shake,
