...
#define OSSL_SLH_PARAMS(name)                                                                                          \
    OSSL_SLH_DSA_##name##_N, OSSL_SLH_DSA_##name##_H, OSSL_SLH_DSA_##name##_D, OSSL_SLH_DSA_##name##_H_DASH,           \
        OSSL_SLH_DSA_##name##_A, OSSL_SLH_DSA_##name##_K, OSSL_SLH_DSA_##name##_M,                                     \
        OSSL_SLH_DSA_##name##_SECURITY_CATEGORY, OSSL_SLH_DSA_##name##_PUB_BYTES, OSSL_SLH_DSA_##name##_SIG_BYTES
