...
static int slh_dsa_compute_pk_root(SLH_DSA_HASH_CTX* ctx,
                                   SLH_DSA_KEY* out,
                                   int verify);
 ...
 */
SLH_DSA_KEY* ossl_slh_dsa_key_new(OSSL_LIB_CTX* libctx,
                                  const char* propq,
                                  const char* alg) {
  SLH_DSA_KEY* ret;
 ...
 */
int ossl_slh_dsa_key_equal(const SLH_DSA_KEY* key1,
 ...
 */
int ossl_slh_dsa_key_fromdata(SLH_DSA_KEY* key,
...
int ossl_slh_dsa_set_priv(SLH_DSA_KEY* key,
                          const uint8_t* priv,
                          size_t priv_len) {
