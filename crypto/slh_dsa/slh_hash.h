 ...
 */
typedef int(OSSL_SLH_HASHFUNC_H_MSG)(SLH_DSA_HASH_CTX* ctx,
                                     const uint8_t* r,
...
typedef int(OSSL_SLH_HASHFUNC_F)(SLH_DSA_HASH_CTX* ctx,
                                 const uint8_t* pk_seed,
                                 const uint8_t* adrs,
                                 const uint8_t* m1,
                                 size_t m1_len,
...
typedef int(OSSL_SLH_HASHFUNC_H)(SLH_DSA_HASH_CTX* ctx,
                                 const uint8_t* pk_seed,
                                 const uint8_t* adrs,
                                 const uint8_t* m1,
                                 const uint8_t* m2,
...
typedef int(OSSL_SLH_HASHFUNC_T)(SLH_DSA_HASH_CTX* ctx,
                                 const uint8_t* pk_seed,
                                 const uint8_t* adrs,
                                 const uint8_t* m1,
                                 size_t m1_len,
