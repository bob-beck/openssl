 ...
 * where the first signature uses the XMSS key at the lowest layer, and the
 * last signature uses the XMSS key at the top layer.
 *
 ...
 * @param leaf_id Index of the WOTS+ key within the XMSS tree that will sign
 * the message
 * @param sig_wpkt A WPACKET object to write the Hypertree Signature to.
 * @returns 1 on success, or 0 on error.
 */
int
ossl_slh_ht_sign (SLH_DSA_HASH_CTX *ctx, const uint8_t *msg,
 ...
 */
int
ossl_slh_ht_verify (SLH_DSA_HASH_CTX *ctx, const uint8_t *msg, PACKET *sig_pkt,
