...
slh_bytes_to_nibbles (const uint8_t *in, size_t in_len, uint8_t *out)
{
  size_t consumed = 0;
 ...
 */
static ossl_inline void
compute_checksum_nibbles (const uint8_t *in, size_t in_len, uint8_t *out)
{
  size_t i;
  uint16_t csum = 0;
 ...
 */
static int
slh_wots_chain (SLH_DSA_HASH_CTX *ctx, const uint8_t *in, uint8_t start_index,
                uint8_t steps, const uint8_t *pk_seed, uint8_t *adrs,
                WPACKET *wpkt)
{
 ...
 */
int
ossl_slh_wots_pk_gen (SLH_DSA_HASH_CTX *ctx, const uint8_t *sk_seed,
                      ...
                      size_t pk_out_len)
{
  ...
  ret = hashf->T (ctx, pk_seed, wots_pk_adrs, tmp, tmp_len, pk_out,
                  pk_out_len);
end:
 ...
 */
int
ossl_slh_wots_sign (SLH_DSA_HASH_CTX *ctx, const uint8_t *msg,
 ...
 */
int
ossl_slh_wots_pk_from_sig (SLH_DSA_HASH_CTX *ctx, PACKET *sig_rpkt,
