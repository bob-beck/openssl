 ...
 */
int
ossl_slh_xmss_node (SLH_DSA_HASH_CTX *ctx, const uint8_t *sk_seed,
 ...
 */
int
ossl_slh_xmss_sign (SLH_DSA_HASH_CTX *ctx, const uint8_t *msg,
 ...
 */
int
ossl_slh_xmss_pk_from_sig (SLH_DSA_HASH_CTX *ctx, uint32_t node_id,
