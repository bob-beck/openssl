 ...
 */
static int
slh_verify_internal(SLH_DSA_HASH_CTX *hctx, const uint8_t *msg, size_t msg_len, const uint8_t *sig, size_t sig_len)
{
 ...
 */
static uint8_t *msg_encode(const uint8_t *msg,
                           size_t         msg_len,
                           const uint8_t *ctx,
                           size_t         ctx_len,
                           int            encode,
