 ...
 */
static int
slh_sign_internal (SLH_DSA_HASH_CTX *hctx, const uint8_t *msg, size_t msg_len,
 ...
 */
static int
slh_verify_internal (SLH_DSA_HASH_CTX *hctx, const uint8_t *msg,
 ...
 */
static uint8_t *
msg_encode (const uint8_t *msg, size_t msg_len, const uint8_t *ctx,
            size_t ctx_len, int encode, uint8_t *tmp, size_t tmp_len,
            size_t *out_len)
{
 ...
 */
int
ossl_slh_dsa_sign (SLH_DSA_HASH_CTX *slh_ctx, const uint8_t *msg,
                   ...
                   size_t *siglen, size_t sigsize)
{
  ...
  if (sig != NULL)
    {
      m = msg_encode (msg, msg_len, ctx, ctx_len, encode, m_tmp,
                      sizeof (m_tmp), &m_len);
      if (m == NULL)
        return 0;
    }
 ...
 */
int
ossl_slh_dsa_verify (SLH_DSA_HASH_CTX *slh_ctx, const uint8_t *msg,
                     size_t msg_len, const uint8_t *ctx, size_t ctx_len,
 ...
 */
static int
get_tree_ids (PACKET *rpkt, const SLH_DSA_PARAMS *params, uint64_t *tree_id,
              uint32_t *leaf_id)
{
  ...
  *leaf_id = (uint32_t)(bytes_to_u64_be (leaf_id_bytes, leaf_id_len)
                        & leaf_id_mask);
  return 1;
}
