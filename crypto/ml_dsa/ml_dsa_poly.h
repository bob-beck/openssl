 ...
 *            range 0..q-1
 */
static ossl_inline ossl_unused void poly_add(const POLY* lhs,
                                             const POLY* rhs,
                                             POLY* out) {
  int i;
 ...
 *            range 0..q-1
 */
static ossl_inline ossl_unused void poly_sub(const POLY* lhs,
                                             const POLY* rhs,
                                             POLY* out) {
  int i;
...
static ossl_inline ossl_unused int poly_sample_in_ball_ntt(POLY* out,
                                                           const uint8_t* seed,
                                                           int seed_len,
                                                           EVP_MD_CTX* h_ctx,
                                                           const EVP_MD* md,
...
static ossl_inline ossl_unused int poly_expand_mask(POLY* out,
                                                    const uint8_t* seed,
                                                    size_t seed_len,
                                                    uint32_t gamma1,
                                                    EVP_MD_CTX* h_ctx,
 ...
 * bits).
 */
static ossl_inline ossl_unused void poly_power2_round(const POLY* t,
                                                      POLY* t1,
                                                      POLY* t0) {
  int i;
...
static ossl_inline ossl_unused void poly_use_hint(const POLY* h,
                                                  const POLY* r,
                                                  uint32_t gamma2,
                                                  POLY* out) {
  int i;
