...
static ossl_inline ossl_unused int poly_sample_in_ball_ntt(
    POLY* out, const uint8_t* seed, int seed_len, EVP_MD_CTX* h_ctx,
...
static ossl_inline ossl_unused int poly_expand_mask(
    POLY* out, const uint8_t* seed, size_t seed_len, uint32_t gamma1,
