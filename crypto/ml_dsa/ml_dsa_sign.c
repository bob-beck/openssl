 ...
 */
static void
signature_init (ML_DSA_SIG *sig, POLY *hint, uint32_t k, POLY *z, uint32_t l,
...
EVP_MD_CTX *
ossl_ml_dsa_mu_init (const ML_DSA_KEY *key, int encode, const uint8_t *ctx,
                     size_t ctx_len)
{
  EVP_MD_CTX *md_ctx;
  uint8_t itb[2];
 ...
 */
static int
ml_dsa_sign_internal (const ML_DSA_KEY *priv, const uint8_t *mu, size_t mu_len,
 ...
 */
static int
ml_dsa_verify_internal (const ML_DSA_KEY *pub, const uint8_t *mu,
 ...
 */
int
ossl_ml_dsa_sign (const ML_DSA_KEY *priv, int msg_is_mu, const uint8_t *msg,
 ...
 */
int
ossl_ml_dsa_verify (const ML_DSA_KEY *pub, int msg_is_mu, const uint8_t *msg,
                    size_t msg_len, const uint8_t *context, size_t context_len,
