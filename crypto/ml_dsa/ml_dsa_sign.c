...
EVP_MD_CTX*
ossl_ml_dsa_mu_init(const ML_DSA_KEY* key,
                    int encode,
                    const uint8_t* ctx,
                    size_t ctx_len)
{
 ...
 */
static int
ml_dsa_sign_internal(const ML_DSA_KEY* priv,
                     const uint8_t* mu,
                     size_t mu_len,
                     const uint8_t* rnd,
                     size_t rnd_len,
                     uint8_t* out_sig)
{
  ...
  for (kappa = 0;; kappa += l) {
    ...
    if (!poly_sample_in_ball_ntt(c_ntt,
                                 c_tilde,
                                 (int)c_tilde_len,
                                 md_ctx,
                                 priv->shake256_md,
 ...
 */
static int
ml_dsa_verify_internal(const ML_DSA_KEY* pub,
                       const uint8_t* mu,
                       size_t mu_len,
 ...
 */
int
ossl_ml_dsa_sign(const ML_DSA_KEY* priv,
                 int msg_is_mu,
                 const uint8_t* msg,
                 size_t msg_len,
 ...
 */
int
ossl_ml_dsa_verify(const ML_DSA_KEY* pub,
                   int msg_is_mu,
                   const uint8_t* msg,
                   size_t msg_len,
                   const uint8_t* context,
