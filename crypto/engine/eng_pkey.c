...
EVP_PKEY*
ENGINE_load_private_key(ENGINE* e,
                        const char* key_id,
                        UI_METHOD* ui_method,
                        void* callback_data)
{
...
EVP_PKEY*
ENGINE_load_public_key(ENGINE* e,
                       const char* key_id,
                       UI_METHOD* ui_method,
                       void* callback_data)
{
...
int
ENGINE_load_ssl_client_cert(ENGINE* e,
                            SSL* s,
                            ...
                            void* callback_data)
{
  ...
  return e->load_ssl_client_cert(
    e, s, ca_dn, pcert, ppkey, pother, ui_method, callback_data);
}
