...
static int int_ctrl_cmd_is_null(const ENGINE_CMD_DEFN* defn) {
  if ((defn->cmd_num == 0) || (defn->cmd_name == NULL)) return 1;
  return 0;
}
...
static int int_ctrl_cmd_by_name(const ENGINE_CMD_DEFN* defn, const char* s) {
  ...
  if (int_ctrl_cmd_is_null(defn)) /* The given name wasn't found */
    return -1;
  return idx;
}
...
static int int_ctrl_cmd_by_num(const ENGINE_CMD_DEFN* defn, unsigned int num) {
  ...
  if (defn->cmd_num == num) return idx;
...
static int int_ctrl_helper(ENGINE* e, int cmd, long i, void* p,
  ...
  if (cmd == ENGINE_CTRL_GET_FIRST_CMD_TYPE) {
    if ((e->cmd_defns == NULL) || int_ctrl_cmd_is_null(e->cmd_defns)) return 0;
...
int ENGINE_ctrl_cmd(ENGINE* e, const char* cmd_name, long i, void* p,
   ...
   * mentioned before.
   */
  if (ENGINE_ctrl(e, num, i, p, f) > 0) return 1;
  return 0;
}
...
int ENGINE_ctrl_cmd_string(ENGINE* e, const char* cmd_name, const char* arg,
  ...
  if (flags & ENGINE_CMD_FLAG_NO_INPUT) {
     ...
     */
    if (ENGINE_ctrl(e, num, 0, (void*)arg, NULL) > 0) return 1;
    return 0;
  }
  /* So, we require input */
  if (arg == NULL) {
   ...
   * mentioned before.
   */
  if (ENGINE_ctrl(e, num, l, NULL, NULL) > 0) return 1;
  return 0;
}
