...
static EVP_PKEY*
openssl_load_privkey(ENGINE* eng,
                     const char* key_id,
                     UI_METHOD* ui_method,
                     void* callback_data);
#endif
...
static int
test_rc4_init_key(EVP_CIPHER_CTX* ctx,
...
static int
test_rc4_cipher(EVP_CIPHER_CTX* ctx,
                unsigned char* out,
...
static int
ossl_hmac_signctx(EVP_PKEY_CTX* ctx,
                  unsigned char* sig,
                  size_t* siglen,
                  EVP_MD_CTX* mctx)
{
