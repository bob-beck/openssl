...
int
engine_table_register(ENGINE_TABLE** table,
...
ENGINE*
ossl_engine_table_select(ENGINE_TABLE** table, int nid, const char* f, int l);
typedef void(engine_table_doall_cb)(int nid,
                                    STACK_OF(ENGINE)* sk,
                                    ENGINE* def,
                                    void* arg);
void
...
int
engine_free_util(ENGINE* e, int not_locked);
...
int
engine_add_dynamic_id(ENGINE* e, ENGINE_DYNAMIC_ID dynamic_id, int not_locked);
void
engine_remove_dynamic_id(ENGINE* e, int not_locked);
