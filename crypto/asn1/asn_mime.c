...
static int asn1_output_data(BIO* out,
                            BIO* data,
                            ASN1_VALUE* val,
                            int flags,
                            const ASN1_ITEM* it);
...
static int mime_hdr_addparam(MIME_HEADER* mhdr,
                             const char* name,
                             const char* value);
...
static int mime_bound_check(char* line,
                            int linelen,
                            const char* bound,
                            int blen);
static int multi_split(BIO* bio,
                       int flags,
                       const char* bound,
                       STACK_OF(BIO)** ret);
...
static int B64_write_ASN1(BIO* out,
                          ASN1_VALUE* val,
                          BIO* in,
                          int flags,
                          const ASN1_ITEM* it) {
...
static ASN1_VALUE* b64_read_asn1(BIO* bio,
                                 const ASN1_ITEM* it,
                                 ASN1_VALUE** x,
                                 OSSL_LIB_CTX* libctx,
                                 const char* propq) {
...
int SMIME_write_ASN1_ex(BIO* bio,
                        ASN1_VALUE* val,
                        BIO* data,
                        int flags,
                        int ctype_nid,
...
ASN1_VALUE* SMIME_read_ASN1_ex(BIO* bio,
                               int flags,
                               BIO** bcont,
                               const ASN1_ITEM* it,
                               ASN1_VALUE** x,
