...
static ASN1_VALUE *
b64_read_asn1 (BIO *bio, const ASN1_ITEM *it, ASN1_VALUE **x,
...
int
SMIME_write_ASN1_ex (BIO *bio, ASN1_VALUE *val, BIO *data, int flags,
...
ASN1_VALUE *
SMIME_read_ASN1_ex (BIO *bio, int flags, BIO **bcont, const ASN1_ITEM *it,
