...
ASN1_SEQUENCE(PBKDF2PARAM) = {ASN1_SIMPLE(PBKDF2PARAM, salt, ASN1_ANY), ASN1_SIMPLE(PBKDF2PARAM, iter, ASN1_INTEGER),
                              ASN1_OPT(PBKDF2PARAM, keylength, ASN1_INTEGER),
                              ASN1_OPT(PBKDF2PARAM, prf, X509_ALGOR)} ASN1_SEQUENCE_END(PBKDF2PARAM)

IMPLEMENT_ASN1_FUNCTIONS(PBKDF2PARAM)

ASN1_SEQUENCE(PBMAC1PARAM) = {ASN1_SIMPLE(PBMAC1PARAM, keyDerivationFunc, X509_ALGOR),
                              ASN1_SIMPLE(PBMAC1PARAM, messageAuthScheme, X509_ALGOR)} ASN1_SEQUENCE_END(PBMAC1PARAM)
