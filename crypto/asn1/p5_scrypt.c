...
X509_ALGOR *
PKCS5_pbe2_set_scrypt (const EVP_CIPHER *cipher, const unsigned char *salt,
                       int saltlen, unsigned char *aiv, uint64_t N, uint64_t r,
                       uint64_t p)
{
...
static X509_ALGOR *
pkcs5_scrypt_set (const unsigned char *salt, int saltlen, size_t keylen,
...
int
PKCS5_v2_scrypt_keyivgen_ex (EVP_CIPHER_CTX *ctx, const char *pass,
...
int
PKCS5_v2_scrypt_keyivgen (EVP_CIPHER_CTX *ctx, const char *pass, int passlen,
