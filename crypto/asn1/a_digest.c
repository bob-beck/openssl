...
int
ASN1_digest (i2d_of_void *i2d, const EVP_MD *type, char *data,
...
int
ossl_asn1_item_digest_ex (const ASN1_ITEM *it, const EVP_MD *md, void *asn,
...
int
ASN1_item_digest (const ASN1_ITEM *it, const EVP_MD *md, void *asn,
                  unsigned char *data, unsigned int *len)
{
