...
int
EVP_PKEY_asn1_get0_info(int* ppkey_id,
                        int* ppkey_base_id,
                        int* ppkey_flags,
                        const char** pinfo,
                        const char** ppem_str,
...
EVP_PKEY_asn1_set_private(
  ...
  int (
    *priv_print)(BIO* out, const EVP_PKEY* pkey, int indent, ASN1_PCTX* pctx))
{
...
EVP_PKEY_asn1_set_param(
  ...
  int (
    *param_print)(BIO* out, const EVP_PKEY* pkey, int indent, ASN1_PCTX* pctx))
{
...
void
EVP_PKEY_asn1_set_set_priv_key(EVP_PKEY_ASN1_METHOD* ameth,
...
void
EVP_PKEY_asn1_set_set_pub_key(EVP_PKEY_ASN1_METHOD* ameth,
...
void
EVP_PKEY_asn1_set_get_priv_key(EVP_PKEY_ASN1_METHOD* ameth,
