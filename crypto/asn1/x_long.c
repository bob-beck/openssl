 ...
 */
static int
num_bits_ulong (unsigned long value)
{
  size_t i;
  unsigned long ret = 0;
...
static int
long_i2c (const ASN1_VALUE **pval, unsigned char *cont, int *putype,
          const ASN1_ITEM *it)
{
  long ltmp;
...
static int
long_print (BIO *out, const ASN1_VALUE **pval, const ASN1_ITEM *it, int indent,
