...
int
ossl_asn1_set_choice_selector (ASN1_VALUE **pval, int value,
                               const ASN1_ITEM *it)
{
  int *sel, ret;
...
static const ASN1_ENCODING *
asn1_get_const_enc_ptr (const ASN1_VALUE **pval, const ASN1_ITEM *it)
{
  const ASN1_AUX *aux;
...
int
ossl_asn1_enc_save (ASN1_VALUE **pval, const unsigned char *in, long inlen,
                    const ASN1_ITEM *it)
{
  ASN1_ENCODING *enc = asn1_get_enc_ptr (pval, it);
...
int
ossl_asn1_enc_restore (int *len, unsigned char **out, const ASN1_VALUE **pval,
                       const ASN1_ITEM *it)
{
...
const ASN1_VALUE **
ossl_asn1_get_const_field_ptr (const ASN1_VALUE **pval,
