...
int
ASN1_verify (i2d_of_void *i2d, X509_ALGOR *a, ASN1_BIT_STRING *signature,
...
int
ASN1_item_verify (const ASN1_ITEM *it, const X509_ALGOR *alg,
...
int
ASN1_item_verify_ex (const ASN1_ITEM *it, const X509_ALGOR *alg,
                     const ASN1_BIT_STRING *signature, const void *data,
...
int
ASN1_item_verify_ctx (const ASN1_ITEM *it, const X509_ALGOR *alg,
                      const ASN1_BIT_STRING *signature, const void *data,
                      EVP_MD_CTX *ctx)
{
  EVP_PKEY *pkey;
