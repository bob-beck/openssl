...
ASN1_VALUE* ASN1_item_new_ex(const ASN1_ITEM* it, OSSL_LIB_CTX* libctx,
                             const char* propq) {
  ASN1_VALUE* ret = NULL;
  if (asn1_item_embed_new(&ret, it, 0, libctx, propq) > 0) return ret;
  return NULL;
}
...
int asn1_item_embed_new(ASN1_VALUE** pval, const ASN1_ITEM* it, int embed,
  ...
  switch (it->itype) {
    case ASN1_ITYPE_EXTERN:
      ...
      if (ef != NULL) {
        if (ef->asn1_ex_new_ex != NULL) {
          if (!ef->asn1_ex_new_ex(pval, it, libctx, propq)) goto asn1err;
        } else if (ef->asn1_ex_new != NULL) {
          if (!ef->asn1_ex_new(pval, it)) goto asn1err;
        }
      }
      break;
    ...
    case ASN1_ITYPE_MSTRING:
      if (!asn1_primitive_new(pval, it, embed)) goto asn1err;
      break;
    ...
    case ASN1_ITYPE_CHOICE:
      ...
      if (asn1_cb && !asn1_cb(ASN1_OP_NEW_POST, pval, it, NULL)) goto auxerr2;
      break;
    ...
    case ASN1_ITYPE_SEQUENCE:
      ...
      for (i = 0, tt = it->templates; i < it->tcount; tt++, i++) {
        ...
        if (!asn1_template_new(pseqval, tt, libctx, propq)) goto asn1err2;
      }
      if (asn1_cb && !asn1_cb(ASN1_OP_NEW_POST, pval, it, NULL)) goto auxerr2;
      break;
  }
...
static int asn1_primitive_new(ASN1_VALUE** pval, const ASN1_ITEM* it,
  ...
  switch (utype) {
    ...
    case V_ASN1_ANY:
      if ((typ = OPENSSL_malloc(sizeof(*typ))) == NULL) return 0;
      typ->value.ptr = NULL;
      typ->type = -1;
      *pval = (ASN1_VALUE*)typ;
      break;
