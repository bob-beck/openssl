...
static int asn1_item_embed_new(ASN1_VALUE** pval,
                               const ASN1_ITEM* it,
                               int embed,
                               OSSL_LIB_CTX* libctx,
                               const char* propq);
static int asn1_primitive_new(ASN1_VALUE** pval,
                              const ASN1_ITEM* it,
                              int embed);
static void asn1_item_clear(ASN1_VALUE** pval, const ASN1_ITEM* it);
static int asn1_template_new(ASN1_VALUE** pval,
...
ASN1_VALUE* ASN1_item_new_ex(const ASN1_ITEM* it,
                             OSSL_LIB_CTX* libctx,
                             const char* propq) {
  ASN1_VALUE* ret = NULL;
...
int asn1_item_embed_new(ASN1_VALUE** pval,
                        const ASN1_ITEM* it,
                        int embed,
                        OSSL_LIB_CTX* libctx,
                        const char* propq) {
