...
static int
asn1_type_get_int_oct(ASN1_OCTET_STRING* oct,
                      int32_t anum,
                      long* num,
                      unsigned char* data,
                      int max_len)
...
ASN1_SEQUENCE(
  asn1_int_oct) = { ASN1_EMBED(asn1_int_oct, num, INT32),
                    ASN1_SIMPLE(
                      asn1_int_oct,
                      oct,
...
int
ASN1_TYPE_set_int_octetstring(ASN1_TYPE* a,
                              long num,
                              unsigned char* data,
                              int len)
{
...
int
ASN1_TYPE_get_int_octetstring(const ASN1_TYPE* a,
                              long* num,
                              unsigned char* data,
                              int max_len)
{
 ...
 */
ASN1_SEQUENCE(
  asn1_oct_int) = { ASN1_SIMPLE(asn1_oct_int, oct, ASN1_OCTET_STRING),
                    ASN1_EMBED(asn1_oct_int,
                               num,
