...
static int asn1_type_get_int_oct(ASN1_OCTET_STRING* oct,
                                 int32_t anum,
                                 long* num,
                                 unsigned char* data,
                                 int max_len) {
...
int ossl_asn1_type_set_octetstring_int(ASN1_TYPE* a,
                                       long num,
                                       unsigned char* data,
                                       int len) {
  asn1_oct_int atmp;
...
int ossl_asn1_type_get_octetstring_int(const ASN1_TYPE* a,
                                       long* num,
                                       unsigned char* data,
                                       int max_len) {
