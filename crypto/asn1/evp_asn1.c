 ...
 */
int
ASN1_TYPE_get_octetstring (const ASN1_TYPE *a, unsigned char *data,
                           int max_len)
{
  int ret, num;
...
static int
asn1_type_get_int_oct (ASN1_OCTET_STRING *oct, int32_t anum, long *num,
...
int
ASN1_TYPE_get_int_octetstring (const ASN1_TYPE *a, long *num,
                               unsigned char *data, int max_len)
{
...
int
ossl_asn1_type_get_octetstring_int (const ASN1_TYPE *a, long *num,
                                    unsigned char *data, int max_len)
{
