...
int
ASN1_item_ndef_i2d (const ASN1_VALUE *val, unsigned char **out,
                    const ASN1_ITEM *it)
{
...
int
ASN1_item_i2d (const ASN1_VALUE *val, unsigned char **out, const ASN1_ITEM *it)
{
...
static int
asn1_item_flags_i2d (const ASN1_VALUE *val, unsigned char **out,
                     const ASN1_ITEM *it, int flags)
{
...
int
ASN1_item_ex_i2d (const ASN1_VALUE **pval, unsigned char **out,
                  const ASN1_ITEM *it, int tag, int aclass)
{
...
static int
asn1_template_ex_i2d (const ASN1_VALUE **pval, unsigned char **out,
...
static int
asn1_set_seq_out (STACK_OF (const_ASN1_VALUE) *sk, unsigned char **out,
...
static int
asn1_i2d_ex_primitive (const ASN1_VALUE **pval, unsigned char **out,
                       const ASN1_ITEM *it, int tag, int aclass)
{
  int len;
  int utype;
...
static int
asn1_ex_i2c (const ASN1_VALUE **pval, unsigned char *cout, int *putype,
             const ASN1_ITEM *it)
{
