...
static int uint64_i2c(const ASN1_VALUE** pval,
                      unsigned char* cont,
                      int* putype,
                      const ASN1_ITEM* it) {
  uint64_t utmp;
...
static int uint64_c2i(ASN1_VALUE** pval,
...
static int uint32_i2c(const ASN1_VALUE** pval,
                      unsigned char* cont,
                      int* putype,
                      const ASN1_ITEM* it) {
  uint32_t utmp;
...
static int uint32_c2i(ASN1_VALUE** pval,
                      const unsigned char* cont,
                      int len,
                      int utype,
                      char* free_cont,
