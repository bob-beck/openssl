...
int
PKCS8_pkey_set0(PKCS8_PRIV_KEY_INFO* priv,
                ASN1_OBJECT* aobj,
                int version,
                int ptype,
                void* pval,
...
int
PKCS8_pkey_get0(const ASN1_OBJECT** ppkalg,
...
int
PKCS8_pkey_add1_attr_by_NID(PKCS8_PRIV_KEY_INFO* p8,
                            int nid,
                            int type,
...
int
PKCS8_pkey_add1_attr_by_OBJ(PKCS8_PRIV_KEY_INFO* p8,
...
int
PKCS8_pkey_add1_attr(PKCS8_PRIV_KEY_INFO* p8, X509_ATTRIBUTE* attr)
{
