...
static int bn_secure_c2i (ASN1_VALUE **pval, const unsigned char *cont,
...
static ASN1_PRIMITIVE_FUNCS bignum_pf
    = { NULL, 0, bn_new, bn_free, 0, bn_c2i, bn_i2c, bn_print };
...
static int
bn_secure_new (ASN1_VALUE **pval, const ASN1_ITEM *it)
{
...
static int
bn_i2c (const ASN1_VALUE **pval, unsigned char *cont, int *putype,
        const ASN1_ITEM *it)
{
  BIGNUM *bn;
  int pad;
...
static int
bn_secure_c2i (ASN1_VALUE **pval, const unsigned char *cont, int len,
               int utype, char *free_cont, const ASN1_ITEM *it)
{
  int ret;
  BIGNUM *bn;
...
static int
bn_print (BIO *out, const ASN1_VALUE **pval, const ASN1_ITEM *it, int indent,
