...
static int asn1_d2i_ex_primitive(ASN1_VALUE          **pval,
                                 ...
                                 ASN1_TLC             *ctx);
static int
asn1_ex_c2i(ASN1_VALUE **pval, const unsigned char *cont, int len, int utype, char *free_cont, const ASN1_ITEM *it);
...
static int asn1_item_ex_d2i_intern(ASN1_VALUE          **pval,
                                   const unsigned char **in,
                                   long                  len,
                                   const ASN1_ITEM      *it,
                                   int                   tag,
