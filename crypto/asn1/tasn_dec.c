 ...
 * excessive recursion. Therefore we limit the stack depth. This is the maximum
 * number of recursive invocations of asn1_item_embed_d2i().
 */
...
static int asn1_template_noexp_d2i (ASN1_VALUE **val, const unsigned char **in,
                                    long len, const ASN1_TEMPLATE *tt,
...
static int
asn1_item_ex_d2i_intern (ASN1_VALUE **pval, const unsigned char **in, long len,
...
ASN1_VALUE *
ASN1_item_d2i_ex (ASN1_VALUE **pval, const unsigned char **in, long len,
...
static int
asn1_item_embed_d2i (ASN1_VALUE **pval, const unsigned char **in, long len,
                     const ASN1_ITEM *it, int tag, int aclass, char opt,
  ...
  if (flags & ASN1_TFLG_SK_MASK)
  ...
  else if (flags & ASN1_TFLG_IMPTAG)
    {
      ...
      ret = asn1_item_embed_d2i (val, &p, len, ASN1_ITEM_ptr (tt->item),
                                 tt->tag, aclass, opt, ctx, depth, libctx,
                                 propq);
      if (!ret)
        {
          ERR_raise (ERR_LIB_ASN1, ERR_R_NESTED_ASN1_ERROR);
...
asn1_check_tlen (long *olen, int *otag, unsigned char *oclass, char *inf,
                 char *cst, const unsigned char **in, long len, int exptag,
