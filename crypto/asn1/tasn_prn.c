...
static int asn1_template_print_ctx (BIO *out, const ASN1_VALUE **fld,
                                    int indent, const ASN1_TEMPLATE *tt,
                                    const ASN1_PCTX *pctx);
...
int
ASN1_item_print (BIO *out, const ASN1_VALUE *ifld, int indent,
...
static int
asn1_item_print_ctx (BIO *out, const ASN1_VALUE **fld, int indent,
                     const ASN1_ITEM *it, const char *fname, const char *sname,
  ...
  if (aux != NULL)
    {
      ...
      asn1_cb = ((aux->flags & ASN1_AFLG_CONST_CB) != 0)
                    ? aux->asn1_const_cb
                    : (ASN1_aux_const_cb *)
                          aux->asn1_cb; /* backward compatibility */
    }
...
static int
asn1_template_print_ctx (BIO *out, const ASN1_VALUE **fld, int indent,
...
static int
asn1_print_boolean (BIO *out, int boolval)
{
  const char *str;
  switch (boolval)
    {
...
static int
asn1_print_integer (BIO *out, const ASN1_INTEGER *str)
{
  char *s;
  int ret = 1;
...
static int
asn1_print_oid (BIO *out, const ASN1_OBJECT *oid)
{
  char objbuf[80];
  const char *ln;
...
static int
asn1_print_obstring (BIO *out, const ASN1_STRING *str, int indent)
{
...
static int
asn1_primitive_print (BIO *out, const ASN1_VALUE **fld, const ASN1_ITEM *it,
                      int indent, const char *fname, const char *sname,
                      const ASN1_PCTX *pctx)
{
  long utype;
  ASN1_STRING *str;
