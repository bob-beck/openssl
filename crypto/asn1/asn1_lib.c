...
static int
asn1_get_length(const unsigned char** pp, int* inf, long* rl, long max);
static void
...
int
ASN1_get_object(const unsigned char** pp,
                long* plength,
                int* ptag,
                int* pclass,
                long omax)
 ...
 */
void
ASN1_put_object(unsigned char** pp,
                int constructed,
                int length,
                int tag,
                int xclass)
...
int
ASN1_STRING_set(ASN1_STRING* str, const void* _data, int len_in)
{
  unsigned char* c;
