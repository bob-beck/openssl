 ...
 * to the last none zero octet: so complement this octet and add one and
 * finally complement any left over until you get to the start of the string.
 *
 ...
 */
static void
twos_complement (unsigned char *dst, const unsigned char *src, size_t len,
                 unsigned char pad)
{
...
static size_t
i2c_ibuf (const unsigned char *b, size_t blen, int neg, unsigned char **pp)
{
  unsigned int pad = 0;
  size_t ret, i;
...
static size_t
c2i_ibuf (unsigned char *b, int *pneg, const unsigned char *p, size_t plen)
{
  int neg, pad;
...
int
ossl_i2c_ASN1_INTEGER (ASN1_INTEGER *a, unsigned char **pp)
{
...
static int
asn1_get_uint64 (uint64_t *pr, const unsigned char *b, size_t blen)
{
  size_t i;
  uint64_t r;
 ...
 */
static size_t
asn1_put_uint64 (unsigned char b[sizeof (uint64_t)], uint64_t r)
{
...
static int
asn1_get_int64 (int64_t *pr, const unsigned char *b, size_t blen, int neg)
{
  uint64_t r;
...
ASN1_INTEGER *
ossl_c2i_ASN1_INTEGER (ASN1_INTEGER **a, const unsigned char **pp, long len)
{
...
static int
asn1_string_get_int64 (int64_t *pr, const ASN1_STRING *a, int itype)
{
  if (a == NULL)
    {
...
static int
asn1_string_set_int64 (ASN1_STRING *a, int64_t r, int itype)
{
...
static int
asn1_string_get_uint64 (uint64_t *pr, const ASN1_STRING *a, int itype)
{
  if (a == NULL)
    {
      ERR_raise (ERR_LIB_ASN1, ERR_R_PASSED_NULL_PARAMETER);
...
static int
asn1_string_set_uint64 (ASN1_STRING *a, uint64_t r, int itype)
{
  unsigned char tbuf[sizeof (r)];
  size_t off;
...
static ASN1_STRING *
bn_to_asn1_string (const BIGNUM *bn, ASN1_STRING *ai, int atype)
{
  ASN1_INTEGER *ret;
  int len;
...
static BIGNUM *
asn1_string_to_bn (const ASN1_INTEGER *ai, BIGNUM *bn, int itype)
{
  BIGNUM *ret;
...
int
ASN1_INTEGER_get_int64 (int64_t *pr, const ASN1_INTEGER *a)
{
...
int
ASN1_INTEGER_get_uint64 (uint64_t *pr, const ASN1_INTEGER *a)
{
...
int
ASN1_ENUMERATED_get_int64 (int64_t *pr, const ASN1_ENUMERATED *a)
{
...
int
ossl_c2i_uint64_int (uint64_t *ret, int *neg, const unsigned char **pp,
                     long len)
{
...
int
ossl_i2c_uint64_int (unsigned char *p, uint64_t r, int neg)
{
  unsigned char buf[sizeof (uint64_t)];
  size_t off;
