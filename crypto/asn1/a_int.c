 ...
 */
static void twos_complement(unsigned char* dst,
...
static size_t i2c_ibuf(const unsigned char* b,
                       size_t blen,
                       int neg,
                       unsigned char** pp) {
  unsigned int pad = 0;
...
static size_t c2i_ibuf(unsigned char* b,
                       int* pneg,
...
static int asn1_get_int64(int64_t* pr,
...
ASN1_INTEGER* ossl_c2i_ASN1_INTEGER(ASN1_INTEGER** a,
...
static int asn1_string_get_uint64(uint64_t* pr,
                                  const ASN1_STRING* a,
                                  int itype) {
  if (a == NULL) {
    ERR_raise(ERR_LIB_ASN1, ERR_R_PASSED_NULL_PARAMETER);
...
static ASN1_STRING* bn_to_asn1_string(const BIGNUM* bn,
                                      ASN1_STRING* ai,
                                      int atype) {
  ASN1_INTEGER* ret;
  int len;
...
static BIGNUM* asn1_string_to_bn(const ASN1_INTEGER* ai,
                                 BIGNUM* bn,
                                 int itype) {
  BIGNUM* ret;
...
int ossl_c2i_uint64_int(uint64_t* ret,
                        int* neg,
                        const unsigned char** pp,
                        long len) {
