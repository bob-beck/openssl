...
size_t
ossl_rand_get_entropy(ossl_unused OSSL_LIB_CTX* ctx,
                      unsigned char** pout,
                      int entropy,
                      size_t min_len,
                      size_t max_len)
...
void
ossl_rand_cleanup_entropy(ossl_unused OSSL_LIB_CTX* ctx,
                          unsigned char* buf,
                          size_t len)
{
...
size_t
ossl_rand_get_nonce(ossl_unused OSSL_LIB_CTX* ctx,
                    unsigned char** pout,
                    size_t min_len,
...
void
ossl_rand_cleanup_nonce(ossl_unused OSSL_LIB_CTX* ctx,
                        unsigned char* buf,
                        size_t len)
{
