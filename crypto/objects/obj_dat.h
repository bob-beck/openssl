...
static const ASN1_OBJECT nid_objs[NUM_NID] = {
  ...
  { "classSignTool", "Class of Signing Tool", NID_classSignTool, 5,
    &so[7905] },
  ...
  { "tcg-tr-registry", "TCG Trait Registries", NID_tcg_tr_registry, 5,
    &so[8866] },
  { "tcg-tr-ID-Boolean", "Boolean Trait", NID_tcg_tr_ID_Boolean, 6,
    &so[8871] },
  ...
  { "id-smime-ori-kem", "id-smime-ori-kem", NID_id_smime_ori_kem, 11,
    &so[9559] },
};
...
static const unsigned int obj_objs[NUM_OBJ] = {
  ...
  1450, /* OBJ_tcg_tr_cat_platformFirmwareSignatureVerification 2 23 133 19 2
           34 */
