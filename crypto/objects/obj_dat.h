...
static const unsigned char so[9571] = {
  ...
  0x01, 0x09,
  0x10, 0x03,
  0x1C, /* [ 9516] OBJ_HKDF_SHA256 */
  0x2A, 0x86,
  0x48, 0x86,
  0xF7, 0x0D,
  0x01, 0x09,
  0x10, 0x03,
  0x1D, /* [ 9527] OBJ_HKDF_SHA384 */
  0x2A, 0x86,
  0x48, 0x86,
  0xF7, 0x0D,
  0x01, 0x09,
  0x10, 0x03,
  0x1E, /* [ 9538] OBJ_HKDF_SHA512 */
  0x2A, 0x86,
  0x48, 0x86,
  0xF7, 0x0D,
  0x01, 0x09,
  0x10, 0x0D, /* [ 9549] OBJ_id_smime_ori */
  0x2A, 0x86,
  0x48, 0x86,
  0xF7, 0x0D,
  0x01, 0x09,
  0x10, 0x0D,
  0x03, /* [ 9559] OBJ_id_smime_ori_kem */
};
...
static const ASN1_OBJECT nid_objs[NUM_NID] = {
  ...
  { "id-tc26-constants",
    "id-tc26-constants",
    NID_id_tc26_constants,
    6,
    &so[6512] },
  { "id-tc26-sign-constants",
    "id-tc26-sign-constants",
    NID_id_tc26_sign_constants,
    7,
    &so[6518] },
  { "id-tc26-gost-3410-2012-512-constants",
    "id-tc26-gost-3410-2012-512-constants",
    NID_id_tc26_gost_3410_2012_512_constants,
    8,
    &so[6525] },
  ...
  { "id-tc26-digest-constants",
    "id-tc26-digest-constants",
    NID_id_tc26_digest_constants,
    7,
    &so[6560] },
  { "id-tc26-cipher-constants",
    "id-tc26-cipher-constants",
    NID_id_tc26_cipher_constants,
    7,
    &so[6567] },
  { "id-tc26-gost-28147-constants",
    "id-tc26-gost-28147-constants",
    NID_id_tc26_gost_28147_constants,
    8,
    &so[6574] },
  ...
  { "id-smime-ct-contentCollection",
    "id-smime-ct-contentCollection",
    NID_id_smime_ct_contentCollection,
    11,
    &so[6747] },
  ...
  { "id-dsa-with-sha3-224",
    "dsa_with_SHA3-224",
    NID_dsa_with_SHA3_224,
    9,
    &so[7075] },
  { "id-dsa-with-sha3-256",
    "dsa_with_SHA3-256",
    NID_dsa_with_SHA3_256,
    9,
    &so[7084] },
  { "id-dsa-with-sha3-384",
    "dsa_with_SHA3-384",
    NID_dsa_with_SHA3_384,
    9,
    &so[7093] },
  { "id-dsa-with-sha3-512",
    "dsa_with_SHA3-512",
    NID_dsa_with_SHA3_512,
    9,
    &so[7102] },
  { "id-ecdsa-with-sha3-224",
    "ecdsa_with_SHA3-224",
    NID_ecdsa_with_SHA3_224,
    9,
    &so[7111] },
  ...
  { "id-ecdsa-with-sha3-384",
    "ecdsa_with_SHA3-384",
    NID_ecdsa_with_SHA3_384,
    9,
    &so[7129] },
  { "id-ecdsa-with-sha3-512",
    "ecdsa_with_SHA3-512",
    NID_ecdsa_with_SHA3_512,
    9,
    &so[7138] },
  ...
  { "id-tc26-gost-3410-2012-256-constants",
    "id-tc26-gost-3410-2012-256-constants",
    NID_id_tc26_gost_3410_2012_256_constants,
    8,
    &so[7357] },
  ...
  { "id-tc26-cipher-gostr3412-2015-magma",
    "id-tc26-cipher-gostr3412-2015-magma",
    NID_id_tc26_cipher_gostr3412_2015_magma,
    8,
    &so[7625] },
  ...
  { "id-tc26-cipher-gostr3412-2015-kuznyechik",
    "id-tc26-cipher-gostr3412-2015-kuznyechik",
    NID_id_tc26_cipher_gostr3412_2015_kuznyechik,
    8,
    &so[7651] },
  ...
  { "id-tc26-wrap-gostr3412-2015-kuznyechik",
    "id-tc26-wrap-gostr3412-2015-kuznyechik",
    NID_id_tc26_wrap_gostr3412_2015_kuznyechik,
    8,
    &so[7701] },
  { "kuznyechik-kexp15",
    "kuznyechik-kexp15",
  ...
  { "id-ct-geofeedCSVwithCRLF",
    "id-ct-geofeedCSVwithCRLF",
    NID_id_ct_geofeedCSVwithCRLF,
    11,
    &so[8053] },
  { "id-ct-signedChecklist",
    "id-ct-signedChecklist",
    NID_id_ct_signedChecklist,
    11,
    &so[8064] },
  ...
  { "id-mod-cmp2000-02",
    "id-mod-cmp2000-02",
    NID_id_mod_cmp2000_02,
    8,
    &so[8102] },
  { "id-mod-cmp2021-88",
    "id-mod-cmp2021-88",
    NID_id_mod_cmp2021_88,
    8,
    &so[8110] },
  { "id-mod-cmp2021-02",
    "id-mod-cmp2021-02",
    NID_id_mod_cmp2021_02,
    8,
    &so[8118] },
  { "id-it-rootCaCert",
    "id-it-rootCaCert",
  ...
  { "id-regCtrl-altCertTemplate",
    "id-regCtrl-altCertTemplate",
    NID_id_regCtrl_altCertTemplate,
    9,
    &so[8158] },
  { "id-regCtrl-algId",
    "id-regCtrl-algId",
  ...
  { "id-aa-ets-attrCertificateRefs",
    "id-aa-ets-attrCertificateRefs",
    NID_id_aa_ets_attrCertificateRefs,
    11,
    &so[8185] },
  { "id-aa-ets-attrRevocationRefs",
    "id-aa-ets-attrRevocationRefs",
    NID_id_aa_ets_attrRevocationRefs,
    11,
    &so[8196] },
  { "id-aa-CMSAlgorithmProtection",
    "id-aa-CMSAlgorithmProtection",
    NID_id_aa_CMSAlgorithmProtection,
    9,
    &so[8207] },
  { "itu-t-identified-organization",
    "itu-t-identified-organization",
    NID_itu_t_identified_organization,
    1,
    &so[8216] },
  { "etsi", "etsi", NID_etsi, 2, &so[8217] },
  { "electronic-signature-standard",
    "electronic-signature-standard",
    NID_electronic_signature_standard,
    4,
    &so[8219] },
  { "ess-attributes", "ess-attributes", NID_ess_attributes, 5, &so[8223] },
  { "id-aa-ets-mimeType",
    "id-aa-ets-mimeType",
    NID_id_aa_ets_mimeType,
    6,
    &so[8228] },
  { "id-aa-ets-longTermValidation",
    "id-aa-ets-longTermValidation",
    NID_id_aa_ets_longTermValidation,
    6,
    &so[8234] },
  { "id-aa-ets-SignaturePolicyDocument",
    "id-aa-ets-SignaturePolicyDocument",
    NID_id_aa_ets_SignaturePolicyDocument,
    6,
    &so[8240] },
  { "id-aa-ets-archiveTimestampV3",
    "id-aa-ets-archiveTimestampV3",
    NID_id_aa_ets_archiveTimestampV3,
    6,
    &so[8246] },
  { "id-aa-ATSHashIndex",
    "id-aa-ATSHashIndex",
    NID_id_aa_ATSHashIndex,
    6,
    &so[8252] },
  { "cades", "cades", NID_cades, 5, &so[8258] },
  { "cades-attributes",
    "cades-attributes",
    NID_cades_attributes,
    6,
    &so[8263] },
  { "id-aa-ets-signerAttrV2",
    "id-aa-ets-signerAttrV2",
    NID_id_aa_ets_signerAttrV2,
    7,
    &so[8269] },
  { "id-aa-ets-sigPolicyStore",
    "id-aa-ets-sigPolicyStore",
    NID_id_aa_ets_sigPolicyStore,
    7,
    &so[8276] },
  ...
  { "id-aa-ets-archiveTimestampV2",
    "id-aa-ets-archiveTimestampV2",
    NID_id_aa_ets_archiveTimestampV2,
    11,
    &so[8304] },
  ...
  { "oracle-jdk-trustedkeyusage",
    ...
    NID_oracle_jdk_trustedkeyusage,
    12,
    &so[8332] },
  ...
  { "sOAIdentifier",
    "X509v3 Source of Authority Identifier",
    NID_soa_identifier,
    3,
    &so[8421] },
  ...
  { "authorizationValidation",
    "X509v3 Authorization Validation",
    NID_authorization_validation,
    3,
    &so[8457] },
  { "protRestrict",
    "X509v3 Protocol Restriction",
    NID_prot_restrict,
    3,
    &so[8460] },
  { "subjectAltPublicKeyInfo",
    "X509v3 Subject Alternative Public Key Info",
    NID_subject_alt_public_key_info,
    3,
    &so[8463] },
  { "altSignatureAlgorithm",
    "X509v3 Alternative Signature Algorithm",
    NID_alt_signature_algorithm,
    3,
    &so[8466] },
  { "altSignatureValue",
    "X509v3 Alternative Signature Value",
    NID_alt_signature_value,
    3,
    &so[8469] },
  { "associatedInformation",
    "X509v3 Associated Information",
    NID_associated_information,
    3,
    &so[8472] },
  { "id-ct-rpkiSignedPrefixList",
    "id-ct-rpkiSignedPrefixList",
    NID_id_ct_rpkiSignedPrefixList,
    11,
    &so[8475] },
  { "id-on-hardwareModuleName",
    "Hardware Module Name",
    NID_id_on_hardwareModuleName,
    8,
    &so[8486] },
  { "id-kp-wisun-fan-device",
    "Wi-SUN Alliance Field Area Network (FAN)",
    NID_id_kp_wisun_fan_device,
    9,
    &so[8494] },
  ...
  { "tcg-tcpaSpecVersion",
    "tcg-tcpaSpecVersion",
    NID_tcg_tcpaSpecVersion,
    4,
    &so[8506] },
  { "tcg-attribute",
    "Trusted Computing Group Attributes",
    NID_tcg_attribute,
    4,
    &so[8510] },
  { "tcg-protocol",
    ...
    &so[8514] },
  { "tcg-algorithm",
    "Trusted Computing Group Algorithms",
    NID_tcg_algorithm,
    4,
    &so[8518] },
  { "tcg-platformClass",
    "Trusted Computing Group Platform Classes",
    NID_tcg_platformClass,
    4,
    &so[8522] },
  { "tcg-ce",
    "Trusted Computing Group Certificate Extensions",
    NID_tcg_ce,
    4,
    &so[8526] },
  { "tcg-kp",
    "Trusted Computing Group Key Purposes",
    NID_tcg_kp,
    4,
    &so[8530] },
  { "tcg-ca",
    "Trusted Computing Group Certificate Policies",
    NID_tcg_ca,
    4,
    &so[8534] },
  { "tcg-address",
    "Trusted Computing Group Address Formats",
    NID_tcg_address,
    4,
    &so[8538] },
  { "tcg-registry",
    "Trusted Computing Group Registry",
    NID_tcg_registry,
    4,
    &so[8542] },
  { "tcg-traits",
    "Trusted Computing Group Traits",
    NID_tcg_traits,
    4,
    &so[8546] },
  { "tcg-common",
    "Trusted Computing Group Common",
    NID_tcg_common,
    5,
    &so[8550] },
  { "tcg-at-platformManufacturerStr",
    "TCG Platform Manufacturer String",
    NID_tcg_at_platformManufacturerStr,
    6,
    &so[8555] },
  { "tcg-at-platformManufacturerId",
    "TCG Platform Manufacturer ID",
    NID_tcg_at_platformManufacturerId,
    6,
    &so[8561] },
  { "tcg-at-platformConfigUri",
    "TCG Platform Configuration URI",
    NID_tcg_at_platformConfigUri,
    6,
    &so[8567] },
  { "tcg-at-platformModel",
    "TCG Platform Model",
    NID_tcg_at_platformModel,
    6,
    &so[8573] },
  { "tcg-at-platformVersion",
    "TCG Platform Version",
    NID_tcg_at_platformVersion,
    6,
    &so[8579] },
  { "tcg-at-platformSerial",
    "TCG Platform Serial Number",
    NID_tcg_at_platformSerial,
    6,
    &so[8585] },
  { "tcg-at-platformConfiguration",
    ...
    6,
    &so[8591] },
  { "tcg-at-platformIdentifier",
    "TCG Platform Identifier",
    NID_tcg_at_platformIdentifier,
    6,
    &so[8597] },
  { "tcg-at-tpmManufacturer",
    "TPM Manufacturer",
    NID_tcg_at_tpmManufacturer,
    5,
    &so[8603] },
  ...
  { "tcg-at-tbbSecurityAssertions",
    ...
    NID_tcg_at_tbbSecurityAssertions,
    5,
    &so[8663] },
  { "tcg-at-tcgCredentialSpecification",
    "TCG Credential Specification",
    NID_tcg_at_tcgCredentialSpecification,
    5,
    &so[8668] },
  { "tcg-at-tcgCredentialType",
    "TCG Credential Type",
    NID_tcg_at_tcgCredentialType,
    5,
    &so[8673] },
  { "tcg-at-previousPlatformCertificates",
    "TCG Previous Platform Certificates",
    NID_tcg_at_previousPlatformCertificates,
    5,
    &so[8678] },
  { "tcg-at-tbbSecurityAssertions-v3",
    "TCG TBB Security Assertions V3",
    NID_tcg_at_tbbSecurityAssertions_v3,
    5,
    &so[8683] },
  { "tcg-at-cryptographicAnchors",
    "TCG Cryptographic Anchors",
    NID_tcg_at_cryptographicAnchors,
    5,
    &so[8688] },
  ...
  { "tcg-tr-ID-CertificateIdentifier",
    ...
    NID_tcg_tr_ID_CertificateIdentifier,
    6,
    &so[8877] },
  { "tcg-tr-ID-CommonCriteria",
    "Common Criteria Trait",
    NID_tcg_tr_ID_CommonCriteria,
    6,
    &so[8883] },
  { "tcg-tr-ID-componentClass",
    "Component Class Trait",
    NID_tcg_tr_ID_componentClass,
    6,
    &so[8889] },
  { "tcg-tr-ID-componentIdentifierV11",
    "Component Identifier V1.1 Trait",
    NID_tcg_tr_ID_componentIdentifierV11,
    6,
    &so[8895] },
  { "tcg-tr-ID-FIPSLevel",
    "FIPS Level Trait",
    NID_tcg_tr_ID_FIPSLevel,
    6,
    &so[8901] },
  { "tcg-tr-ID-ISO9000Level",
    "ISO 9000 Level Trait",
    NID_tcg_tr_ID_ISO9000Level,
    6,
    &so[8907] },
  { "tcg-tr-ID-networkMAC",
    "Network MAC Trait",
    NID_tcg_tr_ID_networkMAC,
    6,
    &so[8913] },
  { "tcg-tr-ID-OID",
    "Object Identifier Trait",
    NID_tcg_tr_ID_OID,
    6,
    &so[8919] },
  { "tcg-tr-ID-PEN",
    "Private Enterprise Number Trait",
    NID_tcg_tr_ID_PEN,
    6,
    &so[8925] },
  { "tcg-tr-ID-platformFirmwareCapabilities",
    "Platform Firmware Capabilities Trait",
    NID_tcg_tr_ID_platformFirmwareCapabilities,
    6,
    &so[8931] },
  { "tcg-tr-ID-platformFirmwareSignatureVerification",
    "Platform Firmware Signature Verification Trait",
    NID_tcg_tr_ID_platformFirmwareSignatureVerification,
    6,
    &so[8937] },
  { "tcg-tr-ID-platformFirmwareUpdateCompliance",
    "Platform Firmware Update Compliance Trait",
    NID_tcg_tr_ID_platformFirmwareUpdateCompliance,
    6,
    &so[8943] },
  { "tcg-tr-ID-platformHardwareCapabilities",
    "Platform Hardware Capabilities Trait",
    NID_tcg_tr_ID_platformHardwareCapabilities,
    6,
    &so[8949] },
  { "tcg-tr-ID-RTM",
    ...
    &so[8955] },
  { "tcg-tr-ID-status",
    "Attribute Status Trait",
    NID_tcg_tr_ID_status,
    6,
    &so[8961] },
  { "tcg-tr-ID-URI",
    "Uniform Resource Identifier Trait",
    NID_tcg_tr_ID_URI,
    6,
    &so[8967] },
  { "tcg-tr-ID-UTF8String",
    "UTF8String Trait",
    NID_tcg_tr_ID_UTF8String,
    6,
    &so[8973] },
  { "tcg-tr-ID-IA5String",
    "IA5String Trait",
    NID_tcg_tr_ID_IA5String,
    6,
    &so[8979] },
  { "tcg-tr-ID-PEMCertString",
    "PEM-Encoded Certificate String Trait",
    NID_tcg_tr_ID_PEMCertString,
    6,
    &so[8985] },
  { "tcg-tr-ID-PublicKey",
    "Public Key Trait",
    NID_tcg_tr_ID_PublicKey,
    6,
    &so[8991] },
  { "tcg-tr-cat-platformManufacturer",
    "Platform Manufacturer Trait Category",
    NID_tcg_tr_cat_platformManufacturer,
    6,
    &so[8997] },
  { "tcg-tr-cat-platformModel",
    "Platform Model Trait Category",
    NID_tcg_tr_cat_platformModel,
    6,
    &so[9003] },
  { "tcg-tr-cat-platformVersion",
    "Platform Version Trait Category",
    NID_tcg_tr_cat_platformVersion,
    6,
    &so[9009] },
  { "tcg-tr-cat-platformSerial",
    "Platform Serial Trait Category",
    NID_tcg_tr_cat_platformSerial,
    6,
    &so[9015] },
  { "tcg-tr-cat-platformManufacturerIdentifier",
    "Platform Manufacturer Identifier Trait Category",
    NID_tcg_tr_cat_platformManufacturerIdentifier,
    6,
    &so[9021] },
  { "tcg-tr-cat-platformOwnership",
    "Platform Ownership Trait Category",
    NID_tcg_tr_cat_platformOwnership,
    6,
    &so[9027] },
  { "tcg-tr-cat-componentClass",
    "Component Class Trait Category",
    NID_tcg_tr_cat_componentClass,
    6,
    &so[9033] },
  { "tcg-tr-cat-componentManufacturer",
    "Component Manufacturer Trait Category",
    NID_tcg_tr_cat_componentManufacturer,
    6,
    &so[9039] },
  { "tcg-tr-cat-componentModel",
    "Component Model Trait Category",
    NID_tcg_tr_cat_componentModel,
    6,
    &so[9045] },
  { "tcg-tr-cat-componentSerial",
    "Component Serial Trait Category",
    NID_tcg_tr_cat_componentSerial,
    6,
    &so[9051] },
  { "tcg-tr-cat-componentStatus",
    "Component Status Trait Category",
    NID_tcg_tr_cat_componentStatus,
    6,
    &so[9057] },
  { "tcg-tr-cat-componentLocation",
    "Component Location Trait Category",
    NID_tcg_tr_cat_componentLocation,
    6,
    &so[9063] },
  { "tcg-tr-cat-componentRevision",
    "Component Revision Trait Category",
    NID_tcg_tr_cat_componentRevision,
    6,
    &so[9069] },
  { "tcg-tr-cat-componentFieldReplaceable",
    "Component Field Replaceable Trait Category",
    NID_tcg_tr_cat_componentFieldReplaceable,
    6,
    &so[9075] },
  { "tcg-tr-cat-EKCertificate",
    "EK Certificate Trait Category",
    NID_tcg_tr_cat_EKCertificate,
    6,
    &so[9081] },
  { "tcg-tr-cat-IAKCertificate",
    "IAK Certificate Trait Category",
    NID_tcg_tr_cat_IAKCertificate,
    6,
    &so[9087] },
  { "tcg-tr-cat-IDevIDCertificate",
    "IDevID Certificate Trait Category",
    NID_tcg_tr_cat_IDevIDCertificate,
    6,
    &so[9093] },
  ...
  { "tcg-tr-cat-SPDMCertificate",
    ...
    NID_tcg_tr_cat_SPDMCertificate,
    6,
    &so[9105] },
  { "tcg-tr-cat-PEMCertificate",
    "PEM Certificate Trait Category",
    NID_tcg_tr_cat_PEMCertificate,
    6,
    &so[9111] },
  { "tcg-tr-cat-PlatformCertificate",
    "Platform Certificate Trait Category",
    NID_tcg_tr_cat_PlatformCertificate,
    6,
    &so[9117] },
  { "tcg-tr-cat-DeltaPlatformCertificate",
    "Delta Platform Certificate Trait Category",
    NID_tcg_tr_cat_DeltaPlatformCertificate,
    6,
    &so[9123] },
  { "tcg-tr-cat-RebasePlatformCertificate",
    "Rebase Platform Certificate Trait Category",
    NID_tcg_tr_cat_RebasePlatformCertificate,
    6,
    &so[9129] },
  { "tcg-tr-cat-genericCertificate",
    "Generic Certificate Trait Category",
    NID_tcg_tr_cat_genericCertificate,
    6,
    &so[9135] },
  { "tcg-tr-cat-CommonCriteria",
    "Common Criteria Trait Category",
    NID_tcg_tr_cat_CommonCriteria,
    6,
    &so[9141] },
  { "tcg-tr-cat-componentIdentifierV11",
    "Component Identifier V1.1 Trait Category",
    NID_tcg_tr_cat_componentIdentifierV11,
    6,
    &so[9147] },
  { "tcg-tr-cat-FIPSLevel",
    "FIPS Level Trait Category",
    NID_tcg_tr_cat_FIPSLevel,
    6,
    &so[9153] },
  { "tcg-tr-cat-ISO9000",
    "ISO 9000 Trait Category",
    NID_tcg_tr_cat_ISO9000,
    6,
    &so[9159] },
  { "tcg-tr-cat-networkMAC",
    "Network MAC Trait Category",
    NID_tcg_tr_cat_networkMAC,
    6,
    &so[9165] },
  { "tcg-tr-cat-attestationProtocol",
    "Attestation Protocol Trait Category",
    NID_tcg_tr_cat_attestationProtocol,
    6,
    &so[9171] },
  { "tcg-tr-cat-PEN",
    "Private Enterprise Number Trait Category",
    NID_tcg_tr_cat_PEN,
    6,
    &so[9177] },
  { "tcg-tr-cat-platformFirmwareCapabilities",
    "Platform Firmware Capabilities Trait Category",
    NID_tcg_tr_cat_platformFirmwareCapabilities,
    6,
    &so[9183] },
  { "tcg-tr-cat-platformHardwareCapabilities",
    "Platform Hardware Capabilities Trait Category",
    NID_tcg_tr_cat_platformHardwareCapabilities,
    6,
    &so[9189] },
  { "tcg-tr-cat-platformFirmwareSignatureVerification",
    "Platform Firmware Signature Verification Trait Category",
    NID_tcg_tr_cat_platformFirmwareSignatureVerification,
    6,
    &so[9195] },
  { "tcg-tr-cat-platformFirmwareUpdateCompliance",
    "Platform Firmware Update Compliance Trait Category",
    NID_tcg_tr_cat_platformFirmwareUpdateCompliance,
    6,
    &so[9201] },
  { "tcg-tr-cat-RTM",
    ...
    6,
    &so[9207] },
  { "tcg-tr-cat-PublicKey",
    "Public Key Trait Category",
    NID_tcg_tr_cat_PublicKey,
    6,
    &so[9213] },
