...
ASN1_OBJECT* OBJ_dup(const ASN1_OBJECT* o) {
  ...
  if (!(o->flags & ASN1_OBJECT_FLAG_DYNAMIC)) return (ASN1_OBJECT*)o;
  ...
  if (o->ln != NULL && (r->ln = OPENSSL_strdup(o->ln)) == NULL) goto err;

  if (o->sn != NULL && (r->sn = OPENSSL_strdup(o->sn)) == NULL) goto err;
