 ...
 */
static int
provider_conf_params (OSSL_PROVIDER *prov, OSSL_PROVIDER_INFO *provinfo,
 ...
 */
static int
provider_conf_activate (OSSL_LIB_CTX *libctx, const char *name,
...
static int
provider_conf_parse_bool_setting (const char *confname, const char *confvalue,
                                  int *val)
{
...
static int
provider_conf_load (OSSL_LIB_CTX *libctx, const char *name, const char *value,
                    const CONF *cnf)
{
  int i;
