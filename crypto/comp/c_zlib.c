...
static ossl_ssize_t
zlib_stateful_compress_block (COMP_CTX *ctx, unsigned char *out, size_t olen,
...
static ossl_ssize_t
zlib_stateful_expand_block (COMP_CTX *ctx, unsigned char *out, size_t olen,
                            unsigned char *in, size_t ilen)
{
  int err = Z_OK;
  struct zlib_state *state = ctx->data;
...
static ossl_ssize_t
zlib_oneshot_compress_block (COMP_CTX *ctx, unsigned char *out, size_t olen,
                             unsigned char *in, size_t ilen)
{
  uLongf out_size;
...
static ossl_ssize_t
zlib_oneshot_expand_block (COMP_CTX *ctx, unsigned char *out, size_t olen,
                           unsigned char *in, size_t ilen)
{
  uLongf out_size;
