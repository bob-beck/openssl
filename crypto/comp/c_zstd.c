...
static ossl_ssize_t
zstd_stateful_compress_block(COMP_CTX *ctx, unsigned char *out, size_t olen, unsigned char *in, size_t ilen)
{
    ZSTD_inBuffer      inbuf;
...
static ossl_ssize_t
zstd_stateful_expand_block(COMP_CTX *ctx, unsigned char *out, size_t olen, unsigned char *in, size_t ilen)
{
    ZSTD_inBuffer      inbuf;
    ZSTD_outBuffer     outbuf;
    size_t             ret;
...
static ossl_ssize_t
zstd_oneshot_compress_block(COMP_CTX *ctx, unsigned char *out, size_t olen, unsigned char *in, size_t ilen)
{
    size_t       out_size;
    ossl_ssize_t ret;
...
static ossl_ssize_t
zstd_oneshot_expand_block(COMP_CTX *ctx, unsigned char *out, size_t olen, unsigned char *in, size_t ilen)
{
    size_t       out_size;
    ossl_ssize_t ret;
...
static const BIO_METHOD bio_meth_zstd = {BIO_TYPE_COMP,
                                         "zstd",
