...
static void
sa_doall (const OPENSSL_SA *sa, void (*node) (void **),
...
static void
sa_free_leaf (ossl_uintmax_t n, void *p, void *arg)
{
  OPENSSL_free (p);
}
...
static void
trampoline (ossl_uintmax_t n, void *l, void *arg)
{
  ((const struct trampoline_st *)arg)->func (n, l);
}

void
ossl_sa_doall (const OPENSSL_SA *sa, void (*leaf) (ossl_uintmax_t, void *))
{
...
void
ossl_sa_doall_arg (const OPENSSL_SA *sa,
                   void (*leaf) (ossl_uintmax_t, void *, void *), void *arg)
{
  if (sa != NULL)
...
size_t
ossl_sa_num (const OPENSSL_SA *sa)
{
  return sa == NULL ? 0 : sa->nelem;
}

void *
ossl_sa_get (const OPENSSL_SA *sa, ossl_uintmax_t n)
{
  int level;
  void **p, *r = NULL;
...
int
ossl_sa_set (OPENSSL_SA *sa, ossl_uintmax_t posn, void *val)
{
  int i, level = 1;
