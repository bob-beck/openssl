...
void
ossl_sm3_block_data_order(SM3_CTX* c, const void* p, size_t num);
void
ossl_sm3_block_data_order_zbb(SM3_CTX* c, const void* p, size_t num);
void
ossl_hwsm3_block_data_order(SM3_CTX* c, const void* p, size_t num);
