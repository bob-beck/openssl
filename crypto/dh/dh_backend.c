...
static int
dh_ffc_params_fromdata (DH *dh, const OSSL_PARAM params[])
{
  int ret;
...
int
ossl_dh_key_todata (DH *dh, OSSL_PARAM_BLD *bld, OSSL_PARAM params[],
                    int include_private)
{
...
dh_bn_dup_check (BIGNUM **out, const BIGNUM *f)
{
...
#ifndef FIPS_MODULE
DH *
ossl_dh_key_from_pkcs8 (const PKCS8_PRIV_KEY_INFO *p8inf, OSSL_LIB_CTX *libctx,
                        const char *propq)
{
