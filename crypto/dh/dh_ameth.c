...
static DH* d2i_dhp(const EVP_PKEY* pkey,
...
static int dh_param_print(BIO* bp,
                          const EVP_PKEY* pkey,
                          int indent,
                          ASN1_PCTX* ctx) {
...
static int dh_public_print(BIO* bp,
                           const EVP_PKEY* pkey,
                           int indent,
                           ASN1_PCTX* ctx) {
...
static int dh_private_print(BIO* bp,
                            const EVP_PKEY* pkey,
                            int indent,
                            ASN1_PCTX* ctx) {
...
static int dh_pkey_export_to(const EVP_PKEY* from,
                             void* to_keydata,
...
static int dh_pkey_import_from_type(const OSSL_PARAM params[],
                                    void* vpctx,
                                    int type) {
