...
static OSSL_PARAM_BLD_DEF*
param_push(OSSL_PARAM_BLD* bld,
           const char* key,
           size_t size,
           size_t alloc,
           int type,
...
static int
param_push_num(OSSL_PARAM_BLD* bld,
               const char* key,
               void* num,
               size_t size,
               int type)
...
static void
free_all_params(OSSL_PARAM_BLD* bld)
{
...
int
OSSL_PARAM_BLD_push_int(OSSL_PARAM_BLD* bld, const char* key, int num)
{
  return param_push_num(bld, key, &num, sizeof(num), OSSL_PARAM_INTEGER);
}

int
OSSL_PARAM_BLD_push_uint(OSSL_PARAM_BLD* bld, const char* key, unsigned int num)
{
  return param_push_num(
    bld, key, &num, sizeof(num), OSSL_PARAM_UNSIGNED_INTEGER);
}

int
OSSL_PARAM_BLD_push_long(OSSL_PARAM_BLD* bld, const char* key, long int num)
{
  return param_push_num(bld, key, &num, sizeof(num), OSSL_PARAM_INTEGER);
}

int
OSSL_PARAM_BLD_push_ulong(OSSL_PARAM_BLD* bld,
                          const char* key,
...
int
OSSL_PARAM_BLD_push_int32(OSSL_PARAM_BLD* bld, const char* key, int32_t num)
{
  return param_push_num(bld, key, &num, sizeof(num), OSSL_PARAM_INTEGER);
}

int
OSSL_PARAM_BLD_push_uint32(OSSL_PARAM_BLD* bld, const char* key, uint32_t num)
{
  return param_push_num(
    bld, key, &num, sizeof(num), OSSL_PARAM_UNSIGNED_INTEGER);
}
...
int
OSSL_PARAM_BLD_push_int64(OSSL_PARAM_BLD* bld, const char* key, int64_t num)
{
  return param_push_num(bld, key, &num, sizeof(num), OSSL_PARAM_INTEGER);
}

int
OSSL_PARAM_BLD_push_uint64(OSSL_PARAM_BLD* bld, const char* key, uint64_t num)
{
  return param_push_num(
    bld, key, &num, sizeof(num), OSSL_PARAM_UNSIGNED_INTEGER);
}
...
int
OSSL_PARAM_BLD_push_size_t(OSSL_PARAM_BLD* bld, const char* key, size_t num)
{
  return param_push_num(
    bld, key, &num, sizeof(num), OSSL_PARAM_UNSIGNED_INTEGER);
}
...
int
OSSL_PARAM_BLD_push_time_t(OSSL_PARAM_BLD* bld, const char* key, time_t num)
{
  return param_push_num(bld, key, &num, sizeof(num), OSSL_PARAM_INTEGER);
}
...
int
OSSL_PARAM_BLD_push_BN_pad(OSSL_PARAM_BLD* bld,
                           const char* key,
                           const BIGNUM* bn,
                           size_t sz)
{
...
int
OSSL_PARAM_BLD_push_utf8_string(OSSL_PARAM_BLD* bld,
                                const char* key,
                                const char* buf,
                                size_t bsize)
{
...
int
OSSL_PARAM_BLD_push_utf8_ptr(OSSL_PARAM_BLD* bld,
                             const char* key,
                             char* buf,
                             size_t bsize)
{
...
int
OSSL_PARAM_BLD_push_octet_string(OSSL_PARAM_BLD* bld,
                                 const char* key,
                                 const void* buf,
                                 size_t bsize)
{
...
int
OSSL_PARAM_BLD_push_octet_ptr(OSSL_PARAM_BLD* bld,
                              const char* key,
                              void* buf,
                              size_t bsize)
{
...
static OSSL_PARAM*
param_bld_convert(OSSL_PARAM_BLD* bld,
                  OSSL_PARAM* param,
