...
void ossl_ht_foreach_until(HT* h,
...
HT_VALUE_LIST* ossl_ht_filter(HT* h,
                              size_t max_len,
...
static int ossl_ht_insert_locked(HT* h,
                                 uint64_t hash,
...
static struct ht_internal_value_st* alloc_new_value(HT* h,
                                                    HT_KEY* key,
                                                    void* data,
                                                    uintptr_t* type) {
