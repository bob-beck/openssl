 ...
 * |itercnt| MUST be >= 100 (e.g., 500) and <=
 * OSSL_CRMF_PBM_MAX_ITERATION_COUNT |macnid| e.g., NID_hmac_sha1 returns
 * pointer to OSSL_CRMF_PBMPARAMETER on success, NULL on error
 */
OSSL_CRMF_PBMPARAMETER *
OSSL_CRMF_pbmp_new (OSSL_LIB_CTX *libctx, size_t slen, int owfnid,
...
int
OSSL_CRMF_pbm_new (OSSL_LIB_CTX *libctx, const char *propq,
