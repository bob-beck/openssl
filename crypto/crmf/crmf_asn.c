...
ASN1_CHOICE(OSSL_CRMF_ENCKEYWITHID_IDENTIFIER) = {
    ASN1_SIMPLE(OSSL_CRMF_ENCKEYWITHID_IDENTIFIER, value.string,
                ASN1_UTF8STRING),
    ASN1_SIMPLE(
        OSSL_CRMF_ENCKEYWITHID_IDENTIFIER, value.generalName,
...
ASN1_CHOICE(OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO) = {
    ASN1_EXP(OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO, value.sender, GENERAL_NAME,
             0),
    ASN1_SIMPLE(
...
ASN1_SEQUENCE(OSSL_CRMF_CERTTEMPLATE) = {
    ...
    ASN1_IMP_OPT(OSSL_CRMF_CERTTEMPLATE, validity, OSSL_CRMF_OPTIONALVALIDITY,
                 4),
    ...
    ASN1_IMP_SEQUENCE_OF_OPT(OSSL_CRMF_CERTTEMPLATE, extensions, X509_EXTENSION,
                             9),
