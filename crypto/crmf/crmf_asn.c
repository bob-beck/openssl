...
ASN1_SEQUENCE(OSSL_CRMF_PRIVATEKEYINFO) = {ASN1_SIMPLE(OSSL_CRMF_PRIVATEKEYINFO, version, ASN1_INTEGER),
...
ASN1_SEQUENCE(OSSL_CRMF_ENCRYPTEDVALUE) = {
    ...
    ASN1_SIMPLE(OSSL_CRMF_ENCRYPTEDVALUE, encValue, ASN1_BIT_STRING)} ASN1_SEQUENCE_END(OSSL_CRMF_ENCRYPTEDVALUE)
...
ASN1_SEQUENCE(OSSL_CRMF_SINGLEPUBINFO) = {
    ...
    ASN1_SIMPLE(OSSL_CRMF_SINGLEPUBINFO, pubLocation, GENERAL_NAME)} ASN1_SEQUENCE_END(OSSL_CRMF_SINGLEPUBINFO)
...
ASN1_SEQUENCE(OSSL_CRMF_PKMACVALUE) = {
    ...
    ASN1_SIMPLE(OSSL_CRMF_PKMACVALUE, value, ASN1_BIT_STRING)} ASN1_SEQUENCE_END(OSSL_CRMF_PKMACVALUE)
...
ASN1_SEQUENCE(OSSL_CRMF_PBMPARAMETER) = {
    ASN1_SIMPLE(OSSL_CRMF_PBMPARAMETER, salt, ASN1_OCTET_STRING), ASN1_SIMPLE(OSSL_CRMF_PBMPARAMETER, owf, X509_ALGOR),
    ASN1_SIMPLE(OSSL_CRMF_PBMPARAMETER, iterationCount, ASN1_INTEGER),
    ASN1_SIMPLE(OSSL_CRMF_PBMPARAMETER, mac, X509_ALGOR)} ASN1_SEQUENCE_END(OSSL_CRMF_PBMPARAMETER)
...
ASN1_SEQUENCE(OSSL_CRMF_POPOSIGNINGKEYINPUT) = {
    ...
    ASN1_SIMPLE(OSSL_CRMF_POPOSIGNINGKEYINPUT, publicKey, X509_PUBKEY)} ASN1_SEQUENCE_END(OSSL_CRMF_POPOSIGNINGKEYINPUT)
...
ASN1_SEQUENCE(OSSL_CRMF_POPOSIGNINGKEY) = {
    ...
    ASN1_SIMPLE(OSSL_CRMF_POPOSIGNINGKEY, signature, ASN1_BIT_STRING)} ASN1_SEQUENCE_END(OSSL_CRMF_POPOSIGNINGKEY)
...
ASN1_SEQUENCE(OSSL_CRMF_ATTRIBUTETYPEANDVALUE) = {
    ...
    ASN1_ADB_OBJECT(OSSL_CRMF_ATTRIBUTETYPEANDVALUE)} ASN1_SEQUENCE_END(OSSL_CRMF_ATTRIBUTETYPEANDVALUE)
...
ASN1_SEQUENCE(OSSL_CRMF_OPTIONALVALIDITY) = {
    ...
    ASN1_EXP_OPT(OSSL_CRMF_OPTIONALVALIDITY, notAfter, ASN1_TIME, 1)} ASN1_SEQUENCE_END(OSSL_CRMF_OPTIONALVALIDITY)
...
ASN1_SEQUENCE(OSSL_CRMF_MSG) = {
    ...
    ASN1_SEQUENCE_OF_OPT(OSSL_CRMF_MSG, regInfo, OSSL_CRMF_ATTRIBUTETYPEANDVALUE)} ASN1_SEQUENCE_END(OSSL_CRMF_MSG)
