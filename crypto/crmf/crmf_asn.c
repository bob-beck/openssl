...
ASN1_SEQUENCE(OSSL_CRMF_PRIVATEKEYINFO)
    = {ASN1_SIMPLE(OSSL_CRMF_PRIVATEKEYINFO, version, ASN1_INTEGER),
       ...
       ASN1_IMP_SET_OF_OPT(OSSL_CRMF_PRIVATEKEYINFO,
                           attributes,
                           X509_ATTRIBUTE,
    ...
    ASN1_CHOICE(OSSL_CRMF_ENCKEYWITHID_IDENTIFIER)
        ...
        ASN1_SEQUENCE(OSSL_CRMF_ENCKEYWITHID)
            = {ASN1_SIMPLE(OSSL_CRMF_ENCKEYWITHID, privateKey, OSSL_CRMF_PRIVATEKEYINFO),
               ASN1_OPT(OSSL_CRMF_ENCKEYWITHID,
                        identifier,
            ...
            ASN1_SEQUENCE(OSSL_CRMF_CERTID)
                = {ASN1_SIMPLE(OSSL_CRMF_CERTID, issuer, GENERAL_NAME),
                   ASN1_SIMPLE(OSSL_CRMF_CERTID, serialNumber, ASN1_INTEGER)} ASN1_SEQUENCE_END(OSSL_CRMF_CERTID)
                ...
                ASN1_SEQUENCE(OSSL_CRMF_ENCRYPTEDVALUE)
                    = {ASN1_IMP_OPT(OSSL_CRMF_ENCRYPTEDVALUE, intendedAlg, X509_ALGOR, 0),
                       ...
                       ASN1_SIMPLE(OSSL_CRMF_ENCRYPTEDVALUE,
                                   encValue,
                    ...
                    ASN1_CHOICE(OSSL_CRMF_ENCRYPTEDKEY)
                        ...
                        ASN1_SEQUENCE(OSSL_CRMF_SINGLEPUBINFO)
                            = {ASN1_SIMPLE(OSSL_CRMF_SINGLEPUBINFO, pubMethod, ASN1_INTEGER),
                               ASN1_SIMPLE(OSSL_CRMF_SINGLEPUBINFO,
                                           pubLocation,
                            ...
                            ASN1_SEQUENCE(OSSL_CRMF_PKIPUBLICATIONINFO)
                                ...
                                ASN1_SEQUENCE(OSSL_CRMF_PKMACVALUE)
                                    = {ASN1_SIMPLE(OSSL_CRMF_PKMACVALUE, algId, X509_ALGOR),
                                       ASN1_SIMPLE(OSSL_CRMF_PKMACVALUE,
                                                   value,
                                    ...
                                    ASN1_CHOICE(OSSL_CRMF_POPOPRIVKEY)
                                        ...
                                        ASN1_SEQUENCE(OSSL_CRMF_PBMPARAMETER)
                                            = {ASN1_SIMPLE(OSSL_CRMF_PBMPARAMETER, salt, ASN1_OCTET_STRING),
                                               ...
                                               ASN1_SIMPLE(OSSL_CRMF_PBMPARAMETER,
                                                           mac,
                                            ...
                                            ASN1_CHOICE(OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO)
                                                = {ASN1_EXP(OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO,
                                                            value.sender,
                                                            GENERAL_NAME,
                                                            0),
                                                   ASN1_SIMPLE(
                                                ...
                                                ASN1_SEQUENCE(OSSL_CRMF_POPOSIGNINGKEYINPUT)
                                                    = {ASN1_SIMPLE(OSSL_CRMF_POPOSIGNINGKEYINPUT,
                                                                   authInfo,
                                                                   OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO),
                                                       ASN1_SIMPLE(
                                                    ...
                                                    ASN1_SEQUENCE(OSSL_CRMF_POPOSIGNINGKEY)
                                                        = {ASN1_IMP_OPT(OSSL_CRMF_POPOSIGNINGKEY,
                                                                        poposkInput,
                                                                        OSSL_CRMF_POPOSIGNINGKEYINPUT,
                                                                        0),
                                                           ASN1_SIMPLE(OSSL_CRMF_POPOSIGNINGKEY,
                                                                       algorithmIdentifier,
                                                                       X509_ALGOR),
                                                           ASN1_SIMPLE(
                                                        ...
                                                        ASN1_CHOICE(OSSL_CRMF_POPO)
                                                            = {ASN1_IMP(OSSL_CRMF_POPO, value.raVerified, ASN1_NULL, 0),
                                                               ASN1_IMP(OSSL_CRMF_POPO,
                                                                        value.signature,
                                                                        OSSL_CRMF_POPOSIGNINGKEY,
                                                                        1),
                                                               ASN1_EXP(OSSL_CRMF_POPO,
                                                            ...
                                                            ASN1_ADB_TEMPLATE(attributetypeandvalue_default) =
                                                                ASN1_OPT(OSSL_CRMF_ATTRIBUTETYPEANDVALUE,
                                                                         value.other,
                                                                         ASN1_ANY);
                                                            ...
                                                            } ASN1_ADB_END(OSSL_CRMF_ATTRIBUTETYPEANDVALUE,
                                                                           0,
                                                                           type,
                                                                           0,
                                                            ...
                                                            ASN1_SEQUENCE(OSSL_CRMF_ATTRIBUTETYPEANDVALUE)
                                                                ...
                                                                ASN1_SEQUENCE(OSSL_CRMF_OPTIONALVALIDITY)
                                                                    = {ASN1_EXP_OPT(OSSL_CRMF_OPTIONALVALIDITY,
                                                                                    notBefore,
                                                                                    ASN1_TIME,
                                                                                    0),
                                                                       ASN1_EXP_OPT(
                                                                    ...
                                                                    ASN1_SEQUENCE(OSSL_CRMF_CERTTEMPLATE)
                                                                        = {
                                                                            ASN1_IMP_OPT(OSSL_CRMF_CERTTEMPLATE,
                                                                                         ...
                                                                                         0),
                                                                            /*
                                                                             * serialNumber MUST be omitted. This field
                                                                             * is assigned by the CA during certificate
                                                                             * creation.
                                                                             */
                                                                            ASN1_IMP_OPT(OSSL_CRMF_CERTTEMPLATE,
                                                                                         serialNumber,
                                                                                         ...
                                                                                         1),
                                                                            /*
                                                                             * signingAlg MUST be omitted. This field is
                                                                             * assigned by the CA during certificate
                                                                             * creation.
                                                                             */
                                                                            ASN1_IMP_OPT(OSSL_CRMF_CERTTEMPLATE,
                                                                                         signingAlg,
                                                                                         X509_ALGOR,
                                                                                         2),
                                                                            ASN1_EXP_OPT(OSSL_CRMF_CERTTEMPLATE,
                                                                                         issuer,
                                                                                         X509_NAME,
                                                                                         3),
                                                                            ASN1_IMP_OPT(OSSL_CRMF_CERTTEMPLATE,
                                                                        ...
                                                                        ASN1_SEQUENCE(OSSL_CRMF_CERTREQUEST)
                                                                            = {ASN1_SIMPLE(OSSL_CRMF_CERTREQUEST,
                                                                                           certReqId,
                                                                                           ASN1_INTEGER),
                                                                               ASN1_SIMPLE(OSSL_CRMF_CERTREQUEST,
                                                                                           certTemplate,
                                                                            ...
                                                                            ASN1_SEQUENCE(OSSL_CRMF_MSG)
                                                                                = {ASN1_SIMPLE(OSSL_CRMF_MSG,
                                                                                               certReq,
                                                                                               OSSL_CRMF_CERTREQUEST),
                                                                                   ASN1_OPT(OSSL_CRMF_MSG,
                                                                                            popo,
                                                                                            OSSL_CRMF_POPO),
                                                                                   ASN1_SEQUENCE_OF_OPT(
                                                                                       OSSL_CRMF_MSG,
