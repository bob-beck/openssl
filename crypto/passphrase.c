 ...
 */
static int
do_ui_passphrase (char *pass, size_t pass_size, size_t *pass_len,
...
int
ossl_pw_get_passphrase (char *pass, size_t pass_size, size_t *pass_len,
...
static int
ossl_pw_get_password (char *buf, int size, int rwflag, void *userdata,
                      const char *info)
{
...
int
ossl_pw_passphrase_callback_enc (char *pass, size_t pass_size,
...
int
ossl_pw_passphrase_callback_dec (char *pass, size_t pass_size,
                                 size_t *pass_len, const OSSL_PARAM params[],
                                 void *arg)
{
