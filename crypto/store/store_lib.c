...
static int
ossl_store_close_it(OSSL_STORE_CTX* ctx);

static int
loader_set_params(OSSL_STORE_LOADER* loader,
                  ...
                  const char* propq)
{
  ...
  if (propq != NULL) {
    ...
    propp[0] = OSSL_PARAM_construct_utf8_string(
...
OSSL_STORE_open(const char* uri,
                ...
                void* post_process_data)
{
  return OSSL_STORE_open_ex(
    uri, NULL, NULL, ui_method, ui_data, NULL, post_process, post_process_data);
}

#ifndef OPENSSL_NO_DEPRECATED_3_0
int
OSSL_STORE_ctrl(OSSL_STORE_CTX* ctx, int cmd, ...)
{
  va_list args;
  int ret;
...
int
OSSL_STORE_vctrl(OSSL_STORE_CTX* ctx, int cmd, va_list args)
{
...
int
OSSL_STORE_expect(OSSL_STORE_CTX* ctx, int expected_type)
{
  int ret = 1;
...
int
OSSL_STORE_find(OSSL_STORE_CTX* ctx, const OSSL_STORE_SEARCH* search)
{
  int ret = 1;
...
int
OSSL_STORE_delete(const char* uri,
                  OSSL_LIB_CTX* libctx,
                  const char* propq,
                  const UI_METHOD* ui_method,
                  void* ui_data,
 ...
 */
OSSL_STORE_INFO*
OSSL_STORE_INFO_new(int type, void* data)
{
...
int
OSSL_STORE_INFO_set0_NAME_description(OSSL_STORE_INFO* info, char* desc)
{
...
OSSL_STORE_INFO*
OSSL_STORE_INFO_new_PUBKEY(EVP_PKEY* pkey)
{
...
OSSL_STORE_INFO*
OSSL_STORE_INFO_new_PKEY(EVP_PKEY* pkey)
{
...
OSSL_STORE_INFO*
OSSL_STORE_INFO_new_CRL(X509_CRL* crl)
{
 ...
 */
int
OSSL_STORE_INFO_get_type(const OSSL_STORE_INFO* info)
{
  return info->type;
}

void*
OSSL_STORE_INFO_get0_data(int type, const OSSL_STORE_INFO* info)
{
  if (info->type == type)
    return info->_.data;
  return NULL;
...
const char*
OSSL_STORE_INFO_get0_NAME(const OSSL_STORE_INFO* info)
{
  if (info->type == OSSL_STORE_INFO_NAME)
...
char*
OSSL_STORE_INFO_get1_NAME(const OSSL_STORE_INFO* info)
{
  if (info->type == OSSL_STORE_INFO_NAME)
...
const char*
OSSL_STORE_INFO_get0_NAME_description(const OSSL_STORE_INFO* info)
{
  if (info->type == OSSL_STORE_INFO_NAME)
...
char*
OSSL_STORE_INFO_get1_NAME_description(const OSSL_STORE_INFO* info)
{
  if (info->type == OSSL_STORE_INFO_NAME)
...
EVP_PKEY*
OSSL_STORE_INFO_get0_PARAMS(const OSSL_STORE_INFO* info)
{
...
EVP_PKEY*
OSSL_STORE_INFO_get1_PARAMS(const OSSL_STORE_INFO* info)
{
  if (info->type == OSSL_STORE_INFO_PARAMS) {
...
EVP_PKEY*
OSSL_STORE_INFO_get0_PUBKEY(const OSSL_STORE_INFO* info)
{
...
EVP_PKEY*
OSSL_STORE_INFO_get1_PUBKEY(const OSSL_STORE_INFO* info)
{
  if (info->type == OSSL_STORE_INFO_PUBKEY) {
...
EVP_PKEY*
OSSL_STORE_INFO_get0_PKEY(const OSSL_STORE_INFO* info)
{
...
EVP_PKEY*
OSSL_STORE_INFO_get1_PKEY(const OSSL_STORE_INFO* info)
{
  if (info->type == OSSL_STORE_INFO_PKEY) {
...
X509*
OSSL_STORE_INFO_get0_CERT(const OSSL_STORE_INFO* info)
{
...
X509*
OSSL_STORE_INFO_get1_CERT(const OSSL_STORE_INFO* info)
{
  if (info->type == OSSL_STORE_INFO_CERT) {
...
X509_CRL*
OSSL_STORE_INFO_get0_CRL(const OSSL_STORE_INFO* info)
{
...
X509_CRL*
OSSL_STORE_INFO_get1_CRL(const OSSL_STORE_INFO* info)
{
  if (info->type == OSSL_STORE_INFO_CRL) {
...
int
OSSL_STORE_supports_search(OSSL_STORE_CTX* ctx, int search_type)
{
  int ret = 0;
...
int
OSSL_STORE_SEARCH_get_type(const OSSL_STORE_SEARCH* criterion)
{
  return criterion->search_type;
}

X509_NAME*
OSSL_STORE_SEARCH_get0_name(const OSSL_STORE_SEARCH* criterion)
{
...
const char*
OSSL_STORE_SEARCH_get0_string(const OSSL_STORE_SEARCH* criterion)
{
