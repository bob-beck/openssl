...
OSSL_STORE_LOADER*
OSSL_STORE_LOADER_new(ENGINE* e, const char* scheme)
{
...
const char*
OSSL_STORE_LOADER_get0_scheme(const OSSL_STORE_LOADER* loader)
{
  return loader->scheme;
}

int
OSSL_STORE_LOADER_set_open(OSSL_STORE_LOADER* loader,
...
int
OSSL_STORE_LOADER_set_open_ex(OSSL_STORE_LOADER* loader,
...
int
OSSL_STORE_LOADER_set_attach(OSSL_STORE_LOADER* loader,
...
int
OSSL_STORE_LOADER_set_ctrl(OSSL_STORE_LOADER* loader,
...
int
OSSL_STORE_LOADER_set_expect(OSSL_STORE_LOADER* loader,
...
int
OSSL_STORE_LOADER_set_find(OSSL_STORE_LOADER* loader,
...
int
OSSL_STORE_LOADER_set_load(OSSL_STORE_LOADER* loader,
...
int
OSSL_STORE_LOADER_set_eof(OSSL_STORE_LOADER* loader,
...
int
OSSL_STORE_LOADER_set_error(OSSL_STORE_LOADER* loader,
...
int
OSSL_STORE_LOADER_set_close(OSSL_STORE_LOADER* loader,
...
store_loader_hash(const OSSL_STORE_LOADER* v)
{
  return OPENSSL_LH_strhash(v->scheme);
}

static int
store_loader_cmp(const OSSL_STORE_LOADER* a, const OSSL_STORE_LOADER* b)
{
...
int
ossl_store_register_loader_int(OSSL_STORE_LOADER* loader)
{
...
int
OSSL_STORE_register_loader(OSSL_STORE_LOADER* loader)
{
  return ossl_store_register_loader_int(loader);
}

const OSSL_STORE_LOADER*
ossl_store_get0_loader_int(const char* scheme)
{
...
OSSL_STORE_LOADER*
ossl_store_unregister_loader_int(const char* scheme)
{
  OSSL_STORE_LOADER template;
  OSSL_STORE_LOADER* loader = NULL;
...
OSSL_STORE_LOADER*
OSSL_STORE_unregister_loader(const char* scheme)
{
  return ossl_store_unregister_loader_int(scheme);
}

void
ossl_store_destroy_loaders_int(void)
{
...
int
OSSL_STORE_do_all_loaders(void (*do_function)(const OSSL_STORE_LOADER* loader,
                                              void* do_arg),
                          void* do_arg)
{
  if (ossl_store_register_init())
