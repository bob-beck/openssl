...
/*
 * Mask Generation Function corresponding to section 7.2.2.2 of NIST SP
 * 800-56B. The variables are named differently to NIST: mask (T) and len
 * (maskLen)are the returned mask. seed (mgfSeed). The range checking steps inm
 * the process are performed outside.
 */
int
