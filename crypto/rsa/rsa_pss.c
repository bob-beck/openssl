...
int
RSA_verify_PKCS1_PSS_mgf1(RSA* rsa,
                          const unsigned char* mHash,
                          const EVP_MD* Hash,
...
int
RSA_padding_add_PKCS1_PSS(RSA* rsa,
                          unsigned char* EM,
                          const unsigned char* mHash,
                          const EVP_MD* Hash,
                          int sLen)
...
int
RSA_padding_add_PKCS1_PSS_mgf1(RSA* rsa,
                               unsigned char* EM,
                               const unsigned char* mHash,
                               const EVP_MD* Hash,
                               const EVP_MD* mgf1Hash,
                               int sLen)
{
  return ossl_rsa_padding_add_PKCS1_PSS_mgf1(
    rsa, EM, mHash, Hash, mgf1Hash, &sLen);
}
