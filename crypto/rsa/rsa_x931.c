 ...
 * hash(Msg) hash of a message (the output size is related to the hash
 * function) trailer (consists of 2 bytes) The 1st byte is related to a part
 * number for a hash algorithm (See RSA_X931_hash_id()), followed by the fixed
 * value 0xCC
 *
