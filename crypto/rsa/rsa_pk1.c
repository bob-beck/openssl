...
int
RSA_padding_add_PKCS1_type_1(unsigned char* to,
                             int tlen,
...
int
RSA_padding_check_PKCS1_type_1(unsigned char* to,
                               int tlen,
                               const unsigned char* from,
                               int flen,
                               int num)
...
int
RSA_padding_add_PKCS1_type_2(unsigned char* to,
                             int tlen,
                             const unsigned char* from,
                             int flen)
{
...
int
RSA_padding_check_PKCS1_type_2(unsigned char* to,
                               int tlen,
                               const unsigned char* from,
                               int flen,
                               int num)
                                        ...
                                        int alt_version)
{
  ...
  if (RAND_priv_bytes_ex(
        libctx, rand_premaster_secret, sizeof(rand_premaster_secret), 0) <= 0) {
    ERR_raise(ERR_LIB_RSA, ERR_R_INTERNAL_ERROR);
    return -1;
  }
