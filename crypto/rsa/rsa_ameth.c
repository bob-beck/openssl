...
rsa_priv_encode (PKCS8_PRIV_KEY_INFO *p8, const EVP_PKEY *pkey)
{
  ...
  if (!PKCS8_pkey_set0 (p8, OBJ_nid2obj (pkey->ameth->pkey_id), 0, strtype,
                        str, rk, rklen))
    {
      ERR_raise (ERR_LIB_RSA, ERR_R_ASN1_LIB);
      ASN1_STRING_free (str);
...
RSA_PSS_PARAMS *
ossl_rsa_pss_params_create (const EVP_MD *sigmd, const EVP_MD *mgf1md,
                            int saltlen)
{
...
int
ossl_rsa_pss_to_ctx (EVP_MD_CTX *ctx, EVP_PKEY_CTX *pkctx,
...
static int
rsa_pss_verify_param (const EVP_MD **pmd, const EVP_MD **pmgf1md,
...
int
ossl_rsa_pss_get_param (const RSA_PSS_PARAMS *pss, const EVP_MD **pmd,
...
static int
rsa_item_verify (EVP_MD_CTX *ctx, const ASN1_ITEM *it, const void *asn,
...
static int
rsa_item_sign (EVP_MD_CTX *ctx, const ASN1_ITEM *it, const void *asn,
...
static int
rsa_sig_info_set (X509_SIG_INFO *siginf, const X509_ALGOR *sigalg,
 ...
 */
static int
rsa_int_export_to (const EVP_PKEY *from, int rsa_type, void *to_keydata,
...
static int
rsa_pkey_export_to (const EVP_PKEY *from, void *to_keydata,
...
static int
rsa_pss_pkey_export_to (const EVP_PKEY *from, void *to_keydata,
                        OSSL_FUNC_keymgmt_import_fn *importer,
                        OSSL_LIB_CTX *libctx, const char *propq)
{
