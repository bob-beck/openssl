...
/*
 * NIST SP 800-56B rev 2 Appendix D: Maximum Security Strength Estimates for
 * IFC Modulus Lengths.
 *
 ...
 * "The maximum security strength estimates were calculated using the formula
 * in Section 7.5 of the FIPS 140 IG and rounded to the nearest multiple of
 * eight bits".
 *
 * The formula is:
 *
 ...
 */
int
RSA_set0_multi_prime_params (RSA *r, BIGNUM *primes[], BIGNUM *exps[],
...
#ifndef FIPS_MODULE
int
RSA_get0_multi_prime_crt_params (const RSA *r, const BIGNUM *exps[],
                                 const BIGNUM *coeffs[])
{
  int pnum;
 ...
 */
int
ossl_rsa_set0_all_params (RSA *r, STACK_OF (BIGNUM) *primes,
...
int
ossl_rsa_get0_all_params (RSA *r, STACK_OF (BIGNUM_const) *primes,
...
int
EVP_PKEY_CTX_set_rsa_pss_keygen_md_name (EVP_PKEY_CTX *ctx, const char *mdname,
                                         const char *mdprops)
{
...
int
EVP_PKEY_CTX_set_rsa_oaep_md_name (EVP_PKEY_CTX *ctx, const char *mdname,
                                   const char *mdprops)
{
...
int
EVP_PKEY_CTX_get_rsa_oaep_md_name (EVP_PKEY_CTX *ctx, char *name,
                                   size_t namesize)
{
...
int
EVP_PKEY_CTX_set_rsa_mgf1_md_name (EVP_PKEY_CTX *ctx, const char *mdname,
                                   const char *mdprops)
{
...
int
EVP_PKEY_CTX_get_rsa_mgf1_md_name (EVP_PKEY_CTX *ctx, char *name,
                                   size_t namesize)
{
