 ...
 */
static int
encode_pkcs1 (unsigned char **out, size_t *out_len, int type,
 ...
 */
int
ossl_rsa_verify (int type, const unsigned char *m, unsigned int m_len,
                 ...
                 const unsigned char *sigbuf, size_t siglen, RSA *rsa)
{
  ...
  else if (type == NID_mdc2 && decrypt_len == 2 + 16 && decrypt_buf[0] == 0x04
           && decrypt_buf[1] == 0x10)
    {
      /*
