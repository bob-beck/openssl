...
RSA_X931_generate_key_ex(RSA* rsa, int bits, const BIGNUM* e, BN_GENCB* cb)
{
  ...
  if (!BN_X931_generate_prime_ex(
        rsa->p, NULL, NULL, NULL, NULL, Xp, e, ctx, cb))
    goto error;

  if (!BN_X931_generate_prime_ex(
        rsa->q, NULL, NULL, NULL, NULL, Xq, e, ctx, cb))
    goto error;
  ...
  if (!RSA_X931_derive_ex(
        rsa, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, e, cb))
    goto error;
