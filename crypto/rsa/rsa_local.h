...
int ossl_rsa_multiprime_derive (RSA *rsa, int bits, int primes,
                                BIGNUM *e_value, STACK_OF (BIGNUM) *factors,
...
int ossl_rsa_check_pminusq_diff (BIGNUM *diff, const BIGNUM *p,
...
int ossl_rsa_check_prime_factor_range (const BIGNUM *p, int nbits,
                                       BN_CTX *ctx);
