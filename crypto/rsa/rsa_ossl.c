...
static int rsa_ossl_public_encrypt(int flen,
...
static int rsa_ossl_private_encrypt(int flen,
                                    ...
                                    RSA* rsa,
                                    int padding);
static int rsa_ossl_public_decrypt(int flen,
                                   const unsigned char* from,
                                   unsigned char* to,
                                   RSA* rsa,
                                   int padding);
...
#ifdef S390X_MOD_EXP
static int rsa_ossl_s390x_mod_exp(BIGNUM* r0,
                                  const BIGNUM* i,
                                  RSA* rsa,
                                  BN_CTX* ctx);
...
static int derive_kdk(int flen,
                      const unsigned char* from,
                      RSA* rsa,
                      unsigned char* buf,
                      int num,
...
static int rsa_ossl_mod_exp(BIGNUM* r0,
                            const BIGNUM* I,
                            RSA* rsa,
                            BN_CTX* ctx) {
  BIGNUM *r1, *m1, *vrfy;
