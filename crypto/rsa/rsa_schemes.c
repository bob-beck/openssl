...
static const char*
nid2name(int meth, const OSSL_ITEM* items, size_t items_n)
{
  size_t i;
...
static int
md_is_a(const void* md, const char* name)
{
...
{
  return meth2nid(
    md, md_is_a, oaeppss_name_nid_map, OSSL_NELEM(oaeppss_name_nid_map));
}
