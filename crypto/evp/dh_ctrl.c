...
static int
dh_paramgen_check(EVP_PKEY_CTX* ctx)
{
...
static int
dh_param_derive_check(EVP_PKEY_CTX* ctx)
{
...
int
EVP_PKEY_CTX_set_dh_paramgen_gindex(EVP_PKEY_CTX* ctx, int gindex)
{
  int ret;
...
int
EVP_PKEY_CTX_set_dh_paramgen_seed(EVP_PKEY_CTX* ctx,
                                  ...
                                  size_t seedlen)
{
  ...
  *p++ = OSSL_PARAM_construct_octet_string(
    OSSL_PKEY_PARAM_FFC_SEED, (void*)seed, seedlen);
  *p = OSSL_PARAM_construct_end();
 ...
 */
int
EVP_PKEY_CTX_set_dh_paramgen_type(EVP_PKEY_CTX* ctx, int typ)
{
...
int
EVP_PKEY_CTX_set_dh_paramgen_prime_len(EVP_PKEY_CTX* ctx, int pbits)
{
  int ret;
  OSSL_PARAM params[2], *p = params;
  size_t bits = pbits;
...
int
EVP_PKEY_CTX_set_dh_paramgen_subprime_len(EVP_PKEY_CTX* ctx, int qbits)
{
  int ret;
  OSSL_PARAM params[2], *p = params;
  size_t bits2 = qbits;
 ...
 */
int
EVP_PKEY_CTX_set_dh_rfc5114(EVP_PKEY_CTX* ctx, int gen)
{
  return EVP_PKEY_CTX_ctrl(ctx,
                           EVP_PKEY_DHX,
                           EVP_PKEY_OP_PARAMGEN,
...
int
EVP_PKEY_CTX_set_dhx_rfc5114(EVP_PKEY_CTX* ctx, int gen)
{
 ...
 */
int
EVP_PKEY_CTX_set_dh_nid(EVP_PKEY_CTX* ctx, int nid)
{
  return EVP_PKEY_CTX_ctrl(ctx,
                           EVP_PKEY_DH,
...
int
EVP_PKEY_CTX_set_dh_pad(EVP_PKEY_CTX* ctx, int pad)
{
 ...
 */
int
EVP_PKEY_CTX_set_dh_kdf_type(EVP_PKEY_CTX* ctx, int kdf)
{
  return EVP_PKEY_CTX_ctrl(ctx,
                           EVP_PKEY_DHX,
                           EVP_PKEY_OP_DERIVE,
 ...
 */
int
EVP_PKEY_CTX_get_dh_kdf_type(EVP_PKEY_CTX* ctx)
{
  return EVP_PKEY_CTX_ctrl(
    ctx, EVP_PKEY_DHX, EVP_PKEY_OP_DERIVE, EVP_PKEY_CTRL_DH_KDF_TYPE, -2, NULL);
}
 ...
 */
int
EVP_PKEY_CTX_set0_dh_kdf_oid(EVP_PKEY_CTX* ctx, ASN1_OBJECT* oid)
{
  return EVP_PKEY_CTX_ctrl(ctx,
                           EVP_PKEY_DHX,
                           EVP_PKEY_OP_DERIVE,
 ...
 */
int
EVP_PKEY_CTX_get0_dh_kdf_oid(EVP_PKEY_CTX* ctx, ASN1_OBJECT** oid)
{
  return EVP_PKEY_CTX_ctrl(ctx,
                           EVP_PKEY_DHX,
                           EVP_PKEY_OP_DERIVE,
 ...
 */
int
EVP_PKEY_CTX_set_dh_kdf_md(EVP_PKEY_CTX* ctx, const EVP_MD* md)
{
  return EVP_PKEY_CTX_ctrl(ctx,
                           EVP_PKEY_DHX,
                           EVP_PKEY_OP_DERIVE,
 ...
 */
int
EVP_PKEY_CTX_get_dh_kdf_md(EVP_PKEY_CTX* ctx, const EVP_MD** pmd)
{
  return EVP_PKEY_CTX_ctrl(ctx,
                           EVP_PKEY_DHX,
                           EVP_PKEY_OP_DERIVE,
...
int
EVP_PKEY_CTX_set_dh_kdf_outlen(EVP_PKEY_CTX* ctx, int outlen)
{
  int ret;
  size_t len = outlen;
  OSSL_PARAM params[2], *p = params;
...
int
EVP_PKEY_CTX_get_dh_kdf_outlen(EVP_PKEY_CTX* ctx, int* plen)
{
  int ret;
  size_t len = UINT_MAX;
  OSSL_PARAM params[2], *p = params;
...
int
EVP_PKEY_CTX_set0_dh_kdf_ukm(EVP_PKEY_CTX* ctx, unsigned char* ukm, int len)
{
  int ret;
  OSSL_PARAM params[2], *p = params;
...
int
EVP_PKEY_CTX_get0_dh_kdf_ukm(EVP_PKEY_CTX* ctx, unsigned char** pukm)
{
  int ret;
  size_t ukmlen;
  OSSL_PARAM params[2], *p = params;
  ...
  *p++ = OSSL_PARAM_construct_octet_ptr(
    OSSL_EXCHANGE_PARAM_KDF_UKM, (void**)pukm, 0);
  *p = OSSL_PARAM_construct_end();
