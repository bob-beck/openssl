...
int
ossl_pkcs5_pbkdf2_hmac_ex (const char *pass, int passlen,
...
int
PKCS5_v2_PBE_keyivgen_ex (EVP_CIPHER_CTX *ctx, const char *pass, int passlen,
...
int
PKCS5_v2_PBKDF2_keyivgen_ex (EVP_CIPHER_CTX *ctx, const char *pass,
