...
void aesni256_cbc_sha1_dec(const void* inp,
                           void* out,
                           size_t blocks,
                           const AES_KEY* key,
                           unsigned char iv[16],
...
static int aesni_cbc_hmac_sha1_cipher(EVP_CIPHER_CTX* ctx,
                                      unsigned char* out,
...
static int aesni_cbc_hmac_sha1_ctrl(EVP_CIPHER_CTX* ctx,
                                    int type,
                                    int arg,
                                    void* ptr) {
  EVP_AES_HMAC_SHA1* key = data(ctx);
