...
void
aesni256_cbc_sha1_dec(const void* inp,
                      void* out,
                      size_t blocks,
                      const AES_KEY* key,
                      unsigned char iv[16],
...
static int
aesni_cbc_hmac_sha1_init_key(EVP_CIPHER_CTX* ctx,
...
static size_t
tls1_1_multi_block_encrypt(EVP_AES_HMAC_SHA1* key,
                           unsigned char* out,
                           const unsigned char* inp,
                           size_t inp_len,
                           int n4x)
...
static int
aesni_cbc_hmac_sha1_cipher(EVP_CIPHER_CTX* ctx,
                           unsigned char* out,
