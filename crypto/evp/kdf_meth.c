...
static void*
evp_kdf_from_algorithm(int name_id,
...
EVP_KDF*
EVP_KDF_fetch(OSSL_LIB_CTX* libctx,
...
const OSSL_PARAM*
EVP_KDF_gettable_params(const EVP_KDF* kdf)
{
  if (kdf->gettable_params == NULL)
    return NULL;
...
const OSSL_PARAM*
EVP_KDF_gettable_ctx_params(const EVP_KDF* kdf)
{
  void* alg;
...
const OSSL_PARAM*
EVP_KDF_settable_ctx_params(const EVP_KDF* kdf)
{
  void* alg;
...
const OSSL_PARAM*
EVP_KDF_CTX_settable_params(EVP_KDF_CTX* ctx)
{
  void* alg;
...
void
EVP_KDF_do_all_provided(OSSL_LIB_CTX* libctx,
