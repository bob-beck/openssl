...
static int
evp_kem_init (EVP_PKEY_CTX *ctx, int operation, const OSSL_PARAM params[],
              EVP_PKEY *authkey)
{
  int ret = 0;
  EVP_KEM *kem = NULL;
...
int
EVP_PKEY_auth_encapsulate_init (EVP_PKEY_CTX *ctx, EVP_PKEY *authpriv,
...
int
EVP_PKEY_encapsulate (EVP_PKEY_CTX *ctx, unsigned char *out, size_t *outlen,
...
int
EVP_PKEY_auth_decapsulate_init (EVP_PKEY_CTX *ctx, EVP_PKEY *authpub,
                                const OSSL_PARAM params[])
{
  if (authpub == NULL)
    return 0;
...
int
EVP_PKEY_decapsulate (EVP_PKEY_CTX *ctx, unsigned char *secret,
                      size_t *secretlen, const unsigned char *in, size_t inlen)
{
...
static void *
evp_kem_from_algorithm (int name_id, const OSSL_ALGORITHM *algodef,
                        OSSL_PROVIDER *prov)
{
...
EVP_KEM *
evp_kem_fetch_from_prov (OSSL_PROVIDER *prov, const char *algorithm,
                         const char *properties)
{
