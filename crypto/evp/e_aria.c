...
static int aria_init_key(EVP_CIPHER_CTX* ctx,
...
static void aria_cbc_encrypt(const unsigned char* in,
                             unsigned char* out,
                             size_t len,
                             const ARIA_KEY* key,
                             unsigned char* ivec,
...
static void aria_cfb128_encrypt(const unsigned char* in,
                                unsigned char* out,
                                size_t length,
                                const ARIA_KEY* key,
                                unsigned char* ivec,
...
static void aria_cfb1_encrypt(const unsigned char* in,
                              unsigned char* out,
                              size_t length,
                              const ARIA_KEY* key,
                              unsigned char* ivec,
...
static void aria_cfb8_encrypt(const unsigned char* in,
                              unsigned char* out,
                              size_t length,
                              const ARIA_KEY* key,
                              unsigned char* ivec,
...
static void aria_ecb_encrypt(const unsigned char* in,
                             unsigned char* out,
                             const ARIA_KEY* key,
                             const int enc) {
...
static void aria_ofb128_encrypt(const unsigned char* in,
                                unsigned char* out,
                                size_t length,
                                const ARIA_KEY* key,
                                unsigned char* ivec,
...
static int aria_ctr_cipher(EVP_CIPHER_CTX* ctx,
                           unsigned char* out,
...
static int aria_gcm_init_key(EVP_CIPHER_CTX* ctx,
                             const unsigned char* key,
                             const unsigned char* iv,
                             int enc) {
  int ret;
...
static int aria_gcm_tls_cipher(EVP_CIPHER_CTX* ctx,
                               unsigned char* out,
                               const unsigned char* in,
                               size_t len) {
  EVP_ARIA_GCM_CTX* gctx = EVP_C_DATA(EVP_ARIA_GCM_CTX, ctx);
...
static int aria_gcm_cipher(EVP_CIPHER_CTX* ctx,
                           unsigned char* out,
                           const unsigned char* in,
                           size_t len) {
  EVP_ARIA_GCM_CTX* gctx = EVP_C_DATA(EVP_ARIA_GCM_CTX, ctx);
...
static int aria_ccm_init_key(EVP_CIPHER_CTX* ctx,
                             const unsigned char* key,
                             const unsigned char* iv,
                             int enc) {
  int ret;
...
static int aria_ccm_tls_cipher(EVP_CIPHER_CTX* ctx,
                               unsigned char* out,
                               const unsigned char* in,
                               size_t len) {
  EVP_ARIA_CCM_CTX* cctx = EVP_C_DATA(EVP_ARIA_CCM_CTX, ctx);
...
static int aria_ccm_cipher(EVP_CIPHER_CTX* ctx,
                           unsigned char* out,
                           const unsigned char* in,
                           size_t len) {
  EVP_ARIA_CCM_CTX* cctx = EVP_C_DATA(EVP_ARIA_CCM_CTX, ctx);
