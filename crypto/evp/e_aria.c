...
static int
aria_init_key(EVP_CIPHER_CTX* ctx,
...
static void
aria_cbc_encrypt(const unsigned char* in,
                 unsigned char* out,
                 size_t len,
                 const ARIA_KEY* key,
                 unsigned char* ivec,
                 const int enc)
{
  ...
  if (enc)
    CRYPTO_cbc128_encrypt(
      in, out, len, key, ivec, (block128_f)ossl_aria_encrypt);
  else
...
static void
aria_cfb128_encrypt(const unsigned char* in,
                    unsigned char* out,
                    size_t length,
                    const ARIA_KEY* key,
                    unsigned char* ivec,
                    ...
                    const int enc)
{
  ...
  CRYPTO_cfb128_encrypt(
    in, out, length, key, ivec, num, enc, (block128_f)ossl_aria_encrypt);
}

static void
aria_cfb1_encrypt(const unsigned char* in,
                  unsigned char* out,
                  size_t length,
                  const ARIA_KEY* key,
                  unsigned char* ivec,
...
static void
aria_cfb8_encrypt(const unsigned char* in,
                  unsigned char* out,
                  size_t length,
                  const ARIA_KEY* key,
                  unsigned char* ivec,
...
static void
aria_ecb_encrypt(const unsigned char* in,
                 unsigned char* out,
                 const ARIA_KEY* key,
                 const int enc)
{
...
static void
aria_ofb128_encrypt(const unsigned char* in,
                    unsigned char* out,
                    size_t length,
                    const ARIA_KEY* key,
                    unsigned char* ivec,
                    int* num)
{
  CRYPTO_ofb128_encrypt(
    in, out, length, key, ivec, num, (block128_f)ossl_aria_encrypt);
}

IMPLEMENT_BLOCK_CIPHER(aria_128,
                       ks,
                       aria,
                       EVP_ARIA_KEY,
                       NID_aria_128,
                       ...
                       NULL)
IMPLEMENT_BLOCK_CIPHER(aria_192,
                       ks,
                       aria,
                       EVP_ARIA_KEY,
                       NID_aria_192,
                       ...
                       EVP_CIPHER_get_asn1_iv,
                       NULL)
IMPLEMENT_BLOCK_CIPHER(aria_256,
                       ks,
                       aria,
                       EVP_ARIA_KEY,
                       NID_aria_256,
...
static int
aria_ctr_cipher(EVP_CIPHER_CTX* ctx,
                unsigned char* out,
...
static int
aria_gcm_init_key(EVP_CIPHER_CTX* ctx,
                  const unsigned char* key,
                  const unsigned char* iv,
                  int enc)
{
...
static int
aria_gcm_tls_cipher(EVP_CIPHER_CTX* ctx,
                    unsigned char* out,
                    const unsigned char* in,
                    size_t len)
{
...
static int
aria_gcm_cipher(EVP_CIPHER_CTX* ctx,
                unsigned char* out,
                const unsigned char* in,
                size_t len)
{
...
static int
aria_ccm_init_key(EVP_CIPHER_CTX* ctx,
                  const unsigned char* key,
                  const unsigned char* iv,
                  int enc)
{
  ...
  if (key) {
    ...
    CRYPTO_ccm128_init(
      &cctx->ccm, cctx->M, cctx->L, &cctx->ks, (block128_f)ossl_aria_encrypt);
    if (ret < 0) {
      ERR_raise(ERR_LIB_EVP, EVP_R_ARIA_KEY_SETUP_FAILED);
      return 0;
    }
...
static int
aria_ccm_tls_cipher(EVP_CIPHER_CTX* ctx,
                    unsigned char* out,
                    const unsigned char* in,
                    size_t len)
{
...
static int
aria_ccm_cipher(EVP_CIPHER_CTX* ctx,
                unsigned char* out,
                const unsigned char* in,
                size_t len)
{
