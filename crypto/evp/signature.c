...
static void
evp_signature_free (void *data)
{
  EVP_SIGNATURE_free (data);
}

static int
evp_signature_up_ref (void *data)
{
  return EVP_SIGNATURE_up_ref (data);
}

static EVP_SIGNATURE *
evp_signature_new (OSSL_PROVIDER *prov)
{
...
static void *
evp_signature_from_algorithm (int name_id, const OSSL_ALGORITHM *algodef,
                              OSSL_PROVIDER *prov)
{
...
OSSL_PROVIDER *
EVP_SIGNATURE_get0_provider (const EVP_SIGNATURE *signature)
{
  return signature->prov;
}

EVP_SIGNATURE *
EVP_SIGNATURE_fetch (OSSL_LIB_CTX *ctx, const char *algorithm,
...
EVP_SIGNATURE *
evp_signature_fetch_from_prov (OSSL_PROVIDER *prov, const char *algorithm,
                               const char *properties)
{
...
int
EVP_SIGNATURE_is_a (const EVP_SIGNATURE *signature, const char *name)
{
...
const char *
EVP_SIGNATURE_get0_name (const EVP_SIGNATURE *signature)
{
  return signature->type_name;
}

const char *
EVP_SIGNATURE_get0_description (const EVP_SIGNATURE *signature)
{
  return signature->description;
}

void
EVP_SIGNATURE_do_all_provided (OSSL_LIB_CTX *libctx,
...
int
EVP_SIGNATURE_names_do_all (const EVP_SIGNATURE *signature,
...
static int
evp_pkey_signature_init (EVP_PKEY_CTX *ctx, EVP_SIGNATURE *signature,
                         int operation, const OSSL_PARAM params[])
{
  ...
  switch (operation)
    ...
    case EVP_PKEY_OP_VERIFYMSG:
      ...
      ret = signature->verify_message_init (ctx->op.sig.algctx, provkey,
                                            params);
      break;
...
int
EVP_PKEY_sign_init_ex (EVP_PKEY_CTX *ctx, const OSSL_PARAM params[])
{
  return evp_pkey_signature_init (ctx, NULL, EVP_PKEY_OP_SIGN, params);
}

int
EVP_PKEY_sign_init_ex2 (EVP_PKEY_CTX *ctx, EVP_SIGNATURE *algo,
...
int
EVP_PKEY_sign_message_init (EVP_PKEY_CTX *ctx, EVP_SIGNATURE *algo,
                            const OSSL_PARAM params[])
{
...
int
EVP_PKEY_sign_message_update (EVP_PKEY_CTX *ctx, const unsigned char *in,
                              size_t inlen)
{
...
int
EVP_PKEY_sign_message_final (EVP_PKEY_CTX *ctx, unsigned char *sig,
                             size_t *siglen)
{
  EVP_SIGNATURE *signature;
  const char *desc;
...
int
EVP_PKEY_verify_init_ex (EVP_PKEY_CTX *ctx, const OSSL_PARAM params[])
{
  return evp_pkey_signature_init (ctx, NULL, EVP_PKEY_OP_VERIFY, params);
}

int
EVP_PKEY_verify_init_ex2 (EVP_PKEY_CTX *ctx, EVP_SIGNATURE *algo,
                          const OSSL_PARAM params[])
{
...
int
EVP_PKEY_verify_message_init (EVP_PKEY_CTX *ctx, EVP_SIGNATURE *algo,
                              const OSSL_PARAM params[])
{
...
int
EVP_PKEY_CTX_set_signature (EVP_PKEY_CTX *ctx, const unsigned char *sig,
                            size_t siglen)
{
...
int
EVP_PKEY_verify_message_update (EVP_PKEY_CTX *ctx, const unsigned char *in,
                                size_t inlen)
{
  EVP_SIGNATURE *signature;
  const char *desc;
...
int
EVP_PKEY_verify_message_final (EVP_PKEY_CTX *ctx)
{
  EVP_SIGNATURE *signature;
  const char *desc;
  int ret;
...
int
EVP_PKEY_verify_recover_init_ex (EVP_PKEY_CTX *ctx, const OSSL_PARAM params[])
{
...
int
EVP_PKEY_verify_recover_init_ex2 (EVP_PKEY_CTX *ctx, EVP_SIGNATURE *algo,
                                  const OSSL_PARAM params[])
{
...
int
EVP_PKEY_verify_recover (EVP_PKEY_CTX *ctx, unsigned char *rout,
