...
#define EVP_MD_SHA3(bitlen)                                                                                            \
    ...
    {                                                                                                                  \
        static const EVP_MD sha3_##bitlen##_md = {                                                                     \
            ...
            EVP_MD_FLAG_DIGALGID_ABSENT,                                                                               \
            EVP_ORIG_GLOBAL,                                                                                           \
            LEGACY_EVP_MD_METH_TABLE(sha3_int_init, sha3_int_update, sha3_int_final, NULL,                             \
...
#define EVP_MD_SHAKE(bitlen)                                                                                           \
    ...
    {                                                                                                                  \
        static const EVP_MD shake##bitlen##_md = {                                                                     \
            ...
            EVP_ORIG_GLOBAL,                                                                                           \
            LEGACY_EVP_MD_METH_TABLE(shake_init, sha3_int_update, sha3_int_final, shake_ctrl,                          \
                                     (KECCAK1600_WIDTH - bitlen * 2) / 8),                                             \
        };                                                                                                             \
