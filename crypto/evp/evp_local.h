...
int
PKCS5_v2_PBKDF2_keyivgen(EVP_CIPHER_CTX* ctx,
                         const char* pass,
                         int passlen,
                         ASN1_TYPE* param,
                         const EVP_CIPHER* c,
                         ...
                         int en_de);
int
PKCS5_v2_PBKDF2_keyivgen_ex(EVP_CIPHER_CTX* ctx,
                            const char* pass,
                            int passlen,
                            ASN1_TYPE* param,
                            const EVP_CIPHER* c,
...
void*
evp_generic_fetch(OSSL_LIB_CTX* ctx,
                  int operation_id,
                  const char* name,
...
evp_generic_fetch_from_prov(OSSL_PROVIDER* prov,
                            ...
                            void (*free_method)(void*));
void
evp_generic_do_all_prefetched(OSSL_LIB_CTX* libctx,
                              int operation_id,
...
EVP_KEYMGMT*
evp_keymgmt_fetch_by_number(OSSL_LIB_CTX* ctx,
                            int name_id,
                            const char* properties);
EVP_SIGNATURE*
evp_signature_fetch_from_prov(OSSL_PROVIDER* prov,
                              ...
                              const char* properties);
EVP_ASYM_CIPHER*
evp_asym_cipher_fetch_from_prov(OSSL_PROVIDER* prov,
                                const char* name,
                                const char* properties);
EVP_KEYEXCH*
evp_keyexch_fetch_from_prov(OSSL_PROVIDER* prov,
                            const char* name,
                            const char* properties);
EVP_KEM*
evp_kem_fetch_from_prov(OSSL_PROVIDER* prov,
                        const char* name,
                        const char* properties);
EVP_CIPHER*
...
evp_digest_fetch_from_prov(OSSL_PROVIDER* prov,
                           ...
                           const char* properties);
EVP_MAC*
evp_mac_fetch_from_prov(OSSL_PROVIDER* prov,
                        const char* algorithm,
                        const char* properties);
 ...
 */
int
evp_do_ciph_getparams(const EVP_CIPHER* ciph, OSSL_PARAM params[]);
int
evp_do_ciph_ctx_getparams(const EVP_CIPHER* ciph,
                          void* provctx,
                          OSSL_PARAM params[]);
int
evp_do_ciph_ctx_setparams(const EVP_CIPHER* ciph,
                          void* provctx,
                          OSSL_PARAM params[]);
int
evp_do_md_getparams(const EVP_MD* md, OSSL_PARAM params[]);
int
evp_do_md_ctx_getparams(const EVP_MD* md, void* provctx, OSSL_PARAM params[]);
int
evp_do_md_ctx_setparams(const EVP_MD* md, void* provctx, OSSL_PARAM params[]);

OSSL_PARAM*
evp_pkey_to_param(EVP_PKEY* pkey, size_t* sz);
...
void
evp_cipher_free_int(EVP_CIPHER* md);
void
