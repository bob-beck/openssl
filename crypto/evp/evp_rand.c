...
static void *
evp_rand_from_algorithm (int name_id, const OSSL_ALGORITHM *algodef,
                         OSSL_PROVIDER *prov)
{
...
EVP_RAND *
EVP_RAND_fetch (OSSL_LIB_CTX *libctx, const char *algorithm,
...
static int
evp_rand_instantiate_locked (EVP_RAND_CTX *ctx, unsigned int strength,
...
int
EVP_RAND_instantiate (EVP_RAND_CTX *ctx, unsigned int strength,
...
static int
evp_rand_generate_locked (EVP_RAND_CTX *ctx, unsigned char *out, size_t outlen,
...
int
EVP_RAND_generate (EVP_RAND_CTX *ctx, unsigned char *out, size_t outlen,
                   unsigned int strength, int prediction_resistance,
                   const unsigned char *addin, size_t addin_len)
{
  int res;
...
static int
evp_rand_reseed_locked (EVP_RAND_CTX *ctx, int prediction_resistance,
...
int
EVP_RAND_reseed (EVP_RAND_CTX *ctx, int prediction_resistance,
                 const unsigned char *ent, size_t ent_len,
                 const unsigned char *addin, size_t addin_len)
{
  int res;
...
static size_t
evp_rand_get_seed_locked (EVP_RAND_CTX *ctx, unsigned char **buffer,
...
size_t
evp_rand_get_seed (EVP_RAND_CTX *ctx, unsigned char **buffer, int entropy,
...
static void
evp_rand_clear_seed_locked (EVP_RAND_CTX *ctx, unsigned char *buffer,
                            size_t b_len)
{
