...
int
EVP_SKEY_export (const EVP_SKEY *skey, int selection, OSSL_CALLBACK *export_cb,
                 void *export_cbarg)
{
  if (skey == NULL)
    {
...
static EVP_SKEY *
evp_skey_alloc_fetch (OSSL_LIB_CTX *libctx, const char *skeymgmtname,
...
EVP_SKEY *
EVP_SKEY_import (OSSL_LIB_CTX *libctx, const char *skeymgmtname,
...
EVP_SKEY *
EVP_SKEY_generate (OSSL_LIB_CTX *libctx, const char *skeymgmtname,
...
int
EVP_SKEY_get0_raw_key (const EVP_SKEY *skey, const unsigned char **key,
                       size_t *len)
{
...
EVP_SKEY *
EVP_SKEY_import_raw_key (OSSL_LIB_CTX *libctx, const char *skeymgmtname,
...
EVP_SKEY *
EVP_SKEY_to_provider (EVP_SKEY *skey, OSSL_LIB_CTX *libctx,
