...
static int chacha_cipher(EVP_CIPHER_CTX* ctx,
                         unsigned char* out,
...
static int chacha20_poly1305_tls_cipher(EVP_CIPHER_CTX* ctx,
                                        unsigned char* out,
...
static int chacha20_poly1305_cipher(EVP_CIPHER_CTX* ctx,
                                    unsigned char* out,
                                    const unsigned char* in,
                                    size_t len) {
  EVP_CHACHA_AEAD_CTX* actx = aead_data(ctx);
...
static int chacha20_poly1305_ctrl(EVP_CIPHER_CTX* ctx,
                                  int type,
                                  int arg,
                                  void* ptr) {
  EVP_CHACHA_AEAD_CTX* actx = aead_data(ctx);
