...
static int
chacha_cipher (EVP_CIPHER_CTX *ctx, unsigned char *out,
...
static int
chacha20_poly1305_init_key (EVP_CIPHER_CTX *ctx, const unsigned char *inkey,
...
static int
chacha20_poly1305_tls_cipher (EVP_CIPHER_CTX *ctx, unsigned char *out,
