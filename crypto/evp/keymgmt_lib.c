...
int
evp_keymgmt_util_assign_pkey (EVP_PKEY *pkey, EVP_KEYMGMT *keymgmt,
                              void *keydata)
{
...
int
evp_keymgmt_util_export (const EVP_PKEY *pk, int selection,
...
void *
evp_keymgmt_util_export_to_provider (EVP_PKEY *pk, EVP_KEYMGMT *keymgmt,
                                     int selection)
{
...
OP_CACHE_ELEM *
evp_keymgmt_util_find_operation_cache (EVP_PKEY *pk, EVP_KEYMGMT *keymgmt,
                                       int selection)
{
...
int
evp_keymgmt_util_cache_keydata (EVP_PKEY *pk, EVP_KEYMGMT *keymgmt,
...
void *
evp_keymgmt_util_fromdata (EVP_PKEY *target, EVP_KEYMGMT *keymgmt,
...
void *
evp_keymgmt_util_gen (EVP_PKEY *target, EVP_KEYMGMT *keymgmt, void *genctx,
 ...
 */
int
evp_keymgmt_util_get_deflt_digest_name (EVP_KEYMGMT *keymgmt, void *keydata,
