 ...
 */
static int
default_check(enum state state, const struct translation_st *translation, const struct translation_ctx_st *ctx)
{
    switch (state) {
    default:
        break;
 ...
 */
static int
default_fixup_args(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx)
{
    int ret;
            ...
            if (ctx->p2 != NULL) {
                if (ctx->action_type == OSSL_ACTION_SET) {
                    ...
                    if ((ctx->allocated_buf = OPENSSL_malloc(ctx->buflen)) == NULL)
                        return 0;
                    if (BN_bn2nativepad(ctx->p2, ctx->allocated_buf, (int)ctx->buflen) < 0) {
...
static int
cleanup_translation_ctx(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx)
{
...
static int
fix_dh_paramgen_type(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx)
{
    int ret;
...
static int
fix_ec_paramgen_curve_nid(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx)
{
    char *p2 = NULL;
    int   ret;
...
static int
fix_rsa_padding_mode(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx)
{
...
static int
fix_rsa_pss_saltlen(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx)
{
    static const OSSL_ITEM str_value_map[] = {
...
static int
get_payload_group_name(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx)
{
...
static int
get_payload_private_key(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx)
{
    EVP_PKEY *pkey = ctx->p2;
...
static int
get_payload_public_key(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx)
{
    EVP_PKEY      *pkey = ctx->p2;
...
static int
get_payload_public_key_ec(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx)
{
#ifndef OPENSSL_NO_EC
    EVP_PKEY       *pkey  = ctx->p2;
    const EC_KEY   *eckey = EVP_PKEY_get0_EC_KEY(pkey);
...
static int
get_dh_dsa_payload_p(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx)
{
...
static int
get_dh_dsa_payload_q(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx)
{
    const BIGNUM *bn = NULL;
...
static int
get_dh_dsa_payload_g(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx)
{
    const BIGNUM *bn = NULL;
...
static const struct translation_st evp_pkey_ctx_translations[] = {
    ...
    {OSSL_ACTION_SET,
     -1,
     -1,
     EVP_PKEY_OP_TYPE_SIG,                          EVP_PKEY_CTRL_SET1_ID,
     "distid",                                                                                                   "hexdistid",
     OSSL_PKEY_PARAM_DIST_ID,                                                                                                                                                 OSSL_PARAM_OCTET_STRING,
     NULL                                                                                                                                                                                                                           },
    {OSSL_ACTION_GET,
     -1,
     -1,
     -1,
     EVP_PKEY_CTRL_GET1_ID,                                                                 "distid",
     "hexdistid",                                                                                                                                OSSL_PKEY_PARAM_DIST_ID,
     OSSL_PARAM_OCTET_PTR,                                                                                                                                                                                 NULL                     },
    {OSSL_ACTION_GET,
     -1,
     -1,
     -1,
     EVP_PKEY_CTRL_GET1_ID_LEN,                                                             NULL,
     NULL,                                                                                                                                       OSSL_PKEY_PARAM_DIST_ID,
     OSSL_PARAM_OCTET_PTR,                                                                                                                                                                                 fix_distid_len           },
    ...
    {OSSL_ACTION_NONE,
     EVP_PKEY_DHX,     0,
     EVP_PKEY_OP_DERIVE,                            EVP_PKEY_CTRL_DH_KDF_TYPE,
     NULL,                                                                                                       NULL,
     OSSL_EXCHANGE_PARAM_KDF_TYPE,                                                                                                                                            OSSL_PARAM_UTF8_STRING,
     fix_dh_kdf_type                                                                                                                                                                                                                },
    {OSSL_ACTION_SET,
     EVP_PKEY_DHX,     0,
     EVP_PKEY_OP_DERIVE,                            EVP_PKEY_CTRL_DH_KDF_MD,
     NULL,                                                                                                       NULL,
     OSSL_EXCHANGE_PARAM_KDF_DIGEST,                                                                                                                                          OSSL_PARAM_UTF8_STRING,
     fix_md                                                                                                                                                                                                                         },
    {OSSL_ACTION_GET,
     EVP_PKEY_DHX,     0,
     EVP_PKEY_OP_DERIVE,                            EVP_PKEY_CTRL_GET_DH_KDF_MD,
     NULL,                                                                                                       NULL,
     OSSL_EXCHANGE_PARAM_KDF_DIGEST,                                                                                                                                          OSSL_PARAM_UTF8_STRING,
     fix_md                                                                                                                                                                                                                         },
    {OSSL_ACTION_SET,
     EVP_PKEY_DHX,     0,
     EVP_PKEY_OP_DERIVE,                            EVP_PKEY_CTRL_DH_KDF_OUTLEN,
     NULL,                                                                                                       NULL,
     OSSL_EXCHANGE_PARAM_KDF_OUTLEN,                                                                                                                                          OSSL_PARAM_UNSIGNED_INTEGER,
     NULL                                                                                                                                                                                                                           },
    {OSSL_ACTION_GET,
     EVP_PKEY_DHX,     0,
     EVP_PKEY_OP_DERIVE,                            EVP_PKEY_CTRL_GET_DH_KDF_OUTLEN,
     NULL,                                                                                                       NULL,
     OSSL_EXCHANGE_PARAM_KDF_OUTLEN,                                                                                                                                          OSSL_PARAM_UNSIGNED_INTEGER,
     NULL                                                                                                                                                                                                                           },
    {OSSL_ACTION_SET,
     EVP_PKEY_DHX,     0,
     EVP_PKEY_OP_DERIVE,                            EVP_PKEY_CTRL_DH_KDF_UKM,
     NULL,                                                                                                       NULL,
     OSSL_EXCHANGE_PARAM_KDF_UKM,                                                                                                                                             OSSL_PARAM_OCTET_STRING,
     NULL                                                                                                                                                                                                                           },
    {OSSL_ACTION_GET,
     EVP_PKEY_DHX,     0,
     EVP_PKEY_OP_DERIVE,                            EVP_PKEY_CTRL_GET_DH_KDF_UKM,
     NULL,                                                                                                       NULL,
     OSSL_EXCHANGE_PARAM_KDF_UKM,                                                                                                                                             OSSL_PARAM_OCTET_PTR,
     NULL                                                                                                                                                                                                                           },
    {OSSL_ACTION_SET,
     EVP_PKEY_DHX,     0,
     EVP_PKEY_OP_DERIVE,                            EVP_PKEY_CTRL_DH_KDF_OID,
     NULL,                                                                                                       NULL,
     OSSL_KDF_PARAM_CEK_ALG,                                                                                                                                                  OSSL_PARAM_UTF8_STRING,
     fix_oid                                                                                                                                                                                                                        },
    {OSSL_ACTION_GET,
     EVP_PKEY_DHX,     0,
     EVP_PKEY_OP_DERIVE,                            EVP_PKEY_CTRL_GET_DH_KDF_OID,
     NULL,                                                                                                       NULL,
     OSSL_KDF_PARAM_CEK_ALG,                                                                                                                                                  OSSL_PARAM_UTF8_STRING,
     fix_oid                                                                                                                                                                                                                        },
    ...
    {OSSL_ACTION_SET,
     EVP_PKEY_DHX,     0,
     EVP_PKEY_OP_PARAMGEN,                          EVP_PKEY_CTRL_DH_PARAMGEN_TYPE,
     "dh_paramgen_type",                                                                                         NULL,
     OSSL_PKEY_PARAM_FFC_TYPE,                                                                                                                                                OSSL_PARAM_UTF8_STRING,
     fix_dh_paramgen_type                                                                                                                                                                                                           },
    {OSSL_ACTION_SET,
     EVP_PKEY_DHX,     0,
     EVP_PKEY_OP_PARAMGEN,                          EVP_PKEY_CTRL_DH_PARAMGEN_PRIME_LEN,
     "dh_paramgen_prime_len",                                                                                    NULL,
     OSSL_PKEY_PARAM_FFC_PBITS,                                                                                                                                               OSSL_PARAM_UNSIGNED_INTEGER,
     NULL                                                                                                                                                                                                                           },
    {OSSL_ACTION_SET,
     EVP_PKEY_DHX,     0,
     EVP_PKEY_OP_PARAMGEN | EVP_PKEY_OP_KEYGEN,
     EVP_PKEY_CTRL_DH_NID,                                                                  "dh_param",
     NULL,                                                                                                                                       OSSL_PKEY_PARAM_GROUP_NAME,
     OSSL_PARAM_UTF8_STRING,                                                                                                                                                                               NULL                     },
    {OSSL_ACTION_SET,
     EVP_PKEY_DHX,     0,
     EVP_PKEY_OP_PARAMGEN | EVP_PKEY_OP_KEYGEN,
     EVP_PKEY_CTRL_DH_RFC5114,                                                              "dh_rfc5114",
     NULL,                                                                                                                                       OSSL_PKEY_PARAM_GROUP_NAME,
    ...
    {OSSL_ACTION_SET,
     EVP_PKEY_DH,      0,
     EVP_PKEY_OP_PARAMGEN,                          EVP_PKEY_CTRL_DH_PARAMGEN_GENERATOR,
     "dh_paramgen_generator",                                                                                    NULL,
     OSSL_PKEY_PARAM_DH_GENERATOR,                                                                                                                                            OSSL_PARAM_INTEGER,
     NULL                                                                                                                                                                                                                           },

    /* DHX specific Keygen Parameters */
    {OSSL_ACTION_SET,
     EVP_PKEY_DHX,     0,
     EVP_PKEY_OP_PARAMGEN,                          EVP_PKEY_CTRL_DH_PARAMGEN_SUBPRIME_LEN,
     "dh_paramgen_subprime_len",                                                                                 NULL,
     OSSL_PKEY_PARAM_FFC_QBITS,                                                                                                                                               OSSL_PARAM_UNSIGNED_INTEGER,
     NULL                                                                                                                                                                                                                           },

    {OSSL_ACTION_SET,
     EVP_PKEY_DH,      0,
     EVP_PKEY_OP_DERIVE,                            EVP_PKEY_CTRL_DH_PAD,
     "dh_pad",                                                                                                   NULL,
     OSSL_EXCHANGE_PARAM_PAD,                                                                                                                                                 OSSL_PARAM_UNSIGNED_INTEGER,
     NULL                                                                                                                                                                                                                           },
    ...
    {OSSL_ACTION_SET,
     EVP_PKEY_DSA,     0,
     EVP_PKEY_OP_PARAMGEN,                          EVP_PKEY_CTRL_DSA_PARAMGEN_BITS,
    ...
    {OSSL_ACTION_SET,
     EVP_PKEY_DSA,     0,
     EVP_PKEY_OP_PARAMGEN,                          EVP_PKEY_CTRL_DSA_PARAMGEN_MD,
     "dsa_paramgen_md",                                                                                          NULL,
     OSSL_PKEY_PARAM_FFC_DIGEST,                                                                                                                                              OSSL_PARAM_UTF8_STRING,
     fix_md                                                                                                                                                                                                                         },
    ...
    {OSSL_ACTION_SET,
     EVP_PKEY_EC,      0,
     EVP_PKEY_OP_PARAMGEN | EVP_PKEY_OP_KEYGEN,
     EVP_PKEY_CTRL_EC_PARAM_ENC,                                                            "ec_param_enc",
     NULL,                                                                                                                                       OSSL_PKEY_PARAM_EC_ENCODING,
     OSSL_PARAM_UTF8_STRING,                                                                                                                                                                               fix_ec_param_enc         },
    {OSSL_ACTION_SET,
     EVP_PKEY_EC,      0,
     EVP_PKEY_OP_PARAMGEN | EVP_PKEY_OP_KEYGEN,
     EVP_PKEY_CTRL_EC_PARAMGEN_CURVE_NID,                                                   "ec_paramgen_curve",
     NULL,                                                                                                                                       OSSL_PKEY_PARAM_GROUP_NAME,
     OSSL_PARAM_UTF8_STRING,                                                                                                                                                                               fix_ec_paramgen_curve_nid},
    /*
    ...
    {OSSL_ACTION_NONE,
     EVP_PKEY_EC,      0,
     EVP_PKEY_OP_DERIVE,                            EVP_PKEY_CTRL_EC_ECDH_COFACTOR,
     "ecdh_cofactor_mode",                                                                                       NULL,
     OSSL_EXCHANGE_PARAM_EC_ECDH_COFACTOR_MODE,                                                                                                                               OSSL_PARAM_INTEGER,
     fix_ecdh_cofactor                                                                                                                                                                                                              },
    {OSSL_ACTION_NONE,
     EVP_PKEY_EC,      0,
     EVP_PKEY_OP_DERIVE,                            EVP_PKEY_CTRL_EC_KDF_TYPE,
     NULL,                                                                                                       NULL,
     OSSL_EXCHANGE_PARAM_KDF_TYPE,                                                                                                                                            OSSL_PARAM_UTF8_STRING,
     fix_ec_kdf_type                                                                                                                                                                                                                },
    {OSSL_ACTION_SET,
     EVP_PKEY_EC,      0,
     EVP_PKEY_OP_DERIVE,                            EVP_PKEY_CTRL_EC_KDF_MD,
     "ecdh_kdf_md",                                                                                              NULL,
     OSSL_EXCHANGE_PARAM_KDF_DIGEST,                                                                                                                                          OSSL_PARAM_UTF8_STRING,
     fix_md                                                                                                                                                                                                                         },
    {OSSL_ACTION_GET,
     EVP_PKEY_EC,      0,
     EVP_PKEY_OP_DERIVE,                            EVP_PKEY_CTRL_GET_EC_KDF_MD,
     NULL,                                                                                                       NULL,
     OSSL_EXCHANGE_PARAM_KDF_DIGEST,                                                                                                                                          OSSL_PARAM_UTF8_STRING,
     fix_md                                                                                                                                                                                                                         },
    {OSSL_ACTION_SET,
     EVP_PKEY_EC,      0,
     EVP_PKEY_OP_DERIVE,                            EVP_PKEY_CTRL_EC_KDF_OUTLEN,
     NULL,                                                                                                       NULL,
     OSSL_EXCHANGE_PARAM_KDF_OUTLEN,                                                                                                                                          OSSL_PARAM_UNSIGNED_INTEGER,
     NULL                                                                                                                                                                                                                           },
    {OSSL_ACTION_GET,
     EVP_PKEY_EC,      0,
     EVP_PKEY_OP_DERIVE,                            EVP_PKEY_CTRL_GET_EC_KDF_OUTLEN,
     NULL,                                                                                                       NULL,
     OSSL_EXCHANGE_PARAM_KDF_OUTLEN,                                                                                                                                          OSSL_PARAM_UNSIGNED_INTEGER,
     NULL                                                                                                                                                                                                                           },
    {OSSL_ACTION_SET,
     EVP_PKEY_EC,      0,
     EVP_PKEY_OP_DERIVE,                            EVP_PKEY_CTRL_EC_KDF_UKM,
     NULL,                                                                                                       NULL,
     OSSL_EXCHANGE_PARAM_KDF_UKM,                                                                                                                                             OSSL_PARAM_OCTET_STRING,
     NULL                                                                                                                                                                                                                           },
    {OSSL_ACTION_GET,
     EVP_PKEY_EC,      0,
     EVP_PKEY_OP_DERIVE,                            EVP_PKEY_CTRL_GET_EC_KDF_UKM,
     NULL,                                                                                                       NULL,
     OSSL_EXCHANGE_PARAM_KDF_UKM,                                                                                                                                             OSSL_PARAM_OCTET_PTR,
     NULL                                                                                                                                                                                                                           },
    ...
    {OSSL_ACTION_SET,
     ...
     EVP_PKEY_CTRL_RSA_PADDING,                                                             "rsa_padding_mode",
     NULL,                                                                                                                                       OSSL_PKEY_PARAM_PAD_MODE,
     OSSL_PARAM_UTF8_STRING,                                                                                                                                                                               fix_rsa_padding_mode     },
    {OSSL_ACTION_GET,
     EVP_PKEY_RSA,     EVP_PKEY_RSA_PSS,
     EVP_PKEY_OP_TYPE_CRYPT | EVP_PKEY_OP_TYPE_SIG,
     EVP_PKEY_CTRL_GET_RSA_PADDING,                                                         NULL,
     NULL,                                                                                                                                       OSSL_PKEY_PARAM_PAD_MODE,
     OSSL_PARAM_UTF8_STRING,                                                                                                                                                                               fix_rsa_padding_mode     },
    ...
    {OSSL_ACTION_SET,
     EVP_PKEY_RSA,     EVP_PKEY_RSA_PSS,
     EVP_PKEY_OP_TYPE_CRYPT | EVP_PKEY_OP_TYPE_SIG,
     EVP_PKEY_CTRL_RSA_MGF1_MD,                                                             "rsa_mgf1_md",
     NULL,                                                                                                                                       OSSL_PKEY_PARAM_MGF1_DIGEST,
     OSSL_PARAM_UTF8_STRING,                                                                                                                                                                               fix_md                   },
    {OSSL_ACTION_GET,
     EVP_PKEY_RSA,     EVP_PKEY_RSA_PSS,
     EVP_PKEY_OP_TYPE_CRYPT | EVP_PKEY_OP_TYPE_SIG,
     EVP_PKEY_CTRL_GET_RSA_MGF1_MD,                                                         NULL,
     NULL,                                                                                                                                       OSSL_PKEY_PARAM_MGF1_DIGEST,
     OSSL_PARAM_UTF8_STRING,                                                                                                                                                                               fix_md                   },
    ...
    {OSSL_ACTION_SET,
     EVP_PKEY_RSA,     EVP_PKEY_RSA_PSS,
     EVP_PKEY_OP_TYPE_SIG,                          EVP_PKEY_CTRL_RSA_PSS_SALTLEN,
     "rsa_pss_saltlen",                                                                                          NULL,
     OSSL_PKEY_PARAM_RSA_PSS_SALTLEN,                                                                                                                                         OSSL_PARAM_UTF8_STRING,
     fix_rsa_pss_saltlen                                                                                                                                                                                                            },
    {OSSL_ACTION_GET,
     EVP_PKEY_RSA,     EVP_PKEY_RSA_PSS,
     EVP_PKEY_OP_TYPE_SIG,                          EVP_PKEY_CTRL_GET_RSA_PSS_SALTLEN,
     NULL,                                                                                                       NULL,
     OSSL_PKEY_PARAM_RSA_PSS_SALTLEN,                                                                                                                                         OSSL_PARAM_UTF8_STRING,
     fix_rsa_pss_saltlen                                                                                                                                                                                                            },
    ...
    {OSSL_ACTION_SET,
     EVP_PKEY_RSA,     0,
     EVP_PKEY_OP_TYPE_CRYPT,                        EVP_PKEY_CTRL_RSA_OAEP_MD,
     "rsa_oaep_md",                                                                                              NULL,
     OSSL_ASYM_CIPHER_PARAM_OAEP_DIGEST,                                                                                                                                      OSSL_PARAM_UTF8_STRING,
     fix_md                                                                                                                                                                                                                         },
    {OSSL_ACTION_GET,
     EVP_PKEY_RSA,     0,
     EVP_PKEY_OP_TYPE_CRYPT,                        EVP_PKEY_CTRL_GET_RSA_OAEP_MD,
     NULL,                                                                                                       NULL,
     OSSL_ASYM_CIPHER_PARAM_OAEP_DIGEST,                                                                                                                                      OSSL_PARAM_UTF8_STRING,
     fix_md                                                                                                                                                                                                                         },
    /*
    ...
    {OSSL_ACTION_SET,
     ...
     NULL,                                                                                                       "rsa_oaep_label",
     OSSL_ASYM_CIPHER_PARAM_OAEP_LABEL,                                                                                                                                       OSSL_PARAM_OCTET_STRING,
     NULL                                                                                                                                                                                                                           },
    {OSSL_ACTION_GET,
     EVP_PKEY_RSA,     0,
     EVP_PKEY_OP_TYPE_CRYPT,                        EVP_PKEY_CTRL_GET_RSA_OAEP_LABEL,
     NULL,                                                                                                       NULL,
     OSSL_ASYM_CIPHER_PARAM_OAEP_LABEL,                                                                                                                                       OSSL_PARAM_OCTET_PTR,
     NULL                                                                                                                                                                                                                           },

    {OSSL_ACTION_SET,
     EVP_PKEY_RSA,     0,
     EVP_PKEY_OP_TYPE_CRYPT,                        EVP_PKEY_CTRL_RSA_IMPLICIT_REJECTION,
     NULL,                                                                                                       "rsa_pkcs1_implicit_rejection",
     OSSL_ASYM_CIPHER_PARAM_IMPLICIT_REJECTION,                                                                                                                               OSSL_PARAM_UNSIGNED_INTEGER,
     NULL                                                                                                                                                                                                                           },

    {OSSL_ACTION_SET,
     EVP_PKEY_RSA_PSS, 0,
     EVP_PKEY_OP_TYPE_GEN,                          EVP_PKEY_CTRL_MD,
     "rsa_pss_keygen_md",                                                                                        NULL,
     OSSL_ALG_PARAM_DIGEST,                                                                                                                                                   OSSL_PARAM_UTF8_STRING,
     fix_md                                                                                                                                                                                                                         },
    {OSSL_ACTION_SET,
     EVP_PKEY_RSA_PSS, 0,
     EVP_PKEY_OP_TYPE_GEN,                          EVP_PKEY_CTRL_RSA_MGF1_MD,
     "rsa_pss_keygen_mgf1_md",                                                                                   NULL,
     OSSL_PKEY_PARAM_MGF1_DIGEST,                                                                                                                                             OSSL_PARAM_UTF8_STRING,
     fix_md                                                                                                                                                                                                                         },
    {OSSL_ACTION_SET,
     EVP_PKEY_RSA_PSS, 0,
     EVP_PKEY_OP_TYPE_GEN,                          EVP_PKEY_CTRL_RSA_PSS_SALTLEN,
     "rsa_pss_keygen_saltlen",                                                                                   NULL,
     OSSL_SIGNATURE_PARAM_PSS_SALTLEN,                                                                                                                                        OSSL_PARAM_INTEGER,
     NULL                                                                                                                                                                                                                           },
    {OSSL_ACTION_SET,
     EVP_PKEY_RSA,     EVP_PKEY_RSA_PSS,
     EVP_PKEY_OP_KEYGEN,                            EVP_PKEY_CTRL_RSA_KEYGEN_BITS,
     "rsa_keygen_bits",                                                                                          NULL,
     OSSL_PKEY_PARAM_RSA_BITS,                                                                                                                                                OSSL_PARAM_UNSIGNED_INTEGER,
     NULL                                                                                                                                                                                                                           },
    {OSSL_ACTION_SET,
     EVP_PKEY_RSA,     EVP_PKEY_RSA_PSS,
     EVP_PKEY_OP_KEYGEN,                            EVP_PKEY_CTRL_RSA_KEYGEN_PUBEXP,
     "rsa_keygen_pubexp",                                                                                        NULL,
     OSSL_PKEY_PARAM_RSA_E,                                                                                                                                                   OSSL_PARAM_UNSIGNED_INTEGER,
     NULL                                                                                                                                                                                                                           },
    {OSSL_ACTION_SET,
     EVP_PKEY_RSA,     EVP_PKEY_RSA_PSS,
     EVP_PKEY_OP_KEYGEN,                            EVP_PKEY_CTRL_RSA_KEYGEN_PRIMES,
     "rsa_keygen_primes",                                                                                        NULL,
     OSSL_PKEY_PARAM_RSA_PRIMES,                                                                                                                                              OSSL_PARAM_UNSIGNED_INTEGER,
     NULL                                                                                                                                                                                                                           },
    ...
    {OSSL_ACTION_SET,
     -1,
     -1,
     EVP_PKEY_OP_TYPE_SIG,                          EVP_PKEY_CTRL_SET_DIGEST_SIZE,
     "digestsize",                                                                                               NULL,
     OSSL_MAC_PARAM_SIZE,                                                                                                                                                     OSSL_PARAM_UNSIGNED_INTEGER,
     NULL                                                                                                                                                                                                                           },
    ...
    {OSSL_ACTION_SET,
     -1,
     -1,
     EVP_PKEY_OP_DERIVE,                            EVP_PKEY_CTRL_TLS_SECRET,
     "secret",                                                                                                   "hexsecret",
     OSSL_KDF_PARAM_SECRET,                                                                                                                                                   OSSL_PARAM_OCTET_STRING,
     NULL                                                                                                                                                                                                                           },
    {OSSL_ACTION_SET,
     -1,
     -1,
     EVP_PKEY_OP_DERIVE,                            EVP_PKEY_CTRL_TLS_SEED,
     "seed",                                                                                                     "hexseed",
    ...
    {OSSL_ACTION_SET,
     -1,
     -1,
     EVP_PKEY_OP_DERIVE,                            EVP_PKEY_CTRL_HKDF_SALT,
     "salt",                                                                                                     "hexsalt",
    ...
    {OSSL_ACTION_SET,
     -1,
     -1,
     EVP_PKEY_OP_DERIVE,                            EVP_PKEY_CTRL_HKDF_KEY,
     "key",                                                                                                      "hexkey",
    ...
    {OSSL_ACTION_SET,
     -1,
     -1,
     EVP_PKEY_OP_DERIVE,                            EVP_PKEY_CTRL_HKDF_INFO,
     "info",                                                                                                     "hexinfo",
    ...
    {OSSL_ACTION_SET,
     -1,
     -1,
     EVP_PKEY_OP_DERIVE,                            EVP_PKEY_CTRL_HKDF_MODE,
     "mode",                                                                                                     NULL,
     OSSL_KDF_PARAM_MODE,                                                                                                                                                     OSSL_PARAM_INTEGER,
     fix_hkdf_mode                                                                                                                                                                                                                  },
    ...
    {OSSL_ACTION_SET,
     -1,
     -1,
     EVP_PKEY_OP_DERIVE,                            EVP_PKEY_CTRL_SCRYPT_SALT,
     "salt",                                                                                                     "hexsalt",
     OSSL_KDF_PARAM_SALT,                                                                                                                                                     OSSL_PARAM_OCTET_STRING,
     NULL                                                                                                                                                                                                                           },
    {OSSL_ACTION_SET,
     ...
     "N",                                                                                                        NULL,
     OSSL_KDF_PARAM_SCRYPT_N,                                                                                                                                                 OSSL_PARAM_UNSIGNED_INTEGER,
     NULL                                                                                                                                                                                                                           },
    {OSSL_ACTION_SET,
     -1,
     -1,
     ...
     "r",                                                                                                        NULL,
     OSSL_KDF_PARAM_SCRYPT_R,                                                                                                                                                 OSSL_PARAM_UNSIGNED_INTEGER,
     NULL                                                                                                                                                                                                                           },
    {OSSL_ACTION_SET,
     -1,
     -1,
     ...
     "p",                                                                                                        NULL,
     OSSL_KDF_PARAM_SCRYPT_P,                                                                                                                                                 OSSL_PARAM_UNSIGNED_INTEGER,
     NULL                                                                                                                                                                                                                           },
    {OSSL_ACTION_SET,
     -1,
     -1,
     EVP_PKEY_OP_DERIVE,                            EVP_PKEY_CTRL_SCRYPT_MAXMEM_BYTES,
     "maxmem_bytes",                                                                                             NULL,
     OSSL_KDF_PARAM_SCRYPT_MAXMEM,                                                                                                                                            OSSL_PARAM_UNSIGNED_INTEGER,
     NULL                                                                                                                                                                                                                           },

    {OSSL_ACTION_SET,
     -1,
     -1,
     EVP_PKEY_OP_KEYGEN | EVP_PKEY_OP_TYPE_CRYPT,
     EVP_PKEY_CTRL_CIPHER,                                                                  NULL,
     NULL,                                                                                                                                       OSSL_PKEY_PARAM_CIPHER,
     OSSL_PARAM_UTF8_STRING,                                                                                                                                                                               fix_cipher               },
    {OSSL_ACTION_SET,
     -1,
     -1,
     EVP_PKEY_OP_KEYGEN,                            EVP_PKEY_CTRL_SET_MAC_KEY,
     "key",                                                                                                      "hexkey",
     OSSL_PKEY_PARAM_PRIV_KEY,                                                                                                                                                OSSL_PARAM_OCTET_STRING,
     NULL                                                                                                                                                                                                                           },
    ...
    {OSSL_ACTION_SET,
     ...
     NULL,                                                                                                       NULL,
     OSSL_SIGNATURE_PARAM_DIGEST,                                                                                                                                             OSSL_PARAM_UTF8_STRING,
     fix_md                                                                                                                                                                                                                         },
    {OSSL_ACTION_GET,
     -1,
     -1,
     EVP_PKEY_OP_TYPE_SIG,                          EVP_PKEY_CTRL_GET_MD,
     NULL,                                                                                                       NULL,
     OSSL_SIGNATURE_PARAM_DIGEST,                                                                                                                                             OSSL_PARAM_UTF8_STRING,
     fix_md                                                                                                                                                                                                                         },
...
static const struct translation_st evp_pkey_translations[] = {
    ...
    {OSSL_ACTION_GET,
     ...
     -1,
     0,                              NULL,
     NULL,                                       OSSL_PKEY_PARAM_RSA_FACTOR1,
    ...
    {OSSL_ACTION_GET,
     ...
     -1,
     0,                              NULL,
     NULL,                                       OSSL_PKEY_PARAM_RSA_FACTOR2,
    ...
    {OSSL_ACTION_GET,
     ...
     -1,
     0,                              NULL,
     NULL,                                       OSSL_PKEY_PARAM_RSA_FACTOR3,
    ...
    {OSSL_ACTION_GET,
     ...
     -1,
     0,                              NULL,
     NULL,                                       OSSL_PKEY_PARAM_RSA_FACTOR4,
    ...
    {OSSL_ACTION_GET,
     ...
     -1,
     0,                              NULL,
     NULL,                                       OSSL_PKEY_PARAM_RSA_FACTOR5,
    ...
    {OSSL_ACTION_GET,
     ...
     -1,
     0,                              NULL,
     NULL,                                       OSSL_PKEY_PARAM_RSA_FACTOR6,
    ...
    {OSSL_ACTION_GET,
     ...
     -1,
     0,                              NULL,
     NULL,                                       OSSL_PKEY_PARAM_RSA_FACTOR7,
    ...
    {OSSL_ACTION_GET,
     ...
     -1,
     0,                              NULL,
     NULL,                                       OSSL_PKEY_PARAM_RSA_FACTOR8,
    ...
    {OSSL_ACTION_GET,
     ...
     -1,
     0,                              NULL,
     NULL,                                       OSSL_PKEY_PARAM_RSA_FACTOR9,
    ...
    {OSSL_ACTION_GET,
     ...
     -1,
     0,                              NULL,
     NULL,                                       OSSL_PKEY_PARAM_RSA_FACTOR10,
    ...
    {OSSL_ACTION_GET,
     ...
     -1,
     0,                              NULL,
     NULL,                                       OSSL_PKEY_PARAM_RSA_EXPONENT1,
    ...
    {OSSL_ACTION_GET,
     ...
     -1,
     0,                              NULL,
     NULL,                                       OSSL_PKEY_PARAM_RSA_EXPONENT2,
    ...
    {OSSL_ACTION_GET,
     ...
     -1,
     0,                              NULL,
     NULL,                                       OSSL_PKEY_PARAM_RSA_EXPONENT3,
    ...
    {OSSL_ACTION_GET,
     ...
     -1,
     0,                              NULL,
     NULL,                                       OSSL_PKEY_PARAM_RSA_EXPONENT4,
    ...
    {OSSL_ACTION_GET,
     ...
     -1,
     0,                              NULL,
     NULL,                                       OSSL_PKEY_PARAM_RSA_EXPONENT5,
    ...
    {OSSL_ACTION_GET,
     ...
     -1,
     0,                              NULL,
     NULL,                                       OSSL_PKEY_PARAM_RSA_EXPONENT6,
    ...
    {OSSL_ACTION_GET,
     ...
     -1,
     0,                              NULL,
     NULL,                                       OSSL_PKEY_PARAM_RSA_EXPONENT7,
    ...
    {OSSL_ACTION_GET,
     ...
     -1,
     0,                              NULL,
     NULL,                                       OSSL_PKEY_PARAM_RSA_EXPONENT8,
    ...
    {OSSL_ACTION_GET,
     ...
     -1,
     0,                              NULL,
     NULL,                                       OSSL_PKEY_PARAM_RSA_EXPONENT9,
    ...
    {OSSL_ACTION_GET,
     ...
     -1,
     0,                              NULL,
     NULL,                                       OSSL_PKEY_PARAM_RSA_EXPONENT10,
    ...
    {OSSL_ACTION_GET,
     ...
     -1,
     0,                              NULL,
     NULL,                                       OSSL_PKEY_PARAM_RSA_COEFFICIENT1,
    ...
    {OSSL_ACTION_GET,
     ...
     -1,
     0,                              NULL,
     NULL,                                       OSSL_PKEY_PARAM_RSA_COEFFICIENT2,
    ...
    {OSSL_ACTION_GET,
     ...
     -1,
     0,                              NULL,
     NULL,                                       OSSL_PKEY_PARAM_RSA_COEFFICIENT3,
    ...
    {OSSL_ACTION_GET,
     ...
     -1,
     0,                              NULL,
     NULL,                                       OSSL_PKEY_PARAM_RSA_COEFFICIENT4,
    ...
    {OSSL_ACTION_GET,
     ...
     -1,
     0,                              NULL,
     NULL,                                       OSSL_PKEY_PARAM_RSA_COEFFICIENT5,
    ...
    {OSSL_ACTION_GET,
     ...
     -1,
     0,                              NULL,
     NULL,                                       OSSL_PKEY_PARAM_RSA_COEFFICIENT6,
    ...
    {OSSL_ACTION_GET,
     ...
     -1,
     0,                              NULL,
     NULL,                                       OSSL_PKEY_PARAM_RSA_COEFFICIENT7,
    ...
    {OSSL_ACTION_GET,
     ...
     -1,
     0,                              NULL,
     NULL,                                       OSSL_PKEY_PARAM_RSA_COEFFICIENT8,
    ...
    {OSSL_ACTION_GET,
     ...
     -1,
     0,                              NULL,
     NULL,                                       OSSL_PKEY_PARAM_RSA_COEFFICIENT9,
    ...
    {OSSL_ACTION_GET,
     ...
     -1,
     0,                              NULL,
     NULL,                                       OSSL_PKEY_PARAM_EC_DECODED_FROM_EXPLICIT_PARAMS,
