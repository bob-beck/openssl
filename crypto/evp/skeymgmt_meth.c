...
static void* skeymgmt_new(void) {
  ...
  if ((skeymgmt = OPENSSL_zalloc(sizeof(*skeymgmt))) == NULL) return NULL;
...
static void* skeymgmt_from_algorithm(int name_id, const OSSL_ALGORITHM* algodef,
  ...
  if ((skeymgmt = skeymgmt_new()) == NULL) return NULL;
...
void EVP_SKEYMGMT_do_all_provided(OSSL_LIB_CTX* libctx,
                                  ...
                                  void* arg) {
  evp_generic_do_all(libctx, OSSL_OP_SKEYMGMT, (void (*)(void*, void*))fn, arg,
