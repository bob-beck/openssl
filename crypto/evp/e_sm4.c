...
static int sm4_init_key(EVP_CIPHER_CTX* ctx,
...
static int sm4_cbc_cipher(EVP_CIPHER_CTX* ctx,
                          unsigned char* out,
...
static int sm4_cfb_cipher(EVP_CIPHER_CTX* ctx,
                          unsigned char* out,
                          const unsigned char* in,
                          size_t len) {
  EVP_SM4_KEY* dat = EVP_C_DATA(EVP_SM4_KEY, ctx);
...
static int sm4_ecb_cipher(EVP_CIPHER_CTX* ctx,
                          unsigned char* out,
                          const unsigned char* in,
                          size_t len) {
...
static int sm4_ofb_cipher(EVP_CIPHER_CTX* ctx,
                          unsigned char* out,
                          const unsigned char* in,
                          size_t len) {
  EVP_SM4_KEY* dat = EVP_C_DATA(EVP_SM4_KEY, ctx);
...
static int sm4_ctr_cipher(EVP_CIPHER_CTX* ctx,
                          unsigned char* out,
                          const unsigned char* in,
                          size_t len) {
