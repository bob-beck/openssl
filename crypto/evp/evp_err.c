...
static const ERR_STRING_DATA EVP_str_reasons[] = {
  ...
  { ERR_PACK (ERR_LIB_EVP, 0, EVP_R_BAD_ALGORITHM_NAME),
    "bad algorithm name" },
  ...
  { ERR_PACK (ERR_LIB_EVP, 0, EVP_R_GET_RAW_KEY_FAILED),
    "get raw key failed" },
  ...
  { ERR_PACK (ERR_LIB_EVP, 0, EVP_R_INVALID_KEY_LENGTH),
    "invalid key length" },
  ...
  { ERR_PACK (ERR_LIB_EVP, 0, EVP_R_MISSING_PARAMETERS),
    "missing parameters" },
  ...
  { ERR_PACK (ERR_LIB_EVP, 0, EVP_R_NO_IMPORT_FUNCTION),
    "no import function" },
  { ERR_PACK (ERR_LIB_EVP, 0, EVP_R_NO_KEYMGMT_AVAILABLE),
    "no keymgmt available" },
  { ERR_PACK (ERR_LIB_EVP, 0, EVP_R_NO_KEYMGMT_PRESENT),
    "no keymgmt present" },
  ...
  { ERR_PACK (ERR_LIB_EVP, 0, EVP_R_PUBLIC_KEY_NOT_RSA),
    "public key not rsa" },
  { ERR_PACK (ERR_LIB_EVP, 0, EVP_R_SETTING_XOF_FAILED),
    "setting xof failed" },
  ...
  { ERR_PACK (ERR_LIB_EVP, 0, EVP_R_UNSUPPORTED_CIPHER),
    "unsupported cipher" },
...
int
ossl_err_load_EVP_strings (void)
{
#ifndef OPENSSL_NO_ERR
