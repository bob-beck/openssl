...
static int
put_evp_method_in_store (void *store, void *method, const OSSL_PROVIDER *prov,
 ...
 */
static void *
construct_evp_method (const OSSL_ALGORITHM *algodef, OSSL_PROVIDER *prov,
                      void *data)
{
  /*
...
void *
evp_generic_fetch (OSSL_LIB_CTX *libctx, int operation_id, const char *name,
...
int
evp_set_default_properties_int (OSSL_LIB_CTX *libctx, const char *propq,
                                int loadconfig, int mirrored)
{
...
static int
evp_default_properties_merge (OSSL_LIB_CTX *libctx, const char *propq,
                              int loadconfig)
{
  OSSL_PROPERTY_LIST **plp = ossl_ctx_global_properties (libctx, loadconfig);
...
int
evp_default_properties_enable_fips_int (OSSL_LIB_CTX *libctx, int enable,
                                        int loadconfig)
{
...
evp_generic_do_all (OSSL_LIB_CTX *libctx, int operation_id,
                    void (*user_fn) (void *method, void *arg), void *user_arg,
                    void *(*new_method) (int name_id,
                                         const OSSL_ALGORITHM *algodef,
                                         OSSL_PROVIDER *prov),
                    int (*up_ref_method) (void *),
...
int
evp_is_a (OSSL_PROVIDER *prov, int number, const char *legacy_name,
          const char *name)
{
  /*
...
int
evp_names_do_all (OSSL_PROVIDER *prov, int number,
