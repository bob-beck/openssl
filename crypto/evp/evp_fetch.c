...
static void* get_evp_method_from_store(void* store,
...
static int put_evp_method_in_store(void* store,
                                   void* method,
                                   const OSSL_PROVIDER* prov,
                                   const char* names,
                                   const char* propdef,
...
void* evp_generic_fetch(OSSL_LIB_CTX* libctx,
                        int operation_id,
                        const char* name,
...
static int evp_default_properties_merge(OSSL_LIB_CTX* libctx,
                                        const char* propq,
                                        int loadconfig) {
  OSSL_PROPERTY_LIST** plp = ossl_ctx_global_properties(libctx, loadconfig);
