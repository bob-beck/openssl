...
static int
evp_pkey_asym_cipher_init (EVP_PKEY_CTX *ctx, int operation,
...
static void *
evp_asym_cipher_from_algorithm (int name_id, const OSSL_ALGORITHM *algodef,
                                OSSL_PROVIDER *prov)
{
...
EVP_ASYM_CIPHER *
EVP_ASYM_CIPHER_fetch (OSSL_LIB_CTX *ctx, const char *algorithm,
...
EVP_ASYM_CIPHER *
evp_asym_cipher_fetch_from_prov (OSSL_PROVIDER *prov, const char *algorithm,
                                 const char *properties)
{
