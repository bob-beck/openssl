...
#define BLOCK_CIPHER_custom(nid, keylen, blocksize, ivlen, mode, MODE, flags)                                          \
    static const EVP_CIPHER aesni_##keylen##_##mode = {                                                                \
        nid##_##keylen##_##mode,                                                                                       \
        blocksize,                                                                                                     \
        (EVP_CIPH_##MODE##_MODE == EVP_CIPH_XTS_MODE || EVP_CIPH_##MODE##_MODE == EVP_CIPH_SIV_MODE ? 2 : 1) *         \
            keylen / 8,                                                                                                \
        ivlen,                                                                                                         \
        flags | EVP_CIPH_##MODE##_MODE,                                                                                \
        EVP_ORIG_GLOBAL,                                                                                               \
...
#define BLOCK_CIPHER_generic(nid, keylen, blocksize, ivlen, nmode, mode, MODE, flags)                                  \
    static const EVP_CIPHER aes_t4_##keylen##_##mode = {nid##_##keylen##_##nmode,                                      \
                                                        blocksize,                                                     \
                                                        keylen / 8,                                                    \
                                                        ivlen,                                                         \
                                                        flags | EVP_CIPH_##MODE##_MODE,                                \
...
static int s390x_aes_gcm_tls_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t len)
{
    ...
    if (EVP_CIPHER_CTX_ctrl(ctx, enc ? EVP_CTRL_GCM_IV_GEN : EVP_CTRL_GCM_SET_IV_INV, EVP_GCM_TLS_EXPLICIT_IV_LEN,
                            out) <= 0)
        goto err;
...
#define BLOCK_CIPHER_generic(nid, keylen, blocksize, ivlen, nmode, mode, MODE, flags)                                  \
    static const EVP_CIPHER s390x_aes_##keylen##_##mode = {nid##_##keylen##_##nmode,                                   \
                                                           blocksize,                                                  \
                                                           keylen / 8,                                                 \
                                                           ivlen,                                                      \
                                                           flags | EVP_CIPH_##MODE##_MODE,                             \
...
#define CUSTOM_FLAGS                                                                                                   \
    (EVP_CIPH_FLAG_DEFAULT_ASN1 | EVP_CIPH_CUSTOM_IV | EVP_CIPH_FLAG_CUSTOM_CIPHER | EVP_CIPH_ALWAYS_CALL_INIT |       \
...
#define XTS_FLAGS                                                                                                      \
    (EVP_CIPH_FLAG_DEFAULT_ASN1 | EVP_CIPH_CUSTOM_IV | EVP_CIPH_ALWAYS_CALL_INIT | EVP_CIPH_CTRL_INIT |                \
...
#define WRAP_FLAGS                                                                                                     \
    (EVP_CIPH_WRAP_MODE | EVP_CIPH_CUSTOM_IV | EVP_CIPH_FLAG_CUSTOM_CIPHER | EVP_CIPH_ALWAYS_CALL_INIT |               \
