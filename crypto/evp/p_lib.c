...
static int pkey_set_type(EVP_PKEY* pkey,
                         ENGINE* e,
                         int type,
                         const char* str,
                         int len,
 ...
 */
static int evp_pkey_cmp_any(const EVP_PKEY* a,
                            const EVP_PKEY* b,
                            int selection) {
#ifdef FIPS_MODULE
...
static int print_set_indent(BIO** out,
                            int* pop_f_prefix,
                            long* saved_indent,
                            long indent) {
  *pop_f_prefix = 0;
...
static int legacy_asn1_ctrl_to_param(EVP_PKEY* pkey,
                                     int op,
                                     int arg1,
                                     void* arg2) {
  if (pkey->keymgmt == NULL)
