...
static int
cmll_t4_init_key (EVP_CIPHER_CTX *ctx, const unsigned char *key,
                  const unsigned char *iv, int enc)
{
  int ret, mode, bits;
...
static int
camellia_cbc_cipher (EVP_CIPHER_CTX *ctx, unsigned char *out,
                     const unsigned char *in, size_t len)
{
  EVP_CAMELLIA_KEY *dat = EVP_C_DATA (EVP_CAMELLIA_KEY, ctx);
...
static int
camellia_ecb_cipher (EVP_CIPHER_CTX *ctx, unsigned char *out,
                     const unsigned char *in, size_t len)
{
...
static int
camellia_ofb_cipher (EVP_CIPHER_CTX *ctx, unsigned char *out,
                     const unsigned char *in, size_t len)
{
  EVP_CAMELLIA_KEY *dat = EVP_C_DATA (EVP_CAMELLIA_KEY, ctx);
...
static int
camellia_cfb_cipher (EVP_CIPHER_CTX *ctx, unsigned char *out,
                     const unsigned char *in, size_t len)
{
  EVP_CAMELLIA_KEY *dat = EVP_C_DATA (EVP_CAMELLIA_KEY, ctx);
...
static int
camellia_cfb8_cipher (EVP_CIPHER_CTX *ctx, unsigned char *out,
                      const unsigned char *in, size_t len)
{
  EVP_CAMELLIA_KEY *dat = EVP_C_DATA (EVP_CAMELLIA_KEY, ctx);
...
static int
camellia_cfb1_cipher (EVP_CIPHER_CTX *ctx, unsigned char *out,
                      const unsigned char *in, size_t len)
{
  EVP_CAMELLIA_KEY *dat = EVP_C_DATA (EVP_CAMELLIA_KEY, ctx);
...
static int
camellia_ctr_cipher (EVP_CIPHER_CTX *ctx, unsigned char *out,
                     const unsigned char *in, size_t len)
{
