...
#ifndef FIPS_MODULE
EVP_MD_CTX *
evp_md_ctx_new_ex (EVP_PKEY *pkey, const ASN1_OCTET_STRING *id,
...
static int
evp_md_init_internal (EVP_MD_CTX *ctx, const EVP_MD *type,
...
int
EVP_DigestInit_ex2 (EVP_MD_CTX *ctx, const EVP_MD *type,
...
static void *
evp_md_from_algorithm (int name_id, const OSSL_ALGORITHM *algodef,
                       OSSL_PROVIDER *prov)
{
...
EVP_MD *
evp_digest_fetch_from_prov (OSSL_PROVIDER *prov, const char *algorithm,
