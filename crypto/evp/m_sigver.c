...
do_sigver_init (EVP_MD_CTX *ctx, EVP_PKEY_CTX **pctx, const EVP_MD *type,
                const char *mdname, OSSL_LIB_CTX *libctx, const char *props,
                ENGINE *e, EVP_PKEY *pkey, int ver, const OSSL_PARAM params[])
{
...
int
EVP_DigestSignInit_ex (EVP_MD_CTX *ctx, EVP_PKEY_CTX **pctx,
...
int
EVP_DigestVerifyInit_ex (EVP_MD_CTX *ctx, EVP_PKEY_CTX **pctx,
                         const char *mdname, OSSL_LIB_CTX *libctx,
                         const char *props, EVP_PKEY *pkey,
                         const OSSL_PARAM params[])
{
...
int
EVP_DigestVerifyFinal (EVP_MD_CTX *ctx, const unsigned char *sig,
                       size_t siglen)
{
  EVP_SIGNATURE *signature;
  const char *desc;
