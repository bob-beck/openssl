...
static int
evp_cipher_init_internal (EVP_CIPHER_CTX *ctx, const EVP_CIPHER *cipher,
 ...
 */
static int
evp_cipher_init_skey_internal (EVP_CIPHER_CTX *ctx, const EVP_CIPHER *cipher,
...
int
EVP_CipherPipelineEncryptInit (EVP_CIPHER_CTX *ctx, const EVP_CIPHER *cipher,
...
int
EVP_CipherPipelineDecryptInit (EVP_CIPHER_CTX *ctx, const EVP_CIPHER *cipher,
                               const unsigned char *key, size_t keylen,
                               size_t numpipes, const unsigned char **iv,
                               size_t ivlen)
{
...
int
EVP_CipherPipelineUpdate (EVP_CIPHER_CTX *ctx, unsigned char **out,
...
int
EVP_CipherPipelineFinal (EVP_CIPHER_CTX *ctx, unsigned char **out,
                         size_t *outl, const size_t *outsize)
{
  size_t i;
...
int
EVP_EncryptInit_ex (EVP_CIPHER_CTX *ctx, const EVP_CIPHER *cipher,
                    ENGINE *impl, const unsigned char *key,
...
int
EVP_EncryptInit_ex2 (EVP_CIPHER_CTX *ctx, const EVP_CIPHER *cipher,
                     const unsigned char *key, const unsigned char *iv,
                     const OSSL_PARAM params[])
{
...
int
EVP_DecryptInit_ex2 (EVP_CIPHER_CTX *ctx, const EVP_CIPHER *cipher,
                     const unsigned char *key, const unsigned char *iv,
                     const OSSL_PARAM params[])
{
...
static int
evp_EncryptDecryptUpdate (EVP_CIPHER_CTX *ctx, unsigned char *out, int *outl,
                          const unsigned char *in, int inl)
{
  int i, j, bl, cmpl = inl;
...
static void *
evp_cipher_from_algorithm (const int name_id, const OSSL_ALGORITHM *algodef,
                           OSSL_PROVIDER *prov)
{
...
EVP_CIPHER *
EVP_CIPHER_fetch (OSSL_LIB_CTX *ctx, const char *algorithm,
...
EVP_CIPHER *
evp_cipher_fetch_from_prov (OSSL_PROVIDER *prov, const char *algorithm,
                            const char *properties)
{
...
EVP_CIPHER_do_all_provided (OSSL_LIB_CTX *libctx,
                            void (*fn) (EVP_CIPHER *mac, void *arg), void *arg)
{
