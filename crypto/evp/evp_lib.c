...
int
evp_cipher_param_to_asn1_ex (EVP_CIPHER_CTX *c, ASN1_TYPE *type,
...
int
evp_cipher_asn1_to_param_ex (EVP_CIPHER_CTX *c, ASN1_TYPE *type,
                             evp_cipher_aead_asn1_params *asn1_params)
{
  int ret = -1; /* Assume the worst */
  const EVP_CIPHER *cipher;
...
int
evp_cipher_get_asn1_aead_params (EVP_CIPHER_CTX *c, ASN1_TYPE *type,
                                 evp_cipher_aead_asn1_params *asn1_params)
{
  int i = 0;
  long tl;
...
int
evp_cipher_set_asn1_aead_params (EVP_CIPHER_CTX *c, ASN1_TYPE *type,
                                 evp_cipher_aead_asn1_params *asn1_params)
{
  if (type == NULL || asn1_params == NULL)
    return 0;
 ...
 */
static EVP_PKEY *
evp_pkey_keygen (OSSL_LIB_CTX *libctx, const char *name, const char *propq,
