...
int ossl_ec_GFp_simple_point_set_affine_coordinates (
    const EC_GROUP *, EC_POINT *, const BIGNUM *x, const BIGNUM *y, BN_CTX *);
...
int ossl_ec_GFp_mont_field_inv (const EC_GROUP *, BIGNUM *r, const BIGNUM *a,
                                BN_CTX *);
int ossl_ec_GFp_mont_field_encode (const EC_GROUP *, BIGNUM *r,
                                   const BIGNUM *a, BN_CTX *);
int ossl_ec_GFp_mont_field_decode (const EC_GROUP *, BIGNUM *r,
                                   const BIGNUM *a, BN_CTX *);
...
int ossl_ec_GF2m_simple_group_set_curve (EC_GROUP *, const BIGNUM *p,
                                         const BIGNUM *a, const BIGNUM *b,
                                         BN_CTX *);
int ossl_ec_GF2m_simple_group_get_curve (const EC_GROUP *, BIGNUM *p,
...
int ossl_ec_GF2m_simple_points_make_affine (const EC_GROUP *, size_t num,
                                            EC_POINT *[], BN_CTX *);
int ossl_ec_GF2m_simple_field_mul (const EC_GROUP *, BIGNUM *r,
                                   const BIGNUM *a, const BIGNUM *b, BN_CTX *);
int ossl_ec_GF2m_simple_field_sqr (const EC_GROUP *, BIGNUM *r,
                                   const BIGNUM *a, BN_CTX *);
int ossl_ec_GF2m_simple_field_div (const EC_GROUP *, BIGNUM *r,
                                   const BIGNUM *a, const BIGNUM *b, BN_CTX *);
...
int ossl_ecdsa_verify_sig (const unsigned char *dgst, int dgst_len,
                           const ECDSA_SIG *sig, EC_KEY *eckey);
int ossl_ecdsa_simple_sign_setup (EC_KEY *eckey, BN_CTX *ctx_in,
 ...
 * implementation (i.e., the default implementation is based on EC_POINT_add
 * and EC_POINT_dbl, which of course are not constant time themselves) or the
...
static ossl_inline int
ec_point_ladder_pre (const EC_GROUP *group, EC_POINT *r, EC_POINT *s,
                     EC_POINT *p, BN_CTX *ctx)
{
...
static ossl_inline int
ec_point_ladder_step (const EC_GROUP *group, EC_POINT *r, EC_POINT *s,
                      EC_POINT *p, BN_CTX *ctx)
{
...
static ossl_inline int
ec_point_ladder_post (const EC_GROUP *group, EC_POINT *r, EC_POINT *s,
                      EC_POINT *p, BN_CTX *ctx)
{
