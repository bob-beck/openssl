...
struct ec_method_st {
  ...
  int (*add)(const EC_GROUP*, EC_POINT* r, const EC_POINT* a, const EC_POINT* b,
             BN_CTX*);
   ...
   * operations:
   */
  int (*field_mul)(const EC_GROUP*, BIGNUM* r, const BIGNUM* a, const BIGNUM* b,
                   BN_CTX*);
  int (*field_sqr)(const EC_GROUP*, BIGNUM* r, const BIGNUM* a, BN_CTX*);
  int (*field_div)(const EC_GROUP*, BIGNUM* r, const BIGNUM* a, const BIGNUM* b,
                   BN_CTX*);
  /*-
...
int ossl_ec_GF2m_simple_point_set_affine_coordinates(const EC_GROUP*, EC_POINT*,
                                                     const BIGNUM* x,
                                                     const BIGNUM* y, BN_CTX*);
...
static ossl_inline int ec_point_ladder_pre(const EC_GROUP* group, EC_POINT* r,
  ...
  if (!EC_POINT_copy(s, p) || !EC_POINT_dbl(group, r, s, ctx)) return 0;
