...
int ossl_ec_GFp_simple_group_set_curve(EC_GROUP*,
                                       const BIGNUM* p,
                                       const BIGNUM* a,
                                       const BIGNUM* b,
                                       BN_CTX*);
int ossl_ec_GFp_simple_group_get_curve(const EC_GROUP*,
                                       BIGNUM* p,
                                       BIGNUM* a,
                                       BIGNUM* b,
                                       BN_CTX*);
...
int ossl_ec_GFp_simple_point_get_affine_coordinates(const EC_GROUP*,
                                                    ...
                                                    BIGNUM* y,
                                                    BN_CTX*);
int ossl_ec_GFp_simple_set_compressed_coordinates(const EC_GROUP*,
                                                  EC_POINT*,
                                                  const BIGNUM* x,
                                                  int y_bit,
                                                  BN_CTX*);
size_t ossl_ec_GFp_simple_point2oct(const EC_GROUP*,
                                    const EC_POINT*,
                                    point_conversion_form_t form,
                                    unsigned char* buf,
                                    size_t len,
...
int ossl_ec_GFp_simple_oct2point(const EC_GROUP*,
                                 ...
                                 size_t len,
                                 BN_CTX*);
int ossl_ec_GFp_simple_add(const EC_GROUP*,
                           EC_POINT* r,
                           const EC_POINT* a,
                           const EC_POINT* b,
                           BN_CTX*);
int ossl_ec_GFp_simple_dbl(const EC_GROUP*,
                           EC_POINT* r,
                           const EC_POINT* a,
                           BN_CTX*);
...
int ossl_ec_GFp_simple_cmp(const EC_GROUP*,
                           const EC_POINT* a,
                           const EC_POINT* b,
                           BN_CTX*);
int ossl_ec_GFp_simple_make_affine(const EC_GROUP*, EC_POINT*, BN_CTX*);
int ossl_ec_GFp_simple_points_make_affine(const EC_GROUP*,
                                          size_t num,
                                          EC_POINT*[],
                                          BN_CTX*);
int ossl_ec_GFp_simple_field_mul(const EC_GROUP*,
                                 BIGNUM* r,
                                 const BIGNUM* a,
                                 const BIGNUM* b,
                                 BN_CTX*);
int ossl_ec_GFp_simple_field_sqr(const EC_GROUP*,
                                 BIGNUM* r,
                                 const BIGNUM* a,
                                 BN_CTX*);
int ossl_ec_GFp_simple_field_inv(const EC_GROUP*,
                                 BIGNUM* r,
                                 const BIGNUM* a,
                                 BN_CTX*);
int ossl_ec_GFp_simple_blind_coordinates(const EC_GROUP* group,
                                         EC_POINT* p,
                                         BN_CTX* ctx);
...
int ossl_ec_GFp_mont_group_set_curve(EC_GROUP*,
                                     const BIGNUM* p,
                                     const BIGNUM* a,
                                     const BIGNUM* b,
                                     BN_CTX*);
...
int ossl_ec_GFp_mont_field_mul(const EC_GROUP*,
                               BIGNUM* r,
                               const BIGNUM* a,
                               const BIGNUM* b,
                               BN_CTX*);
int ossl_ec_GFp_mont_field_sqr(const EC_GROUP*,
                               BIGNUM* r,
                               const BIGNUM* a,
                               BN_CTX*);
int ossl_ec_GFp_mont_field_inv(const EC_GROUP*,
                               BIGNUM* r,
                               const BIGNUM* a,
                               BN_CTX*);
int ossl_ec_GFp_mont_field_encode(const EC_GROUP*,
                                  BIGNUM* r,
                                  const BIGNUM* a,
                                  BN_CTX*);
int ossl_ec_GFp_mont_field_decode(const EC_GROUP*,
                                  BIGNUM* r,
                                  const BIGNUM* a,
                                  BN_CTX*);
...
int ossl_ec_GFp_nist_group_set_curve(EC_GROUP*,
                                     const BIGNUM* p,
                                     const BIGNUM* a,
                                     const BIGNUM* b,
                                     BN_CTX*);
int ossl_ec_GFp_nist_field_mul(const EC_GROUP*,
                               BIGNUM* r,
                               const BIGNUM* a,
                               const BIGNUM* b,
                               BN_CTX*);
int ossl_ec_GFp_nist_field_sqr(const EC_GROUP*,
                               BIGNUM* r,
                               const BIGNUM* a,
                               BN_CTX*);
...
int ossl_ec_GF2m_simple_group_set_curve(EC_GROUP*,
                                        const BIGNUM* p,
                                        const BIGNUM* a,
                                        const BIGNUM* b,
                                        BN_CTX*);
int ossl_ec_GF2m_simple_group_get_curve(const EC_GROUP*,
                                        BIGNUM* p,
                                        BIGNUM* a,
                                        BIGNUM* b,
                                        BN_CTX*);
...
int ossl_ec_GF2m_simple_point_get_affine_coordinates(const EC_GROUP*,
                                                     ...
                                                     BIGNUM* y,
                                                     BN_CTX*);
int ossl_ec_GF2m_simple_set_compressed_coordinates(const EC_GROUP*,
                                                   EC_POINT*,
                                                   const BIGNUM* x,
                                                   int y_bit,
                                                   BN_CTX*);
size_t ossl_ec_GF2m_simple_point2oct(const EC_GROUP*,
                                     const EC_POINT*,
                                     point_conversion_form_t form,
                                     unsigned char* buf,
                                     size_t len,
...
int ossl_ec_GF2m_simple_oct2point(const EC_GROUP*,
                                  ...
                                  size_t len,
                                  BN_CTX*);
int ossl_ec_GF2m_simple_add(const EC_GROUP*,
                            EC_POINT* r,
                            const EC_POINT* a,
                            const EC_POINT* b,
                            BN_CTX*);
int ossl_ec_GF2m_simple_dbl(const EC_GROUP*,
                            EC_POINT* r,
                            const EC_POINT* a,
                            BN_CTX*);
...
int ossl_ec_GF2m_simple_cmp(const EC_GROUP*,
                            const EC_POINT* a,
                            const EC_POINT* b,
                            BN_CTX*);
...
int ossl_ec_GF2m_simple_points_make_affine(const EC_GROUP*,
                                           ...
                                           EC_POINT*[],
                                           BN_CTX*);
int ossl_ec_GF2m_simple_field_mul(const EC_GROUP*,
                                  BIGNUM* r,
                                  const BIGNUM* a,
                                  const BIGNUM* b,
                                  BN_CTX*);
int ossl_ec_GF2m_simple_field_sqr(const EC_GROUP*,
                                  BIGNUM* r,
                                  const BIGNUM* a,
                                  BN_CTX*);
int ossl_ec_GF2m_simple_field_div(const EC_GROUP*,
                                  BIGNUM* r,
                                  const BIGNUM* a,
                                  const BIGNUM* b,
                                  BN_CTX*);
...
int ossl_ec_GFp_nistp224_point_get_affine_coordinates(const EC_GROUP* group,
                                                      ...
                                                      BIGNUM* y,
                                                      BN_CTX* ctx);
int ossl_ec_GFp_nistp224_mul(const EC_GROUP* group,
                             EC_POINT* r,
                             const BIGNUM* scalar,
                             size_t num,
                             const EC_POINT* points[],
...
int ossl_ec_GFp_nistp256_point_get_affine_coordinates(const EC_GROUP* group,
                                                      ...
                                                      BIGNUM* y,
                                                      BN_CTX* ctx);
int ossl_ec_GFp_nistp256_mul(const EC_GROUP* group,
                             EC_POINT* r,
                             const BIGNUM* scalar,
                             size_t num,
                             const EC_POINT* points[],
...
int ossl_ec_GFp_nistp384_point_get_affine_coordinates(const EC_GROUP* group,
                                                      ...
                                                      BIGNUM* y,
                                                      BN_CTX* ctx);
int ossl_ec_GFp_nistp384_mul(const EC_GROUP* group,
                             EC_POINT* r,
                             const BIGNUM* scalar,
                             size_t num,
                             const EC_POINT* points[],
...
int ossl_ec_GFp_nistp521_point_get_affine_coordinates(const EC_GROUP* group,
                                                      ...
                                                      BIGNUM* y,
                                                      BN_CTX* ctx);
int ossl_ec_GFp_nistp521_mul(const EC_GROUP* group,
                             EC_POINT* r,
                             const BIGNUM* scalar,
                             size_t num,
                             const EC_POINT* points[],
 ...
 */
EC_GROUP* ossl_ec_group_new_ex(OSSL_LIB_CTX* libctx,
                               const char* propq,
                               const EC_METHOD* meth);
...
size_t ossl_ec_key_simple_priv2oct(const EC_KEY* eckey,
                                   unsigned char* buf,
                                   size_t len);
int ossl_ec_key_simple_oct2priv(EC_KEY* eckey,
                                const unsigned char* buf,
                                size_t len);
...
EC_KEY* ossl_ec_key_new_method_int(OSSL_LIB_CTX* libctx,
                                   const char* propq,
                                   ENGINE* engine);

int ossl_ec_key_gen(EC_KEY* eckey);
int ossl_ecdh_compute_key(unsigned char** pout,
                          size_t* poutlen,
                          const EC_POINT* pub_key,
                          const EC_KEY* ecdh);
int ossl_ecdh_simple_compute_key(unsigned char** pout,
                                 size_t* poutlen,
                                 const EC_POINT* pub_key,
                                 const EC_KEY* ecdh);
...
int ossl_ecdsa_sign_setup(EC_KEY* eckey,
                          BN_CTX* ctx_in,
                          BIGNUM** kinvp,
                          BIGNUM** rp);
int ossl_ecdsa_sign(int type,
                    ...
                    const BIGNUM* r,
                    EC_KEY* eckey);
ECDSA_SIG* ossl_ecdsa_sign_sig(const unsigned char* dgst,
                               int dgst_len,
                               const BIGNUM* in_kinv,
                               const BIGNUM* in_r,
                               EC_KEY* eckey);
int ossl_ecdsa_verify(int type,
                      ...
                      int sig_len,
                      EC_KEY* eckey);
int ossl_ecdsa_verify_sig(const unsigned char* dgst,
                          int dgst_len,
                          const ECDSA_SIG* sig,
                          EC_KEY* eckey);
int ossl_ecdsa_simple_sign_setup(EC_KEY* eckey,
                                 BN_CTX* ctx_in,
                                 BIGNUM** kinvp,
                                 BIGNUM** rp);
ECDSA_SIG* ossl_ecdsa_simple_sign_sig(const unsigned char* dgst,
                                      ...
                                      const BIGNUM* in_r,
                                      EC_KEY* eckey);
int ossl_ecdsa_simple_verify_sig(const unsigned char* dgst,
                                 int dgst_len,
                                 const ECDSA_SIG* sig,
                                 EC_KEY* eckey);
...
int ossl_ec_point_blind_coordinates(const EC_GROUP* group,
                                    EC_POINT* p,
                                    BN_CTX* ctx);
