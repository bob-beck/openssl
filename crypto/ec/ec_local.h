...
struct ec_method_st {
    ...
    ECDSA_SIG *(
        *ecdsa_sign_sig)(const unsigned char *dgst, int dgstlen, const BIGNUM *kinv, const BIGNUM *r, EC_KEY *eckey);
...
struct ec_group_st {
     ...
     * macros, below.
     */
    enum { PCT_none, PCT_nistp224, PCT_nistp256, PCT_nistp384, PCT_nistp521, PCT_nistz256, PCT_ec } pre_comp_type;
