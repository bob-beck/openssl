...
static int
ec_group_explicit_todata (const EC_GROUP *group, OSSL_PARAM_BLD *tmpl,
...
int
ossl_ec_group_todata (const EC_GROUP *group, OSSL_PARAM_BLD *tmpl,
 ...
 */
int
ossl_ec_key_fromdata (EC_KEY *ec, const OSSL_PARAM params[],
                      int include_private)
{
                                   ...
                                   OSSL_LIB_CTX *libctx, const char *propq)
{
  ...
  if (ptype == V_ASN1_SEQUENCE)
  ...
  else if (ptype == V_ASN1_OBJECT)
    {
      ...
      group
          = EC_GROUP_new_by_curve_name_ex (libctx, propq, OBJ_obj2nid (poid));
      if (group == NULL)
        goto ecerr;
...
EC_KEY *
ossl_ec_key_from_pkcs8 (const PKCS8_PRIV_KEY_INFO *p8inf, OSSL_LIB_CTX *libctx,
                        const char *propq)
{
