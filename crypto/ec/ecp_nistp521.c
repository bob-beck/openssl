...
/*
 * A 64-bit implementation of the NIST P-521 elliptic curve point
 * multiplication
 *
...
int
ossl_ec_GFp_nistp521_group_set_curve (EC_GROUP *group, const BIGNUM *p,
 ...
 */
int
ossl_ec_GFp_nistp521_points_mul (const EC_GROUP *group, EC_POINT *r,
