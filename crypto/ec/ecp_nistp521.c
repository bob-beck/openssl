 ...
 */
static void
felem_square_ref(largefelem out, const felem in)
{
  felem inx2, inx4;
 ...
 */
static void
felem_mul_ref(largefelem out, const felem in1, const felem in2)
{
  felem in2x2;
...
static void
felem_square_wrapper(largefelem out, const felem in);
static void
felem_mul_wrapper(largefelem out, const felem in1, const felem in2);

static void (*felem_square_p)(largefelem out,
                              const felem in) = felem_square_wrapper;
static void (*felem_mul_p)(largefelem out,
                           const felem in1,
                           const felem in2) = felem_mul_wrapper;

void
p521_felem_square(largefelem out, const felem in);
void
p521_felem_mul(largefelem out, const felem in1, const felem in2);
...
NISTP521_PRE_COMP*
EC_nistp521_pre_comp_dup(NISTP521_PRE_COMP* p)
{
  int i;
  if (p != NULL)
...
void
EC_nistp521_pre_comp_free(NISTP521_PRE_COMP* p)
{
  int i;
