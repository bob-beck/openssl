 ...
 */
int
ossl_ec_GF2m_simple_group_init (EC_GROUP *group)
{
  group->field = BN_new ();
  group->a = BN_new ();
  group->b = BN_new ();
 ...
 */
void
ossl_ec_GF2m_simple_group_finish (EC_GROUP *group)
{
  BN_free (group->field);
  BN_free (group->a);
  BN_free (group->b);
 ...
 */
void
ossl_ec_GF2m_simple_group_clear_finish (EC_GROUP *group)
{
 ...
 */
int
ossl_ec_GF2m_simple_group_copy (EC_GROUP *dest, const EC_GROUP *src)
{
...
int
ossl_ec_GF2m_simple_group_set_curve (EC_GROUP *group, const BIGNUM *p,
 ...
 */
int
ossl_ec_GF2m_simple_group_get_curve (const EC_GROUP *group, BIGNUM *p,
 ...
 */
int
ossl_ec_GF2m_simple_group_get_degree (const EC_GROUP *group)
{
 ...
 */
int
ossl_ec_GF2m_simple_group_check_discriminant (const EC_GROUP *group,
                                              BN_CTX *ctx)
{
  int ret = 0;
  BIGNUM *b;
...
/* Frees an EC_POINT. */
void
ossl_ec_GF2m_simple_point_finish (EC_POINT *point)
{
  BN_free (point->X);
  BN_free (point->Y);
  BN_free (point->Z);
...
void
ossl_ec_GF2m_simple_point_clear_finish (EC_POINT *point)
{
 ...
 */
int
ossl_ec_GF2m_simple_point_copy (EC_POINT *dest, const EC_POINT *src)
{
 ...
 */
int
ossl_ec_GF2m_simple_point_set_to_infinity (const EC_GROUP *group,
                                           EC_POINT *point)
{
  point->Z_is_one = 0;
  BN_zero (point->Z);
 ...
 */
int
ossl_ec_GF2m_simple_point_set_affine_coordinates (const EC_GROUP *group,
                                                  EC_POINT *point,
                                                  const BIGNUM *x,
 ...
 */
int
ossl_ec_GF2m_simple_point_get_affine_coordinates (const EC_GROUP *group,
 ...
 */
int
ossl_ec_GF2m_simple_add (const EC_GROUP *group, EC_POINT *r, const EC_POINT *a,
 ...
 */
int
ossl_ec_GF2m_simple_dbl (const EC_GROUP *group, EC_POINT *r, const EC_POINT *a,
                         BN_CTX *ctx)
{
...
int
ossl_ec_GF2m_simple_invert (const EC_GROUP *group, EC_POINT *point,
                            BN_CTX *ctx)
{
...
int
ossl_ec_GF2m_simple_is_at_infinity (const EC_GROUP *group,
                                    const EC_POINT *point)
{
...
/*-
 * Determines whether the given EC_POINT is an actual point on the curve
 * defined in the EC_GROUP.  A point is valid if it satisfies the Weierstrass
 * equation: y^2 + x*y = x^3 + a*x^2 + b.
 */
int
ossl_ec_GF2m_simple_is_on_curve (const EC_GROUP *group, const EC_POINT *point,
                                 BN_CTX *ctx)
{
  int ret = -1;
  BIGNUM *lh, *y2;
 ...
 */
int
ossl_ec_GF2m_simple_cmp (const EC_GROUP *group, const EC_POINT *a,
                         const EC_POINT *b, BN_CTX *ctx)
{
  BIGNUM *aX, *aY, *bX, *bY;
  int ret = -1;
...
int
ossl_ec_GF2m_simple_make_affine (const EC_GROUP *group, EC_POINT *point,
                                 BN_CTX *ctx)
{
  BIGNUM *x, *y;
  int ret = 0;
 ...
 */
int
ossl_ec_GF2m_simple_points_make_affine (const EC_GROUP *group, size_t num,
...
int
ossl_ec_GF2m_simple_field_mul (const EC_GROUP *group, BIGNUM *r,
...
int
ossl_ec_GF2m_simple_field_sqr (const EC_GROUP *group, BIGNUM *r,
...
int
ossl_ec_GF2m_simple_field_div (const EC_GROUP *group, BIGNUM *r,
                               const BIGNUM *a, const BIGNUM *b, BN_CTX *ctx)
{
 ...
 */
static int
ec_GF2m_simple_ladder_pre (const EC_GROUP *group, EC_POINT *r, EC_POINT *s,
 ...
 */
static int
ec_GF2m_simple_ladder_step (const EC_GROUP *group, EC_POINT *r, EC_POINT *s,
                            EC_POINT *p, BN_CTX *ctx)
{
 ...
 */
static int
ec_GF2m_simple_ladder_post (const EC_GROUP *group, EC_POINT *r, EC_POINT *s,
                            EC_POINT *p, BN_CTX *ctx)
{
  int ret = 0;
...
static int
ec_GF2m_simple_points_mul (const EC_GROUP *group, EC_POINT *r,
...
/*-
 * Computes the multiplicative inverse of a in GF(2^m), storing the result in
 * r. If a is zero (or equivalent), you'll get an EC_R_CANNOT_INVERT error. SCA
 * hardening is with blinding: BN_GF2m_mod_inv does that.
 */
static int
ec_GF2m_simple_field_inv (const EC_GROUP *group, BIGNUM *r, const BIGNUM *a,
                          BN_CTX *ctx)
{
  int ret;
