 ...
 */
int ossl_ec_GF2m_simple_group_get_curve(const EC_GROUP* group,
                                        BIGNUM* p,
                                        BIGNUM* a,
                                        BIGNUM* b,
                                        BN_CTX* ctx) {
 ...
 */
int ossl_ec_GF2m_simple_add(const EC_GROUP* group,
                            EC_POINT* r,
                            const EC_POINT* a,
                            const EC_POINT* b,
                            BN_CTX* ctx) {
 ...
 */
int ossl_ec_GF2m_simple_dbl(const EC_GROUP* group,
                            EC_POINT* r,
                            const EC_POINT* a,
                            BN_CTX* ctx) {
...
int ossl_ec_GF2m_simple_invert(const EC_GROUP* group,
                               EC_POINT* point,
                               BN_CTX* ctx) {
 ...
 *   1   not equal
 */
int ossl_ec_GF2m_simple_cmp(const EC_GROUP* group,
                            const EC_POINT* a,
                            const EC_POINT* b,
                            BN_CTX* ctx) {
  BIGNUM *aX, *aY, *bX, *bY;
...
int ossl_ec_GF2m_simple_make_affine(const EC_GROUP* group,
                                    EC_POINT* point,
                                    BN_CTX* ctx) {
  BIGNUM *x, *y;
  int ret = 0;
 ...
 */
int ossl_ec_GF2m_simple_points_make_affine(const EC_GROUP* group,
                                           size_t num,
                                           EC_POINT* points[],
                                           BN_CTX* ctx) {
  size_t i;
...
int ossl_ec_GF2m_simple_field_mul(const EC_GROUP* group,
                                  BIGNUM* r,
                                  const BIGNUM* a,
                                  const BIGNUM* b,
                                  BN_CTX* ctx) {
...
int ossl_ec_GF2m_simple_field_sqr(const EC_GROUP* group,
                                  BIGNUM* r,
                                  const BIGNUM* a,
                                  BN_CTX* ctx) {
...
int ossl_ec_GF2m_simple_field_div(const EC_GROUP* group,
                                  BIGNUM* r,
                                  const BIGNUM* a,
                                  const BIGNUM* b,
                                  BN_CTX* ctx) {
...
static int ec_GF2m_simple_points_mul(const EC_GROUP* group,
                                     EC_POINT* r,
                                     const BIGNUM* scalar,
                                     size_t num,
 ...
 */
static int ec_GF2m_simple_field_inv(const EC_GROUP* group,
                                    BIGNUM* r,
                                    const BIGNUM* a,
                                    BN_CTX* ctx) {
  int ret;
