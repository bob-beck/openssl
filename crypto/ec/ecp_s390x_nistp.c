...
static int
ec_GFp_s390x_nistp_mul (const EC_GROUP *group, EC_POINT *r,
...
static ECDSA_SIG *
ecdsa_s390x_nistp_sign_sig (const unsigned char *dgst, int dgstlen,
...
static int
ecdsa_s390x_nistp_verify_sig (const unsigned char *dgst, int dgstlen,
