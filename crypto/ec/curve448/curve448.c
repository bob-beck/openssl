...
static const curve448_scalar_t precomputed_scalarmul_adjustment = {
  { { SC_LIMB(0xc873d6d54a7bb0cfULL),
      SC_LIMB(0xe933d8d723a70aadULL),
      SC_LIMB(0xbb124b65129c96fdULL),
...
static ossl_inline void
constant_time_lookup_niels(niels_s* RESTRICT ni,
                           const niels_t* table,
                           int nelts,
                           int idx)
{
                            ...
                            const uint8_t scalar[X_PRIVATE_BYTES])
{
  ...
  ossl_curve448_precomputed_scalarmul(
    p, ossl_curve448_precomputed_base, the_scalar);
                                               ...
                                               const curve448_scalar_t scalar2)
{
  ...
  if (i > control_pre[0].power) {
    ...
    pniels_to_pt(combo, precmp_var[control_var[0].addend >> 1]);
    add_niels_to_pt(
      combo, ossl_curve448_wnaf_base[control_pre[0].addend >> 1], i);
    contv++;
    contp++;
  } else {
