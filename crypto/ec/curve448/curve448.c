...
static void
point_double_internal (curve448_point_t p, const curve448_point_t q,
                       int before_double)
{
  gf a, b, c, d;
...
void
ossl_curve448_point_double (curve448_point_t p, const curve448_point_t q)
{
...
cond_neg_niels (niels_t n, mask_t neg)
{
...
static void
pt_to_pniels (pniels_t b, const curve448_point_t a)
{
...
static void
pniels_to_pt (curve448_point_t e, const pniels_t d)
{
  gf eu;
...
static void
niels_to_pt (curve448_point_t e, const niels_t n)
{
  gf_add (e->y, n->b, n->a);
  gf_sub (e->x, n->b, n->a);
...
c448_bool_t
ossl_curve448_point_eq (const curve448_point_t p, const curve448_point_t q)
{
  mask_t succ;
  gf a, b;
...
static ossl_inline void
constant_time_lookup_niels (niels_s *RESTRICT ni, const niels_t *table,
                            int nelts, int idx)
{
...
c448_error_t
ossl_x448_int (uint8_t out[X_PUBLIC_BYTES], const uint8_t base[X_PUBLIC_BYTES],
...
void
ossl_x448_derive_public_key (uint8_t out[X_PUBLIC_BYTES],
                             const uint8_t scalar[X_PRIVATE_BYTES])
{
  /* Scalar conditioning */
...
static int
recode_wnaf (struct smvt_control *control,
...
static void
prepare_wnaf_table (pniels_t *output, const curve448_point_t working,
                    unsigned int tbits)
{
