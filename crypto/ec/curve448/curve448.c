...
static void point_double_internal(curve448_point_t p,
...
static void add_niels_to_pt(curve448_point_t d,
                            const niels_t e,
                            int before_double) {
  gf a, b, c;
...
static void sub_niels_from_pt(curve448_point_t d,
                              const niels_t e,
                              int before_double) {
  gf a, b, c;
...
static void add_pniels_to_pt(curve448_point_t p,
                             const pniels_t pn,
                             int before_double) {
  gf L0;
...
static void sub_pniels_from_pt(curve448_point_t p,
                               const pniels_t pn,
                               int before_double) {
  gf L0;
...
int ossl_x448(uint8_t out_shared_key[56],
