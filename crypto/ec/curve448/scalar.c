 ...
 */
static void
sc_subx (curve448_scalar_t out, const c448_word_t accum[C448_SCALAR_LIMBS],
...
static void
sc_montmul (curve448_scalar_t out, const curve448_scalar_t a,
...
void
ossl_curve448_scalar_mul (curve448_scalar_t out, const curve448_scalar_t a,
                          const curve448_scalar_t b)
{
  sc_montmul (out, a, b);
...
scalar_decode_short (curve448_scalar_t s, const unsigned char *ser,
                     size_t nbytes)
{
  size_t i, j, k = 0;
