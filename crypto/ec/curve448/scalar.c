...
static const curve448_scalar_t sc_p = { { { SC_LIMB(0x2378c292ab5844f3ULL),
                               ...
                               sc_r2 = { { {
                                 ...
                                 SC_LIMB(0xe3539257049b9b60ULL),
                                 SC_LIMB(0x7af32c4bc1b195d9ULL),
                                 SC_LIMB(0x0d66de2388ea1859ULL),
                                 SC_LIMB(0xae17cf725ee4d838ULL),
                                 SC_LIMB(0x1a9cc14ba3c47c44ULL),
...
static void
sc_montmul(curve448_scalar_t out,
...
scalar_decode_short(curve448_scalar_t s,
                            ...
                            const unsigned char ser[C448_SCALAR_BYTES])
{
  ...
  ossl_curve448_scalar_mul(
    s, s, ossl_curve448_scalar_one); /* ham-handed reduce */
