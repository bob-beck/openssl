...
static c448_error_t
oneshot_hash (OSSL_LIB_CTX *ctx, uint8_t *out, size_t outlen,
              const uint8_t *in, size_t inlen, const char *propq)
{
...
static c448_error_t
hash_init_with_dom (OSSL_LIB_CTX *ctx, EVP_MD_CTX *hashctx, uint8_t prehashed,
...
int
ossl_ed448_verify (OSSL_LIB_CTX *ctx, const uint8_t *message,
