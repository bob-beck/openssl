...
void
ossl_gf_mul(gf_s* RESTRICT cs, const gf as, const gf bs)
{
...
void
ossl_gf_mulw_unsigned(gf_s* RESTRICT cs, const gf as, uint32_t b)
{
...
void
ossl_gf_sqr(gf_s* RESTRICT cs, const gf as)
{
  const uint64_t* a = as->limb;
  uint64_t* c = cs->limb;
  uint128_t accum0 = 0, accum1 = 0, accum2;
