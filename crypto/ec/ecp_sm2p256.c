...
static void
ecp_sm2p256_point_add_affine (P256_POINT *R, const P256_POINT *P,
 ...
 */
static void
ecp_sm2p256_point_P_mul_by_scalar (P256_POINT *R, const BN_ULONG *k,
                                   P256_POINT_AFFINE P)
{
  int i, init = 0;
 ...
 */
static int
ecp_sm2p256_get_affine (const EC_GROUP *group, const EC_POINT *point,
...
static int
ecp_sm2p256_windowed_mul (const EC_GROUP *group, P256_POINT *r,
...
static int
ecp_sm2p256_points_mul (const EC_GROUP *group, EC_POINT *r,
...
static int
ecp_sm2p256_field_mul (const EC_GROUP *group, BIGNUM *r, const BIGNUM *a,
...
static int
ecp_sm2p256_field_sqr (const EC_GROUP *group, BIGNUM *r, const BIGNUM *a,
                       BN_CTX *ctx)
{
  ALIGN32 BN_ULONG a_fe[P256_LIMBS] = { 0 };
  ALIGN32 BN_ULONG r_fe[P256_LIMBS] = { 0 };
...
static int
ecp_sm2p256_inv_mod_ord (const EC_GROUP *group, BIGNUM *r, const BIGNUM *x,
                         BN_CTX *ctx)
{
  int ret = 0;
