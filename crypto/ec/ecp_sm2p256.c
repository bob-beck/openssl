...
/* Right shift: a >> 1 */
void
bn_rshift1(BN_ULONG* a);
/* Sub: r = a - b */
void
bn_sub(BN_ULONG* r, const BN_ULONG* a, const BN_ULONG* b);
/* Modular div by 2: r = a / 2 mod p */
void
ecp_sm2p256_div_by_2(BN_ULONG* r, const BN_ULONG* a);
/* Modular div by 2: r = a / 2 mod n, where n = ord(p) */
void
ecp_sm2p256_div_by_2_mod_ord(BN_ULONG* r, const BN_ULONG* a);
/* Modular add: r = a + b mod p */
void
ecp_sm2p256_add(BN_ULONG* r, const BN_ULONG* a, const BN_ULONG* b);
/* Modular sub: r = a - b mod p */
void
ecp_sm2p256_sub(BN_ULONG* r, const BN_ULONG* a, const BN_ULONG* b);
/* Modular sub: r = a - b mod n, where n = ord(p) */
void
ecp_sm2p256_sub_mod_ord(BN_ULONG* r, const BN_ULONG* a, const BN_ULONG* b);
/* Modular mul by 3: out = 3 * a mod p */
void
ecp_sm2p256_mul_by_3(BN_ULONG* r, const BN_ULONG* a);
/* Modular mul: r = a * b mod p */
void
ecp_sm2p256_mul(BN_ULONG* r, const BN_ULONG* a, const BN_ULONG* b);
/* Modular sqr: r = a ^ 2 mod p */
void
ecp_sm2p256_sqr(BN_ULONG* r, const BN_ULONG* a);

static ossl_inline BN_ULONG
is_zeros(const BN_ULONG* a)
{
  BN_ULONG res;
...
is_equal(const BN_ULONG* a, const BN_ULONG* b)
{
  BN_ULONG res;
...
static ossl_inline int
is_greater(const BN_ULONG* a, const BN_ULONG* b)
{
  int i;
...
ecp_sm2p256_mod_inverse(BN_ULONG* out, const BN_ULONG* in)
{
...
static ossl_inline void
ecp_sm2p256_mod_ord_inverse(BN_ULONG* out, const BN_ULONG* in)
{
  BN_MOD_INV(
    out, in, ecp_sm2p256_div_by_2_mod_ord, ecp_sm2p256_sub_mod_ord, def_ord);
}

/* Point double: R <- P + P */
static void
ecp_sm2p256_point_double(P256_POINT* R, const P256_POINT* P)
{
  unsigned int i;
...
static void
ecp_sm2p256_point_add_affine(P256_POINT* R,
                             const P256_POINT* P,
...
/* Point add: R <- P + Q */
static void
ecp_sm2p256_point_add(P256_POINT* R, const P256_POINT* P, const P256_POINT* Q)
{
  unsigned int i;
  ALIGN32 BN_ULONG tmp0[P256_LIMBS] = { 0 };
  ALIGN32 BN_ULONG tmp1[P256_LIMBS] = { 0 };
...
static void
ecp_sm2p256_point_G_mul_by_scalar(P256_POINT* R, const BN_ULONG* k)
{
 ...
 */
static void
ecp_sm2p256_point_P_mul_by_scalar(P256_POINT* R,
                                  const BN_ULONG* k,
                                  P256_POINT_AFFINE P)
{
  int i, init = 0;
...
/* Get affine point */
static void
ecp_sm2p256_point_get_affine(P256_POINT_AFFINE* R, const P256_POINT* P)
{
...
#if !defined(OPENSSL_NO_SM2_PRECOMP)
static int
ecp_sm2p256_is_affine_G(const EC_POINT* generator)
{
 ...
 */
static int
ecp_sm2p256_get_affine(const EC_GROUP* group,
...
static int
ecp_sm2p256_windowed_mul(const EC_GROUP* group,
                         P256_POINT* r,
                         const BIGNUM** scalar,
                         const EC_POINT** point,
                         size_t num,
...
static int
ecp_sm2p256_points_mul(const EC_GROUP* group,
                       EC_POINT* r,
                       const BIGNUM* scalar,
                       size_t num,
...
static int
ecp_sm2p256_field_mul(const EC_GROUP* group,
                      BIGNUM* r,
                      const BIGNUM* a,
                      const BIGNUM* b,
                      BN_CTX* ctx)
...
static int
ecp_sm2p256_field_sqr(const EC_GROUP* group,
                      BIGNUM* r,
                      const BIGNUM* a,
                      BN_CTX* ctx)
{
...
static int
ecp_sm2p256_inv_mod_ord(const EC_GROUP* group,
                        BIGNUM* r,
                        const BIGNUM* x,
                        BN_CTX* ctx)
{
