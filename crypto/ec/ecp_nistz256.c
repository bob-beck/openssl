...
void ecp_nistz256_scatter_w5 (P256_POINT *val, const P256_POINT *in_t,
                              int idx);
...
static void
ecp_nistz256_point_add (P256_POINT *r, const P256_POINT *a,
                        const P256_POINT *b)
{
...
static void
ecp_nistz256_point_add_affine (P256_POINT *r, const P256_POINT *a,
                               const P256_POINT_AFFINE *b)
{
  BN_ULONG U2[P256_LIMBS], S2[P256_LIMBS];
  BN_ULONG Z1sqr[P256_LIMBS];
...
/* r = in^-1 mod p */
static void
ecp_nistz256_mod_inverse (BN_ULONG r[P256_LIMBS],
                          const BN_ULONG in[P256_LIMBS])
{
  /*
...
static int
ecp_nistz256_inv_mod_ord (const EC_GROUP *group, BIGNUM *r, const BIGNUM *x,
                          BN_CTX *ctx)
{
