...
static int ecx_priv_decode_ex(EVP_PKEY* pkey,
...
static int ecx_key_print(BIO* bp,
                         const EVP_PKEY* pkey,
                         int indent,
                         ASN1_PCTX* ctx,
                         ecx_key_op_t op) {
...
static int ecx_priv_print(BIO* bp,
                          const EVP_PKEY* pkey,
                          int indent,
                          ASN1_PCTX* ctx) {
...
static int ecx_pub_print(BIO* bp,
                         const EVP_PKEY* pkey,
                         int indent,
                         ASN1_PCTX* ctx) {
...
static int ecx_set_priv_key(EVP_PKEY* pkey,
...
static int ecx_set_pub_key(EVP_PKEY* pkey,
...
static int ecx_get_priv_key(const EVP_PKEY* pkey,
                            unsigned char* priv,
                            size_t* len) {
...
static int ecx_get_pub_key(const EVP_PKEY* pkey,
                           unsigned char* pub,
                           size_t* len) {
  const ECX_KEY* key = pkey->pkey.ecx;
...
static int ecx_generic_import_from(const OSSL_PARAM params[],
                                   void* vpctx,
                                   int keytype) {
...
static int pkey_ecx_derive25519(EVP_PKEY_CTX* ctx,
                                unsigned char* key,
                                size_t* keylen) {
...
static int pkey_ecx_derive448(EVP_PKEY_CTX* ctx,
                              unsigned char* key,
                              size_t* keylen) {
  const unsigned char *privkey, *pubkey;
...
static int pkey_ecd_digestsign25519(EVP_MD_CTX* ctx,
                                    unsigned char* sig,
                                    size_t* siglen,
...
static int pkey_ecd_digestsign448(EVP_MD_CTX* ctx,
                                  unsigned char* sig,
                                  size_t* siglen,
                                  const unsigned char* tbs,
                                  size_t tbslen) {
...
static int s390x_pkey_ecx_derive25519(EVP_PKEY_CTX* ctx,
                                      unsigned char* key,
                                      size_t* keylen) {
  const unsigned char *privkey, *pubkey;
...
static int s390x_pkey_ecx_derive448(EVP_PKEY_CTX* ctx,
                                    unsigned char* key,
                                    size_t* keylen) {
  const unsigned char *privkey, *pubkey;
