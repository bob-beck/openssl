...
static int
ecx_priv_decode_ex (EVP_PKEY *pkey, const PKCS8_PRIV_KEY_INFO *p8,
...
static int
ecx_key_print (BIO *bp, const EVP_PKEY *pkey, int indent, ASN1_PCTX *ctx,
               ecx_key_op_t op)
{
  const ECX_KEY *ecxkey = pkey->pkey.ecx;
...
static int
ecx_pkey_export_to (const EVP_PKEY *from, void *to_keydata,
...
static int
ecd_item_verify (EVP_MD_CTX *ctx, const ASN1_ITEM *it, const void *asn,
                 const X509_ALGOR *sigalg, const ASN1_BIT_STRING *str,
                 EVP_PKEY *pkey)
{
...
static int
ecd_item_sign25519 (EVP_MD_CTX *ctx, const ASN1_ITEM *it, const void *asn,
...
static int
ecd_sig_info_set25519 (X509_SIG_INFO *siginf, const X509_ALGOR *alg,
...
static int
ecd_item_sign448 (EVP_MD_CTX *ctx, const ASN1_ITEM *it, const void *asn,
                  X509_ALGOR *alg1, X509_ALGOR *alg2, ASN1_BIT_STRING *str)
{
...
static int
ecd_sig_info_set448 (X509_SIG_INFO *siginf, const X509_ALGOR *alg,
                     const ASN1_STRING *sig)
{
...
static int
validate_ecx_derive (EVP_PKEY_CTX *ctx, unsigned char *key, size_t *keylen,
...
static int
pkey_ecd_digestsign25519 (EVP_MD_CTX *ctx, unsigned char *sig, size_t *siglen,
...
static int
pkey_ecd_digestsign448 (EVP_MD_CTX *ctx, unsigned char *sig, size_t *siglen,
                        const unsigned char *tbs, size_t tbslen)
{
  const ECX_KEY *edkey
      = evp_pkey_get_legacy (EVP_MD_CTX_get_pkey_ctx (ctx)->pkey);
...
static int
pkey_ecd_digestverify25519 (EVP_MD_CTX *ctx, const unsigned char *sig,
...
static int
pkey_ecd_digestverify448 (EVP_MD_CTX *ctx, const unsigned char *sig,
                          size_t siglen, const unsigned char *tbs,
                          size_t tbslen)
{
  const ECX_KEY *edkey
...
static int
s390x_pkey_ecx_derive25519 (EVP_PKEY_CTX *ctx, unsigned char *key,
                            size_t *keylen)
{
  const unsigned char *privkey, *pubkey;
...
static int
s390x_pkey_ecx_derive448 (EVP_PKEY_CTX *ctx, unsigned char *key,
                          size_t *keylen)
{
  const unsigned char *privkey, *pubkey;
...
static int
s390x_pkey_ecd_digestsign25519 (EVP_MD_CTX *ctx, unsigned char *sig,
                                size_t *siglen, const unsigned char *tbs,
                                size_t tbslen)
{
  union
...
static int
s390x_pkey_ecd_digestsign448 (EVP_MD_CTX *ctx, unsigned char *sig,
                              size_t *siglen, const unsigned char *tbs,
                              size_t tbslen)
{
  union
...
static int
s390x_pkey_ecd_digestverify25519 (EVP_MD_CTX *ctx, const unsigned char *sig,
                                  size_t siglen, const unsigned char *tbs,
                                  size_t tbslen)
{
  union
...
static int
s390x_pkey_ecd_digestverify448 (EVP_MD_CTX *ctx, const unsigned char *sig,
                                size_t siglen, const unsigned char *tbs,
                                size_t tbslen)
{
  union
