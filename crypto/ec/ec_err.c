...
static const ERR_STRING_DATA EC_str_reasons[] = {
  ...
  { ERR_PACK (ERR_LIB_EC, 0, EC_R_BIGNUM_OUT_OF_RANGE),
    "bignum out of range" },
  ...
  { ERR_PACK (ERR_LIB_EC, 0, EC_R_INVALID_DIGEST_TYPE),
    "invalid digest type" },
  ...
  { ERR_PACK (ERR_LIB_EC, 0, EC_R_INVALID_GROUP_ORDER),
    "invalid group order" },
  ...
  { ERR_PACK (ERR_LIB_EC, 0, EC_R_UNDEFINED_GENERATOR),
    "undefined generator" },
