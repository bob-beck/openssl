    ...
    ASN1_ADB(X9_62_CHARACTERISTIC_TWO) = {
        ...
        ADB_ENTRY(
            ...
            ASN1_SIMPLE(X9_62_CHARACTERISTIC_TWO,
                        p.ppBasis,
                        X9_62_PENTANOMIAL))} ASN1_ADB_END(X9_62_CHARACTERISTIC_TWO, 0, type, 0, &char_two_def_tt, NULL);
...
# else
                        {
                            ...
                            if (tmp == NID_X9_62_tpBasis) {
                                ...
                                if (!(char_two->m > penta->k3 && penta->k3 > penta->k2 && penta->k2 > penta->k1
                                      && penta->k1 > 0)) {
...
# endif
                        ...
                        if (params->order == NULL || params->base == NULL || params->base->data == NULL
                        ...
                        EC_GROUP_set_point_conversion_form(ret,
                                                           (point_conversion_form_t)(params->base->data[0] & ~0x01));
...
err:
                    ...
                    int i2d_ECPrivateKey(const EC_KEY *a, unsigned char **out)
                    {
                        ...
                        if (!(a->enc_flag & EC_PKEY_NO_PARAMETERS)) {
                            if ((priv_key->parameters = EC_GROUP_get_ecpkparameters(a->group, priv_key->parameters))
                                == NULL) {
                                ERR_raise(ERR_LIB_EC, ERR_R_EC_LIB);
                                goto err;
                            }
