 ...
 */
int
ossl_ec_GF2m_simple_set_compressed_coordinates (const EC_GROUP *group,
                                                EC_POINT *point,
 ...
 */
size_t
ossl_ec_GF2m_simple_point2oct (const EC_GROUP *group, const EC_POINT *point,
 ...
 */
int
ossl_ec_GF2m_simple_oct2point (const EC_GROUP *group, EC_POINT *point,
