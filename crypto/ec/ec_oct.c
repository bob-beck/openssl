...
int
EC_POINT_set_compressed_coordinates(const EC_GROUP* group,
                                    EC_POINT* point,
                                    const BIGNUM* x,
                                    int y_bit,
                                    BN_CTX* ctx)
{
  ...
  return group->meth->point_set_compressed_coordinates(
    group, point, x, y_bit, ctx);
}
...
int
EC_POINT_set_compressed_coordinates_GF2m(const EC_GROUP* group,
                                         EC_POINT* point,
                                         const BIGNUM* x,
                                         int y_bit,
                                         BN_CTX* ctx)
...
int
EC_POINT_oct2point(const EC_GROUP* group,
                   EC_POINT* point,
...
size_t
EC_POINT_point2buf(const EC_GROUP* group,
                   const EC_POINT* point,
                   point_conversion_form_t form,
                   unsigned char** pbuf,
                   BN_CTX* ctx)
