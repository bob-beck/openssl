...
int
ossl_ecdsa_sign_setup (EC_KEY *eckey, BN_CTX *ctx_in, BIGNUM **kinvp,
                       BIGNUM **rp)
{
...
int
ossl_ecdsa_sign (int type, const unsigned char *dgst, int dlen,
...
int
ossl_ecdsa_deterministic_sign (const unsigned char *dgst, int dlen,
...
ecdsa_sign_setup (EC_KEY *eckey, BN_CTX *ctx_in, BIGNUM **kinvp, BIGNUM **rp,
                  const unsigned char *dgst, int dlen, unsigned int nonce_type,
                  const char *digestname, OSSL_LIB_CTX *libctx,
                  const char *propq)
{
  BN_CTX *ctx = NULL;
...
int
ossl_ecdsa_simple_sign_setup (EC_KEY *eckey, BN_CTX *ctx_in, BIGNUM **kinvp,
                              BIGNUM **rp)
{
...
ECDSA_SIG *
ossl_ecdsa_simple_sign_sig (const unsigned char *dgst, int dgst_len,
...
int
ossl_ecdsa_simple_verify_sig (const unsigned char *dgst, int dgst_len,
                              const ECDSA_SIG *sig, EC_KEY *eckey)
{
  int ret = -1, i;
  BN_CTX *ctx;
