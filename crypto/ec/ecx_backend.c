...
int
ossl_ecx_key_fromdata (ECX_KEY *ecx, const OSSL_PARAM *param_pub_key,
...
#ifndef FIPS_MODULE
ECX_KEY *
ossl_ecx_key_op (const X509_ALGOR *palg, const unsigned char *p, int plen,
                 int id, ecx_key_op_t op, OSSL_LIB_CTX *libctx,
                 const char *propq)
{
  ECX_KEY *key = NULL;
