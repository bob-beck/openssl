...
static ossl_inline void felem_mul_reduce_ref(felem out,
                                             const felem in1,
                                             const felem in2) {
  widefelem tmp;
 ...
 */
static void point_double(felem x_out,
                         felem y_out,
                         felem z_out,
                         const felem x_in,
                         const felem y_in,
 ...
 */
static void select_point(const limb idx,
                         unsigned int size,
...
static void make_points_affine(size_t num,
                               felem points[][3],
                               felem tmp_felems[]) {
  /*
