...
int
ossl_ec_GFp_nist_group_set_curve (EC_GROUP *group, const BIGNUM *p,
...
int
ossl_ec_GFp_nist_field_mul (const EC_GROUP *group, BIGNUM *r, const BIGNUM *a,
...
int
ossl_ec_GFp_nist_field_sqr (const EC_GROUP *group, BIGNUM *r, const BIGNUM *a,
                            BN_CTX *ctx)
{
  int ret = 0;
  BN_CTX *ctx_new = NULL;
