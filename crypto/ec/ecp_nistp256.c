 ...
 */
static void
smallfelem_mul (longfelem out, const smallfelem small1,
...
static void
smallfelem_mul_contract (smallfelem out, const smallfelem in1,
...
point_add (felem x3, felem y3, felem z3, const felem x1, const felem y1,
           const felem z1, const int mixed, const smallfelem x2,
 ...
 */
static void
point_add_small (smallfelem x3, smallfelem y3, smallfelem z3, smallfelem x1,
                 smallfelem y1, smallfelem z1, smallfelem x2, smallfelem y2,
                 smallfelem z2)
{
 ...
 */
static void
select_point (const u64 idx, unsigned int size,
...
batch_mul (felem x_out, felem y_out, felem z_out,
           ...
           const u8 *g_scalar, const int mixed,
...
int
ossl_ec_GFp_nistp256_group_set_curve (EC_GROUP *group, const BIGNUM *p,
...
static void
make_points_affine (size_t num, smallfelem points[][3],
 ...
 */
int
ossl_ec_GFp_nistp256_points_mul (const EC_GROUP *group, EC_POINT *r,
