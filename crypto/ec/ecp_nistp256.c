...
static const u64 kPrime[4] = { 0xfffffffffffffffful,
                               0xffffffff,
                               0,
...
/* zero107 is 0 mod p */
static const felem zero107 = { two107m43m11,
                               two107,
                               two107m43p11,
                               two107m43p11 };
...
static void
smallfelem_mul_contract(smallfelem out,
 ...
 */
static void
point_double_small(smallfelem x_out,
                   smallfelem y_out,
                   smallfelem z_out,
                   ...
                   const smallfelem z_in)
{
  ...
  point_double(
    felem_x_out, felem_y_out, felem_z_out, felem_x_in, felem_y_in, felem_z_in);
                ...
                smallfelem z2)
{
  ...
  point_add(
    felem_x3, felem_y3, felem_z3, felem_x1, felem_y1, felem_z1, 0, x2, y2, z2);
...
NISTP256_PRE_COMP*
EC_nistp256_pre_comp_dup(NISTP256_PRE_COMP* p)
{
  int i;
  if (p != NULL)
...
void
EC_nistp256_pre_comp_free(NISTP256_PRE_COMP* pre)
{
  int i;
                                ...
                                BN_CTX* ctx)
{
  ...
  if (num_points > 0) {
    ...
    if (mixed)
      tmp_smallfelems =
        OPENSSL_malloc_array(num_points * 17 + 1, sizeof(*tmp_smallfelems));
