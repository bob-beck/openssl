...
int ossl_ec_GFp_simple_group_get_curve(const EC_GROUP* group,
                                       BIGNUM* p,
                                       BIGNUM* a,
                                       BIGNUM* b,
                                       BN_CTX* ctx) {
...
int ossl_ec_GFp_simple_add(const EC_GROUP* group,
                           EC_POINT* r,
                           const EC_POINT* a,
                           const EC_POINT* b,
                           BN_CTX* ctx) {
...
int ossl_ec_GFp_simple_dbl(const EC_GROUP* group,
                           EC_POINT* r,
                           const EC_POINT* a,
                           BN_CTX* ctx) {
  int (*field_mul)(const EC_GROUP*, BIGNUM*, const BIGNUM*, const BIGNUM*,
...
int ossl_ec_GFp_simple_invert(const EC_GROUP* group,
                              EC_POINT* point,
                              BN_CTX* ctx) {
...
int ossl_ec_GFp_simple_is_on_curve(const EC_GROUP* group,
                                   const EC_POINT* point,
                                   BN_CTX* ctx) {
  int (*field_mul)(const EC_GROUP*, BIGNUM*, const BIGNUM*, const BIGNUM*,
                   BN_CTX*);
...
int ossl_ec_GFp_simple_cmp(const EC_GROUP* group,
                           const EC_POINT* a,
                           const EC_POINT* b,
                           BN_CTX* ctx) {
  /*-
...
int ossl_ec_GFp_simple_make_affine(const EC_GROUP* group,
                                   EC_POINT* point,
                                   BN_CTX* ctx) {
  BN_CTX* new_ctx = NULL;
  BIGNUM *x, *y;
...
int ossl_ec_GFp_simple_points_make_affine(const EC_GROUP* group,
                                          size_t num,
                                          EC_POINT* points[],
                                          BN_CTX* ctx) {
  BN_CTX* new_ctx = NULL;
...
int ossl_ec_GFp_simple_field_mul(const EC_GROUP* group,
                                 BIGNUM* r,
                                 const BIGNUM* a,
                                 const BIGNUM* b,
                                 BN_CTX* ctx) {
...
int ossl_ec_GFp_simple_field_sqr(const EC_GROUP* group,
                                 BIGNUM* r,
                                 const BIGNUM* a,
                                 BN_CTX* ctx) {
 ...
 */
int ossl_ec_GFp_simple_field_inv(const EC_GROUP* group,
                                 BIGNUM* r,
                                 const BIGNUM* a,
                                 BN_CTX* ctx) {
  BIGNUM* e = NULL;
