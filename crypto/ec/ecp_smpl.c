...
int
ossl_ec_GFp_simple_group_init (EC_GROUP *group)
{
  group->field = BN_new ();
  group->a = BN_new ();
  group->b = BN_new ();
...
void
ossl_ec_GFp_simple_group_finish (EC_GROUP *group)
{
  BN_free (group->field);
  BN_free (group->a);
  BN_free (group->b);
...
void
ossl_ec_GFp_simple_group_clear_finish (EC_GROUP *group)
{
...
int
ossl_ec_GFp_simple_group_copy (EC_GROUP *dest, const EC_GROUP *src)
{
...
int
ossl_ec_GFp_simple_group_set_curve (EC_GROUP *group, const BIGNUM *p,
...
int
ossl_ec_GFp_simple_group_get_curve (const EC_GROUP *group, BIGNUM *p,
...
int
ossl_ec_GFp_simple_group_get_degree (const EC_GROUP *group)
{
  return BN_num_bits (group->field);
}

int
ossl_ec_GFp_simple_group_check_discriminant (const EC_GROUP *group,
                                             BN_CTX *ctx)
{
  int ret = 0;
...
int
ossl_ec_GFp_simple_point_init (EC_POINT *point)
{
  point->X = BN_new ();
  point->Y = BN_new ();
  point->Z = BN_new ();
...
int
ossl_ec_GFp_simple_point_copy (EC_POINT *dest, const EC_POINT *src)
{
...
int
ossl_ec_GFp_simple_point_set_to_infinity (const EC_GROUP *group,
                                          EC_POINT *point)
{
  point->Z_is_one = 0;
  BN_zero (point->Z);
...
int
ossl_ec_GFp_simple_get_Jprojective_coordinates_GFp (const EC_GROUP *group,
...
int
ossl_ec_GFp_simple_point_set_affine_coordinates (const EC_GROUP *group,
                                                 EC_POINT *point,
                                                 const BIGNUM *x,
...
int
ossl_ec_GFp_simple_point_get_affine_coordinates (const EC_GROUP *group,
                                                 const EC_POINT *point,
                                                 BIGNUM *x, BIGNUM *y,
                                                 BN_CTX *ctx)
{
...
int
ossl_ec_GFp_simple_add (const EC_GROUP *group, EC_POINT *r, const EC_POINT *a,
...
int
ossl_ec_GFp_simple_dbl (const EC_GROUP *group, EC_POINT *r, const EC_POINT *a,
                        BN_CTX *ctx)
{
  int (*field_mul) (const EC_GROUP *, BIGNUM *, const BIGNUM *, const BIGNUM *,
                    BN_CTX *);
...
int
ossl_ec_GFp_simple_invert (const EC_GROUP *group, EC_POINT *point, BN_CTX *ctx)
{
...
int
ossl_ec_GFp_simple_is_at_infinity (const EC_GROUP *group,
                                   const EC_POINT *point)
{
...
int
ossl_ec_GFp_simple_is_on_curve (const EC_GROUP *group, const EC_POINT *point,
                                BN_CTX *ctx)
{
  int (*field_mul) (const EC_GROUP *, BIGNUM *, const BIGNUM *, const BIGNUM *,
                    BN_CTX *);
...
int
ossl_ec_GFp_simple_cmp (const EC_GROUP *group, const EC_POINT *a,
                        const EC_POINT *b, BN_CTX *ctx)
{
  /*-
   * return values:
...
int
ossl_ec_GFp_simple_make_affine (const EC_GROUP *group, EC_POINT *point,
                                BN_CTX *ctx)
{
  BN_CTX *new_ctx = NULL;
  BIGNUM *x, *y;
...
int
ossl_ec_GFp_simple_points_make_affine (const EC_GROUP *group, size_t num,
...
int
ossl_ec_GFp_simple_field_mul (const EC_GROUP *group, BIGNUM *r,
...
int
ossl_ec_GFp_simple_field_sqr (const EC_GROUP *group, BIGNUM *r,
 ...
 */
int
ossl_ec_GFp_simple_field_inv (const EC_GROUP *group, BIGNUM *r,
                              const BIGNUM *a, BN_CTX *ctx)
{
  BIGNUM *e = NULL;
  BN_CTX *new_ctx = NULL;
 ...
 */
int
ossl_ec_GFp_simple_blind_coordinates (const EC_GROUP *group, EC_POINT *p,
                                      BN_CTX *ctx)
{
  int ret = 0;
  BIGNUM *lambda = NULL;
 ...
 *
 * For doubling we use Formula 3 from Izu-Takagi "A fast parallel elliptic
 * curve multiplication resistant against side channel attacks" appendix,
 * described at
 ...
 */
int
ossl_ec_GFp_simple_ladder_pre (const EC_GROUP *group, EC_POINT *r, EC_POINT *s,
 ...
 * "A fast parallel elliptic curve multiplication resistant against side
 * channel attacks", as described at
 * https://hyperelliptic.org/EFD/g1p/auto-shortw-xz.html#ladder-mladd-2002-it-4
 */
int
ossl_ec_GFp_simple_ladder_step (const EC_GROUP *group, EC_POINT *r,
 ...
 */
int
ossl_ec_GFp_simple_ladder_post (const EC_GROUP *group, EC_POINT *r,
                                EC_POINT *s, EC_POINT *p, BN_CTX *ctx)
{
  int ret = 0;
  BIGNUM *t0, *t1, *t2, *t3, *t4, *t5, *t6 = NULL;
