...
static int
ec_precompute_mont_data(EC_GROUP*);
...
int
EC_GROUP_set_generator(EC_GROUP* group,
...
BN_MONT_CTX*
EC_GROUP_get_mont_data(const EC_GROUP* group)
{
...
const BIGNUM*
EC_GROUP_get0_field(const EC_GROUP* group)
{
  return group->field;
}
...
int
EC_GROUP_get_curve(const EC_GROUP* group,
                   BIGNUM* p,
                   BIGNUM* a,
                   BIGNUM* b,
                   BN_CTX* ctx)
...
#ifndef OPENSSL_NO_DEPRECATED_3_0
int
EC_GROUP_set_curve_GFp(EC_GROUP* group,
                       const BIGNUM* p,
                       const BIGNUM* a,
                       const BIGNUM* b,
                       BN_CTX* ctx)
...
int
EC_GROUP_get_curve_GFp(const EC_GROUP* group,
                       BIGNUM* p,
                       BIGNUM* a,
                       BIGNUM* b,
                       BN_CTX* ctx)
...
int
EC_GROUP_set_curve_GF2m(EC_GROUP* group,
                        const BIGNUM* p,
                        const BIGNUM* a,
                        const BIGNUM* b,
                        BN_CTX* ctx)
...
int
EC_GROUP_get_curve_GF2m(const EC_GROUP* group,
                        BIGNUM* p,
                        BIGNUM* a,
                        BIGNUM* b,
                        BN_CTX* ctx)
...
EC_GROUP_cmp(const EC_GROUP* a, const EC_GROUP* b, BN_CTX* ctx)
{
  ...
  if (r ||
      EC_POINT_cmp(
        a, EC_GROUP_get0_generator(a), EC_GROUP_get0_generator(b), ctx) != 0)
    r = 1;
...
#ifndef OPENSSL_NO_DEPRECATED_3_0
int
EC_POINT_set_Jprojective_coordinates_GFp(const EC_GROUP* group,
                                         EC_POINT* point,
                                         const BIGNUM* x,
                                         const BIGNUM* y,
                                         const BIGNUM* z,
                                         BN_CTX* ctx)
{
  ...
  return ossl_ec_GFp_simple_set_Jprojective_coordinates_GFp(
...
int
EC_POINT_set_affine_coordinates(const EC_GROUP* group,
                                EC_POINT* point,
                                const BIGNUM* x,
                                const BIGNUM* y,
                                BN_CTX* ctx)
...
#ifndef OPENSSL_NO_DEPRECATED_3_0
int
EC_POINT_set_affine_coordinates_GFp(const EC_GROUP* group,
                                    EC_POINT* point,
                                    const BIGNUM* x,
                                    const BIGNUM* y,
                                    BN_CTX* ctx)
...
#ifndef OPENSSL_NO_EC2M
int
EC_POINT_set_affine_coordinates_GF2m(const EC_GROUP* group,
                                     EC_POINT* point,
                                     const BIGNUM* x,
                                     const BIGNUM* y,
                                     BN_CTX* ctx)
...
#ifndef OPENSSL_NO_EC2M
int
EC_POINT_get_affine_coordinates_GF2m(const EC_GROUP* group,
                                     const EC_POINT* point,
                                     BIGNUM* x,
                                     BIGNUM* y,
                                     BN_CTX* ctx)
...
int
EC_POINT_add(const EC_GROUP* group,
             EC_POINT* r,
             const EC_POINT* a,
             const EC_POINT* b,
             BN_CTX* ctx)
...
int
EC_POINT_cmp(const EC_GROUP* group,
             const EC_POINT* a,
             const EC_POINT* b,
             BN_CTX* ctx)
{
...
int
EC_POINTs_make_affine(const EC_GROUP* group,
                      size_t num,
                      EC_POINT* points[],
                      BN_CTX* ctx)
{
...
#ifndef OPENSSL_NO_DEPRECATED_3_0
int
EC_POINTs_mul(const EC_GROUP* group,
              EC_POINT* r,
              const BIGNUM* scalar,
              size_t num,
 ...
 */
static int
ec_precompute_mont_data(EC_GROUP* group)
{
...
static int
ec_field_inverse_mod_ord(const EC_GROUP* group,
                         BIGNUM* r,
                         const BIGNUM* x,
                         BN_CTX* ctx)
{
 ...
 */
int
ossl_ec_group_do_inverse_ord(const EC_GROUP* group,
                             BIGNUM* res,
                             const BIGNUM* x,
                             BN_CTX* ctx)
{
 ...
 */
int
ossl_ec_point_blind_coordinates(const EC_GROUP* group, EC_POINT* p, BN_CTX* ctx)
{
...
int
EC_GROUP_get_pentanomial_basis(const EC_GROUP* group,
                               unsigned int* k1,
                               unsigned int* k2,
                               unsigned int* k3)
{
 ...
 */
static EC_GROUP*
ec_group_explicit_to_named(const EC_GROUP* group,
                           OSSL_LIB_CTX* libctx,
                           const char* propq,
                           BN_CTX* ctx)
{
...
static EC_GROUP*
group_new_from_name(const OSSL_PARAM* p,
                    OSSL_LIB_CTX* libctx,
                    const char* propq)
{
  int ok = 0, nid;
...
int
ossl_ec_group_set_params(EC_GROUP* group, const OSSL_PARAM params[])
{
...
OSSL_PARAM*
EC_GROUP_to_params(const EC_GROUP* group,
                   OSSL_LIB_CTX* libctx,
                   const char* propq,
                   BN_CTX* bnctx)
{
