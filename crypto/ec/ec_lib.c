...
EC_GROUP *
ossl_ec_group_new_ex (OSSL_LIB_CTX *libctx, const char *propq,
...
EC_GROUP_set_curve_name (EC_GROUP *group, int nid)
{
  ...
  group->asn1_flag = (nid != NID_undef) ? OPENSSL_EC_NAMED_CURVE
...
EC_GROUP_cmp (const EC_GROUP *a, const EC_GROUP *b, BN_CTX *ctx)
{
  ...
  if (r || BN_cmp (a1, b1) != 0 || BN_cmp (a2, b2) != 0
      || BN_cmp (a3, b3) != 0)
    r = 1;
...
static int
ec_field_inverse_mod_ord (const EC_GROUP *group, BIGNUM *r, const BIGNUM *x,
                          BN_CTX *ctx)
{
  BIGNUM *e = NULL;
  int ret = 0;
 ...
 */
int
ossl_ec_group_do_inverse_ord (const EC_GROUP *group, BIGNUM *res,
 ...
 */
int
ossl_ec_point_blind_coordinates (const EC_GROUP *group, EC_POINT *p,
                                 BN_CTX *ctx)
{
 ...
 */
static EC_GROUP *
ec_group_explicit_to_named (const EC_GROUP *group, OSSL_LIB_CTX *libctx,
...
static EC_GROUP *
group_new_from_name (const OSSL_PARAM *p, OSSL_LIB_CTX *libctx,
                     const char *propq)
{
  int ok = 0, nid;
...
EC_GROUP *
EC_GROUP_new_from_params (const OSSL_PARAM params[], OSSL_LIB_CTX *libctx,
                          const char *propq)
{
...
OSSL_PARAM *
EC_GROUP_to_params (const EC_GROUP *group, OSSL_LIB_CTX *libctx,
