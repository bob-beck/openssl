 ...
 */
int
ossl_lm_ots_compute_pubkey (EVP_MD_CTX *ctx, EVP_MD_CTX *ctxIq,
 ...
 * @param ctxIq A EVP_MD_CTX object that contains a non finalized value of H(I
 * || q).
 ...
 */
static int
lm_ots_compute_pubkey_final (EVP_MD_CTX *ctx, EVP_MD_CTX *ctxIq,
