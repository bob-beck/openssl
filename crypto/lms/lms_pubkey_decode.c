 ...
 */
static int
lms_pubkey_from_pkt (LMS_KEY *lmskey, const unsigned char *pubkeydata,
                     size_t publen)
{
  uint32_t lms_type;
  uint32_t ots_type;
 ...
 */
int
ossl_lms_pubkey_decode (const unsigned char *pub, size_t publen,
                        LMS_KEY *lmskey)
{
 ...
 */
int
ossl_lms_pubkey_from_params (const OSSL_PARAM params[], LMS_KEY *lmskey)
{
