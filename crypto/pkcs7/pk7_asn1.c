...
ASN1_ADB(PKCS7) = {
  ...
  ADB_ENTRY(
    ...
    ASN1_NDEF_EXP_OPT(PKCS7, d.signed_and_enveloped, PKCS7_SIGN_ENVELOPE, 0)),
...
d2i_PKCS7(PKCS7** a, const unsigned char** in, long len)
{
  ...
  ret = (PKCS7*)ASN1_item_d2i_ex(
    (ASN1_VALUE**)a, in, len, (PKCS7_it()), libctx, propq);
  if (ret != NULL)
...
int
i2d_PKCS7(const PKCS7* a, unsigned char** out)
{
...
PKCS7*
PKCS7_new_ex(OSSL_LIB_CTX* libctx, const char* propq)
{
