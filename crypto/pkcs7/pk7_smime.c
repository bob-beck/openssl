...
PKCS7 *
PKCS7_sign_ex (X509 *signcert, EVP_PKEY *pkey, STACK_OF (X509) *certs,
...
int
PKCS7_verify (PKCS7 *p7, STACK_OF (X509) *certs, X509_STORE *store,
...
PKCS7 *
PKCS7_encrypt_ex (STACK_OF (X509) *certs, BIO *in, const EVP_CIPHER *cipher,
                  int flags, OSSL_LIB_CTX *libctx, const char *propq)
{
  PKCS7 *p7;
  BIO *p7bio = NULL;
  int i;
