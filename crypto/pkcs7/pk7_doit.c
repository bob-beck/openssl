...
int
PKCS7_signatureVerify (BIO *bio, PKCS7 *p7, PKCS7_SIGNER_INFO *si,
                       X509 *signer)
{
...
int
PKCS7_add_attribute (PKCS7_SIGNER_INFO *p7si, int nid, int atrtype,
                     void *value)
{
...
static int
add_attribute (STACK_OF (X509_ATTRIBUTE) **sk, int nid, int atrtype,
               void *value)
{
