...
const BIGNUM ossl_bignum_const_2 = { (BN_ULONG*)&value_2,
                                     1,
                                     1,
                                     0,
                                     BN_FLG_STATIC_DATA };
    ...
    make_dh_bn(dh2048_256_p) make_dh_bn(dh2048_256_q) make_dh_bn(dh2048_256_g)
      ...
      make_dh_bn(ffdhe2048_p) make_dh_bn(ffdhe2048_q) make_dh_bn(ffdhe3072_p)
        make_dh_bn(ffdhe3072_q) make_dh_bn(ffdhe4096_p) make_dh_bn(ffdhe4096_q)
          make_dh_bn(ffdhe6144_p) make_dh_bn(ffdhe6144_q)
                ...
                make_dh_bn(modp_2048_p) make_dh_bn(modp_2048_q)
                  make_dh_bn(modp_3072_p) make_dh_bn(modp_3072_q)
                    make_dh_bn(modp_4096_p) make_dh_bn(modp_4096_q)
                      make_dh_bn(modp_6144_p) make_dh_bn(modp_6144_q)
                        make_dh_bn(modp_8192_p) make_dh_bn(modp_8192_q)
