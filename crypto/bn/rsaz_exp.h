...
void
RSAZ_1024_mod_exp_avx2(BN_ULONG result[16],
...
int
ossl_rsaz_avx512ifma_eligible(void);

int
ossl_rsaz_avxifma_eligible(void);
...
bn_reduce_once_in_place(BN_ULONG* r,
                        BN_ULONG carry,
                        const BN_ULONG* m,
                        BN_ULONG* tmp,
                        size_t num)
