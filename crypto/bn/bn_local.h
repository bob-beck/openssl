...
unsigned __int64
__umulh(unsigned __int64 a, unsigned __int64 b);
unsigned __int64
_umul128(unsigned __int64 a, unsigned __int64 b, unsigned __int64* h);
...
bn_mul_recursive(BN_ULONG* r,
                 ...
                 BN_ULONG* t);
void
bn_mul_part_recursive(BN_ULONG* r,
                      BN_ULONG* a,
                      BN_ULONG* b,
                      int n,
                      int tna,
...
void
bn_mul_low_recursive(BN_ULONG* r,
                     BN_ULONG* a,
                     BN_ULONG* b,
                     int n2,
                     BN_ULONG* t);
