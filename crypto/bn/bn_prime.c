...
int
BN_generate_prime_ex2 (BIGNUM *ret, int bits, int safe, const BIGNUM *add,
...
int
BN_is_prime_fasttest_ex (const BIGNUM *w, int checks, BN_CTX *ctx,
                         int do_trial_division, BN_GENCB *cb)
{
...
int
ossl_bn_check_prime (const BIGNUM *w, int checks, BN_CTX *ctx,
                     int do_trial_division, BN_GENCB *cb)
{
 ...
 */
int
ossl_bn_check_generated_prime (const BIGNUM *w, int checks, BN_CTX *ctx,
                               BN_GENCB *cb)
{
 ...
 */
static int
bn_is_prime_int (const BIGNUM *w, int checks, BN_CTX *ctx,
                 int do_trial_division, BN_GENCB *cb)
{
  int i, status, ret = -1;
#ifndef FIPS_MODULE
 ...
 */
int
ossl_bn_miller_rabin_is_prime (const BIGNUM *w, int iterations, BN_CTX *ctx,
 ...
 */
static int
probable_prime (BIGNUM *rnd, int bits, int safe, prime_t *mods, BN_CTX *ctx)
{
  int i;
  BN_ULONG delta;
 ...
 */
static int
probable_prime_dh (BIGNUM *rnd, int bits, int safe, prime_t *mods,
