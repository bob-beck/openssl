...
static const BN_ULONG _nist_p_224[][BN_NIST_224_TOP] = { { 0x00000001,
                                                           0x00000000,
                                                           0x00000000,
                                                           0xFFFFFFFF,
                                                           0xFFFFFFFF,
...
static void
nist_cp_bn(BN_ULONG* dst, const BN_ULONG* src, int top)
{
  int i;
...
store_lo32(void* ptr, NIST_INT64 val)
{
...
BN_nist_mod_192(BIGNUM* r, const BIGNUM* a, const BIGNUM* field, BN_CTX* ctx)
{
  ...
  nist_cp_bn_0(
    buf.bn, a_d + BN_NIST_192_TOP, top - BN_NIST_192_TOP, BN_NIST_192_TOP);
...
typedef BN_ULONG (*bn_addsub_f)(BN_ULONG*,
                                const BN_ULONG*,
                                const BN_ULONG*,
                                int);
...
BN_nist_mod_224(BIGNUM* r, const BIGNUM* a, const BIGNUM* field, BN_CTX* ctx)
{
  ...
  nist_cp_bn_0(c_d,
               a_d + (BN_NIST_224_TOP - 1),
               top - (BN_NIST_224_TOP - 1),
               BN_NIST_224_TOP);
...
#else
  nist_cp_bn_0(
    buf.bn, a_d + BN_NIST_224_TOP, top - BN_NIST_224_TOP, BN_NIST_224_TOP);
#endif
...
BN_nist_mod_256(BIGNUM* r, const BIGNUM* a, const BIGNUM* field, BN_CTX* ctx)
{
  ...
  nist_cp_bn_0(
    buf.bn, a_d + BN_NIST_256_TOP, top - BN_NIST_256_TOP, BN_NIST_256_TOP);
...
#define nist_set_384(                                                          \
  to, from, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12)                 \
...
BN_nist_mod_384(BIGNUM* r, const BIGNUM* a, const BIGNUM* field, BN_CTX* ctx)
{
  ...
  nist_cp_bn_0(
    buf.bn, a_d + BN_NIST_384_TOP, top - BN_NIST_384_TOP, BN_NIST_384_TOP);
...
#else
  {
    ...
    carry = (int)bn_add_words(
      r_d + (128 / BN_BITS2), r_d + (128 / BN_BITS2), t_d, BN_NIST_256_TOP);
    /*
     * S2
     */
...
BN_nist_mod_521(BIGNUM* r, const BIGNUM* a, const BIGNUM* field, BN_CTX* ctx)
{
  ...
  /* upper 521 bits, copy ... */
  nist_cp_bn_0(t_d,
               a_d + (BN_NIST_521_TOP - 1),
               top - (BN_NIST_521_TOP - 1),
               BN_NIST_521_TOP);
  /* ... and right shift */
