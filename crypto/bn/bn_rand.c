...
static int
bnrand (BNRAND_FLAG flag, BIGNUM *rnd, int bits, int top, int bottom,
...
int
BN_rand_ex (BIGNUM *rnd, int bits, int top, int bottom, unsigned int strength,
            BN_CTX *ctx)
{
...
int
BN_priv_rand_ex (BIGNUM *rnd, int bits, int top, int bottom,
                 unsigned int strength, BN_CTX *ctx)
{
...
#ifndef FIPS_MODULE
int
BN_priv_rand (BIGNUM *rnd, int bits, int top, int bottom)
{
...
static int
bnrand_range (BNRAND_FLAG flag, BIGNUM *r, const BIGNUM *range,
              unsigned int strength, BN_CTX *ctx)
{
  int n;
  int count = 100;
...
int
BN_rand_range_ex (BIGNUM *r, const BIGNUM *range, unsigned int strength,
                  BN_CTX *ctx)
{
...
int
BN_priv_rand_range_ex (BIGNUM *r, const BIGNUM *range, unsigned int strength,
                       BN_CTX *ctx)
{
...
#ifndef FIPS_MODULE
int
BN_priv_rand_range (BIGNUM *r, const BIGNUM *range)
{
...
int
ossl_bn_priv_rand_range_fixed_top (BIGNUM *r, const BIGNUM *range,
                                   unsigned int strength, BN_CTX *ctx)
{
  int n;
  int count = 100;
 ...
 */
int
ossl_bn_gen_dsa_nonce_fixed_top (BIGNUM *out, const BIGNUM *range,
                                 const BIGNUM *priv,
...
int
BN_generate_dsa_nonce (BIGNUM *out, const BIGNUM *range, const BIGNUM *priv,
