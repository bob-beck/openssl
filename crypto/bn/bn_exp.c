...
static int
MOD_EXP_CTIME_COPY_FROM_PREBUF (BIGNUM *b, int top, unsigned char *buf,
                                int idx, int window)
{
  int i, j;
  int width = 1 << window;
 ...
 */
int
bn_mod_exp_mont_fixed_top (BIGNUM *rr, const BIGNUM *a, const BIGNUM *p,
 ...
 */
int
BN_mod_exp_mont_consttime_x2 (BIGNUM *rr1, const BIGNUM *a1, const BIGNUM *p1,
