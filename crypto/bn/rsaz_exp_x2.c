...
get_digit(const uint8_t* in, int in_len);
static ossl_inline void
put_digit(uint8_t* out, int out_len, uint64_t digit);
static void
to_words52(BN_ULONG* out, int out_len, const BN_ULONG* in, int in_bitsize);
static void
from_words52(BN_ULONG* bn_out, int out_bitsize, const BN_ULONG* in);
static ossl_inline void
set_bit(BN_ULONG* a, int idx);

/* Number of |digit_size|-bit digits in |bitsize|-bit value */
static ossl_inline int
number_of_digits(int bitsize, int digit_size)
{
...
void
ossl_rsaz_amm52x20_x1_ifma256(BN_ULONG* res,
                              const BN_ULONG* a,
                              const BN_ULONG* b,
                              const BN_ULONG* m,
                              BN_ULONG k0);
void
ossl_rsaz_amm52x20_x2_ifma256(BN_ULONG* out,
                              const BN_ULONG* a,
                              const BN_ULONG* b,
                              const BN_ULONG* m,
                              const BN_ULONG k0[2]);
void
ossl_extract_multiplier_2x20_win5(BN_ULONG* red_Y,
                                  const BN_ULONG* red_table,
                                  int red_table_idx1,
                                  int red_table_idx2);

void
ossl_rsaz_amm52x30_x1_ifma256(BN_ULONG* res,
                              const BN_ULONG* a,
                              const BN_ULONG* b,
                              const BN_ULONG* m,
                              BN_ULONG k0);
void
ossl_rsaz_amm52x30_x2_ifma256(BN_ULONG* out,
                              const BN_ULONG* a,
                              const BN_ULONG* b,
                              const BN_ULONG* m,
                              const BN_ULONG k0[2]);
void
ossl_extract_multiplier_2x30_win5(BN_ULONG* red_Y,
                                  const BN_ULONG* red_table,
                                  int red_table_idx1,
                                  int red_table_idx2);

void
ossl_rsaz_amm52x40_x1_ifma256(BN_ULONG* res,
                              const BN_ULONG* a,
                              const BN_ULONG* b,
                              const BN_ULONG* m,
                              BN_ULONG k0);
void
ossl_rsaz_amm52x40_x2_ifma256(BN_ULONG* out,
                              const BN_ULONG* a,
                              const BN_ULONG* b,
                              const BN_ULONG* m,
                              const BN_ULONG k0[2]);
void
ossl_extract_multiplier_2x40_win5(BN_ULONG* red_Y,
                                  const BN_ULONG* red_table,
                                  int red_table_idx1,
                                  int red_table_idx2);

void
ossl_rsaz_amm52x20_x1_avxifma256(BN_ULONG* res,
                                 const BN_ULONG* a,
                                 const BN_ULONG* b,
                                 const BN_ULONG* m,
                                 BN_ULONG k0);
void
ossl_rsaz_amm52x20_x2_avxifma256(BN_ULONG* out,
                                 const BN_ULONG* a,
                                 const BN_ULONG* b,
                                 const BN_ULONG* m,
                                 const BN_ULONG k0[2]);
void
ossl_extract_multiplier_2x20_win5_avx(BN_ULONG* red_Y,
                                      const BN_ULONG* red_table,
                                      int red_table_idx1,
                                      int red_table_idx2);

void
ossl_rsaz_amm52x30_x1_avxifma256(BN_ULONG* res,
                                 const BN_ULONG* a,
                                 const BN_ULONG* b,
                                 const BN_ULONG* m,
                                 BN_ULONG k0);
void
ossl_rsaz_amm52x30_x2_avxifma256(BN_ULONG* out,
                                 const BN_ULONG* a,
                                 const BN_ULONG* b,
                                 const BN_ULONG* m,
                                 const BN_ULONG k0[2]);
void
ossl_extract_multiplier_2x30_win5_avx(BN_ULONG* red_Y,
                                      const BN_ULONG* red_table,
                                      int red_table_idx1,
                                      int red_table_idx2);

void
ossl_rsaz_amm52x40_x1_avxifma256(BN_ULONG* res,
                                 const BN_ULONG* a,
                                 const BN_ULONG* b,
                                 const BN_ULONG* m,
                                 BN_ULONG k0);
void
ossl_rsaz_amm52x40_x2_avxifma256(BN_ULONG* out,
                                 const BN_ULONG* a,
                                 const BN_ULONG* b,
                                 const BN_ULONG* m,
                                 const BN_ULONG k0[2]);
void
ossl_extract_multiplier_2x40_win5_avx(BN_ULONG* red_Y,
                                      const BN_ULONG* red_table,
                                      int red_table_idx1,
                                      int red_table_idx2);

typedef void (*AMM)(BN_ULONG* res,
                    const BN_ULONG* a,
                    const BN_ULONG* b,
                    const BN_ULONG* m,
                    BN_ULONG k0);
...
typedef void (*DAMM)(BN_ULONG* res,
                     const BN_ULONG* a,
                     const BN_ULONG* b,
                     const BN_ULONG* m,
                     const BN_ULONG k0[2]);
...
typedef void (*DEXTRACT)(BN_ULONG* res,
                         const BN_ULONG* red_table,
                         int red_table_idx,
                         int tbl_idx);
...
static int
RSAZ_mod_exp_x2_ifma256(BN_ULONG* res,
                        const BN_ULONG* base,
 ...
 */
int
ossl_rsaz_mod_exp_avx512_x2(BN_ULONG* res1,
                            ...
                            int factor_size)
{
  ...
  ret = RSAZ_mod_exp_x2_ifma256(
    rr1_red, base1_red, exp, m1_red, rr1_red, k0, factor_size);
  if (!ret)
    goto err;
 ...
 */
int
RSAZ_mod_exp_x2_ifma256(BN_ULONG* out,
                        const BN_ULONG* base,
                        const BN_ULONG* exp[2],
                        const BN_ULONG* m,
                        const BN_ULONG* rr,
...
#define DAMS(r, a, m, k0) damm((r), (a), (a), (m), (k0))
  ...
  /* Exponentiation */
  {
    ...
    for (exp_bit_no -= exp_win_size; exp_bit_no >= 0;
      ...
      damm((BN_ULONG*)red_Y,
           (const BN_ULONG*)red_Y,
           (const BN_ULONG*)red_X,
           m,
           k0);
    }
  }
 ...
 */
static void
from_words52(BN_ULONG* out, int out_bitsize, const BN_ULONG* in)
{
  int i;
...

  {
    ...
    if (out_bitsize > DIGIT_SIZE) {
      ...
      put_digit(
        out_str, BITS2WORD8_SIZE(out_bitsize), (in[1] << 4 | in[0] >> 48));
    } else if (out_bitsize) {
