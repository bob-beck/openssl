...
static void to_words52(BN_ULONG* out,
                       int out_len,
                       const BN_ULONG* in,
                       int in_bitsize);
...
void ossl_rsaz_amm52x20_x1_ifma256(BN_ULONG* res,
                                   ...
                                   const BN_ULONG* m,
                                   BN_ULONG k0);
void ossl_rsaz_amm52x20_x2_ifma256(BN_ULONG* out,
                                   const BN_ULONG* a,
                                   const BN_ULONG* b,
                                   const BN_ULONG* m,
                                   const BN_ULONG k0[2]);
...
void ossl_rsaz_amm52x30_x1_ifma256(BN_ULONG* res,
                                   ...
                                   const BN_ULONG* m,
                                   BN_ULONG k0);
void ossl_rsaz_amm52x30_x2_ifma256(BN_ULONG* out,
                                   const BN_ULONG* a,
                                   const BN_ULONG* b,
                                   const BN_ULONG* m,
                                   const BN_ULONG k0[2]);
...
void ossl_rsaz_amm52x40_x1_ifma256(BN_ULONG* res,
                                   ...
                                   const BN_ULONG* m,
                                   BN_ULONG k0);
void ossl_rsaz_amm52x40_x2_ifma256(BN_ULONG* out,
                                   const BN_ULONG* a,
                                   const BN_ULONG* b,
                                   const BN_ULONG* m,
                                   const BN_ULONG k0[2]);
...
void ossl_rsaz_amm52x20_x1_avxifma256(BN_ULONG* res,
                                      ...
                                      const BN_ULONG* m,
                                      BN_ULONG k0);
void ossl_rsaz_amm52x20_x2_avxifma256(BN_ULONG* out,
                                      const BN_ULONG* a,
                                      const BN_ULONG* b,
                                      const BN_ULONG* m,
                                      const BN_ULONG k0[2]);
...
void ossl_rsaz_amm52x30_x1_avxifma256(BN_ULONG* res,
                                      ...
                                      const BN_ULONG* m,
                                      BN_ULONG k0);
void ossl_rsaz_amm52x30_x2_avxifma256(BN_ULONG* out,
                                      const BN_ULONG* a,
                                      const BN_ULONG* b,
                                      const BN_ULONG* m,
                                      const BN_ULONG k0[2]);
...
void ossl_rsaz_amm52x40_x1_avxifma256(BN_ULONG* res,
                                      ...
                                      const BN_ULONG* m,
                                      BN_ULONG k0);
void ossl_rsaz_amm52x40_x2_avxifma256(BN_ULONG* out,
                                      const BN_ULONG* a,
                                      const BN_ULONG* b,
                                      const BN_ULONG* m,
                                      const BN_ULONG k0[2]);
...
static int RSAZ_mod_exp_x2_ifma256(BN_ULONG* res,
                                   const BN_ULONG* base,
...
#define DAMS(r, a, m, k0) damm((r), (a), (a), (m), (k0))
  ...
  /* Exponentiation */
  {
    ...
    for (exp_bit_no -= exp_win_size; exp_bit_no >= 0;
      ...
      damm((BN_ULONG*)red_Y, (const BN_ULONG*)red_Y, (const BN_ULONG*)red_X, m,
           k0);
    }
  }
