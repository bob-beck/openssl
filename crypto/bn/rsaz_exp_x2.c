...
static void to_words52 (BN_ULONG *out, int out_len, const BN_ULONG *in,
                        int in_bitsize);
static void from_words52 (BN_ULONG *bn_out, int out_bitsize,
                          const BN_ULONG *in);
 ...
 */
int
ossl_rsaz_mod_exp_avx512_x2 (BN_ULONG *res1, const BN_ULONG *base1,
 ...
 */
int
RSAZ_mod_exp_x2_ifma256 (BN_ULONG *out, const BN_ULONG *base,
                         const BN_ULONG *exp[2], const BN_ULONG *m,
                         const BN_ULONG *rr, const BN_ULONG k0[2],
                         int modulus_bitsize)
{
