 ...
 */
int
OCSP_basic_sign_ctx (OCSP_BASICRESP *brsp, X509 *signer, EVP_MD_CTX *ctx,
...
int
OCSP_RESPID_set_by_key_ex (OCSP_RESPID *respid, X509 *cert,
...
int
OCSP_RESPID_match_ex (OCSP_RESPID *respid, X509 *cert, OSSL_LIB_CTX *libctx,
                      const char *propq)
{
  EVP_MD *sha1 = NULL;
  int ret = 0;
