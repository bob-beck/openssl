...
int
OCSP_REQUEST_get_ext_by_OBJ(OCSP_REQUEST* x,
...
int
OCSP_REQUEST_add1_ext_i2d(OCSP_REQUEST* x,
                          int nid,
                          void* value,
                          int crit,
                          unsigned long flags)
{
  return X509V3_add1_i2d(
    &x->tbsRequest.requestExtensions, nid, value, crit, flags);
}
...
int
OCSP_ONEREQ_add1_ext_i2d(OCSP_ONEREQ* x,
                         int nid,
                         void* value,
                         int crit,
                         unsigned long flags)
...
int
OCSP_BASICRESP_get_ext_by_OBJ(OCSP_BASICRESP* x,
                              const ASN1_OBJECT* obj,
                              int lastpos)
{
  return (
...
int
OCSP_BASICRESP_add1_ext_i2d(OCSP_BASICRESP* x,
                            int nid,
                            void* value,
                            int crit,
                            unsigned long flags)
{
  return X509V3_add1_i2d(
    &x->tbsResponseData.responseExtensions, nid, value, crit, flags);
}
...
int
OCSP_SINGLERESP_get_ext_by_OBJ(OCSP_SINGLERESP* x,
                               const ASN1_OBJECT* obj,
                               int lastpos)
{
...
int
OCSP_SINGLERESP_add1_ext_i2d(OCSP_SINGLERESP* x,
                             int nid,
                             void* value,
                             int crit,
                             unsigned long flags)
...
ocsp_add1_nonce(STACK_OF(X509_EXTENSION)** exts, unsigned char* val, int len)
{
  ...
  if (val)
    ...
    goto err;
  if (X509V3_add1_i2d(
        exts, NID_id_pkix_OCSP_Nonce, &os, 0, X509V3_ADD_REPLACE) <= 0)
    goto err;
  ret = 1;
err:
 ...
 */
X509_EXTENSION*
OCSP_url_svcloc_new(const X509_NAME* issuer, const char** urls)
{
  X509_EXTENSION* x = NULL;
