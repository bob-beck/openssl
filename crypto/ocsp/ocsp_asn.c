...
ASN1_SEQUENCE(OCSP_SIGNATURE)
    ...
    ASN1_SEQUENCE(OCSP_CERTID)
        = {ASN1_EMBED(OCSP_CERTID, hashAlgorithm, X509_ALGOR),
           ...
           ASN1_EMBED(OCSP_CERTID, serialNumber, ASN1_INTEGER)} ASN1_SEQUENCE_END(OCSP_CERTID)

        IMPLEMENT_ASN1_FUNCTIONS(OCSP_CERTID)

        ASN1_SEQUENCE(OCSP_ONEREQ)
            = {ASN1_SIMPLE(OCSP_ONEREQ, reqCert, OCSP_CERTID),
               ASN1_EXP_SEQUENCE_OF_OPT(OCSP_ONEREQ,
            ...
            ASN1_SEQUENCE(OCSP_REQINFO)
                = {ASN1_EXP_OPT(OCSP_REQINFO, version, ASN1_INTEGER, 0),
                   ...
                   ASN1_EXP_SEQUENCE_OF_OPT(OCSP_REQINFO,
                                            requestExtensions,
                                            X509_EXTENSION,
                ...
                ASN1_SEQUENCE(OCSP_REQUEST)
                    = {ASN1_EMBED(OCSP_REQUEST, tbsRequest, OCSP_REQINFO),
                       ASN1_EXP_OPT(OCSP_REQUEST, optionalSignature, OCSP_SIGNATURE, 0)} ASN1_SEQUENCE_END(OCSP_REQUEST)
                    ...
                    ASN1_SEQUENCE(OCSP_RESPBYTES)
                        = {ASN1_SIMPLE(OCSP_RESPBYTES, responseType, ASN1_OBJECT),
                           ASN1_SIMPLE(OCSP_RESPBYTES, response, ASN1_OCTET_STRING)} ASN1_SEQUENCE_END(OCSP_RESPBYTES)

                        IMPLEMENT_ASN1_FUNCTIONS(OCSP_RESPBYTES)

                        ASN1_SEQUENCE(OCSP_RESPONSE)
                            = {ASN1_SIMPLE(OCSP_RESPONSE, responseStatus, ASN1_ENUMERATED),
                               ASN1_EXP_OPT(OCSP_RESPONSE,
                                            responseBytes,
                                            OCSP_RESPBYTES,
                                    ...
                                    ASN1_CHOICE(OCSP_CERTSTATUS)
                                        ...
                                        ASN1_SEQUENCE(OCSP_SINGLERESP)
                                            = {ASN1_SIMPLE(OCSP_SINGLERESP, certId, OCSP_CERTID),
                                               ...
                                               ASN1_EXP_SEQUENCE_OF_OPT(OCSP_SINGLERESP,
                                                                        singleExtensions,
                                                                        X509_EXTENSION,
                                            ...
                                            ASN1_SEQUENCE(OCSP_RESPDATA)
                                                = {ASN1_EXP_OPT(OCSP_RESPDATA, version, ASN1_INTEGER, 0),
                                                   ...
                                                   ASN1_EXP_SEQUENCE_OF_OPT(OCSP_RESPDATA,
                                                                            responseExtensions,
                                                                            X509_EXTENSION,
                                                ...
                                                ASN1_SEQUENCE(OCSP_BASICRESP)
                                                    = {ASN1_EMBED(OCSP_BASICRESP, tbsResponseData, OCSP_RESPDATA),
                                                       ...
                                                       ASN1_EXP_SEQUENCE_OF_OPT(OCSP_BASICRESP,
                                                                                certs,
                                                                                X509,
