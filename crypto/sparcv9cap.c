...
void OPENSSL_cpuid_setup(void) {
  ...
  if ((e = getenv("OPENSSL_sparcv9cap"))) {
    ...
    if ((e = strchr(e, ':'))) OPENSSL_sparcv9cap_P[1] = strtoul(e + 1, NULL, 0);
    return;
  }
  ...
  if (getisax != NULL) {
    ...
    if (sizeof(size_t) == 8) OPENSSL_sparcv9cap_P[0] |= SPARCV9_64BIT_STACK;
  ...
  if (sizeof(size_t) == 8) OPENSSL_sparcv9cap_P[0] |= SPARCV9_64BIT_STACK;
    ...
    if (ret >= 0 && ret & 1) OPENSSL_sparcv9cap_P[0] |= SPARCV9_64BIT_STACK;
  }
#endif
}
