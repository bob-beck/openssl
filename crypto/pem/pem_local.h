...
#define IMPLEMENT_PEM_provided_write_to(                                       \
  name, TYPE, type, str, asn1, OUTTYPE, outtype, writename)                    \
...
#define IMPLEMENT_PEM_provided_write_cb_to(                                    \
  name, TYPE, type, str, asn1, OUTTYPE, outtype, writename)                    \
