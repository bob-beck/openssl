 ...
 *      header data.
 */
int ossl_do_blob_header(const unsigned char** in,
                        unsigned int length,
                        unsigned int* pmagic,
...
static void* do_b2i_key(const unsigned char** in,
                        unsigned int length,
                        int* isdss,
                        int* ispub) {
  const unsigned char* p = *in;
...
#ifndef OPENSSL_NO_DSA
DSA* ossl_b2i_DSA_after_header(const unsigned char** in,
                               unsigned int bitlen,
                               int ispub) {
  const unsigned char* p = *in;
  DSA* dsa = NULL;
...
RSA* ossl_b2i_RSA_after_header(const unsigned char** in,
                               unsigned int bitlen,
                               int ispub) {
...
int ossl_do_PVK_header(const unsigned char** in,
                       unsigned int length,
                       int skip_magic,
                       int* isdss,
...
static void* do_PVK_key_bio(BIO* in,
                            pem_password_cb* cb,
                            void* u,
                            int* isdss,
                            int* ispub,
...
EVP_PKEY* b2i_PVK_bio_ex(BIO* in,
                         pem_password_cb* cb,
                         void* u,
                         OSSL_LIB_CTX* libctx,
                         const char* propq) {
...
static int i2b_PVK(unsigned char** out,
                   const EVP_PKEY* pk,
                   int enclevel,
                   pem_password_cb* cb,
                   void* u,
