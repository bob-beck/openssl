...
static int
pem_bytes_read_bio_flags (unsigned char **pdata, long *plen, char **pnm,
                          const char *name, BIO *bp, pem_password_cb *cb,
                          void *u, unsigned int flags)
{
...
int
PEM_bytes_read_bio_secmem (unsigned char **pdata, long *plen, char **pnm,
                           const char *name, BIO *bp, pem_password_cb *cb,
                           void *u)
{
  return pem_bytes_read_bio_flags (pdata, plen, pnm, name, bp, cb, u,
...
#ifndef OPENSSL_NO_STDIO
int
PEM_ASN1_write (i2d_of_void *i2d, const char *name, FILE *fp, const void *x,
...
static int
PEM_ASN1_write_bio_internal (i2d_of_void *i2d, OSSL_i2d_of_void_ctx *i2d_ctx,
...
int
PEM_ASN1_write_bio_ctx (OSSL_i2d_of_void_ctx *i2d, void *vctx,
 ...
 */
static int
get_header_and_data (BIO *bp, BIO **header, BIO **data, char *name,
                     unsigned int flags)
{
  BIO *tmp = *header;
  char *linebuf, *p;
 ...
 */
int
PEM_read_bio_ex (BIO *bp, char **name_out, char **header, unsigned char **data,
