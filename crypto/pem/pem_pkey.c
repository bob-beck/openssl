...
EVP_PKEY* PEM_read_bio_PUBKEY_ex(BIO* bp,
                                 EVP_PKEY** x,
                                 pem_password_cb* cb,
                                 void* u,
                                 OSSL_LIB_CTX* libctx,
...
EVP_PKEY* PEM_read_PUBKEY_ex(FILE* fp,
                             EVP_PKEY** x,
                             pem_password_cb* cb,
                             void* u,
                             OSSL_LIB_CTX* libctx,
...
EVP_PKEY* PEM_read_PUBKEY(FILE* fp,
                          EVP_PKEY** x,
                          pem_password_cb* cb,
                          void* u) {
...
EVP_PKEY* PEM_read_bio_PrivateKey_ex(BIO* bp,
                                     EVP_PKEY** x,
                                     pem_password_cb* cb,
                                     void* u,
                                     OSSL_LIB_CTX* libctx,
...
#ifndef OPENSSL_NO_STDIO
EVP_PKEY* PEM_read_PrivateKey_ex(FILE* fp,
                                 EVP_PKEY** x,
                                 pem_password_cb* cb,
                                 void* u,
                                 OSSL_LIB_CTX* libctx,
