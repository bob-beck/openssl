...
static EVP_PKEY *
pem_read_bio_key_decoder (BIO *bp, EVP_PKEY **x, pem_password_cb *cb, void *u,
...
static EVP_PKEY *
pem_read_bio_key_legacy (BIO *bp, EVP_PKEY **x, pem_password_cb *cb, void *u,
                         OSSL_LIB_CTX *libctx, const char *propq,
                         int selection)
{
  char *nm = NULL;
...
static EVP_PKEY *
pem_read_bio_key (BIO *bp, EVP_PKEY **x, pem_password_cb *cb, void *u,
                  OSSL_LIB_CTX *libctx, const char *propq, int selection)
{
  EVP_PKEY *ret = NULL;
  BIO *new_bio = NULL;
  int pos;
  ...
  if (ret == NULL
      && (BIO_seek (bp, pos) < 0
          || (ret
              = pem_read_bio_key_legacy (bp, x, ossl_pw_pem_password, &pwdata,
...
EVP_PKEY *
PEM_read_bio_PUBKEY_ex (BIO *bp, EVP_PKEY **x, pem_password_cb *cb, void *u,
                        OSSL_LIB_CTX *libctx, const char *propq)
{
...
EVP_PKEY *
PEM_read_PUBKEY_ex (FILE *fp, EVP_PKEY **x, pem_password_cb *cb, void *u,
                    OSSL_LIB_CTX *libctx, const char *propq)
{
  BIO *b;
  EVP_PKEY *ret;
...
EVP_PKEY *
PEM_read_bio_PrivateKey_ex (BIO *bp, EVP_PKEY **x, pem_password_cb *cb,
 ...
 */
int
PEM_write_bio_PrivateKey_traditional (BIO *bp, const EVP_PKEY *x,
...
static int
no_password_cb (char *buf, int num, int rwflag, void *userdata)
{
  return -1;
}

EVP_PKEY *
PEM_read_bio_Parameters_ex (BIO *bp, EVP_PKEY **x, OSSL_LIB_CTX *libctx,
                            const char *propq)
{
  /*
...
#ifndef OPENSSL_NO_STDIO
EVP_PKEY *
PEM_read_PrivateKey_ex (FILE *fp, EVP_PKEY **x, pem_password_cb *cb, void *u,
                        OSSL_LIB_CTX *libctx, const char *propq)
{
  BIO *b;
  EVP_PKEY *ret;
