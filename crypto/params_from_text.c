    ...
    switch (paramdef->data_type) {
      ...
      case OSSL_PARAM_OCTET_STRING:
        if (ishex) {
          ...
          if (!OPENSSL_hexstr2buf_ex(buf, buf_n, &l, value, ':')) return 0;
        } else {
