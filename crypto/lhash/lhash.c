...
OPENSSL_LHASH*
OPENSSL_LH_set_thunks(OPENSSL_LHASH* lh,
...
static void
doall_util_fn(OPENSSL_LHASH* lh,
              int use_arg,
...
OPENSSL_LH_doall(OPENSSL_LHASH* lh, OPENSSL_LH_DOALL_FUNC func)
{
  ...
  doall_util_fn(lh,
                ...
                lh->daw,
                func,
                (OPENSSL_LH_DOALL_FUNCARG)NULL,
                (OPENSSL_LH_DOALL_FUNCARG_THUNK)NULL,
                NULL);
}
                     ...
                     void* arg)
{
  ...
  doall_util_fn(lh,
                1,
                (OPENSSL_LH_DOALL_FUNC_THUNK)NULL,
                (OPENSSL_LH_DOALL_FUNC)NULL,
                func,
                lh->daaw,
                arg);
}
