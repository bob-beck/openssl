...
OPENSSL_LHASH *
OPENSSL_LH_set_thunks (OPENSSL_LHASH *lh, OPENSSL_LH_HASHFUNCTHUNK hw,
...
OPENSSL_LHASH *
OPENSSL_LH_new (OPENSSL_LH_HASHFUNC h, OPENSSL_LH_COMPFUNC c)
{
  OPENSSL_LHASH *ret;
...
void *
OPENSSL_LH_insert (OPENSSL_LHASH *lh, void *data)
{
  unsigned long hash;
...
void *
OPENSSL_LH_delete (OPENSSL_LHASH *lh, const void *data)
{
  unsigned long hash;
  OPENSSL_LH_NODE *nn, **rn;
  void *ret;
...
void *
OPENSSL_LH_retrieve (OPENSSL_LHASH *lh, const void *data)
{
  unsigned long hash;
  OPENSSL_LH_NODE **rn;
...
static void
doall_util_fn (OPENSSL_LHASH *lh, int use_arg,
               OPENSSL_LH_DOALL_FUNC_THUNK wfunc, OPENSSL_LH_DOALL_FUNC func,
...
void
OPENSSL_LH_doall (OPENSSL_LHASH *lh, OPENSSL_LH_DOALL_FUNC func)
{
  if (lh == NULL)
    return;
...
void
OPENSSL_LH_doall_arg (OPENSSL_LHASH *lh, OPENSSL_LH_DOALL_FUNCARG func,
                      void *arg)
{
  if (lh == NULL)
    return;
...
static OPENSSL_LH_NODE **
getrn (OPENSSL_LHASH *lh, const void *data, unsigned long *rhash)
{
 ...
 */
unsigned long
OPENSSL_LH_strhash (const char *c)
{
  unsigned long ret = 0;
  long n;
  unsigned long v;
 ...
 */
unsigned long
ossl_lh_strcasehash (const char *c)
{
  unsigned long ret = 0;
  long n;
  unsigned long v;
...
unsigned long
OPENSSL_LH_num_items (const OPENSSL_LHASH *lh)
{
  return lh ? lh->num_items : 0;
}

unsigned long
OPENSSL_LH_get_down_load (const OPENSSL_LHASH *lh)
{
  return lh->down_load;
}

void
OPENSSL_LH_set_down_load (OPENSSL_LHASH *lh, unsigned long down_load)
{
