...
int ossl_err_load_crypto_strings(void)
{
    if (0
...
#endif
        || ossl_err_load_X509_strings() == 0 || ossl_err_load_ASN1_strings() == 0 ||
        ...
        || ossl_err_load_BIO_strings() == 0 || ossl_err_load_PKCS7_strings() == 0 ||
        ossl_err_load_X509V3_strings() == 0 || ossl_err_load_PKCS12_strings() == 0 ||
