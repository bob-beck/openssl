...
static int
is_temporary_method_store(int no_store, void* cbdata)
{
...
static int
ossl_method_construct_reserve_store(int no_store, void* cbdata)
{
  struct construct_data_st* data = cbdata;
...
static int
ossl_method_construct_unreserve_store(void* cbdata)
{
  struct construct_data_st* data = cbdata;
...
static int
ossl_method_construct_precondition(OSSL_PROVIDER* provider,
                                   int operation_id,
                                   int no_store,
                                   void* cbdata,
                                   int* result)
...
static int
ossl_method_construct_postcondition(OSSL_PROVIDER* provider,
                                    int operation_id,
                                    int no_store,
                                    void* cbdata,
                                    int* result)
...
static void
ossl_method_construct_this(OSSL_PROVIDER* provider,
...
void*
ossl_method_construct(OSSL_LIB_CTX* libctx,
                      int operation_id,
                      OSSL_PROVIDER** provider_rw,
                      int force_store,
                      OSSL_METHOD_CONSTRUCT_METHOD* mcm,
                      void* mcm_data)
{
