 ...
 */
unsigned char *
PKCS12_pbe_crypt_ex (const X509_ALGOR *algor, const char *pass, int passlen,
                     const unsigned char *in, int inlen, unsigned char **data,
                     int *datalen, int en_de, OSSL_LIB_CTX *libctx,
                     const char *propq)
{
...
void *
PKCS12_item_decrypt_d2i_ex (const X509_ALGOR *algor, const ASN1_ITEM *it,
