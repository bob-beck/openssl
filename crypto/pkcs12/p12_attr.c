...
int
PKCS12_add_friendlyname_asc (PKCS12_SAFEBAG *bag, const char *name,
                             int namelen)
{
...
int
PKCS12_add_friendlyname_utf8 (PKCS12_SAFEBAG *bag, const char *name,
                              int namelen)
{
...
int
PKCS12_add1_attr_by_NID (PKCS12_SAFEBAG *bag, int nid, int type,
...
int
PKCS12_add1_attr_by_txt (PKCS12_SAFEBAG *bag, const char *attrname, int type,
                         const unsigned char *bytes, int len)
{
...
void
PKCS12_SAFEBAG_set0_attrs (PKCS12_SAFEBAG *bag,
