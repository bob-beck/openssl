...
PKCS12 *
PKCS12_create_ex2 (const char *pass, const char *name, EVP_PKEY *pkey,
                   X509 *cert, STACK_OF (X509) *ca, int nid_key, int nid_cert,
                   int iter, int mac_iter, int keytype, OSSL_LIB_CTX *ctx,
  ...
  if (cert)
    {
      ...
      bag = pkcs12_add_cert_bag (&bags, cert, name, namelen, pkeyid,
                                 pkeyidlen);
      if (cb != NULL)
        {
          cbret = cb (bag, cbarg);
...
PKCS12 *
PKCS12_create_ex (const char *pass, const char *name, EVP_PKEY *pkey,
                  X509 *cert, STACK_OF (X509) *ca, int nid_key, int nid_cert,
                  int iter, int mac_iter, int keytype, OSSL_LIB_CTX *ctx,
                  const char *propq)
{
...
pkcs12_add_cert_bag (STACK_OF (PKCS12_SAFEBAG) **pbags, X509 *cert,
                     const char *name, int namelen, unsigned char *keyid,
                     int keyidlen)
{
  PKCS12_SAFEBAG *bag = NULL;
...
PKCS12_SAFEBAG *
PKCS12_add_key_ex (STACK_OF (PKCS12_SAFEBAG) **pbags, EVP_PKEY *key,
                   int key_usage, int iter, int nid_key, const char *pass,
...
PKCS12_SAFEBAG *
PKCS12_add_key (STACK_OF (PKCS12_SAFEBAG) **pbags, EVP_PKEY *key,
                int key_usage, int iter, int nid_key, const char *pass)
{
...
PKCS12_SAFEBAG *
PKCS12_add_secret (STACK_OF (PKCS12_SAFEBAG) **pbags, int nid_type,
...
int
PKCS12_add_safe_ex (STACK_OF (PKCS7) **psafes, STACK_OF (PKCS12_SAFEBAG) *bags,
...
PKCS12 *
PKCS12_add_safes_ex (STACK_OF (PKCS7) *safes, int nid_p7, OSSL_LIB_CTX *ctx,
                     const char *propq)
{
  PKCS12 *p12;
