...
X509_SIG *
PKCS8_encrypt_ex (int pbe_nid, const EVP_CIPHER *cipher, const char *pass,
                  int passlen, unsigned char *salt, int saltlen, int iter,
                  PKCS8_PRIV_KEY_INFO *p8inf, OSSL_LIB_CTX *libctx,
                  const char *propq)
{
  X509_SIG *p8 = NULL;
  X509_ALGOR *pbe;
...
X509_SIG *
PKCS8_set0_pbe_ex (const char *pass, int passlen, PKCS8_PRIV_KEY_INFO *p8inf,
...
X509_SIG *
PKCS8_set0_pbe (const char *pass, int passlen, PKCS8_PRIV_KEY_INFO *p8inf,
                X509_ALGOR *pbe)
{
