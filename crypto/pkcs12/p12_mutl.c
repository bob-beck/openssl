...
static int
pkcs12_gen_gost_mac_key (const char *pass, int passlen,
...
static int
PBMAC1_PBKDF2_HMAC (OSSL_LIB_CTX *ctx, const char *propq, const char *pass,
...
static int
pkcs12_gen_mac (PKCS12 *p12, const char *pass, int passlen, unsigned char *mac,
                unsigned int *maclen, int pbmac1_md_nid, int pbmac1_kdf_nid,
                int (*pkcs12_key_gen) (const char *pass, int passlen,
                                       unsigned char *salt, int slen, int id,
                                       int iter, int n, unsigned char *out,
                                       const EVP_MD *md_type))
{
  int ret = 0;
  const EVP_MD *md;
...
/* Set a mac */
int
PKCS12_set_mac (PKCS12 *p12, const char *pass, int passlen,
...
static int
pkcs12_pbmac1_pbkdf2_key_gen (const char *pass, int passlen,
                              unsigned char *salt, int saltlen, int id,
...
int
PKCS12_set_pbmac1_pbkdf2 (PKCS12 *p12, const char *pass, int passlen,
                          unsigned char *salt, int saltlen, int iter,
