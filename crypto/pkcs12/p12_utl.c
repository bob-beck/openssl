 ...
 */
unsigned char*
OPENSSL_utf82uni(const char* asc, int asclen, unsigned char** uni, int* unilen)
{
  int ulen, i, j;
...
static int
bmp_to_utf8(char* str, const unsigned char* utf16, int len)
{
...
char*
OPENSSL_uni2utf8(const unsigned char* uni, int unilen)
{
  int asclen, i, j;
  char* asctmp;
...
int
i2d_PKCS12_bio(BIO* bp, const PKCS12* p12)
{
...
int
i2d_PKCS12_fp(FILE* fp, const PKCS12* p12)
{
