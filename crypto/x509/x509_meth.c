...
X509_LOOKUP_METHOD*
X509_LOOKUP_meth_new(const char* name)
{
...
void
X509_LOOKUP_meth_free(X509_LOOKUP_METHOD* method)
{
  if (method != NULL)
...
int
X509_LOOKUP_meth_set_new_item(X509_LOOKUP_METHOD* method,
...
int
X509_LOOKUP_meth_set_free(X509_LOOKUP_METHOD* method,
...
int
X509_LOOKUP_meth_set_init(X509_LOOKUP_METHOD* method,
...
int
X509_LOOKUP_meth_set_shutdown(X509_LOOKUP_METHOD* method,
...
int
X509_LOOKUP_meth_set_ctrl(X509_LOOKUP_METHOD* method, X509_LOOKUP_ctrl_fn ctrl)
{
  method->ctrl = ctrl;
  return 1;
}
...
int
X509_LOOKUP_meth_set_get_by_alias(X509_LOOKUP_METHOD* method,
