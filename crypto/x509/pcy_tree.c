...
static void
expected_print (BIO *channel, X509_POLICY_LEVEL *lev, X509_POLICY_NODE *node,
                int indent)
{
...
static void
tree_print (BIO *channel, char *str, X509_POLICY_TREE *tree,
 ...
 */
static int
tree_init (X509_POLICY_TREE **ptree, STACK_OF (X509) *certs,
           unsigned int flags)
{
 ...
 */
static int
tree_link_matching_nodes (X509_POLICY_LEVEL *curr, X509_POLICY_DATA *data,
                          X509_POLICY_TREE *tree)
{
