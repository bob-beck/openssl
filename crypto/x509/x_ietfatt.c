...
d2i_OSSL_IETF_ATTR_SYNTAX (OSSL_IETF_ATTR_SYNTAX **a, const unsigned char **in,
                           long len)
{
...
void *
OSSL_IETF_ATTR_SYNTAX_get0_value (const OSSL_IETF_ATTR_SYNTAX *a, int ind,
                                  int *type)
{
  OSSL_IETF_ATTR_SYNTAX_VALUE *val;
...
int
OSSL_IETF_ATTR_SYNTAX_add1_value (OSSL_IETF_ATTR_SYNTAX *a, int type,
                                  void *data)
{
  OSSL_IETF_ATTR_SYNTAX_VALUE *val;
      ...
      for (i = 0; i < sk_GENERAL_NAME_num (a->policyAuthority); i++)
        {
          ...
          if (GENERAL_NAME_print (
                  bp, sk_GENERAL_NAME_value (a->policyAuthority, i))
              <= 0)
            goto err;
