...
i2v_TLS_FEATURE (const X509V3_EXT_METHOD *method, TLS_FEATURE *tls_feature,
...
ASN1_ITEM_TEMPLATE (TLS_FEATURE)
    = ASN1_EX_TEMPLATE_TYPE (ASN1_TFLG_SEQUENCE_OF, 0, TLS_FEATURE,
                             ASN1_INTEGER)
...
static TLS_FEATURE_NAME tls_feature_tbl[]
    = { { 5, "status_request" }, { 17, "status_request_v2" } };
 ...
 */
static TLS_FEATURE *
v2i_TLS_FEATURE (const X509V3_EXT_METHOD *method, X509V3_CTX *ctx,
                 STACK_OF (CONF_VALUE) *nval)
{
  TLS_FEATURE *tlsf;
  char *extval, *endptr;
