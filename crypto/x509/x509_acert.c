...
int X509_ACERT_get_attr_by_OBJ(const X509_ACERT* x,
...
int X509_ACERT_add1_attr_by_NID(X509_ACERT* x,
                                int nid,
                                int type,
                                const void* bytes,
                                int len) {
...
int X509_ACERT_add_attr_nconf(CONF* conf,
                              const char* section,
                              X509_ACERT* acert) {
  int ret = 0, i;
...
void* X509_ACERT_get_ext_d2i(const X509_ACERT* x,
                             int nid,
                             int* crit,
                             int* idx) {
...
int X509_ACERT_add1_ext_i2d(X509_ACERT* x,
                            int nid,
                            void* value,
                            int crit,
                            unsigned long flags) {
