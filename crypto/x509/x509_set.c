...
int
X509_SIG_INFO_get (const X509_SIG_INFO *siginf, int *mdnid, int *pknid,
...
void
X509_SIG_INFO_set (X509_SIG_INFO *siginf, int mdnid, int pknid, int secbits,
                   uint32_t flags)
{
  siginf->mdnid = mdnid;
  siginf->pknid = pknid;
...
int
X509_get_signature_info (X509 *x, int *mdnid, int *pknid, int *secbits,
                         uint32_t *flags)
{
...
static int
x509_sig_info_init (X509_SIG_INFO *siginf, const X509_ALGOR *alg,
