...
int
X509v3_get_ext_by_critical(const STACK_OF(X509_EXTENSION)* sk,
                           int crit,
                           int lastpos)
{
  int n, c;
...
X509_EXTENSION*
X509_EXTENSION_create_by_NID(X509_EXTENSION** ex,
                             int nid,
                             int crit,
...
X509_EXTENSION*
X509_EXTENSION_create_by_OBJ(X509_EXTENSION** ex,
                             const ASN1_OBJECT* obj,
                             int crit,
                             ASN1_OCTET_STRING* data)
{
