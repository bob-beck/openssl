...
int
X509_CRL_print_ex(BIO* out, X509_CRL* x, unsigned long nmflag)
{
  ...
  X509V3_extensions_print(
    out, "CRL extensions", X509_CRL_get0_extensions(x), 0, 4);
  ...
  for (i = 0; i < sk_X509_REVOKED_num(rev); i++) {
    ...
    BIO_printf(out, "\n");
    X509V3_extensions_print(
      out, "CRL entry extensions", X509_REVOKED_get0_extensions(r), 0, 8);
  }
