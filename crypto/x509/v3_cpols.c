...
static int i2r_certpol(X509V3_EXT_METHOD* method,
...
static STACK_OF(POLICYINFO)* r2i_certpol(X509V3_EXT_METHOD* method,
                                         X509V3_CTX* ctx,
                                         const char* value);
static void print_qualifiers(BIO* out,
                             STACK_OF(POLICYQUALINFO)* quals,
                             int indent);
static void print_notice(BIO* out, USERNOTICE* notice, int indent);
static POLICYINFO* policy_section(X509V3_CTX* ctx,
                                  STACK_OF(CONF_VALUE)* polstrs,
                                  int ia5org);
...
ASN1_SEQUENCE(POLICYINFO) = {
    ...
    ASN1_SEQUENCE_OF_OPT(POLICYINFO,
                         qualifiers,
    ...
    {ADB_ENTRY(NID_id_qt_cps,
     ...
     ADB_ENTRY(NID_id_qt_unotice,
               ASN1_SIMPLE(POLICYQUALINFO,
                           d.usernotice,
                           USERNOTICE))} ASN1_ADB_END(POLICYQUALINFO,
                                                      0,
                                                      pqualid,
                                                      0,
                                                      &policydefault_tt,
