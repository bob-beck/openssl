...
X509_verify(X509* a, EVP_PKEY* r)
{
  ...
  return ASN1_item_verify_ex(ASN1_ITEM_rptr(X509_CINF),
                             &a->sig_alg,
                             &a->signature,
                             &a->cert_info,
                             a->distinguishing_id,
                   ...
                   const char* propq)
{
  ...
  return ASN1_item_verify_ex(ASN1_ITEM_rptr(X509_REQ_INFO),
                             &a->sig_alg,
                             a->signature,
                             &a->req_info,
                             a->distinguishing_id,
...
int
X509_ACERT_verify(X509_ACERT* a, EVP_PKEY* r)
{
  if (X509_ALGOR_cmp(&a->sig_alg, &a->acinfo->signature) != 0)
    return 0;

  return ASN1_item_verify_ex(ASN1_ITEM_rptr(X509_ACERT_INFO),
                             &a->sig_alg,
                             &a->signature,
                             a->acinfo,
                             NULL,
...
NETSCAPE_SPKI_verify(NETSCAPE_SPKI* a, EVP_PKEY* r)
{
  return ASN1_item_verify(
    ASN1_ITEM_rptr(NETSCAPE_SPKAC), &a->sig_algor, a->signature, a->spkac, r);
}
...
X509_sign(X509* x, EVP_PKEY* pkey, const EVP_MD* md)
{
  ...
  return ASN1_item_sign_ex(ASN1_ITEM_rptr(X509_CINF),
...
X509*
X509_load_http(const char* url, BIO* bio, BIO* rbio, int timeout)
{
...
X509_REQ_sign(X509_REQ* x, EVP_PKEY* pkey, const EVP_MD* md)
{
  ...
  return ASN1_item_sign_ex(ASN1_ITEM_rptr(X509_REQ_INFO),
                           &x->sig_alg,
                           NULL,
                           x->signature,
                           &x->req_info,
...
X509_CRL_sign(X509_CRL* x, EVP_PKEY* pkey, const EVP_MD* md)
{
  ...
  return ASN1_item_sign_ex(ASN1_ITEM_rptr(X509_CRL_INFO),
                           &x->crl.sig_alg,
                           &x->sig_alg,
                           &x->signature,
                           &x->crl,
...
X509_CRL*
X509_CRL_load_http(const char* url, BIO* bio, BIO* rbio, int timeout)
{
  return (X509_CRL*)simple_get_asn1(
    url, bio, rbio, timeout, ASN1_ITEM_rptr(X509_CRL));
}

int
X509_ACERT_sign(X509_ACERT* x, EVP_PKEY* pkey, const EVP_MD* md)
{
  return ASN1_item_sign_ex(ASN1_ITEM_rptr(X509_ACERT_INFO),
                           &x->sig_alg,
                           &x->acinfo->signature,
                           &x->signature,
                           x->acinfo,
...
int
X509_ACERT_sign_ctx(X509_ACERT* x, EVP_MD_CTX* ctx)
{
...
{
  return ASN1_item_sign_ex(ASN1_ITEM_rptr(NETSCAPE_SPKAC),
                           &x->sig_algor,
                           NULL,
                           x->signature,
                           x->spkac,
...
int
i2d_X509_fp(FILE* fp, const X509* x509)
{
...
int
i2d_X509_bio(BIO* bp, const X509* x509)
{
...
int
i2d_X509_CRL_fp(FILE* fp, const X509_CRL* crl)
{
...
int
i2d_X509_CRL_bio(BIO* bp, const X509_CRL* crl)
{
...
int
i2d_PKCS7_fp(FILE* fp, const PKCS7* p7)
{
...
int
i2d_PKCS7_bio(BIO* bp, const PKCS7* p7)
{
...
int
i2d_X509_REQ_fp(FILE* fp, const X509_REQ* req)
{
...
int
i2d_X509_REQ_bio(BIO* bp, const X509_REQ* req)
{
...
int
i2d_RSAPrivateKey_fp(FILE* fp, const RSA* rsa)
{
...
{
  return ASN1_d2i_fp(
    (void* (*)(void))RSA_new, (D2I_OF(void))d2i_RSA_PUBKEY, fp, (void**)rsa);
}

int
i2d_RSAPublicKey_fp(FILE* fp, const RSA* rsa)
{
  return ASN1_item_i2d_fp(ASN1_ITEM_rptr(RSAPublicKey), fp, rsa);
}

int
i2d_RSA_PUBKEY_fp(FILE* fp, const RSA* rsa)
{
...
int
i2d_RSAPrivateKey_bio(BIO* bp, const RSA* rsa)
{
...
int
i2d_RSAPublicKey_bio(BIO* bp, const RSA* rsa)
{
  return ASN1_item_i2d_bio(ASN1_ITEM_rptr(RSAPublicKey), bp, rsa);
}

int
i2d_RSA_PUBKEY_bio(BIO* bp, const RSA* rsa)
{
...
int
i2d_DSAPrivateKey_fp(FILE* fp, const DSA* dsa)
{
...
int
i2d_DSA_PUBKEY_fp(FILE* fp, const DSA* dsa)
{
...
int
i2d_DSAPrivateKey_bio(BIO* bp, const DSA* dsa)
{
...
int
i2d_DSA_PUBKEY_bio(BIO* bp, const DSA* dsa)
{
...
int
i2d_EC_PUBKEY_fp(FILE* fp, const EC_KEY* eckey)
{
...
int
i2d_ECPrivateKey_fp(FILE* fp, const EC_KEY* eckey)
{
...
int
i2d_EC_PUBKEY_bio(BIO* bp, const EC_KEY* ecdsa)
{
...
int
i2d_ECPrivateKey_bio(BIO* bp, const EC_KEY* eckey)
{
...
int
X509_pubkey_digest(const X509* data,
                   const EVP_MD* type,
                   unsigned char* md,
                   unsigned int* len)
{
            ...
            unsigned int* len)
{
  ...
  return ossl_asn1_item_digest_ex(ASN1_ITEM_rptr(X509),
                                  md,
                                  (char*)cert,
                                  data,
                                  len,
...
ASN1_OCTET_STRING*
X509_digest_sig(const X509* cert, EVP_MD** md_used, int* md_is_fallback)
{
  unsigned int len;
    ...
    if (pknid == EVP_PKEY_RSA_PSS) {
      ...
      if (pss == NULL ||
          !ossl_rsa_pss_get_param_unverified(
            pss, &mmd, &mgf1md, &saltlen, &trailerfield) ||
          mmd == NULL) {
      ...
      if ((md = EVP_MD_fetch(
             cert->libctx, EVP_MD_get0_name(mmd), cert->propq)) == NULL)
  ...
  } else if ((md = EVP_MD_fetch(
                cert->libctx, OBJ_nid2sn(mdnid), cert->propq)) == NULL &&
...
int
X509_CRL_digest(const X509_CRL* data,
                const EVP_MD* type,
                unsigned char* md,
                unsigned int* len)
{
  ...
  return ossl_asn1_item_digest_ex(ASN1_ITEM_rptr(X509_CRL),
                                  type,
                                  (char*)data,
                                  md,
                                  len,
...
int
X509_REQ_digest(const X509_REQ* data,
                const EVP_MD* type,
                unsigned char* md,
                unsigned int* len)
{
  return ossl_asn1_item_digest_ex(ASN1_ITEM_rptr(X509_REQ),
                                  type,
                                  (char*)data,
                                  md,
                                  len,
...
int
X509_NAME_digest(const X509_NAME* data,
                 const EVP_MD* type,
                 unsigned char* md,
                 unsigned int* len)
{
...
{
  return ASN1_item_digest(
    ASN1_ITEM_rptr(PKCS7_ISSUER_AND_SERIAL), type, (char*)data, md, len);
}
...
int
i2d_PKCS8_fp(FILE* fp, const X509_SIG* p8)
{
...
int
i2d_PKCS8_bio(BIO* bp, const X509_SIG* p8)
{
...
#ifndef OPENSSL_NO_STDIO
X509_PUBKEY*
d2i_X509_PUBKEY_fp(FILE* fp, X509_PUBKEY** xpk)
{
  return ASN1_d2i_fp_of(X509_PUBKEY, X509_PUBKEY_new, d2i_X509_PUBKEY, fp, xpk);
}

int
i2d_X509_PUBKEY_fp(FILE* fp, const X509_PUBKEY* xpk)
{
...
X509_PUBKEY*
d2i_X509_PUBKEY_bio(BIO* bp, X509_PUBKEY** xpk)
{
  return ASN1_d2i_bio_of(
    X509_PUBKEY, X509_PUBKEY_new, d2i_X509_PUBKEY, bp, xpk);
}

int
i2d_X509_PUBKEY_bio(BIO* bp, const X509_PUBKEY* xpk)
{
...
{
  return ASN1_d2i_fp_of(PKCS8_PRIV_KEY_INFO,
...
int
i2d_PKCS8_PRIV_KEY_INFO_fp(FILE* fp, const PKCS8_PRIV_KEY_INFO* p8inf)
{
  return ASN1_i2d_fp_of(
    PKCS8_PRIV_KEY_INFO, i2d_PKCS8_PRIV_KEY_INFO, fp, p8inf);
}

int
i2d_PKCS8PrivateKeyInfo_fp(FILE* fp, const EVP_PKEY* key)
{
...
int
i2d_PrivateKey_fp(FILE* fp, const EVP_PKEY* pkey)
{
...
int
i2d_PUBKEY_fp(FILE* fp, const EVP_PKEY* pkey)
{
...
{
  return ASN1_d2i_bio_of(PKCS8_PRIV_KEY_INFO,
                         PKCS8_PRIV_KEY_INFO_new,
                         d2i_PKCS8_PRIV_KEY_INFO,
                         bp,
                         p8inf);
...
int
i2d_PKCS8_PRIV_KEY_INFO_bio(BIO* bp, const PKCS8_PRIV_KEY_INFO* p8inf)
{
  return ASN1_i2d_bio_of(
    PKCS8_PRIV_KEY_INFO, i2d_PKCS8_PRIV_KEY_INFO, bp, p8inf);
}

int
i2d_PKCS8PrivateKeyInfo_bio(BIO* bp, const EVP_PKEY* key)
{
  PKCS8_PRIV_KEY_INFO* p8inf;
  int ret;
...
int
i2d_PrivateKey_bio(BIO* bp, const EVP_PKEY* pkey)
{
...
int
i2d_PUBKEY_bio(BIO* bp, const EVP_PKEY* pkey)
{
  return ASN1_i2d_bio_of(EVP_PKEY, i2d_PUBKEY, bp, pkey);
}

EVP_PKEY*
d2i_PUBKEY_ex_bio(BIO* bp,
                  EVP_PKEY** a,
                  OSSL_LIB_CTX* libctx,
                  const char* propq)
{
...
#ifndef OPENSSL_NO_STDIO
X509_ACERT*
d2i_X509_ACERT_fp(FILE* fp, X509_ACERT** acert)
{
  return ASN1_item_d2i_fp(ASN1_ITEM_rptr(X509_ACERT), fp, acert);
}

int
i2d_X509_ACERT_fp(FILE* fp, const X509_ACERT* acert)
{
...
X509_ACERT*
d2i_X509_ACERT_bio(BIO* bp, X509_ACERT** acert)
{
  return ASN1_item_d2i_bio(ASN1_ITEM_rptr(X509_ACERT), bp, acert);
}

int
i2d_X509_ACERT_bio(BIO* bp, const X509_ACERT* acert)
{
