...
int X509_REQ_verify_ex(X509_REQ* a,
                       EVP_PKEY* r,
                       OSSL_LIB_CTX* libctx,
                       const char* propq) {
...
static ASN1_VALUE* simple_get_asn1(const char* url,
                                   BIO* bio,
                                   BIO* rbio,
                                   int timeout,
                                   const ASN1_ITEM* it) {
...
X509_CRL* X509_CRL_load_http(const char* url,
                             BIO* bio,
                             BIO* rbio,
                             int timeout) {
...
int X509_digest(const X509* cert,
                const EVP_MD* md,
                unsigned char* data,
                unsigned int* len) {
...
EVP_PKEY* d2i_PrivateKey_ex_fp(FILE* fp,
                               EVP_PKEY** a,
                               OSSL_LIB_CTX* libctx,
                               const char* propq) {
  BIO* b;
...
EVP_PKEY* d2i_PUBKEY_ex_fp(FILE* fp,
                           EVP_PKEY** a,
                           OSSL_LIB_CTX* libctx,
                           const char* propq) {
  BIO* b;
...
EVP_PKEY* d2i_PrivateKey_ex_bio(BIO* bp,
                                EVP_PKEY** a,
                                OSSL_LIB_CTX* libctx,
                                const char* propq) {
  BUF_MEM* b = NULL;
...
EVP_PKEY* d2i_PUBKEY_ex_bio(BIO* bp,
                            EVP_PKEY** a,
                            OSSL_LIB_CTX* libctx,
                            const char* propq) {
  BUF_MEM* b = NULL;
