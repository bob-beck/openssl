...
static const ERR_STRING_DATA X509_str_reasons[] = {
  ...
  { ERR_PACK (ERR_LIB_X509, 0, X509_R_BAD_X509_FILETYPE),
    "bad x509 filetype" },
  { ERR_PACK (ERR_LIB_X509, 0, X509_R_BASE64_DECODE_ERROR),
    "base64 decode error" },
  { ERR_PACK (ERR_LIB_X509, 0, X509_R_CANT_CHECK_DH_KEY),
    "can't check dh key" },
  ...
  { ERR_PACK (ERR_LIB_X509, 0, X509_R_CRL_ALREADY_DELTA),
    "crl already delta" },
  ...
  { ERR_PACK (ERR_LIB_X509, 0, X509_R_INVALID_DIRECTORY),
    "invalid directory" },
  { ERR_PACK (ERR_LIB_X509, 0, X509_R_INVALID_DISTPOINT),
    "invalid distpoint" },
  ...
  { ERR_PACK (ERR_LIB_X509, 0, X509_R_KEY_TYPE_MISMATCH),
    "key type mismatch" },
  ...
  { ERR_PACK (ERR_LIB_X509, 0, X509_R_UNSUPPORTED_VERSION),
    "unsupported version" },
  { ERR_PACK (ERR_LIB_X509, 0, X509_R_WRONG_LOOKUP_TYPE),
    "wrong lookup type" },
...
int
ossl_err_load_X509_strings (void)
{
#ifndef OPENSSL_NO_ERR
