...
static int
x509_name_ex_d2i(ASN1_VALUE** val,
...
static int
x509_name_ex_i2d(const ASN1_VALUE** val,
                 unsigned char** out,
                 const ASN1_ITEM* it,
                 int tag,
                 int aclass);
...
static void
x509_name_ex_free(ASN1_VALUE** val, const ASN1_ITEM* it);
...
static int
i2d_name_canon(const STACK_OF(STACK_OF_X509_NAME_ENTRY)* intname,
               unsigned char** in);

static int
x509_name_ex_print(BIO* out,
...
x509_name_encode(X509_NAME* a)
{
  ...
  len = ASN1_item_ex_i2d(
    &intname.a, NULL, ASN1_ITEM_rptr(X509_NAME_INTERNAL), -1, -1);
                   ...
                   const ASN1_PCTX* pctx)
{
  if (X509_NAME_print_ex(
        out, (const X509_NAME*)*pval, indent, pctx->nm_flags) <= 0)
    return 0;
  return 2;
}
...
int
X509_NAME_get0_der(const X509_NAME* nm,
