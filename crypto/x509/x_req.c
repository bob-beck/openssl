...
static int
req_cb(int operation, ASN1_VALUE** pval, const ASN1_ITEM* it, void* exarg)
{
...
void
X509_REQ_set0_distinguishing_id(X509_REQ* x, ASN1_OCTET_STRING* d_id)
{
...
ASN1_OCTET_STRING*
X509_REQ_get0_distinguishing_id(X509_REQ* x)
{
...
X509_REQ*
X509_REQ_new_ex(OSSL_LIB_CTX* libctx, const char* propq)
{
  X509_REQ* req = NULL;
