...
static int
i2r_ISSUER_SERIAL(X509V3_EXT_METHOD* method,
...
i2r_OBJECT_DIGEST_INFO(X509V3_EXT_METHOD* method,
                       ...
                       int indent);
static int
i2r_TARGET_CERT(X509V3_EXT_METHOD* method,
                OSSL_TARGET_CERT* tc,
                BIO* out,
                int indent);
static int
i2r_TARGET(X509V3_EXT_METHOD* method,
           OSSL_TARGET* target,
           BIO* out,
           int indent);
static int
...
static int
i2r_TARGET(X509V3_EXT_METHOD* method, OSSL_TARGET* target, BIO* out, int indent)
{
  switch (target->type) {
...
static int
i2r_TARGETS(X509V3_EXT_METHOD* method,
