...
static int i2r_TARGET_CERT (X509V3_EXT_METHOD *method, OSSL_TARGET_CERT *tc,
                            BIO *out, int indent);
static int i2r_TARGET (X509V3_EXT_METHOD *method, OSSL_TARGET *target,
                       BIO *out, int indent);
...
static int
i2r_ISSUER_SERIAL (X509V3_EXT_METHOD *method, OSSL_ISSUER_SERIAL *iss,
                   BIO *out, int indent)
{
  if (iss->issuer != NULL)
    {
...
static int
i2r_OBJECT_DIGEST_INFO (X509V3_EXT_METHOD *method,
                        OSSL_OBJECT_DIGEST_INFO *odi, BIO *out, int indent)
{
  int64_t dot = 0;
...
static int
i2r_TARGET_CERT (X509V3_EXT_METHOD *method, OSSL_TARGET_CERT *tc, BIO *out,
                 int indent)
{
...
static int
i2r_TARGET (X509V3_EXT_METHOD *method, OSSL_TARGET *target, BIO *out,
            int indent)
{
  switch (target->type)
    {
...
static int
i2r_TARGETS (X509V3_EXT_METHOD *method, OSSL_TARGETS *targets, BIO *out,
             int indent)
{
  int i;
  OSSL_TARGET *target;
...
static int
i2r_TARGETING_INFORMATION (X509V3_EXT_METHOD *method,
                           OSSL_TARGETING_INFORMATION *tinfo, BIO *out,
                           int indent)
{
  int i;
