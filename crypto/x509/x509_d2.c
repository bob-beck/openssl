...
int X509_STORE_set_default_paths_ex(X509_STORE* ctx,
                                    OSSL_LIB_CTX* libctx,
                                    const char* propq) {
  X509_LOOKUP* lookup;
...
int X509_STORE_load_file_ex(X509_STORE* ctx,
                            const char* file,
                            OSSL_LIB_CTX* libctx,
                            const char* propq) {
  X509_LOOKUP* lookup;
...
int X509_STORE_load_store_ex(X509_STORE* ctx,
                             const char* uri,
                             OSSL_LIB_CTX* libctx,
                             const char* propq) {
  X509_LOOKUP* lookup;
...
int X509_STORE_load_locations_ex(X509_STORE* ctx,
                                 const char* file,
                                 const char* path,
                                 OSSL_LIB_CTX* libctx,
                                 const char* propq) {
