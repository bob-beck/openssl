...
int
X509_STORE_set_default_paths_ex (X509_STORE *ctx, OSSL_LIB_CTX *libctx,
                                 const char *propq)
{
  X509_LOOKUP *lookup;
...
int
X509_STORE_load_file_ex (X509_STORE *ctx, const char *file,
...
int
X509_STORE_load_path (X509_STORE *ctx, const char *path)
{
  X509_LOOKUP *lookup;
...
int
X509_STORE_load_store_ex (X509_STORE *ctx, const char *uri,
                          OSSL_LIB_CTX *libctx, const char *propq)
{
  X509_LOOKUP *lookup;
...
int
X509_STORE_load_store (X509_STORE *ctx, const char *uri)
{
  return X509_STORE_load_store_ex (ctx, uri, NULL, NULL);
}

int
X509_STORE_load_locations_ex (X509_STORE *ctx, const char *file,
