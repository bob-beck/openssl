 ...
 */
static int
i2r_ASIdentifierChoice(BIO* out,
 ...
 */
static int
i2r_ASIdentifiers(const X509V3_EXT_METHOD* method,
                  void* ext,
                  BIO* out,
                  int indent)
{
  ASIdentifiers* asid = ext;
  return (i2r_ASIdentifierChoice(
            out, asid->asnum, indent, "Autonomous System Numbers") &&
          i2r_ASIdentifierChoice(
            out, asid->rdi, indent, "Routing Domain Identifiers"));
}
 ...
 */
int
X509v3_asid_add_id_or_range(ASIdentifiers* asid,
                            int which,
                            ASN1_INTEGER* min,
                            ASN1_INTEGER* max)
{
 ...
 */
static void*
v2i_ASIdentifiers(const struct v3_ext_method* method,
 ...
 */
static int
asid_validate_path_internal(X509_STORE_CTX* ctx,
                            STACK_OF(X509)* chain,
                            ASIdentifiers* ext)
{
 ...
 */
int
X509v3_asid_validate_resource_set(STACK_OF(X509)* chain,
                                  ASIdentifiers* ext,
