...
static int
check_purpose_ns_ssl_server(const X509_PURPOSE* xp,
                            const X509* x,
                            int non_leaf);
static int
...
static int
check_purpose_smime_encrypt(const X509_PURPOSE* xp,
                            const X509* x,
                            int non_leaf);
static int
check_purpose_crl_sign(const X509_PURPOSE* xp, const X509* x, int non_leaf);
static int
check_purpose_timestamp_sign(const X509_PURPOSE* xp,
                             const X509* x,
                             int non_leaf);
static int
...
static int
check_purpose_ns_ssl_server(const X509_PURPOSE* xp, const X509* x, int non_leaf)
{
...
static int
check_purpose_smime_encrypt(const X509_PURPOSE* xp, const X509* x, int non_leaf)
{
  int ret = purpose_smime(x, non_leaf);
