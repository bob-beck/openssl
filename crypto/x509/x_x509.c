...
X509*
X509_new_ex(OSSL_LIB_CTX* libctx, const char* propq)
{
  X509* cert = NULL;
...
void*
X509_get_ex_data(const X509* r, int idx)
{
 ...
 */
static int
i2d_x509_aux_internal(const X509* a, unsigned char** pp)
{
  int length, tmplen;
 ...
 */
int
i2d_X509_AUX(const X509* a, unsigned char** pp)
{
  int length;
  unsigned char* tmp;
...
void
X509_set0_distinguishing_id(X509* x, ASN1_OCTET_STRING* d_id)
{
...
ASN1_OCTET_STRING*
X509_get0_distinguishing_id(X509* x)
{
