...
static int
append_ia5(STACK_OF(OPENSSL_STRING)** sk, const ASN1_IA5STRING* email);
...
static int
x509v3_add_len_value(const char* name,
                     const char* value,
                     size_t vallen,
...
int
X509V3_add_value(const char* name,
                 const char* value,
                 STACK_OF(CONF_VALUE)** extlist)
{
...
int
X509V3_add_value_uchar(const char* name,
...
int
X509V3_add_value_bool(const char* name,
                      int asn1_bool,
                      STACK_OF(CONF_VALUE)** extlist)
{
  if (asn1_bool)
...
int
X509V3_add_value_bool_nf(const char* name,
                         int asn1_bool,
                         STACK_OF(CONF_VALUE)** extlist)
{
  if (asn1_bool)
...
static char*
bignum_to_string(const BIGNUM* bn)
{
  char *tmp, *ret;
  size_t len;
...
int
X509V3_add_value_int(const char* name,
...
int
ossl_v3_name_cmp(const char* name, const char* cmp)
{
  size_t len;
  int ret;
  char c;
...
typedef int (*equal_fn)(const unsigned char* pattern,
                        size_t pattern_len,
...
static void
skip_prefix(const unsigned char** p,
            size_t* plen,
            size_t subject_len,
            unsigned int flags)
{
...
static int
equal_nocase(const unsigned char* pattern,
             size_t pattern_len,
             const unsigned char* subject,
             size_t subject_len,
             unsigned int flags)
...
static int
equal_case(const unsigned char* pattern,
           size_t pattern_len,
           const unsigned char* subject,
           size_t subject_len,
           unsigned int flags)
 ...
 */
static int
equal_email(const unsigned char* a,
            size_t a_len,
 ...
 */
static int
wildcard_match(const unsigned char* prefix,
               size_t prefix_len,
...
static int
equal_wildcard(const unsigned char* pattern,
               size_t pattern_len,
               const unsigned char* subject,
               size_t subject_len,
               unsigned int flags)
...
static int
do_check_string(const ASN1_STRING* a,
                int cmp_type,
                equal_fn equal,
                unsigned int flags,
                const char* b,
 ...
 */
static int
get_ipv4_component(uint8_t* out_byte, const char** str)
{
...
int
X509V3_NAME_from_section(X509_NAME* nm,
...
int
OSSL_GENERAL_NAMES_print(BIO* out, GENERAL_NAMES* gens, int indent)
{
  int i;
