                             ...
                             int indent)
{
  if (time->startTime != NULL && time->endTime != NULL)
    ...
    { /* Invalid: there must be SOME time specified. */
...
static int
i2r_OSSL_DAY_TIME (X509V3_EXT_METHOD *method, OSSL_DAY_TIME *dt, BIO *out,
                   int indent)
{
  int64_t h = 0;
  int64_t m = 0;
...
static int
i2r_OSSL_DAY_TIME_BAND (X509V3_EXT_METHOD *method, OSSL_DAY_TIME_BAND *band,
                        BIO *out, int indent)
{
...
static int
i2r_OSSL_PERIOD (X509V3_EXT_METHOD *method, OSSL_TIME_PERIOD *p, BIO *out,
                 int indent)
{
  int i;
...
static int
i2r_OSSL_TIME_SPEC_TIME (X509V3_EXT_METHOD *method, OSSL_TIME_SPEC_TIME *time,
                         BIO *out, int indent)
{
  OSSL_TIME_PERIOD *tp;
  int i;
...
static int
i2r_OSSL_TIME_SPEC (X509V3_EXT_METHOD *method, OSSL_TIME_SPEC *time, BIO *out,
                    int indent)
{
  int64_t tz;
