...
static int
x509_pubkey_set0_libctx (X509_PUBKEY *x, OSSL_LIB_CTX *libctx,
                         const char *propq)
{
  if (x != NULL)
    {
...
static int
x509_pubkey_ex_new_ex (ASN1_VALUE **pval, const ASN1_ITEM *it,
                       OSSL_LIB_CTX *libctx, const char *propq)
{
  X509_PUBKEY *ret;
...
static int
x509_pubkey_ex_d2i_ex (ASN1_VALUE **pval, const unsigned char **in, long len,
                       const ASN1_ITEM *it, int tag, int aclass, char opt,
                       ASN1_TLC *ctx, OSSL_LIB_CTX *libctx, const char *propq)
{
...
static int
x509_pubkey_ex_i2d (const ASN1_VALUE **pval, unsigned char **out,
...
static int
x509_pubkey_ex_print (BIO *out, const ASN1_VALUE **pval, int indent,
 ...
 */
static EVP_PKEY *
d2i_PUBKEY_int (EVP_PKEY **a, const unsigned char **pp, long length,
                OSSL_LIB_CTX *libctx, const char *propq,
...
EVP_PKEY *
d2i_PUBKEY_ex (EVP_PKEY **a, const unsigned char **pp, long length,
               OSSL_LIB_CTX *libctx, const char *propq)
{
...
void
X509_PUBKEY_set0_public_key (X509_PUBKEY *pub, unsigned char *penc,
                             int penclen)
{
...
X509_PUBKEY_get0_param (ASN1_OBJECT **ppkalg, const unsigned char **pk,
                        int *ppklen, X509_ALGOR **pa, const X509_PUBKEY *pub)
{
  if (ppkalg)
...
int
ossl_x509_PUBKEY_get0_libctx (OSSL_LIB_CTX **plibctx, const char **ppropq,
