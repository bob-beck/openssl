...
static int x509_pubkey_set0_libctx(X509_PUBKEY* x,
                                   OSSL_LIB_CTX* libctx,
                                   const char* propq) {
  if (x != NULL) {
    x->libctx = libctx;
...
static int x509_pubkey_ex_new_ex(ASN1_VALUE** pval,
                                 const ASN1_ITEM* it,
                                 OSSL_LIB_CTX* libctx,
                                 const char* propq) {
  X509_PUBKEY* ret;
...
static int x509_pubkey_ex_i2d(const ASN1_VALUE** pval,
                              unsigned char** out,
                              const ASN1_ITEM* it,
                              int tag,
                              int aclass) {
...
static int x509_pubkey_ex_print(BIO* out,
