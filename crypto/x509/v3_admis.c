...
static int
i2r_ADMISSION_SYNTAX(const struct v3_ext_method* method,
                     void* in,
                     BIO* bp,
                     int ind);
...
static int
i2r_NAMING_AUTHORITY(const struct v3_ext_method* method,
                     void* in,
                     BIO* bp,
                     int ind)
{
...
void
NAMING_AUTHORITY_set0_authorityId(NAMING_AUTHORITY* n, ASN1_OBJECT* id)
{
...
void
NAMING_AUTHORITY_set0_authorityURL(NAMING_AUTHORITY* n, ASN1_IA5STRING* u)
{
...
void
NAMING_AUTHORITY_set0_authorityText(NAMING_AUTHORITY* n, ASN1_STRING* t)
{
...
void
ADMISSION_SYNTAX_set0_admissionAuthority(ADMISSION_SYNTAX* as, GENERAL_NAME* aa)
{
...
void
ADMISSION_SYNTAX_set0_contentsOfAdmissions(ADMISSION_SYNTAX* as,
...
const GENERAL_NAME*
ADMISSIONS_get0_admissionAuthority(const ADMISSIONS* a)
{
  return a->admissionAuthority;
}

void
ADMISSIONS_set0_admissionAuthority(ADMISSIONS* a, GENERAL_NAME* aa)
{
...
ADMISSIONS_get0_namingAuthority(const ADMISSIONS* a)
{
  return a->namingAuthority;
}

void
ADMISSIONS_set0_namingAuthority(ADMISSIONS* a, NAMING_AUTHORITY* na)
{
...
ADMISSIONS_get0_professionInfos(const ADMISSIONS* a)
{
  return a->professionInfos;
}

void
ADMISSIONS_set0_professionInfos(ADMISSIONS* a, PROFESSION_INFOS* pi)
{
...
void
PROFESSION_INFO_set0_addProfessionInfo(PROFESSION_INFO* pi,
...
void
PROFESSION_INFO_set0_namingAuthority(PROFESSION_INFO* pi, NAMING_AUTHORITY* na)
{
...
void
PROFESSION_INFO_set0_professionItems(PROFESSION_INFO* pi,
...
void
PROFESSION_INFO_set0_professionOIDs(PROFESSION_INFO* pi,
...
void
PROFESSION_INFO_set0_registrationNumber(PROFESSION_INFO* pi,
