...
static int
i2r_NAMING_AUTHORITY (const struct v3_ext_method *method, void *in, BIO *bp,
                      int ind)
{
...
static int
i2r_ADMISSION_SYNTAX (const struct v3_ext_method *method, void *in, BIO *bp,
                      int ind)
{
...
void
ADMISSION_SYNTAX_set0_admissionAuthority (ADMISSION_SYNTAX *as,
                                          GENERAL_NAME *aa)
{
...
void
PROFESSION_INFO_set0_namingAuthority (PROFESSION_INFO *pi,
                                      NAMING_AUTHORITY *na)
{
