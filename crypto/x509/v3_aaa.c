...
ASN1_ITEM_TEMPLATE (OSSL_ALLOWED_ATTRIBUTES_SYNTAX)
    = ASN1_EX_TEMPLATE_TYPE (ASN1_TFLG_SET_OF, 0,
...
static int
i2r_ALLOWED_ATTRIBUTES_CHOICE (X509V3_EXT_METHOD *method,
                               OSSL_ALLOWED_ATTRIBUTES_CHOICE *a, BIO *out,
                               int indent)
{
...
static int
i2r_ALLOWED_ATTRIBUTES_ITEM (X509V3_EXT_METHOD *method,
                             OSSL_ALLOWED_ATTRIBUTES_ITEM *aai, BIO *out,
                             int indent)
{
  int i;
...
static int
i2r_ALLOWED_ATTRIBUTES_SYNTAX (X509V3_EXT_METHOD *method,
                               OSSL_ALLOWED_ATTRIBUTES_SYNTAX *aaa, BIO *out,
                               int indent)
{
  int i;
