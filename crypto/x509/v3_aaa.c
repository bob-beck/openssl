...
ASN1_CHOICE(OSSL_ALLOWED_ATTRIBUTES_CHOICE) = {
    ...
    ASN1_IMP(OSSL_ALLOWED_ATTRIBUTES_CHOICE, choice.attributeTypeandValues, X509_ATTRIBUTE, OSSL_AAA_ATTRIBUTE_VALUES),
...
ASN1_ITEM_TEMPLATE(OSSL_ALLOWED_ATTRIBUTES_SYNTAX) = ASN1_EX_TEMPLATE_TYPE(ASN1_TFLG_SET_OF, 0,
