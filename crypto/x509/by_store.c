...
static int cache_objects(X509_LOOKUP* lctx,
                         CACHED_STORE* store,
...
static int by_store_ctrl(X509_LOOKUP* ctx,
                         int cmd,
                         const char* argp,
                         long argl,
                         char** retp) {
...
static int by_store(X509_LOOKUP* ctx,
...
static int by_store_subject(X509_LOOKUP* ctx,
                            X509_LOOKUP_TYPE type,
