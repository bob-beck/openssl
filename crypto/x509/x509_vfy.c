 ...
 */
static X509* get0_best_issuer_sk(X509_STORE_CTX* ctx,
...
static int check_issued(ossl_unused X509_STORE_CTX* ctx,
                        X509* x,
                        X509* issuer) {
 ...
 * Returns -1 on internal error.
 */
static int get1_best_issuer_other_sk(X509** issuer,
                                     X509_STORE_CTX* ctx,
                                     X509* x) {
 ...
 * Sadly, returns 0 also on internal error in ctx->verify_cb().
 */
static int check_purpose(X509_STORE_CTX* ctx,
                         X509* x,
                         int purpose,
                         int depth,
                         int must_be_ca) {
...
int X509_STORE_CTX_init_rpk(X509_STORE_CTX* ctx,
                            X509_STORE* store,
                            EVP_PKEY* rpk) {
