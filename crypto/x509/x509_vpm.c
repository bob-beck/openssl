...
static int
int_x509_param_set_hosts (X509_VERIFY_PARAM *vpm, int mode, const char *name,
                          size_t namelen)
{
  char *copy;
...
int
X509_VERIFY_PARAM_inherit (X509_VERIFY_PARAM *dest,
 ...
 */
void
X509_VERIFY_PARAM_move_peername (X509_VERIFY_PARAM *to,
