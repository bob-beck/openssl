...
int
X509_NAME_get_text_by_NID(const X509_NAME* name, int nid, char* buf, int len)
{
  ASN1_OBJECT* obj;
...
int
X509_NAME_get_text_by_OBJ(const X509_NAME* name,
...
int
X509_NAME_get_index_by_OBJ(const X509_NAME* name,
                           const ASN1_OBJECT* obj,
                           int lastpos)
{
  int n;
...
int
X509_NAME_add_entry_by_OBJ(X509_NAME* name,
                           const ASN1_OBJECT* obj,
                           int type,
...
int
X509_NAME_add_entry_by_NID(X509_NAME* name,
                           int nid,
                           int type,
                           const unsigned char* bytes,
                           int len,
...
int
X509_NAME_add_entry_by_txt(X509_NAME* name,
                           const char* field,
                           int type,
                           const unsigned char* bytes,
                           int len,
 ...
 */
int
X509_NAME_add_entry(X509_NAME* name,
...
X509_NAME_ENTRY*
X509_NAME_ENTRY_create_by_NID(X509_NAME_ENTRY** ne,
                              int nid,
                              int type,
                              const unsigned char* bytes,
                              int len)
...
int
X509_NAME_ENTRY_set_data(X509_NAME_ENTRY* ne,
                         int type,
                         const unsigned char* bytes,
                         int len)
{
  ...
  if ((type > 0) && (type & MBSTRING_FLAG))
    return ASN1_STRING_set_by_NID(
             &ne->value, bytes, len, type, OBJ_obj2nid(ne->object))
             ? 1
             : 0;
  if (len < 0)
