...
int
TS_CONF_set_signer_digest (CONF *conf, const char *section, const char *md,
                           TS_RESP_CTX *ctx)
{
  int ret = 0;
...
int
TS_CONF_set_clock_precision_digits (const CONF *conf, const char *section,
                                    TS_RESP_CTX *ctx)
{
  int ret = 0;
  long digits = 0;
...
int
TS_CONF_set_ess_cert_id_chain (CONF *conf, const char *section,
                               TS_RESP_CTX *ctx)
{
...
int
TS_CONF_set_ess_cert_id_digest (CONF *conf, const char *section,
                                TS_RESP_CTX *ctx)
{
  int ret = 0;
