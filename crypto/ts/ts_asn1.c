...
ASN1_SEQUENCE(TS_ACCURACY) = {ASN1_OPT(TS_ACCURACY, seconds, ASN1_INTEGER),
...
ASN1_SEQUENCE(TS_TST_INFO) = {ASN1_SIMPLE(TS_TST_INFO, version, ASN1_INTEGER),
...
ASN1_SEQUENCE(TS_STATUS_INFO) = {ASN1_SIMPLE(TS_STATUS_INFO, status, ASN1_INTEGER),
