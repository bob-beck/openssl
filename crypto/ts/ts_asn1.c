...
d2i_TS_MSG_IMPRINT_bio(BIO* bp, TS_MSG_IMPRINT** a)
{
  return ASN1_d2i_bio_of(
    TS_MSG_IMPRINT, TS_MSG_IMPRINT_new, d2i_TS_MSG_IMPRINT, bp, a);
}

int
i2d_TS_MSG_IMPRINT_bio(BIO* bp, const TS_MSG_IMPRINT* a)
{
...
{
  return ASN1_d2i_fp_of(
    TS_MSG_IMPRINT, TS_MSG_IMPRINT_new, d2i_TS_MSG_IMPRINT, fp, a);
}

int
i2d_TS_MSG_IMPRINT_fp(FILE* fp, const TS_MSG_IMPRINT* a)
{
...
ASN1_SEQUENCE(
  TS_REQ) = { ASN1_SIMPLE(TS_REQ, version, ASN1_INTEGER),
              ...
              ASN1_IMP_SEQUENCE_OF_OPT(TS_REQ,
                                       extensions,
                                       X509_EXTENSION,
...
int
i2d_TS_REQ_bio(BIO* bp, const TS_REQ* a)
{
...
int
i2d_TS_REQ_fp(FILE* fp, const TS_REQ* a)
{
...
int
i2d_TS_TST_INFO_bio(BIO* bp, const TS_TST_INFO* a)
{
...
int
i2d_TS_TST_INFO_fp(FILE* fp, const TS_TST_INFO* a)
{
...
ASN1_SEQUENCE(
  TS_STATUS_INFO) = { ASN1_SIMPLE(TS_STATUS_INFO, status, ASN1_INTEGER),
                      ASN1_SEQUENCE_OF_OPT(TS_STATUS_INFO,
                                           text,
                                           ASN1_UTF8STRING),
                      ASN1_OPT(
                        TS_STATUS_INFO,
...
int
i2d_TS_RESP_bio(BIO* bp, const TS_RESP* a)
{
...
int
i2d_TS_RESP_fp(FILE* fp, const TS_RESP* a)
{
