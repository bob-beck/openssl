...
static const ERR_STRING_DATA TS_str_reasons[] = {
  ...
  { ERR_PACK (ERR_LIB_TS, 0, TS_R_CANNOT_LOAD_KEY),
  ...
  { ERR_PACK (ERR_LIB_TS, 0, TS_R_NO_TIME_STAMP_TOKEN),
    "no time stamp token" },
  ...
  { ERR_PACK (ERR_LIB_TS, 0, TS_R_UNACCEPTABLE_POLICY),
    "unacceptable policy" },
  { ERR_PACK (ERR_LIB_TS, 0, TS_R_UNSUPPORTED_MD_ALGORITHM),
    "unsupported md algorithm" },
  { ERR_PACK (ERR_LIB_TS, 0, TS_R_UNSUPPORTED_VERSION),
    "unsupported version" },
