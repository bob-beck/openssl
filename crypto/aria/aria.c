...
void
ossl_aria_encrypt (const unsigned char *in, unsigned char *out,
                   const ARIA_KEY *key)
{
...
int
ossl_aria_set_encrypt_key (const unsigned char *userKey, const int bits,
                           ARIA_KEY *key)
{
  register uint32_t reg0, reg1, reg2, reg3;
...
int
ossl_aria_set_decrypt_key (const unsigned char *userKey, const int bits,
                           ARIA_KEY *key)
{
  ARIA_u128 *rk_head;
  ARIA_u128 *rk_tail;
...
static const ARIA_u128 c1
    = { { 0x51, 0x7c, 0xc1, 0xb7, 0x27, 0x22, 0x0a, 0x94, 0xfe, 0x13, 0xab,
          0xe8, 0xfa, 0x9a, 0x6e, 0xe0 } };

static const ARIA_u128 c2
    = { { 0x6d, 0xb1, 0x4a, 0xcc, 0x9e, 0x21, 0xc8, 0x20, 0xff, 0x28, 0xb1,
          0xd5, 0xef, 0x5d, 0xe2, 0xb0 } };

static const ARIA_u128 c3
    = { { 0xdb, 0x92, 0x37, 0x1d, 0x21, 0x26, 0xe9, 0x70, 0x03, 0x24, 0x97,
 ...
 */
static void
xor128 (ARIA_c128 o, const ARIA_c128 x, const ARIA_u128 *y)
{
  int i;
...
rotnr (unsigned int n, ARIA_u128 *o, const ARIA_u128 *xor, const ARIA_u128 *z)
{
 ...
 */
static void
rot19r (ARIA_u128 *o, const ARIA_u128 *xor, const ARIA_u128 *z)
{
  rotnr (19, o, xor, z);
}
 ...
 */
static void
rot31r (ARIA_u128 *o, const ARIA_u128 *xor, const ARIA_u128 *z)
{
  rotnr (31, o, xor, z);
}
 ...
 */
static void
rot61l (ARIA_u128 *o, const ARIA_u128 *xor, const ARIA_u128 *z)
{
 ...
 */
static void
rot31l (ARIA_u128 *o, const ARIA_u128 *xor, const ARIA_u128 *z)
{
 ...
 */
static void
rot19l (ARIA_u128 *o, const ARIA_u128 *xor, const ARIA_u128 *z)
{
 ...
 */
static void
sl1 (ARIA_u128 *o, const ARIA_u128 *x, const ARIA_u128 *y)
{
  unsigned int i;
 ...
 */
static void
sl2 (ARIA_c128 o, const ARIA_u128 *x, const ARIA_u128 *y)
{
  unsigned int i;
  for (i = 0; i < ARIA_BLOCK_SIZE; i += 4)
    {
 ...
 */
static void
a (ARIA_u128 *y, const ARIA_u128 *x)
{
  y->c[0]
      = x->c[3] ^ x->c[4] ^ x->c[6] ^ x->c[8] ^ x->c[9] ^ x->c[13] ^ x->c[14];
  y->c[1]
      = x->c[2] ^ x->c[5] ^ x->c[7] ^ x->c[8] ^ x->c[9] ^ x->c[12] ^ x->c[15];
  y->c[2] = x->c[1] ^ x->c[4] ^ x->c[6] ^ x->c[10] ^ x->c[11] ^ x->c[12]
            ^ x->c[15];
  y->c[3] = x->c[0] ^ x->c[5] ^ x->c[7] ^ x->c[10] ^ x->c[11] ^ x->c[13]
            ^ x->c[14];
  y->c[4]
 ...
 */
static ossl_inline void
FO (ARIA_u128 *o, const ARIA_u128 *d, const ARIA_u128 *rk)
{
  ARIA_u128 y;
 ...
 */
static ossl_inline void
FE (ARIA_u128 *o, const ARIA_u128 *d, const ARIA_u128 *rk)
{
  ARIA_u128 y;
 ...
 */
static void
do_encrypt (unsigned char *o, const unsigned char *pin, unsigned int rounds,
