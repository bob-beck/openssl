 ...
 */
static ossl_inline void rotnr(unsigned int n,
                              ARIA_u128* o,
                              const ARIA_u128* xor,
                              const ARIA_u128* z) {
 ...
 */
static ossl_inline void FO(ARIA_u128* o,
                           const ARIA_u128* d,
                           const ARIA_u128* rk) {
  ARIA_u128 y;
 ...
 * It is safe for the input and output to overlap.
 */
static ossl_inline void FE(ARIA_u128* o,
                           const ARIA_u128* d,
                           const ARIA_u128* rk) {
  ARIA_u128 y;
 ...
 */
static void do_encrypt(unsigned char* o,
