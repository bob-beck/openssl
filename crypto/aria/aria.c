...
void
ossl_aria_encrypt(const unsigned char* in,
                  unsigned char* out,
                  const ARIA_KEY* key)
{
...
int
ossl_aria_set_encrypt_key(const unsigned char* userKey,
                          const int bits,
                          ARIA_KEY* key)
{
  register uint32_t reg0, reg1, reg2, reg3;
...
int
ossl_aria_set_decrypt_key(const unsigned char* userKey,
                          const int bits,
                          ARIA_KEY* key)
{
  ARIA_u128* rk_head;
...
static const ARIA_u128 c1 = { { 0x51,
                                0x7c,
                                0xc1,
                                0xb7,
                                0x27,
...
static const ARIA_u128 c2 = { { 0x6d,
                                0xb1,
                                0x4a,
                                0xcc,
                                0x9e,
...
static const ARIA_u128 c3 = { { 0xdb,
                                0x92,
                                0x37,
                                0x1d,
                                0x21,
