...
property_defn_hash(const PROPERTY_DEFN_ELEM* a)
{
  return OPENSSL_LH_strhash(a->prop);
}

static int
property_defn_cmp(const PROPERTY_DEFN_ELEM* a, const PROPERTY_DEFN_ELEM* b)
{
  return strcmp(a->prop, b->prop);
}

static void
property_defn_free(PROPERTY_DEFN_ELEM* elem)
{
...
void
ossl_property_defns_free(void* vproperty_defns)
{
...
void*
ossl_property_defns_new(OSSL_LIB_CTX* ctx)
{
 ...
 */
int
ossl_prop_defn_set(OSSL_LIB_CTX* ctx, const char* prop, OSSL_PROPERTY_LIST** pl)
{
