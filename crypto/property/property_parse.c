...
static int parse_name(OSSL_LIB_CTX* ctx,
                      const char* t[],
                      int create,
...
static int parse_string(OSSL_LIB_CTX* ctx,
                        const char* t[],
                        char delim,
...
static int parse_unquoted(OSSL_LIB_CTX* ctx,
                          const char* t[],
                          OSSL_PROPERTY_DEFINITION* res,
                          const int create) {
  char v[1000];
...
static int parse_value(OSSL_LIB_CTX* ctx,
                       const char* t[],
                       OSSL_PROPERTY_DEFINITION* res,
                       int create) {
  const char* s = *t;
...
OSSL_PROPERTY_LIST* ossl_parse_query(OSSL_LIB_CTX* ctx,
                                     const char* s,
                                     int create_values) {
  STACK_OF(OSSL_PROPERTY_DEFINITION)* sk;
  OSSL_PROPERTY_LIST* res = NULL;
