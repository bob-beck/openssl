...
property_hash (const PROPERTY_STRING *a)
{
  return OPENSSL_LH_strhash (a->s);
}

static int
property_cmp (const PROPERTY_STRING *a, const PROPERTY_STRING *b)
{
  return strcmp (a->s, b->s);
}

static void
property_free (PROPERTY_STRING *ps)
{
  OPENSSL_free (ps);
}

static void
property_table_free (PROP_TABLE **pt)
{
  PROP_TABLE *t = *pt;
...
void
ossl_property_string_data_free (void *vpropdata)
{
...
void *
ossl_property_string_data_new (OSSL_LIB_CTX *ctx)
{
...
static PROPERTY_STRING *
new_property_string (const char *s, OSSL_PROPERTY_IDX *pidx)
{
...
static OSSL_PROPERTY_IDX
ossl_property_string (OSSL_LIB_CTX *ctx, int name, int create, const char *s)
{
...
static void
find_str_fn (PROPERTY_STRING *prop, void *vfindstr)
{
...
static const char *
ossl_property_str (int name, OSSL_LIB_CTX *ctx, OSSL_PROPERTY_IDX idx)
{
  const char *r;
  PROPERTY_STRING_DATA *propdata
      = ossl_lib_ctx_get_data (ctx, OSSL_LIB_CTX_PROPERTY_STRING_INDEX);
...
OSSL_PROPERTY_IDX
ossl_property_name (OSSL_LIB_CTX *ctx, const char *s, int create)
{
  return ossl_property_string (ctx, 1, create, s);
}

const char *
ossl_property_name_str (OSSL_LIB_CTX *ctx, OSSL_PROPERTY_IDX idx)
{
  return ossl_property_str (1, ctx, idx);
}

OSSL_PROPERTY_IDX
ossl_property_value (OSSL_LIB_CTX *ctx, const char *s, int create)
{
  return ossl_property_string (ctx, 0, create, s);
}

const char *
ossl_property_value_str (OSSL_LIB_CTX *ctx, OSSL_PROPERTY_IDX idx)
{
