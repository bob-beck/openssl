...
static OSSL_PROPERTY_IDX ossl_property_string(OSSL_LIB_CTX* ctx,
                                              int name,
                                              int create,
                                              const char* s) {
...
static const char* ossl_property_str(int name,
                                     OSSL_LIB_CTX* ctx,
                                     OSSL_PROPERTY_IDX idx) {
  const char* r;
  PROPERTY_STRING_DATA* propdata =
...
#ifdef OPENSSL_SMALL_FOOTPRINT
  {
    ...
    lh_PROPERTY_STRING_doall_arg(
        name ? propdata->prop_names : propdata->prop_values, find_str_fn,
        &findstr);
    r = findstr.str;
  }
#else
...
OSSL_PROPERTY_IDX ossl_property_name(OSSL_LIB_CTX* ctx,
                                     const char* s,
                                     int create) {
...
OSSL_PROPERTY_IDX ossl_property_value(OSSL_LIB_CTX* ctx,
                                      const char* s,
                                      int create) {
