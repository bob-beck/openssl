...
static const ERR_STRING_DATA SSL_str_reasons[] = {
  ...
  { ERR_PACK (ERR_LIB_SSL, 0, SSL_R_BAD_SRP_PARAMETERS),
    "bad srp parameters" },
  { ERR_PACK (ERR_LIB_SSL, 0, SSL_R_BAD_SRTP_MKI_VALUE),
    "bad srtp mki value" },
  ...
  { ERR_PACK (ERR_LIB_SSL, 0, SSL_R_CCS_RECEIVED_EARLY),
    "ccs received early" },
  ...
  { ERR_PACK (ERR_LIB_SSL, 0, SSL_R_CLIENTHELLO_TLSEXT),
    "clienthello tlsext" },
  ...
  { ERR_PACK (ERR_LIB_SSL, 0, SSL_R_INCONSISTENT_EXTMS),
    "inconsistent extms" },
  ...
  { ERR_PACK (ERR_LIB_SSL, 0, SSL_R_INVALID_SESSION_ID),
    "invalid session id" },
  ...
  { ERR_PACK (ERR_LIB_SSL, 0, SSL_R_MISSING_PARAMETERS),
    "missing parameters" },
  ...
  { ERR_PACK (ERR_LIB_SSL, 0, SSL_R_MISSING_TMP_DH_KEY),
    "missing tmp dh key" },
  ...
  { ERR_PACK (ERR_LIB_SSL, 0, SSL_R_NO_CERTIFICATE_SET),
    "no certificate set" },
  ...
  { ERR_PACK (ERR_LIB_SSL, 0, SSL_R_NO_REQUIRED_DIGEST),
    "no required digest" },
  ...
  { ERR_PACK (ERR_LIB_SSL, 0, SSL_R_NO_SUITABLE_GROUPS),
    "no suitable groups" },
  ...
  { ERR_PACK (ERR_LIB_SSL, 0, SSL_R_PEM_NAME_BAD_PREFIX),
    "pem name bad prefix" },
  { ERR_PACK (ERR_LIB_SSL, 0, SSL_R_PEM_NAME_TOO_SHORT),
    "pem name too short" },
  ...
  { ERR_PACK (ERR_LIB_SSL, 0, SSL_R_QUIC_NETWORK_ERROR),
    "quic network error" },
  ...
  { ERR_PACK (ERR_LIB_SSL, 0, SSL_R_SERVERHELLO_TLSEXT),
    "serverhello tlsext" },
  ...
  { ERR_PACK (ERR_LIB_SSL, 0, SSL_R_UNEXPECTED_MESSAGE),
    "unexpected message" },
  { ERR_PACK (ERR_LIB_SSL, 0, SSL_R_UNEXPECTED_RECORD), "unexpected record" },
  { ERR_PACK (ERR_LIB_SSL, 0, SSL_R_UNINITIALIZED), "uninitialized" },
  { ERR_PACK (ERR_LIB_SSL, 0, SSL_R_UNKNOWN_ALERT_TYPE),
    "unknown alert type" },
...
int
ossl_err_load_SSL_strings (void)
{
#ifndef OPENSSL_NO_ERR
