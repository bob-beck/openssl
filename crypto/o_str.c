...
void *
CRYPTO_memdup (const void *data, size_t siz, const char *file, int line)
{
  void *ret;
...
size_t
OPENSSL_strnlen (const char *str, size_t maxlen)
{
  const char *p;
...
size_t
OPENSSL_strlcpy (char *dst, const char *src, size_t size)
{
  size_t l = 0;
  for (; size > 1 && *src; size--)
    {
...
size_t
OPENSSL_strlcat (char *dst, const char *src, size_t size)
{
  size_t l = 0;
 ...
 */
int
OPENSSL_strtoul (const char *str, char **endptr, int base, unsigned long *num)
{
  char *tmp_endptr;
...
static int
hexstr2buf_sep (unsigned char *buf, size_t buf_n, size_t *buflen,
 ...
 */
int
OPENSSL_hexstr2buf_ex (unsigned char *buf, size_t buf_n, size_t *buflen,
                       const char *str, const char sep)
{
...
unsigned char *
OPENSSL_hexstr2buf (const char *str, long *buflen)
{
  return ossl_hexstr2buf_sep (str, buflen, DEFAULT_SEPARATOR);
}

static int
buf2hexstr_sep (char *str, size_t str_n, size_t *strlength,
...
int
OPENSSL_buf2hexstr_ex (char *str, size_t str_n, size_t *strlength,
                       const unsigned char *buf, size_t buflen, const char sep)
{
 ...
 */
char *
OPENSSL_buf2hexstr (const unsigned char *buf, long buflen)
{
