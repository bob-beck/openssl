 ...
 *       by endptr.
 */
int OPENSSL_strtoul(const char* str,
                    char** endptr,
                    int base,
                    unsigned long* num) {
  char* tmp_endptr;
...
static int hexstr2buf_sep(unsigned char* buf,
                          size_t buf_n,
                          size_t* buflen,
                          const char* str,
                          const char sep) {
 ...
 */
int OPENSSL_hexstr2buf_ex(unsigned char* buf,
                          size_t buf_n,
                          size_t* buflen,
                          const char* str,
                          const char sep) {
...
unsigned char* ossl_hexstr2buf_sep(const char* str,
                                   long* buflen,
                                   const char sep) {
  unsigned char* buf;
...
static int buf2hexstr_sep(char* str,
                          size_t str_n,
                          size_t* strlength,
