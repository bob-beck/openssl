...
#define BIO_CMSG_ALLOC_LEN BIO_MAX(BIO_CMSG_ALLOC_LEN_1, BIO_MAX(BIO_CMSG_ALLOC_LEN_2, BIO_CMSG_ALLOC_LEN_3))
#endif
...
static long dgram_get_mtu_overhead(BIO_ADDR *addr)
{
    ...
    case AF_INET6: {
        ...
        if (BIO_ADDR_rawaddress(addr, &tmp_addr, NULL) && IN6_IS_ADDR_V4MAPPED(&tmp_addr))
            /*
             * Assume this is UDP - 20 bytes for IP, 8 bytes for UDP
             */
            ret = 28;
...
static long dgram_ctrl(BIO *b, int cmd, long num, void *ptr)
{
    ...
    case BIO_CTRL_DGRAM_SET_DONT_FRAG:
        ...
        case AF_INET:
            ...
            sockopt_val = num ? 1 : 0;
            if ((ret = setsockopt(b->num, IPPROTO_IP, IP_DONTFRAGMENT, (const char *)&sockopt_val,
        ...
        case AF_INET6:
            ...
            sockopt_val = num ? 1 : 0;
            if ((ret = setsockopt(b->num, IPPROTO_IPV6, IPV6_DONTFRAG, (const void *)&sockopt_val,
                                  sizeof(sockopt_val))) < 0)
                ERR_raise_data(ERR_LIB_SYS, get_last_socket_error(), "calling setsockopt()");
