        ...
        case BIO_CONN_S_BLOCKED_CONNECT:
          ...
          if (i != 0)
          ...
          else
            {
               ...
               * processing of ktls_start. Thus, it is not a problem to call it
               * for non-TLS sockets.
               */
              ktls_enable (b->num);
#endif
...
static int
conn_sendmmsg (BIO *bio, BIO_MSG *msg, size_t stride, size_t num_msgs,
...
static int
conn_recvmmsg (BIO *bio, BIO_MSG *msg, size_t stride, size_t num_msgs,
               uint64_t flags, size_t *msgs_processed)
{
  int ret;
  BIO_CONNECT *data;
