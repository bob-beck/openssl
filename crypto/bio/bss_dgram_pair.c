 ...
 */
static void ring_buf_head_tail(struct ring_buf* r,
                               int idx,
                               uint8_t** buf,
                               size_t* len) {
...
static int dgram_pair_sendmmsg(BIO* b,
                               BIO_MSG* msg,
                               size_t stride,
                               size_t num_msg,
                               uint64_t flags,
                               size_t* num_processed);
static int dgram_pair_recvmmsg(BIO* b,
                               BIO_MSG* msg,
                               size_t stride,
                               size_t num_msg,
                               uint64_t flags,
...
static size_t dgram_pair_read_inner(struct bio_dgram_pair_st* b,
                                    uint8_t* buf,
                                    size_t sz);
...
int BIO_new_bio_dgram_pair(BIO** pbio1,
                           size_t writebuf1,
                           BIO** pbio2,
                           size_t writebuf2) {
  int ret = 0;
 ...
 * response code.
 */
static ossl_ssize_t dgram_pair_read_actual(BIO* bio,
                                           char* buf,
                                           size_t sz,
                                           BIO_ADDR* local,
                                           BIO_ADDR* peer,
...
/* Threadsafe */
static int dgram_pair_recvmmsg(BIO* bio,
                               BIO_MSG* msg,
                               size_t stride,
                               size_t num_msg,
                               uint64_t flags,
 ...
 * response code.
 */
static ossl_ssize_t dgram_pair_write_actual(BIO* bio,
                                            const char* buf,
                                            size_t sz,
...
/* Threadsafe */
static int dgram_pair_sendmmsg(BIO* bio,
                               BIO_MSG* msg,
                               size_t stride,
                               size_t num_msg,
                               uint64_t flags,
