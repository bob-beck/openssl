...
int
BIO_meth_set_write_ex(BIO_METHOD* biom,
...
int
bread_conv(BIO* bio, char* data, size_t datal, size_t* readbytes)
{
  int ret;
...
int
BIO_meth_set_read_ex(BIO_METHOD* biom,
...
#ifndef OPENSSL_NO_DEPRECATED_3_5
long (*BIO_meth_get_callback_ctrl(const BIO_METHOD* biom))(BIO*,
                                                           int,
                                                           BIO_info_cb*)
{
...
#ifndef OPENSSL_NO_DEPRECATED_3_5
int (*BIO_meth_get_sendmmsg(
  const BIO_METHOD* biom))(BIO*, BIO_MSG*, size_t, size_t, uint64_t, size_t*)
{
