 ...
 * BIO_seek() support to source/sink BIO's (such as a file BIO that uses
 * stdin). It does this by caching ALL data read from the BIO source/sink into
 * a resizable memory buffer.
 */
