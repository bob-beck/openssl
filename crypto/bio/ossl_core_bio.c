...
static OSSL_CORE_BIO *
core_bio_new_from_new_bio (BIO *bio)
{
...
int
ossl_core_bio_read_ex (OSSL_CORE_BIO *cb, void *data, size_t dlen,
                       size_t *readbytes)
{
...
int
ossl_core_bio_write_ex (OSSL_CORE_BIO *cb, const void *data, size_t dlen,
                        size_t *written)
{
