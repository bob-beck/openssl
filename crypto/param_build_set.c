...
int
ossl_param_build_set_int (OSSL_PARAM_BLD *bld, OSSL_PARAM *p, const char *key,
                          int num)
{
  if (bld != NULL)
...
int
ossl_param_build_set_long (OSSL_PARAM_BLD *bld, OSSL_PARAM *p, const char *key,
                           long num)
{
  if (bld != NULL)
...
int
ossl_param_build_set_utf8_string (OSSL_PARAM_BLD *bld, OSSL_PARAM *p,
...
int
ossl_param_build_set_octet_string (OSSL_PARAM_BLD *bld, OSSL_PARAM *p,
...
int
ossl_param_build_set_bn_pad (OSSL_PARAM_BLD *bld, OSSL_PARAM *p,
...
int
ossl_param_build_set_bn (OSSL_PARAM_BLD *bld, OSSL_PARAM *p, const char *key,
                         const BIGNUM *bn)
{
  if (bld != NULL)
...
int
ossl_param_build_set_multi_key_bn (OSSL_PARAM_BLD *bld, OSSL_PARAM *params,
                                   const char *names[],
