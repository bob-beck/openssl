 ...
 */
static void ocb_block_lshift(const unsigned char* in,
                             size_t shift,
                             unsigned char* out) {
  int i;
 ...
 */
int CRYPTO_ocb128_copy_ctx(OCB128_CONTEXT* dest,
                           OCB128_CONTEXT* src,
                           void* keyenc,
                           void* keydec) {
 ...
 */
int CRYPTO_ocb128_setiv(OCB128_CONTEXT* ctx,
 ...
 */
int CRYPTO_ocb128_aad(OCB128_CONTEXT* ctx,
...
static int ocb_finish(OCB128_CONTEXT* ctx,
                      unsigned char* tag,
                      size_t len,
                      int write) {
  OCB_BLOCK tmp;
 ...
 */
int CRYPTO_ocb128_finish(OCB128_CONTEXT* ctx,
