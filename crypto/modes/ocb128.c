 ...
 */
static void
ocb_block_lshift (const unsigned char *in, size_t shift, unsigned char *out)
{
  int i;
 ...
 */
static void
ocb_double (OCB_BLOCK *in, OCB_BLOCK *out)
{
  unsigned char mask;
 ...
 */
static void
ocb_block_xor (const unsigned char *in1, const unsigned char *in2, size_t len,
               unsigned char *out)
{
  size_t i;
  for (i = 0; i < len; i++)
 ...
 */
static OCB_BLOCK *
ocb_lookup_l (OCB128_CONTEXT *ctx, size_t idx)
{
  ...
  if (idx >= ctx->max_l_index)
    {
      ...
      tmp_ptr = OPENSSL_realloc_array (ctx->l, ctx->max_l_index,
                                       sizeof (OCB_BLOCK));
 ...
 */
OCB128_CONTEXT *
CRYPTO_ocb128_new (void *keyenc, void *keydec, block128_f encrypt,
 ...
 */
int
CRYPTO_ocb128_init (OCB128_CONTEXT *ctx, void *keyenc, void *keydec,
 ...
 */
int
CRYPTO_ocb128_copy_ctx (OCB128_CONTEXT *dest, OCB128_CONTEXT *src,
 ...
 */
int
CRYPTO_ocb128_setiv (OCB128_CONTEXT *ctx, const unsigned char *iv, size_t len,
                     size_t taglen)
{
 ...
 */
int
CRYPTO_ocb128_aad (OCB128_CONTEXT *ctx, const unsigned char *aad, size_t len)
{
 ...
 */
int
CRYPTO_ocb128_encrypt (OCB128_CONTEXT *ctx, const unsigned char *in,
 ...
 */
int
CRYPTO_ocb128_decrypt (OCB128_CONTEXT *ctx, const unsigned char *in,
                       unsigned char *out, size_t len)
{
  u64 i, all_num_blocks;
  size_t num_blocks, last_len;
...
static int
ocb_finish (OCB128_CONTEXT *ctx, unsigned char *tag, size_t len, int write)
{
  OCB_BLOCK tmp;
 ...
 */
int
CRYPTO_ocb128_finish (OCB128_CONTEXT *ctx, const unsigned char *tag,
                      size_t len)
{
 ...
 */
int
CRYPTO_ocb128_tag (OCB128_CONTEXT *ctx, unsigned char *tag, size_t len)
{
