 ...
 */
static void
ocb_block_xor(const unsigned char* in1,
...
ocb_lookup_l(OCB128_CONTEXT* ctx, size_t idx)
{
  ...
  if (idx >= ctx->max_l_index) {
    ...
    tmp_ptr =
      OPENSSL_realloc_array(ctx->l, ctx->max_l_index, sizeof(OCB_BLOCK));
 ...
 */
int
CRYPTO_ocb128_init(OCB128_CONTEXT* ctx,
                   void* keyenc,
                   void* keydec,
                   block128_f encrypt,
                   block128_f decrypt,
 ...
 */
int
CRYPTO_ocb128_copy_ctx(OCB128_CONTEXT* dest,
                       OCB128_CONTEXT* src,
                       void* keyenc,
                       void* keydec)
{
 ...
 */
int
CRYPTO_ocb128_setiv(OCB128_CONTEXT* ctx,
 ...
 */
int
CRYPTO_ocb128_encrypt(OCB128_CONTEXT* ctx,
 ...
 */
int
CRYPTO_ocb128_decrypt(OCB128_CONTEXT* ctx,
                      const unsigned char* in,
                      unsigned char* out,
                      size_t len)
{
 ...
 */
int
CRYPTO_ocb128_finish(OCB128_CONTEXT* ctx, const unsigned char* tag, size_t len)
{
