...
siv128_do_s2v_p(SIV128_CONTEXT* ctx,
                SIV_BLOCK* out,
...
__owur static ossl_inline int
siv128_do_encrypt(EVP_CIPHER_CTX* ctx,
                  unsigned char* out,
                  unsigned char const* in,
                  size_t len,
                  SIV_BLOCK* icv)
 ...
 */
SIV128_CONTEXT*
ossl_siv128_new(const unsigned char* key,
                int klen,
                EVP_CIPHER* cbc,
                EVP_CIPHER* ctr,
                OSSL_LIB_CTX* libctx,
 ...
 */
int
ossl_siv128_init(SIV128_CONTEXT* ctx,
 ...
 */
int
ossl_siv128_encrypt(SIV128_CONTEXT* ctx,
 ...
 */
int
ossl_siv128_decrypt(SIV128_CONTEXT* ctx,
                    const unsigned char* in,
                    unsigned char* out,
                    size_t len)
{
