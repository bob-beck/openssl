 ...
 */
void
CRYPTO_cfb128_encrypt (const unsigned char *in, unsigned char *out, size_t len,
                       const void *key, unsigned char ivec[16], int *num,
 ...
 */
static void
cfbr_encrypt_block (const unsigned char *in, unsigned char *out, int nbits,
...
CRYPTO_cfb128_1_encrypt (const unsigned char *in, unsigned char *out,
                         size_t bits, const void *key, unsigned char ivec[16],
