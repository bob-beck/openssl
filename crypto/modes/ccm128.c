 ...
 */
void
CRYPTO_ccm128_init (CCM128_CONTEXT *ctx, unsigned int M, unsigned int L,
...
int
CRYPTO_ccm128_setiv (CCM128_CONTEXT *ctx, const unsigned char *nonce,
...
void
CRYPTO_ccm128_aad (CCM128_CONTEXT *ctx, const unsigned char *aad, size_t alen)
{
  unsigned int i;
...
int
CRYPTO_ccm128_encrypt (CCM128_CONTEXT *ctx, const unsigned char *inp,
...
int
CRYPTO_ccm128_decrypt (CCM128_CONTEXT *ctx, const unsigned char *inp,
                       unsigned char *out, size_t len)
{
  size_t n;
  unsigned int i, L;
...
int
CRYPTO_ccm128_encrypt_ccm64 (CCM128_CONTEXT *ctx, const unsigned char *inp,
...
int
CRYPTO_ccm128_decrypt_ccm64 (CCM128_CONTEXT *ctx, const unsigned char *inp,
                             unsigned char *out, size_t len, ccm128_f stream)
{
  size_t n;
  unsigned int i, L;
