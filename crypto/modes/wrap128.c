...
size_t CRYPTO_128_wrap(void* key, const unsigned char* iv, unsigned char* out,
  ...
  size_t i, j, t;
  if ((inlen & 0x7) || (inlen < 16) || (inlen > CRYPTO128_WRAP_MAX)) return 0;
  A = B;
  t = 1;
...
size_t CRYPTO_128_wrap_pad(void* key, const unsigned char* icv,
  ...
  if (inlen == 0 || inlen >= CRYPTO128_WRAP_MAX) return 0;
...
size_t CRYPTO_128_unwrap_pad(void* key, const unsigned char* icv,
  ...
  if ((inlen & 0x7) != 0 || inlen < 16 || inlen >= CRYPTO128_WRAP_MAX) return 0;
