 ...
 */
static EX_CALLBACKS *
get_and_lock (OSSL_EX_DATA_GLOBAL *global, int class_index, int read)
{
  EX_CALLBACKS *ip;
 ...
 */
static void
dummy_new (void *parent, void *ptr, CRYPTO_EX_DATA *ad, int idx, long argl,
           void *argp)
{
}

static void
dummy_free (void *parent, void *ptr, CRYPTO_EX_DATA *ad, int idx, long argl,
            void *argp)
{
}

static int
dummy_dup (CRYPTO_EX_DATA *to, const CRYPTO_EX_DATA *from, void **from_d,
...
int
CRYPTO_free_ex_index (int class_index, int idx)
{
 ...
 */
int
ossl_crypto_get_ex_new_index_ex (OSSL_LIB_CTX *ctx, int class_index, long argl,
 ...
 */
int
ossl_crypto_new_ex_data_ex (OSSL_LIB_CTX *ctx, int class_index, void *obj,
                            CRYPTO_EX_DATA *ad)
{
  int mx, i;
  void *ptr;
 ...
 */
int
CRYPTO_dup_ex_data (int class_index, CRYPTO_EX_DATA *to,
...
static int
ex_callback_compare (const void *a, const void *b)
{
 ...
 */
int
CRYPTO_alloc_ex_data (int class_index, void *obj, CRYPTO_EX_DATA *ad, int idx)
{
  void *curval;
...
int
ossl_crypto_alloc_ex_data_intern (int class_index, void *obj,
