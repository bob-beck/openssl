 ...
 */
static EX_CALLBACKS* get_and_lock(OSSL_EX_DATA_GLOBAL* global,
                                  int class_index,
                                  int read) {
  EX_CALLBACKS* ip;
 ...
 */
static void dummy_new(void* parent,
                      void* ptr,
                      CRYPTO_EX_DATA* ad,
                      int idx,
                      long argl,
...
static void dummy_free(void* parent,
                       void* ptr,
                       CRYPTO_EX_DATA* ad,
                       int idx,
                       long argl,
...
static int dummy_dup(CRYPTO_EX_DATA* to,
 ...
 */
int ossl_crypto_new_ex_data_ex(OSSL_LIB_CTX* ctx,
                               int class_index,
                               void* obj,
                               CRYPTO_EX_DATA* ad) {
  int mx, i;
 ...
 * function
 */
int CRYPTO_alloc_ex_data(int class_index,
                         void* obj,
                         CRYPTO_EX_DATA* ad,
                         int idx) {
  void* curval;
...
int ossl_crypto_alloc_ex_data_intern(int class_index,
                                     void* obj,
                                     CRYPTO_EX_DATA* ad,
                                     int idx) {
  EX_CALLBACK* f;
