...
#define DEFINE_OSSL_CMP_CTX_get0(FIELD, TYPE) DEFINE_OSSL_CMP_CTX_get0_NAME(FIELD, FIELD, TYPE)
...
#define DEFINE_OSSL_set0(PREFIX, FIELD, TYPE) DEFINE_OSSL_set0_NAME(PREFIX, FIELD, FIELD, TYPE)
