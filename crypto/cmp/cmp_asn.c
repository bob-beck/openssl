...
ASN1_SEQUENCE(OSSL_CMP_REVANNCONTENT) = {
    ...
    ASN1_OPT(OSSL_CMP_REVANNCONTENT,
             crlDetails,
...
ASN1_SEQUENCE(OSSL_CMP_CHALLENGE) = {
    ...
    ASN1_SIMPLE(OSSL_CMP_CHALLENGE,
                challenge,
...
ASN1_SEQUENCE(OSSL_CMP_CERTSTATUS) = {
    ...
    ASN1_EXP_OPT(OSSL_CMP_CERTSTATUS,
                 hashAlg,
                 X509_ALGOR,
...
ASN1_SEQUENCE(OSSL_CMP_PKIHEADER) = {
    ...
    ASN1_EXP_SEQUENCE_OF_OPT(OSSL_CMP_PKIHEADER,
                             generalInfo,
                             OSSL_CMP_ITAV,
