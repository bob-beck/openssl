...
ASN1_SEQUENCE(OSSL_CMP_CAKEYUPDANNCONTENT) = {
    ...
    /* OSSL_CMP_CMPCERTIFICATE is effectively X509 so it is used directly */
    ASN1_SIMPLE(OSSL_CMP_CAKEYUPDANNCONTENT, newWithNew, X509)} ASN1_SEQUENCE_END(OSSL_CMP_CAKEYUPDANNCONTENT)
...
ASN1_ADB(OSSL_CMP_ITAV) = {
    ...
    ADB_ENTRY(NID_id_it_crls,
              ASN1_SEQUENCE_OF_OPT(
                  ...
                  X509_CRL))} ASN1_ADB_END(OSSL_CMP_ITAV, 0, infoType, 0, &infotypeandvalue_default_tt, NULL);

ASN1_SEQUENCE(OSSL_CMP_ITAV) = {ASN1_SIMPLE(OSSL_CMP_ITAV, infoType, ASN1_OBJECT),
...
ASN1_SEQUENCE(OSSL_CMP_ROOTCAKEYUPDATE) = {
    ...
    ASN1_EXP_OPT(OSSL_CMP_ROOTCAKEYUPDATE, oldWithNew, X509, 1)} ASN1_SEQUENCE_END(OSSL_CMP_ROOTCAKEYUPDATE)
IMPLEMENT_ASN1_FUNCTIONS(OSSL_CMP_ROOTCAKEYUPDATE)

ASN1_ITEM_TEMPLATE(OSSL_CMP_ATAVS) = ASN1_EX_TEMPLATE_TYPE(ASN1_TFLG_SEQUENCE_OF, 0, OSSL_CMP_ATAVS,
...
ASN1_SEQUENCE(OSSL_CMP_CRLSTATUS) = {
    ...
    ASN1_OPT(OSSL_CMP_CRLSTATUS, thisUpdate, ASN1_TIME)} ASN1_SEQUENCE_END(OSSL_CMP_CRLSTATUS)
...
OSSL_CMP_ITAV *OSSL_CMP_ITAV_new_caCerts(const STACK_OF(X509) *caCerts)
{
    ...
    if (itav == NULL)
        return NULL;
    if (sk_X509_num(caCerts) > 0 && (itav->infoValue.caCerts = sk_X509_deep_copy(caCerts, X509_dup, X509_free)) == NULL)
    {
...
ASN1_SEQUENCE(OSSL_CMP_CERTIFIEDKEYPAIR) = {
    ...
    ASN1_EXP_OPT(OSSL_CMP_CERTIFIEDKEYPAIR, publicationInfo, OSSL_CRMF_PKIPUBLICATIONINFO,
...
ASN1_SEQUENCE(OSSL_CMP_REVDETAILS) = {
    ...
    ASN1_OPT(OSSL_CMP_REVDETAILS, crlEntryDetails, X509_EXTENSIONS)} ASN1_SEQUENCE_END(OSSL_CMP_REVDETAILS)
...
ASN1_SEQUENCE(OSSL_CMP_REVREPCONTENT) = {
    ...
    ASN1_EXP_SEQUENCE_OF_OPT(OSSL_CMP_REVREPCONTENT, crls, X509_CRL, 1)} ASN1_SEQUENCE_END(OSSL_CMP_REVREPCONTENT)
IMPLEMENT_ASN1_FUNCTIONS(OSSL_CMP_REVREPCONTENT)

ASN1_SEQUENCE(OSSL_CMP_KEYRECREPCONTENT) = {ASN1_SIMPLE(OSSL_CMP_KEYRECREPCONTENT, status, OSSL_CMP_PKISI),
...
ASN1_SEQUENCE(OSSL_CMP_PKISI) = {ASN1_SIMPLE(OSSL_CMP_PKISI, status, OSSL_CMP_PKISTATUS),
                                 /* OSSL_CMP_PKIFREETEXT is a ASN1_UTF8STRING sequence, so used directly */
                                 ...
                                 ASN1_OPT(OSSL_CMP_PKISI, failInfo, ASN1_BIT_STRING)} ASN1_SEQUENCE_END(OSSL_CMP_PKISI)
...
ASN1_SEQUENCE(OSSL_CMP_CERTSTATUS) = {
    ...
    ASN1_EXP_OPT(OSSL_CMP_CERTSTATUS, hashAlg, X509_ALGOR, 0)} ASN1_SEQUENCE_END(OSSL_CMP_CERTSTATUS)
IMPLEMENT_ASN1_FUNCTIONS(OSSL_CMP_CERTSTATUS)

ASN1_ITEM_TEMPLATE(OSSL_CMP_CERTCONFIRMCONTENT) = ASN1_EX_TEMPLATE_TYPE(ASN1_TFLG_SEQUENCE_OF, 0,
...
ASN1_SEQUENCE(OSSL_CMP_CERTRESPONSE) = {
    ...
    ASN1_OPT(OSSL_CMP_CERTRESPONSE, rspInfo, ASN1_OCTET_STRING)} ASN1_SEQUENCE_END(OSSL_CMP_CERTRESPONSE)
IMPLEMENT_ASN1_FUNCTIONS(OSSL_CMP_CERTRESPONSE)

ASN1_SEQUENCE(OSSL_CMP_POLLREQ) = {
    ASN1_SIMPLE(OSSL_CMP_POLLREQ, certReqId, ASN1_INTEGER)} ASN1_SEQUENCE_END(OSSL_CMP_POLLREQ)
...
ASN1_ITEM_TEMPLATE(OSSL_CMP_POLLREPCONTENT) = ASN1_EX_TEMPLATE_TYPE(ASN1_TFLG_SEQUENCE_OF, 0, OSSL_CMP_POLLREPCONTENT,
                                                                    OSSL_CMP_POLLREP)
...
ASN1_ITEM_TEMPLATE(OSSL_CMP_CRLANNCONTENT) = ASN1_EX_TEMPLATE_TYPE(ASN1_TFLG_SEQUENCE_OF, 0, OSSL_CMP_CRLANNCONTENT,
                                                                   X509_CRL)
...
ASN1_SEQUENCE(OSSL_CMP_PKIHEADER) = {
    ...
    ASN1_EXP_SEQUENCE_OF_OPT(OSSL_CMP_PKIHEADER, generalInfo, OSSL_CMP_ITAV, 8)} ASN1_SEQUENCE_END(OSSL_CMP_PKIHEADER)
...
ASN1_SEQUENCE(OSSL_CMP_PROTECTEDPART) = {
    ...
    ASN1_SIMPLE(OSSL_CMP_MSG, body, OSSL_CMP_PKIBODY)} ASN1_SEQUENCE_END(OSSL_CMP_PROTECTEDPART)
...
ASN1_SEQUENCE_cb(OSSL_CMP_MSG, ossl_cmp_msg_cb) = {
    ...
    /* OSSL_CMP_CMPCERTIFICATE is effectively X509 so it is used directly */
    ASN1_EXP_SEQUENCE_OF_OPT(OSSL_CMP_MSG, extraCerts, X509, 1)} ASN1_SEQUENCE_END_cb(OSSL_CMP_MSG, OSSL_CMP_MSG)
