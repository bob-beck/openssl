...
ASN1_SEQUENCE(OSSL_CMP_REVANNCONTENT)
    = {
        ...
        ASN1_OPT(OSSL_CMP_REVANNCONTENT, crlDetails, X509_EXTENSIONS)} ASN1_SEQUENCE_END(OSSL_CMP_REVANNCONTENT)
    ...
    ASN1_SEQUENCE(OSSL_CMP_CHALLENGE)
        = {ASN1_OPT(OSSL_CMP_CHALLENGE, owf, X509_ALGOR),
           ...
           ASN1_SIMPLE(OSSL_CMP_CHALLENGE, challenge, ASN1_OCTET_STRING)} ASN1_SEQUENCE_END(OSSL_CMP_CHALLENGE)
                ...
                ASN1_SEQUENCE(OSSL_CMP_CAKEYUPDANNCONTENT)
                    ...
                    ASN1_SEQUENCE(OSSL_CMP_ERRORMSGCONTENT)
                        = {ASN1_SIMPLE(OSSL_CMP_ERRORMSGCONTENT, pKIStatusInfo, OSSL_CMP_PKISI),
                           ...
                           ASN1_SEQUENCE_OF_OPT(OSSL_CMP_ERRORMSGCONTENT,
                                                errorDetails,
                                                ASN1_UTF8STRING)} ASN1_SEQUENCE_END(OSSL_CMP_ERRORMSGCONTENT)
                        IMPLEMENT_ASN1_FUNCTIONS(OSSL_CMP_ERRORMSGCONTENT)

                        ASN1_ADB_TEMPLATE(infotypeandvalue_default) =
                            ASN1_OPT(OSSL_CMP_ITAV, infoValue.other, ASN1_ANY);
                        ...
                        ASN1_ADB(OSSL_CMP_ITAV) =
                            {
                                ...
                                ADB_ENTRY(NID_id_it_signKeyPairTypes,
                                          ASN1_SEQUENCE_OF_OPT(OSSL_CMP_ITAV, infoValue.signKeyPairTypes, X509_ALGOR)),
                                ADB_ENTRY(NID_id_it_encKeyPairTypes,
                                          ASN1_SEQUENCE_OF_OPT(OSSL_CMP_ITAV, infoValue.encKeyPairTypes, X509_ALGOR)),
                                ...
                                ADB_ENTRY(NID_id_it_unsupportedOIDs,
                                          ASN1_SEQUENCE_OF_OPT(OSSL_CMP_ITAV, infoValue.unsupportedOIDs, ASN1_OBJECT)),
                                ...
                                ADB_ENTRY(NID_id_it_confirmWaitTime,
                                          ASN1_OPT(OSSL_CMP_ITAV, infoValue.confirmWaitTime, ASN1_GENERALIZEDTIME)),
                                ...
                                ADB_ENTRY(NID_id_it_rootCaKeyUpdate,
                                          ASN1_OPT(OSSL_CMP_ITAV, infoValue.rootCaKeyUpdate, OSSL_CMP_ROOTCAKEYUPDATE)),
                                ADB_ENTRY(NID_id_it_certReqTemplate,
                                          ASN1_OPT(OSSL_CMP_ITAV, infoValue.certReqTemplate, OSSL_CMP_CERTREQTEMPLATE)),
                                ADB_ENTRY(NID_id_it_certProfile,
                                          ASN1_SEQUENCE_OF_OPT(OSSL_CMP_ITAV, infoValue.certProfile, ASN1_UTF8STRING)),
                                ADB_ENTRY(
                                ...
                                ADB_ENTRY(NID_id_it_crls,
                                          ASN1_SEQUENCE_OF_OPT(OSSL_CMP_ITAV,
                                                               infoValue.crls,
                                                               X509_CRL))} ASN1_ADB_END(OSSL_CMP_ITAV,
                                                                                        0,
                                                                                        infoType,
                                                                                        0,
                        ...
                        ASN1_SEQUENCE(OSSL_CMP_ITAV)
                            ...
                            ASN1_SEQUENCE(OSSL_CMP_ROOTCAKEYUPDATE)
                                = {
                                    ...
                                    ASN1_EXP_OPT(OSSL_CMP_ROOTCAKEYUPDATE,
                                                 oldWithNew,
                                                 X509,
...
#define OSSL_CMP_CRLSOURCE_ISSUER 1
                                            ...
                                            ASN1_SEQUENCE(OSSL_CMP_CRLSTATUS)
                                                ...
                                                void OSSL_CMP_ITAV_set0(OSSL_CMP_ITAV * itav,
                                                                        ASN1_OBJECT * type,
                                                                        ASN1_TYPE * value)
                                                {
                                                    itav->infoType        = type;
...
err:
                                                ...
                                                OSSL_CMP_ITAV
                                                *OSSL_CMP_ITAV_new0_certReqTemplate(OSSL_CRMF_CERTTEMPLATE
                                                                                        * certTemplate,
                                                    ...
                                                    OSSL_CMP_ATAVS         **keySpec)
                                                {
                                                    ...
                                                    *certTemplate = NULL;
                                                    ...
                                                    if ((*certTemplate = OSSL_CRMF_CERTTEMPLATE_dup(tpl->certTemplate))
                                                        == NULL)
                                                        return 0;
                                                    if (keySpec != NULL && tpl->keySpec != NULL) {
                                                        ...
                                                        *keySpec =
                                                            sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_new_reserve(NULL, n);
                                                        if (*keySpec == NULL)
                                                            goto err;
                                                        for (i = 0; i < n; i++) {
                                                            OSSL_CMP_ATAV *atav =
                                                                sk_OSSL_CMP_ATAV_value(tpl->keySpec, i);
                                                            ASN1_OBJECT *type =
...
err:
                                                ...
                                                OSSL_CMP_ATAV *OSSL_CMP_ATAV_create(ASN1_OBJECT * type,
                                                                                    ASN1_TYPE * value)
                                                {
                                                    OSSL_CMP_ATAV *atav;
                                                ...
                                                void OSSL_CMP_ATAV_set0(OSSL_CMP_ATAV * atav,
                                                                        ASN1_OBJECT * type,
                                                                        ASN1_TYPE * value)
                                                {
                                                    atav->type        = type;
                                                ...
                                                int OSSL_CMP_ATAV_get_rsaKeyLen(const OSSL_CMP_ATAV *atav)
                                                {
                                                    ...
                                                    if (atav == NULL
                                                        || OBJ_obj2nid(atav->type) != NID_id_regCtrl_rsaKeyLen
                                                                        ...
                                                                        const OSSL_CMP_ATAV *atav)
                                                {
                                                    ...
                                                    if (*sk_p == NULL) {
                                                        if ((*sk_p = sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_new_null())
                                                            == NULL)
                                                            goto err;
                                                        created = 1;
                                                    }
...
err:
                                                                                              ...
                                                                                              int             only_DN)
                                                {
                                                    ...
                                                    const ASN1_TIME      *last =
                                                        crl == NULL ? NULL : X509_CRL_get0_lastUpdate(crl);
                                                    OSSL_CMP_CRLSTATUS *status = NULL;
                                                    int                 i, NID_akid = NID_authority_key_identifier;

                                                    /*
                                                     * Note:
                                                     * X509{,_CRL}_get_ext_d2i(..., NID, ..., NULL) return the 1st
                                                     * extension with given NID that is available, if any. If there are
                                                     * more, this is an error.
                                                     */
                                                    if (cert != NULL) {
                                                        crldps = X509_get_ext_d2i(cert,
                                                        ...
                                                        for (i = 0; i < sk_DIST_POINT_num(crldps); i++) {
                                                            ...
                                                            if (gennames_allowed(dp->CRLissuer, only_DN)
                                                                && CRLissuer == NULL)
                                                                /* don't break because any dp->distpoint in list is
                                                                 * preferred */
                                                    ...
                                                    if (dpn == NULL && CRLissuer == NULL) {
                                                        if (cert != NULL) {
                                                            ...
                                                            if (akid != NULL && gennames_allowed(akid->issuer, only_DN))
                                                                ...
                                                                CRLissuer = issuers =
                                                                    gennames_new(X509_get_issuer_name(cert));
                                                        }
                                                        if (CRLissuer == NULL && crl != NULL) {
                                                            ...
                                                            if (akid != NULL && gennames_allowed(akid->issuer, only_DN))
                                                                ...
                                                                CRLissuer = issuers =
                                                                    gennames_new(X509_CRL_get_issuer(crl));
                                                        }
                                                        if (CRLissuer == NULL)
                                                            goto end;
                                                    }
...
err:
                                                ...
                                                /* get ASN.1 encoded integer, return -2 on error; -1 is valid for
                                                 * certReqId */
                                                ...
                                                static int ossl_cmp_msg_cb(int                          operation,
                                                                           ASN1_VALUE                 **pval,
                                                ...
                                                ASN1_CHOICE(OSSL_CMP_CERTORENCCERT)
                                                    = {
                                                        /* OSSL_CMP_CMPCERTIFICATE is effectively X509 so it is used
                                                           directly */
                                                    ...
                                                    ASN1_SEQUENCE(OSSL_CMP_CERTIFIEDKEYPAIR)
                                                        = {ASN1_SIMPLE(OSSL_CMP_CERTIFIEDKEYPAIR,
                                                                       certOrEncCert,
                                                                       OSSL_CMP_CERTORENCCERT),
                                                           ASN1_EXP_OPT(OSSL_CMP_CERTIFIEDKEYPAIR,
                                                                        privateKey,
                                                                        OSSL_CRMF_ENCRYPTEDKEY,
                                                                        0),
                                                           ASN1_EXP_OPT(OSSL_CMP_CERTIFIEDKEYPAIR,
                                                        ...
                                                        ASN1_SEQUENCE(OSSL_CMP_REVDETAILS)
                                                            = {ASN1_SIMPLE(OSSL_CMP_REVDETAILS,
                                                                           certDetails,
                                                            ...
                                                            ASN1_ITEM_TEMPLATE(OSSL_CMP_REVREQCONTENT)
                                                                ...
                                                                ASN1_SEQUENCE(OSSL_CMP_REVREPCONTENT)
                                                                    = {ASN1_SEQUENCE_OF(OSSL_CMP_REVREPCONTENT,
                                                                                        status,
                                                                                        OSSL_CMP_PKISI),
                                                                       ASN1_EXP_SEQUENCE_OF_OPT(OSSL_CMP_REVREPCONTENT,
                                                                                                revCerts,
                                                                                                OSSL_CRMF_CERTID,
                                                                                                0),
                                                                    ...
                                                                    ASN1_SEQUENCE(OSSL_CMP_KEYRECREPCONTENT)
                                                                        ...
                                                                        ASN1_ITEM_TEMPLATE(OSSL_CMP_PKISTATUS)
                                                                            = ASN1_EX_TEMPLATE_TYPE(ASN1_TFLG_UNIVERSAL,
                                                                                                    0,
                                                                                                    status,
                                                                                                    ASN1_INTEGER)
                                                                            ...
                                                                            ASN1_SEQUENCE(OSSL_CMP_PKISI)
                                                                                = {ASN1_SIMPLE(OSSL_CMP_PKISI,
                                                                                               status,
                                                                                               OSSL_CMP_PKISTATUS),
                                                                                   /* OSSL_CMP_PKIFREETEXT is a
                                                                                      ASN1_UTF8STRING sequence, so used
                                                                                      directly */
                                                                                   ASN1_SEQUENCE_OF_OPT(
                                                                                       OSSL_CMP_PKISI,
                                                                                       statusString,
                                                                                       ASN1_UTF8STRING),
                                                                                   /* OSSL_CMP_PKIFAILUREINFO is
                                                                                      effectively ASN1_BIT_STRING, used
                                                                                      directly */
                                                                                   ASN1_OPT(
                                                                                       OSSL_CMP_PKISI,
                                                                                       failInfo,
                                                                                ...
                                                                                ASN1_SEQUENCE(OSSL_CMP_CERTSTATUS)
                                                                                    = {ASN1_SIMPLE(OSSL_CMP_CERTSTATUS,
                                                                                                   certHash,
                                                                                                   ASN1_OCTET_STRING),
                                                                                       ASN1_SIMPLE(OSSL_CMP_CERTSTATUS,
                                                                                                   certReqId,
                                                                                                   ASN1_INTEGER),
                                                                                       ASN1_OPT(OSSL_CMP_CERTSTATUS,
                                                                                                statusInfo,
                                                                                                OSSL_CMP_PKISI),
                                                                                       ASN1_EXP_OPT(
                                                                                           OSSL_CMP_CERTSTATUS,
                                                                                        ...
                                                                                        ASN1_SEQUENCE(
                                                                                            ...
                                                                                            ASN1_SEQUENCE(
                                                                                                ...
                                                                                                = {ASN1_SIMPLE(
                                                                                                    OSSL_CMP_POLLREQ,
                                                                                                    certReqId,
                                                                                                    ASN1_INTEGER)} ASN1_SEQUENCE_END(OSSL_CMP_POLLREQ)
                                                                                                IMPLEMENT_ASN1_FUNCTIONS(
                                                                                                    OSSL_CMP_POLLREQ)
                                                                                                            ...
                                                                                                            ASN1_SEQUENCE(
                                                                                                                ...
                                                                                                                = {
                                                                                                                    /* OSSL_CMP_CMPCERTIFICATE
                                                                                                                       is effectively X509 so it is used directly */
                                                                                                                    ASN1_EXP_SEQUENCE_OF_OPT(
                                                                                                                        OSSL_CMP_CERTREPMESSAGE,
                                                                                                                        caPubs,
                                                                                                                        X509,
