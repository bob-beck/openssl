...
static const ERR_STRING_DATA CMP_str_reasons[] = {
  ...
  { ERR_PACK (ERR_LIB_CMP, 0, CMP_R_CERTHASH_UNMATCHED),
    "certhash unmatched" },
  ...
  { ERR_PACK (ERR_LIB_CMP, 0, CMP_R_MISSING_PBM_SECRET),
    "missing pbm secret" },
  ...
  { ERR_PACK (ERR_LIB_CMP, 0, CMP_R_MISSING_PROTECTION),
    "missing protection" },
  { ERR_PACK (ERR_LIB_CMP, 0, CMP_R_MISSING_PUBLIC_KEY),
    "missing public key" },
  ...
  { ERR_PACK (ERR_LIB_CMP, 0, CMP_R_UNEXPECTED_PKIBODY),
    "unexpected pkibody" },
  { ERR_PACK (ERR_LIB_CMP, 0, CMP_R_UNEXPECTED_PKISTATUS),
    "unexpected pkistatus" },
  { ERR_PACK (ERR_LIB_CMP, 0, CMP_R_UNEXPECTED_POLLREQ),
    "unexpected pollreq" },
  ...
  { ERR_PACK (ERR_LIB_CMP, 0, CMP_R_UNKNOWN_CRL_ISSUER),
    "unknown crl issuer" },
  ...
  { ERR_PACK (ERR_LIB_CMP, 0, CMP_R_WRONG_CERTID_IN_RP),
    "wrong certid in rp" },
  ...
  { ERR_PACK (ERR_LIB_CMP, 0, CMP_R_WRONG_SERIAL_IN_RP),
    "wrong serial in rp" },
  { 0, NULL }
};
...
int
ossl_err_load_CMP_strings (void)
{
#ifndef OPENSSL_NO_ERR
