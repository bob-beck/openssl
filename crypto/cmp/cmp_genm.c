...
static void cert_msg(const char       *func,
                     const char       *file,
                     int               lineno,
...
static int ossl_X509_check_all(OSSL_CMP_CTX            *ctx,
                               const char              *source,
                               STACK_OF(X509)          *certs,
                               int                      type_CA,
...
static int
verify_ss_cert(OSSL_LIB_CTX *libctx, const char *propq, X509_STORE *ts, STACK_OF(X509) *untrusted, X509 *target)
{
...
static int verify_ss_cert_trans(OSSL_CMP_CTX *ctx,
