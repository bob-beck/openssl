 ...
 */
static const char*
CMP_PKIFAILUREINFO_to_string(int number)
{
  switch (number) {
...
int
ossl_cmp_pkisi_check_pkifailureinfo(const OSSL_CMP_PKISI* si, int bit_index)
{
 ...
 */
static char*
snprint_PKIStatusInfo_parts(int status,
                            int fail_info,
...
char*
OSSL_CMP_snprint_PKIStatusInfo(const OSSL_CMP_PKISI* statusInfo,
                               char* buf,
                               size_t bufsize)
{
  int failure_info;
...
char*
OSSL_CMP_CTX_snprint_PKIStatus(const OSSL_CMP_CTX* ctx,
                               char* buf,
                               size_t bufsize)
{
  if (ctx == NULL) {
