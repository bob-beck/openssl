...
static int check_cert_path(const OSSL_CMP_CTX* ctx,
                           X509_STORE* store,
                           X509* scrt) {
...
static int check_msg_given_cert(const OSSL_CMP_CTX* ctx,
                                X509* cert,
                                const OSSL_CMP_MSG* msg) {
 ...
 * On success cache the found cert using ossl_cmp_ctx_set1_validatedSrvCert().
 */
static int check_msg_all_certs(OSSL_CMP_CTX* ctx,
                               const OSSL_CMP_MSG* msg,
                               int mode_3gpp) {
  int ret = 0;
