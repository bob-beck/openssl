...
static BIGNUM *
srp_Calc_xy (const BIGNUM *x, const BIGNUM *y, const BIGNUM *N,
...
static BIGNUM *
srp_Calc_k (const BIGNUM *N, const BIGNUM *g, OSSL_LIB_CTX *libctx,
            const char *propq)
{
...
BIGNUM *
SRP_Calc_server_key (const BIGNUM *A, const BIGNUM *v, const BIGNUM *u,
...
BIGNUM *
SRP_Calc_B_ex (const BIGNUM *b, const BIGNUM *N, const BIGNUM *g,
...
BIGNUM *
SRP_Calc_x_ex (const BIGNUM *s, const char *user, const char *pass,
               OSSL_LIB_CTX *libctx, const char *propq)
{
...
BIGNUM *
SRP_Calc_A (const BIGNUM *a, const BIGNUM *N, const BIGNUM *g)
{
  BN_CTX *bn_ctx;
  BIGNUM *A = NULL;
...
BIGNUM *
SRP_Calc_client_key_ex (const BIGNUM *N, const BIGNUM *B, const BIGNUM *g,
...
BIGNUM *
SRP_Calc_client_key (const BIGNUM *N, const BIGNUM *B, const BIGNUM *g,
                     const BIGNUM *x, const BIGNUM *a, const BIGNUM *u)
{
...
int
SRP_Verify_B_mod_N (const BIGNUM *B, const BIGNUM *N)
{
  BIGNUM *r;
  BN_CTX *bn_ctx;
  int ret = 0;
 ...
 */
char *
SRP_check_known_gN_param (const BIGNUM *g, const BIGNUM *N)
{
  size_t i;
  if ((g == NULL) || (N == NULL))
    return NULL;
