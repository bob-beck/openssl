...
static int test_time_to_timeval(void) {
  ...
  if (!TEST_long_eq(tv.tv_sec, 0) || !TEST_long_eq(tv.tv_usec, 0)) return 0;
  ...
  a = ossl_ticks2time(1);
  tv = ossl_time_to_timeval(a);
  if (!TEST_long_eq(tv.tv_sec, 0) || !TEST_long_eq(tv.tv_usec, 1)) return 0;
  ...
  tv = ossl_time_to_timeval(a);
  if (!TEST_long_eq(tv.tv_sec, 0) || !TEST_long_eq(tv.tv_usec, 2)) return 0;
  a = ossl_ticks2time(999000);
  tv = ossl_time_to_timeval(a);
  if (!TEST_long_eq(tv.tv_sec, 0) || !TEST_long_eq(tv.tv_usec, 999)) return 0;
  a = ossl_ticks2time(999999001);
  tv = ossl_time_to_timeval(a);
  if (!TEST_long_eq(tv.tv_sec, 1) || !TEST_long_eq(tv.tv_usec, 0)) return 0;
  ...
  tv = ossl_time_to_timeval(a);
  if (!TEST_long_eq(tv.tv_sec, 1) || !TEST_long_eq(tv.tv_usec, 1)) return 0;
