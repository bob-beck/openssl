...
static int exdup(CRYPTO_EX_DATA* to,
...
static void exfree(void* parent,
                   void* ptr,
                   CRYPTO_EX_DATA* ad,
                   int idx,
                   long argl,
...
static void exnew2(void* parent,
                   void* ptr,
                   CRYPTO_EX_DATA* ad,
                   int idx,
                   long argl,
...
static void exfree2(void* parent,
                    void* ptr,
                    CRYPTO_EX_DATA* ad,
                    int idx,
                    long argl,
