...
static void
exnew (void *parent, void *ptr, CRYPTO_EX_DATA *ad, int idx, long argl,
       void *argp)
{
...
static int
exdup (CRYPTO_EX_DATA *to, const CRYPTO_EX_DATA *from, void **from_d, int idx,
       long argl, void *argp)
{
  if (!TEST_int_eq (idx, saved_idx) || !TEST_long_eq (argl, saved_argl)
...
static void
exfree (void *parent, void *ptr, CRYPTO_EX_DATA *ad, int idx, long argl,
        void *argp)
{
  if (!TEST_int_eq (idx, saved_idx) || !TEST_long_eq (argl, saved_argl)
...
static void
exnew2 (void *parent, void *ptr, CRYPTO_EX_DATA *ad, int idx, long argl,
        void *argp)
{
...
static int
exdup2 (CRYPTO_EX_DATA *to, const CRYPTO_EX_DATA *from, void **from_d, int idx,
        long argl, void *argp)
{
...
static void
exfree2 (void *parent, void *ptr, CRYPTO_EX_DATA *ad, int idx, long argl,
         void *argp)
{
