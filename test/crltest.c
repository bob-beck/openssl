 ...
 */
static BIO*
glue2bio(const char** pem, char** out)
{
  size_t s = 0;
 ...
 */
static X509*
X509_from_strings(const char** pem)
{
  X509* x;
  char* p;
  BIO* b = glue2bio(pem, &p);
...
static int
test_unknown_critical_crl(int n)
{
