...
static int
GEN_SCRIPT_print (GEN_SCRIPT *gen_script, BIO *bio,
...
static void
SCRIPT_INFO_print (SCRIPT_INFO *script_info, BIO *bio, int error,
                   const char *msg)
{
  if (error)
...
static int
TERP_init (TERP *terp, const TERP_CONFIG *cfg, const SCRIPT_INFO *script_info,
           const GEN_SCRIPT *gen_script)
{
