...
static int execute_cmp_asn1_get_int_test(CMP_ASN_TEST_FIXTURE* fixture) {
  ...
  if (!TEST_ptr(asn1integer)) return res;
  ...
  res = 0;
  if (!TEST_true(ASN1_INTEGER_set_int64(asn1integer, max_int + 1))) goto err;
...
static int execute_CMP_ASN1_OCTET_STRING_set1_test(
    CMP_ASN_TEST_FIXTURE* fixture) {
