...
{
  return test_rsa_simple(
    idx, RSA_PKCS1_PADDING, RSA_PKCS1_PADDING, 1, NULL, NULL, NULL);
}
...
test_rsa_security_bit(int n)
{
   ...
   */
  if (TEST_true(RSA_set0_key(
        key, BN_bin2bn(num, bytes, NULL), BN_bin2bn(num, bytes, NULL), NULL)) &&
...
test_rsa_saos(void)
{
  ...
  if (!TEST_false(
        RSA_verify_ASN1_OCTET_STRING(0,
                                     in,
                                     inlen,
                                     (unsigned char*)no_octet_sig,
