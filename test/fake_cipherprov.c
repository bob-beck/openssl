...
static int
ctx_from_key_params (PROV_CIPHER_FAKE_CTX *pctx, const OSSL_PARAM *params)
{
  const OSSL_PARAM *p;
  char key_name[MAX_KEYNAME];
  char *pval = key_name;
...
static void
fake_skeymgmt_free (void *keydata)
{
  OPENSSL_free (keydata);
}

static void *
fake_skeymgmt_import (void *provctx, int selection, const OSSL_PARAM *p)
{
...
static int
fake_skeymgmt_export (void *keydata, int selection,
...
static void
fake_freectx (void *vctx)
{
  OPENSSL_free (vctx);
}

static int
fake_skey_init (PROV_CIPHER_FAKE_CTX *ctx, void *pkeyparam,
...
static int
fake_skey_einit (void *vctx, void *pkeyparam, const unsigned char *iv,
...
static int
fake_skey_dinit (void *vctx, void *pkeyparam, const unsigned char *iv,
                 size_t ivlen, const OSSL_PARAM params[])
{
  PROV_CIPHER_FAKE_CTX *ctx = (PROV_CIPHER_FAKE_CTX *)vctx;
...
static int
fake_cipher (void *vctx, unsigned char *out, size_t *outl, size_t outsize,
...
static int
fake_final (void *vctx, unsigned char *out, size_t *outl, size_t outsize)
{
  *outl = 0;
  return 1;
}
...
static int
fake_get_params (OSSL_PARAM params[])
{
...
fake_gettable_ctx_params (ossl_unused void *cctx, ossl_unused void *provctx)
{
...
static int
fake_get_ctx_params (void *vctx, OSSL_PARAM params[])
{
  OSSL_PARAM *p;
...
static const OSSL_PARAM *
fake_settable_ctx_params (ossl_unused void *cctx, ossl_unused void *provctx)
{
...
fake_cipher_query (void *provctx, int operation_id, int *no_cache)
{
  *no_cache = 0;
  switch (operation_id)
    {
...
static const OSSL_DISPATCH fake_cipher_method[]
    = { { OSSL_FUNC_PROVIDER_TEARDOWN, (void (*) (void))OSSL_LIB_CTX_free },
        { OSSL_FUNC_PROVIDER_QUERY_OPERATION,
          (void (*) (void))fake_cipher_query },
        OSSL_DISPATCH_END };

static int
fake_cipher_provider_init (const OSSL_CORE_HANDLE *handle,
...
OSSL_PROVIDER *
fake_cipher_start (OSSL_LIB_CTX *libctx)
{
  OSSL_PROVIDER *p;
...
void
fake_cipher_finish (OSSL_PROVIDER *p)
{
