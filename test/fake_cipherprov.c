...
static int fake_skey_init(PROV_CIPHER_FAKE_CTX *ctx,
                          void                 *pkeyparam,
...
static int
fake_skey_einit(void *vctx, void *pkeyparam, const unsigned char *iv, size_t ivlen, const OSSL_PARAM params[])
{
...
static int
fake_skey_dinit(void *vctx, void *pkeyparam, const unsigned char *iv, size_t ivlen, const OSSL_PARAM params[])
{
    PROV_CIPHER_FAKE_CTX *ctx = (PROV_CIPHER_FAKE_CTX *)vctx;
...
static int
fake_cipher(void *vctx, unsigned char *out, size_t *outl, size_t outsize, const unsigned char *in, size_t inl)
{
    PROV_CIPHER_FAKE_CTX *ctx = (PROV_CIPHER_FAKE_CTX *)vctx;
    size_t                i;
