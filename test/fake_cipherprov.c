...
static void* fake_skeymgmt_import(void* provctx,
                                  int selection,
                                  const OSSL_PARAM* p) {
...
static int fake_skeymgmt_export(void* keydata,
                                int selection,
...
static int fake_skey_einit(void* vctx,
                           void* pkeyparam,
                           const unsigned char* iv,
                           size_t ivlen,
                           const OSSL_PARAM params[]) {
...
static int fake_skey_dinit(void* vctx,
                           void* pkeyparam,
                           const unsigned char* iv,
                           size_t ivlen,
                           const OSSL_PARAM params[]) {
...
static int fake_cipher(void* vctx,
                       unsigned char* out,
                       size_t* outl,
                       size_t outsize,
...
static int fake_final(void* vctx,
                      unsigned char* out,
                      size_t* outl,
                      size_t outsize) {
  *outl = 0;
