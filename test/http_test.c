...
static int test_http_method(int do_get, int do_txt, int suggested_status)
{
    ...
    rsp = do_get ? OSSL_HTTP_get(real_server ? REAL_SERVER_URL : path, NULL /* proxy */, NULL /* no_proxy */,
                                 real_server ? NULL : wbio, real_server ? NULL : rbio, NULL /* bio_update_fn */,
                                 NULL /* arg */, 0 /* buf_size */, headers,
                                 real_server ? "text/html; charset=utf-8" : content_type, !do_txt /* expect_asn1 */,
                                 OSSL_HTTP_DEFAULT_MAX_RESP_LEN, 0 /* timeout */)
                 : OSSL_HTTP_transfer(NULL, NULL /* host */, NULL /* port */, path, 0 /* use_ssl */, NULL /* proxy */,
                                      NULL /* no_pr */, wbio, rbio, NULL /* bio_fn */, NULL /* arg */, 0 /* buf_size */,
                                      headers, content_type, req, content_type, !do_txt /* expect_asn1 */,
...
static int test_http_url_invalid(const char *url)
{
    ...
    res = TEST_false(OSSL_HTTP_parse_url(url, &ssl, NULL, &host, &port, &num, &path, NULL, NULL)) &&
