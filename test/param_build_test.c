...
static int
template_public_single_zero_test(int idx)
{
...
static int
template_private_single_zero_test(void)
{
  OSSL_PARAM_BLD* bld = NULL;
  OSSL_PARAM *params = NULL, *params_blt = NULL, *p;
  BIGNUM *zbn = NULL, *zbn_res = NULL;
...
static int
template_public_test(int tstid)
{
...
static int
template_private_test(int tstid)
{
