...
static void
tear_down(CMP_SES_TEST_FIXTURE* fixture)
{
...
static int
execute_exec_RR_ses_test(CMP_SES_TEST_FIXTURE* fixt)
{
...
static int
execute_exec_GENM_ses_test_single(CMP_SES_TEST_FIXTURE* fixture)
{
...
static int
execute_exec_GENM_ses_test(CMP_SES_TEST_FIXTURE* fixture)
{
...
static int
execute_exec_certrequest_ses_test(CMP_SES_TEST_FIXTURE* fixture)
{
  OSSL_CMP_CTX* ctx = fixture->cmp_ctx;
...
static int
test_exec_RR_ses(int request_error)
{
...
static int
test_exec_RR_ses_ok(void)
{
  return test_exec_RR_ses(0);
}

static int
test_exec_RR_ses_request_error(void)
{
  return test_exec_RR_ses(1);
}

static int
test_exec_RR_ses_receive_error(void)
{
  SETUP_TEST_FIXTURE(CMP_SES_TEST_FIXTURE, set_up);
...
static int
test_exec_REQ_ses_poll(int req_type,
                       int check_after,
                       int poll_count,
                       int total_timeout,
                       int expect)
{
  ...
  OSSL_CMP_CTX_set_option(
    fixture->cmp_ctx, OSSL_CMP_OPT_TOTAL_TIMEOUT, total_timeout);
...
static int
test_exec_IR_ses_poll_ok(void)
{
  return test_exec_REQ_ses_poll(
    OSSL_CMP_PKIBODY_IR, checkAfter, 2, 0, OSSL_CMP_PKISTATUS_accepted);
}

static int
test_exec_IR_ses_poll_no_timeout(void)
{
  return test_exec_REQ_ses_poll(OSSL_CMP_PKIBODY_IR,
                                checkAfter,
                                2 /* pollCount */,
...
static int
test_exec_IR_ses_poll_total_timeout(void)
{
  return !test_exec_REQ_ses_poll(OSSL_CMP_PKIBODY_IR,
                                 checkAfter + 1,
                                 3 /* pollCount */,
...
static int
test_exec_CR_ses(int implicit_confirm, int granted, int reject)
{
  SETUP_TEST_FIXTURE(CMP_SES_TEST_FIXTURE, set_up);
  fixture->req_type = OSSL_CMP_PKIBODY_CR;
  OSSL_CMP_CTX_set_option(
    fixture->cmp_ctx, OSSL_CMP_OPT_IMPLICIT_CONFIRM, implicit_confirm);
...
static int
test_exec_CR_ses_explicit_confirm(void)
{
  return test_exec_CR_ses(0, 0, 0) && test_exec_CR_ses(0, 0, 1 /* reject */);
}

static int
test_exec_CR_ses_implicit_confirm(void)
{
  return test_exec_CR_ses(1, 0, 0) && test_exec_CR_ses(1, 1 /* granted */, 0);
}

static int
test_exec_KUR_ses(int transfer_error, int pubkey, int raverified)
{
  SETUP_TEST_FIXTURE(CMP_SES_TEST_FIXTURE, set_up);
  ...
  if (pubkey || raverified)
    OSSL_CMP_CTX_set_option(
      fixture->cmp_ctx, OSSL_CMP_OPT_POPO_METHOD, OSSL_CRMF_POPO_RAVERIFIED);
...
static int
test_exec_KUR_ses_ok(void)
{
  return test_exec_KUR_ses(0, 0, 0);
}

static int
test_exec_KUR_ses_transfer_error(void)
{
  return test_exec_KUR_ses(1, 0, 0);
}

static int
test_exec_KUR_ses_wrong_popo(void)
{
...
static int
test_exec_KUR_ses_pub(void)
{
  return test_exec_KUR_ses(0, 1, 0);
}

static int
test_exec_KUR_ses_wrong_pub(void)
{
  return test_exec_KUR_ses(0, 1, 1);
}

static int
test_certConf_cb(OSSL_CMP_CTX* ctx, X509* cert, int fail_info, const char** txt)
{
...
static int
test_exec_P10CR_ses(int reject)
{
  OSSL_CMP_CTX* ctx;
  X509_REQ* csr = NULL;
...
static int
test_exec_P10CR_ses_ok(void)
{
  return test_exec_P10CR_ses(0);
}

static int
test_exec_P10CR_ses_reject(void)
{
  return test_exec_P10CR_ses(1);
}

static int
execute_try_certreq_poll_test(CMP_SES_TEST_FIXTURE* fixture)
{
  OSSL_CMP_CTX* ctx = fixture->cmp_ctx;
  int check_after;
...
static int
execute_try_certreq_poll_abort_test(CMP_SES_TEST_FIXTURE* fixture)
{
  OSSL_CMP_CTX* ctx = fixture->cmp_ctx;
  int check_after;
...
static int
test_try_certreq_poll_abort(void)
{
  SETUP_TEST_FIXTURE(CMP_SES_TEST_FIXTURE, set_up);
  fixture->expected = 1;
...
static int
test_exec_GENM_ses_poll_ok(void)
{
  return test_exec_REQ_ses_poll(
    OSSL_CMP_PKIBODY_GENM, checkAfter, 2, 0, OSSL_CMP_PKISTATUS_accepted);
}

static int
test_exec_GENM_ses_poll_no_timeout(void)
{
  return test_exec_REQ_ses_poll(OSSL_CMP_PKIBODY_GENM,
                                checkAfter,
                                1 /* pollCount */,
                                checkAfter + 1,
                                OSSL_CMP_PKISTATUS_accepted);
...
static int
test_exec_GENM_ses_poll_total_timeout(void)
{
  return test_exec_REQ_ses_poll(OSSL_CMP_PKIBODY_GENM,
                                checkAfter + 1,
                                3 /* pollCount */,
...
static int
test_exec_GENM_ses(int transfer_error, int total_timeout, int expect)
{
  SETUP_TEST_FIXTURE(CMP_SES_TEST_FIXTURE, set_up);
  if (transfer_error)
    OSSL_CMP_CTX_set_transfer_cb_arg(fixture->cmp_ctx, NULL);
...
static int
execute_exchange_error_test(CMP_SES_TEST_FIXTURE* fixture)
{
  int res =
