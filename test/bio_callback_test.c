...
static long
my_bio_cb_ex (BIO *b, int oper, const char *argp, size_t len, int argi,
...
static long
my_bio_callback (BIO *b, int oper, const char *argp, int argi, long argl,
                 long ret)
{
  if (my_param_count >= MAXCOUNT)
    return -1;
