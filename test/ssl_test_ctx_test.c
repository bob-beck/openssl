...
static int
clientconf_eq(SSL_TEST_CLIENT_CONF* conf1, SSL_TEST_CLIENT_CONF* conf2)
{
...
static int
serverconf_eq(SSL_TEST_SERVER_CONF* serv, SSL_TEST_SERVER_CONF* serv2)
{
...
static int
extraconf_eq(SSL_TEST_EXTRA_CONF* extra, SSL_TEST_EXTRA_CONF* extra2)
{
...
static int
testctx_eq(SSL_TEST_CTX* ctx, SSL_TEST_CTX* ctx2)
{
...
static int
execute_test(SSL_TEST_CTX_TEST_FIXTURE* fixture)
{
  int success = 0;
  SSL_TEST_CTX* ctx;

  if (!TEST_ptr(ctx = SSL_TEST_CTX_create(conf,
...
static void
tear_down(SSL_TEST_CTX_TEST_FIXTURE* fixture)
{
...
static int
test_bad_configuration(int idx)
{
  SSL_TEST_CTX* ctx;
