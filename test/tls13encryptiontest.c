...
multihexstr2buf (const char *str[3], size_t *len)
{
...
static int
load_record (TLS_RL_RECORD *rec, RECORD_DATA *recd, unsigned char **key,
...
static int
test_record (TLS_RL_RECORD *rec, RECORD_DATA *recd, int enc)
{
  int ret = 0;
  unsigned char *refd;
  size_t refdatalen = 0;
