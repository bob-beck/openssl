...
static RECORD_DATA refdata[] = {
     ...
     */
     ...
     {"f10b26d8fcaf67b5b828f712122216a1cd14187465b77637cbcd78539128bb93"
      ...
      "6e8e"},
     "c66cb1aec519df44c91e10995511ac8b",                                                     "f7f6884c4981716c2d0d29a4",
     "0000000000000000"},
    { /* Client: Finished */
     ...
     {"9539b4ae2f87fd8e616b295628ea953d9e3858db274970d19813ec136cae7d96"
      ...
      "",
      ""},
     "2679a43e1d76784034ea1797d5ad2649",                                                     "5482405290dd0d2f81c0d942",
     "0000000000000000"},
    { /* Server: NewSessionTicket */
     ...
     "c1cad4425a438b5de714830a",                                                                                         "0000000000000000"},
    { /* Client: Application Data */
     ...
     "b99dc58cd5ff5ab082fdad19",                                                                                         "0000000000000000"},
    ...
    { /* Server: Application Data */
     ...
     {"f65f49fd2df6cd2347c3d30166e3cfddb6308a5906c076112c6a37ff1dbd406b"
      ...
      "",
      ""},
     "a688ebb5ac826d6f42d45c0cc44b9b7d",                                                     "c1cad4425a438b5de714830a",
     "0000000000000001"},
    { /* Client: CloseNotify */
     {"010015", "", ""},
     {"2c2148163d7938a35f6acf2a6606f8cbd1d9f2", "", ""},
     "88b96ad686c84be55ace18a59cce5c87",                                                     "b99dc58cd5ff5ab082fdad19",
     "0000000000000001"},
    { /* Server: CloseNotify */
     {"010015", "", ""},
     ...
     "c1cad4425a438b5de714830a",                                                                                         "0000000000000002"}
};
...
static int load_record(TLS_RL_RECORD  *rec,
                       RECORD_DATA    *recd,
                       unsigned char **key,
                       unsigned char  *iv,
                       size_t          ivlen,
...
static int test_tls13_encryption(void)
{
    ...
    for (ctr = 0; ctr < OSSL_NELEM(refdata); ctr++) {
        ...
        if (!TEST_true(ossl_tls_record_method.new_record_layer(NULL,
                                                               NULL,
                                                               TLS1_3_VERSION,
