...
static int dummy_decoder_decode(void                     *ctx,
                                OSSL_CORE_BIO            *cin,
                                int                       selection,
...
static int dummy_encoder_encode(void                     *ctx,
                                OSSL_CORE_BIO            *out,
                                const void               *obj_raw,
...
static int dummy_rand_instantiate(void                *vdrbg,
...
static int dummy_rand_generate(void                *vctx,
                               unsigned char       *out,
                               size_t               outlen,
                               unsigned int         strength,
                               int                  prediction_resistance,
...
static int
dummy_provider_init(const OSSL_CORE_HANDLE *handle, const OSSL_DISPATCH *in, const OSSL_DISPATCH **out, void **provctx)
{
