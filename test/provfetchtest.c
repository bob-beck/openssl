...
static int dummy_provider_init(const OSSL_CORE_HANDLE* handle,
  ...
  *out = dummy_dispatch_table;
   ...
   */
  if (RAND_bytes_ex(libctx, buf, sizeof(buf), 0) <= 0) return 0;
