...
static int
dummy_decoder_decode (void *ctx, OSSL_CORE_BIO *cin, int selection,
...
static int
dummy_encoder_encode (void *ctx, OSSL_CORE_BIO *out, const void *obj_raw,
...
static void *
dummy_store_open (void *provctx, const char *uri)
{
  return NULL;
}

static int
dummy_store_load (void *loaderctx, OSSL_CALLBACK *object_cb,
...
static int
dumm_store_eof (void *loaderctx)
{
  return 0;
}

static int
dummy_store_close (void *loaderctx)
{
  return 0;
}
...
static void *
dummy_rand_newctx (void *provctx, void *parent,
...
static void
dummy_rand_freectx (void *vctx)
{
}

static int
dummy_rand_instantiate (void *vdrbg, unsigned int strength,
...
static int
dummy_rand_uninstantiate (void *vdrbg)
{
  return 1;
}

static int
dummy_rand_generate (void *vctx, unsigned char *out, size_t outlen,
...
dummy_rand_gettable_ctx_params (void *vctx, void *provctx)
{
...
static int
dummy_rand_get_ctx_params (void *vctx, OSSL_PARAM params[])
{
  OSSL_PARAM *p;
...
static int
dummy_rand_enable_locking (void *vtest)
{
  return 1;
}

static int
dummy_rand_lock (void *vtest)
{
  return 1;
}

static void
dummy_rand_unlock (void *vtest)
{
}
...
dummy_query (void *provctx, int operation_id, int *no_cache)
{
  *no_cache = 0;
  switch (operation_id)
    {
...
static int
dummy_provider_init (const OSSL_CORE_HANDLE *handle, const OSSL_DISPATCH *in,
