...
static int
dummy_store_load(void* loaderctx,
                 OSSL_CALLBACK* object_cb,
                 void* object_cbarg,
                 OSSL_PASSPHRASE_CALLBACK* pw_cb,
                 void* pw_cbarg)
...
static void*
dummy_rand_newctx(void* provctx,
                  void* parent,
...
static int
dummy_rand_instantiate(void* vdrbg,
...
static int
dummy_provider_init(const OSSL_CORE_HANDLE* handle,
...
fetch_test(int tst)
{
  ...
  switch (tst % 4) {
    ...
    case 1:
      ...
      break;
    case 2:
      loader = OSSL_STORE_LOADER_fetch(
        libctx, "DUMMY", query ? "provider=dummy" : NULL);
      if (!TEST_ptr(loader))
        goto err;
      break;
    case 3:
