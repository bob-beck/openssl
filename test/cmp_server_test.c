...
static void
tear_down(CMP_SRV_TEST_FIXTURE* fixture)
{
  OSSL_CMP_SRV_CTX_free(fixture->srv_ctx);
  OPENSSL_free(fixture);
}

static CMP_SRV_TEST_FIXTURE*
...
static int
execute_test_handle_request(CMP_SRV_TEST_FIXTURE* fixture)
{
  ...
  if (!TEST_true(OSSL_CMP_SRV_CTX_init(ctx,
                                       dummy_custom_ctx,
