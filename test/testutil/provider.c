...
int
test_get_libctx (OSSL_LIB_CTX **libctx, OSSL_PROVIDER **default_null_prov,
...
int
test_arg_libctx (OSSL_LIB_CTX **libctx, OSSL_PROVIDER **default_null_prov,
 ...
 * Returns 1 if the version is retrieved correctly, 0 if the FIPS provider
 * isn't loaded and -1 on error.
 */
static int
fips_provider_version (OSSL_LIB_CTX *libctx, FIPS_VERSION *vers)
{
...
int
fips_provider_version_eq (OSSL_LIB_CTX *libctx, int major, int minor,
                          int patch)
{
  FIPS_VERSION prov;
  int res;
...
int
fips_provider_version_ne (OSSL_LIB_CTX *libctx, int major, int minor,
                          int patch)
{
  FIPS_VERSION prov;
  int res;
...
int
fips_provider_version_le (OSSL_LIB_CTX *libctx, int major, int minor,
                          int patch)
{
  FIPS_VERSION prov;
  int res;
...
int
fips_provider_version_lt (OSSL_LIB_CTX *libctx, int major, int minor,
                          int patch)
{
  FIPS_VERSION prov;
  int res;
...
int
fips_provider_version_gt (OSSL_LIB_CTX *libctx, int major, int minor,
                          int patch)
{
  FIPS_VERSION prov;
  int res;
...
int
fips_provider_version_ge (OSSL_LIB_CTX *libctx, int major, int minor,
                          int patch)
{
  FIPS_VERSION prov;
  int res;
