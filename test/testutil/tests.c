 ...
 */
void
test_fail_message_prefix (const char *prefix, const char *file, int line,
...
static void
test_fail_message_va (const char *prefix, const char *file, int line,
                      const char *type, const char *left, const char *right,
...
static void
test_fail_message (const char *prefix, const char *file, int line,
                   const char *type, const char *left, const char *right,
...
void
test_error_c90 (const char *desc, ...)
{
  va_list ap;
...
int
test_str_eq (const char *file, int line, const char *st1, const char *st2,
...
int
test_str_ne (const char *file, int line, const char *st1, const char *st2,
             const char *s1, const char *s2)
{
  if ((s1 == NULL) ^ (s2 == NULL))
    return 1;
...
int
test_strn_eq (const char *file, int line, const char *st1, const char *st2,
...
int
test_strn_ne (const char *file, int line, const char *st1, const char *st2,
              const char *s1, size_t n1, const char *s2, size_t n2)
{
  if ((s1 == NULL) ^ (s2 == NULL))
    return 1;
...
int
test_mem_eq (const char *file, int line, const char *st1, const char *st2,
...
int
test_mem_ne (const char *file, int line, const char *st1, const char *st2,
             const void *s1, size_t n1, const void *s2, size_t n2)
{
  if ((s1 == NULL) ^ (s2 == NULL))
    return 1;
...
int
test_BN_eq_word (const char *file, int line, const char *bns, const char *ws,
...
int
test_BN_abs_eq_word (const char *file, int line, const char *bns,
...
#define DEFINE_TIME_T_COMPARISON(opname, op)                                  \
  int test_time_t_##opname (const char *file, int line, const char *s1,       \
                            const char *s2, const time_t t1, const time_t t2) \
  {                                                                           \
    ASN1_TIME *at1 = ASN1_TIME_set (NULL, t1);                                \
    ASN1_TIME *at2 = ASN1_TIME_set (NULL, t2);                                \
    int r = at1 != NULL && at2 != NULL && ASN1_TIME_compare (at1, at2) op 0;  \
    if (!r)                                                                   \
