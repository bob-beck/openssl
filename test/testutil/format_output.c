...
static void
test_diff_header (const char *left, const char *right)
{
...
static void
test_string_null_empty (const char *m, char c)
{
  if (m == NULL)
...
static void
test_fail_string_common (const char *prefix, const char *file, int line,
 ...
 */
void
test_fail_string_message (const char *prefix, const char *file, int line,
 ...
 */
static void
hex_convert_memory (const unsigned char *m, size_t n, char *b, size_t width)
{
  size_t i;
 ...
 */
static void
test_bignum_header_line (void)
{
  test_printf_stderr (" %*s\n", bn_chars + 6, "bit position");
}

static const char *
test_bignum_zero_null (const BIGNUM *bn)
{
  if (bn != NULL)
 ...
 */
static void
test_bignum_zero_print (const BIGNUM *bn, char sep)
{
 ...
 */
static int
convert_bn_memory (const unsigned char *in, size_t bytes, char *out, int *lz,
                   const BIGNUM *bn)
{
  int n = (int)(bytes * 2), i;
  char *p = out, *q = NULL;
 ...
 */
static void
test_fail_bignum_common (const char *prefix, const char *file, int line,
                         const char *type, const char *left, const char *right,
                         const char *op, const BIGNUM *bn1, const BIGNUM *bn2)
{
 ...
 */
void
test_fail_bignum_message (const char *prefix, const char *file, int line,
                          const char *type, const char *left,
                          const char *right, const char *op, const BIGNUM *bn1,
                          const BIGNUM *bn2)
{
...
void
test_fail_bignum_mono_message (const char *prefix, const char *file, int line,
                               const char *type, const char *left,
 ...
 */
static void
test_memory_null_empty (const unsigned char *m, char c)
{
  if (m == NULL)
 ...
 */
static void
test_fail_memory_common (const char *prefix, const char *file, int line,
                         const char *type, const char *left, const char *right,
                         const char *op, const unsigned char *m1, size_t l1,
 ...
 */
void
test_fail_memory_message (const char *prefix, const char *file, int line,
                          const char *type, const char *left,
                          const char *right, const char *op,
