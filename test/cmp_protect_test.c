...
#define SET_OPT_UNPROTECTED_SEND(ctx, val) OSSL_CMP_CTX_set_option((ctx), OSSL_CMP_OPT_UNPROTECTED_SEND, (val))
...
static int test_cmp_build_cert_chain(void)
{
    ...
    if (!TEST_ptr(fixture->certs = sk_X509_new_null()) || !TEST_ptr(fixture->chain = sk_X509_new_null()) ||
        ...
        !TEST_true(sk_X509_push(fixture->chain, endentity2)) || !TEST_true(sk_X509_push(fixture->chain, intermediate)))
    {
        tear_down(fixture);
        fixture = NULL;
    }
