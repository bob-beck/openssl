...
static void *
xor_prov_import_key (const OSSL_DISPATCH *fns, void *provctx, int selection,
...
static int
tls_prov_get_capabilities (void *provctx, const char *capability,
...
static int
xor_derive (void *vpxorctx, unsigned char *secret, size_t *secretlen,
            size_t outlen)
{
  PROV_XORKEMKEX_CTX *pxorctx = (PROV_XORKEMKEX_CTX *)vpxorctx;
  int i;
...
static int
xor_encapsulate (void *vpxorctx, unsigned char *ct, size_t *ctlen,
...
static int
xor_decapsulate (void *vpxorctx, unsigned char *ss, size_t *sslen,
...
static XORKEY *
xor_key_op (const X509_ALGOR *palg, const unsigned char *p, int plen,
            xor_key_op_t op, OSSL_LIB_CTX *libctx, const char *propq)
{
  XORKEY *key = NULL;
  int nid = NID_undef;
...
static XORKEY *
xor_key_from_x509pubkey (const X509_PUBKEY *xpk, OSSL_LIB_CTX *libctx,
                         const char *propq)
{
...
static XORKEY *
xor_key_from_pkcs8 (const PKCS8_PRIV_KEY_INFO *p8inf, OSSL_LIB_CTX *libctx,
                    const char *propq)
{
  XORKEY *xork = NULL;
  const unsigned char *p;
...
key_to_p8info (const void *key, int key_nid, void *params, int params_type,
               i2d_of_void *k2d)
{
...
static X509_SIG *
key_to_encp8 (const void *key, int key_nid, void *params, int params_type,
              i2d_of_void *k2d, struct key2any_ctx_st *ctx)
{
...
static X509_PUBKEY *
xorx_key_to_pubkey (const void *key, int key_nid, void *params,
...
static int
key_to_epki_der_priv_bio (BIO *out, const void *key, int key_nid,
...
static int
key_to_epki_pem_priv_bio (BIO *out, const void *key, int key_nid,
                          ossl_unused const char *pemname,
                          key_to_paramstring_fn *p2s, i2d_of_void *k2d,
                          struct key2any_ctx_st *ctx)
{
...
static int
key_to_pki_der_priv_bio (BIO *out, const void *key, int key_nid,
                         ossl_unused const char *pemname,
                         key_to_paramstring_fn *p2s, i2d_of_void *k2d,
                         struct key2any_ctx_st *ctx)
{
...
static int
key_to_pki_pem_priv_bio (BIO *out, const void *key, int key_nid,
                         ossl_unused const char *pemname,
                         key_to_paramstring_fn *p2s, i2d_of_void *k2d,
                         struct key2any_ctx_st *ctx)
{
...
static int
key_to_spki_der_pub_bio (BIO *out, const void *key, int key_nid,
                         ossl_unused const char *pemname,
                         key_to_paramstring_fn *p2s, i2d_of_void *k2d,
                         struct key2any_ctx_st *ctx)
{
...
static int
key_to_spki_pem_pub_bio (BIO *out, const void *key, int key_nid,
                         ossl_unused const char *pemname,
                         key_to_paramstring_fn *p2s, i2d_of_void *k2d,
                         struct key2any_ctx_st *ctx)
{
...
static int
prepare_xorx_params (const void *xorxkey, int nid, int save, void **pstr,
                     int *pstrtype)
{
...
static int
key2any_encode (struct key2any_ctx_st *ctx, OSSL_CORE_BIO *cout,
                const void *key, const char *typestr, const char *pemname,
                key_to_der_fn *writer, OSSL_PASSPHRASE_CALLBACK *pwcb,
                void *pwcbarg, key_to_paramstring_fn *key2paramstring,
                i2d_of_void *key2der)
{
  int ret = 0;
...
static int
xor_read_der (PROV_XOR_CTX *provctx, OSSL_CORE_BIO *cin, unsigned char **data,
              long *len)
{
  BUF_MEM *mem = NULL;
...
static void *
xor_der2key_decode_p8 (const unsigned char **input_der, long input_der_len,
...
der2key_newctx (void *provctx, struct keytype_desc_st *desc,
                const char *tls_name)
{
...
static int
xor_der2key_decode (void *vctx, OSSL_CORE_BIO *cin, int selection,
...
static int
der2key_export_object (void *vctx, const void *reference, size_t reference_sz,
...
static void *
xorx_d2i_PKCS8 (void **key, const unsigned char **der, long der_len,
                struct der2key_ctx_st *ctx)
{
...
static int
xor_sig_setup_md (PROV_XORSIG_CTX *ctx, const char *mdname,
                  const char *mdprops)
{
  EVP_MD *md;
...
static int
xor_sig_sign_init (void *vpxor_sigctx, void *vxorsig,
                   const OSSL_PARAM params[])
{
...
static int
xor_sig_verify_init (void *vpxor_sigctx, void *vxorsig,
                     const OSSL_PARAM params[])
{
...
static int
xor_sig_sign (void *vpxor_sigctx, unsigned char *sig, size_t *siglen,
...
static int
xor_sig_verify (void *vpxor_sigctx, const unsigned char *sig, size_t siglen,
...
static int
xor_sig_digest_signverify_init (void *vpxor_sigctx, const char *mdname,
...
static int
xor_sig_digest_sign_init (void *vpxor_sigctx, const char *mdname,
...
static int
xor_sig_digest_verify_init (void *vpxor_sigctx, const char *mdname,
                            void *vxorsig, const OSSL_PARAM params[])
{
  return xor_sig_digest_signverify_init (vpxor_sigctx, mdname, vxorsig,
                                         EVP_PKEY_OP_VERIFY);
...
int
xor_sig_digest_sign_final (void *vpxor_sigctx, unsigned char *sig,
...
int
xor_sig_digest_verify_final (void *vpxor_sigctx, const unsigned char *sig,
                             size_t siglen)
{
  PROV_XORSIG_CTX *pxor_sigctx = (PROV_XORSIG_CTX *)vpxor_sigctx;
  unsigned char digest[EVP_MAX_MD_SIZE];
...
int
tls_provider_init (const OSSL_CORE_HANDLE *handle, const OSSL_DISPATCH *in,
                   const OSSL_DISPATCH **out, void **provctx)
{
