...
static const OSSL_PARAM  xor_params[] = {OSSL_PARAM_int(OSSL_PKEY_PARAM_BITS, NULL),
...
static X509_SIG *
key_to_encp8(const void *key, int key_nid, void *params, int params_type, i2d_of_void *k2d, struct key2any_ctx_st *ctx)
{
