...
static void dgram_cb(int write_p,
                     int version,
                     int content_type,
                     const void* buf,
                     size_t msglen,
 ...
 */
static int unreliable_client_read(SSL* clientquic,
                                  SSL** stream,
                                  void* buf,
                                  size_t buflen,
                                  size_t* readbytes,
                                                        ...
                                                        TPARAM_CHECK_INJECT_RAW_A(
                                                            ...
                                                            TPARAM_CHECK_INJECT_RAW_A(
                                                                ...
                                                                TPARAM_CHECK_INJECT_RAW_A(
                                                                    ...
                                                                    "PREFERRED_"
                                                                    "ADDR is "
                                                                    "malformed") TPARAM_CHECK_INJECT_RAW_A(malformed_unknown_1,
                                                                    ...
                                                                    TPARAM_CHECK_INJECT_RAW_A(
                                                                        ...
                                                                        "ort "
                                                                        "parame"
                                                                        "ter") TPARAM_CHECK_INJECT_RAW_A(malformed_unknown_3,
                                                                                                         "bad transport parameter")
                                                                        ...
                                                                        TPARAM_CHECK_INJECT_A(
                                                                            ...
                                                                            "rm"
                                                                            "e"
                                                                            "d") TPARAM_CHECK_INJECT_A(MAX_ACK_DELAY,
                                                                                ...
                                                                                TPARAM_CHECK_DROP_INJECT_A(
                                                                                    ...
                                                                                    TPARAM_CHECK_DROP_INJECT_A(
                                                                                        ...
                                                                                        TPARAM_CHECK_INJECT_TWICE_A(ACK_DELAY_EXP,
                                                                                                                    ack_delay_exp,
                                                                                                                    "ACK_DELAY_EXP appears multiple times") TPARAM_CHECK_INJECT_TWICE_A(MAX_ACK_DELAY,
                                                                                                                                                                                        ack_delay_exp,
                                                                                                        ...
                                                                                                        TPARAM_CHECK_DROP_INJECT_A(
                                                                                                            ...
                                                                                                            TPARAM_CHECK_DROP_INJECT_A(
                                                                                                                ...
                                                                                                                TPARAM_CHECK_INT(INITIAL_MAX_DATA,
                                                                                                                                 "INITIAL_MAX_DATA is malformed") TPARAM_CHECK_INT(INITIAL_MAX_STREAM_DATA_BIDI_LOCAL,
                                                                                                                        ...
                                                                                                                        TPARAM_CHECK_INT(
                                                                                                                            ...
                                                                                                                            TPARAM_CHECK_INT(INITIAL_MAX_STREAMS_BIDI,
                                                                                                                                             "INITIAL_MAX_STREAMS_BIDI is malformed") TPARAM_CHECK_INT(INITIAL_MAX_STREAMS_UNI,
                                                                                                                                                                                                       "INITIAL_MAX_STREAMS_UNI is malformed") TPARAM_CHECK_INT(MAX_IDLE_TIMEOUT,
...
static int tparam_on_enc_ext(QTEST_FAULT* qtf,
...
static int create_quic_ssl_objects(SSL_CTX* sctx,
                                   SSL_CTX* cctx,
                                   SSL** lssl,
                                   SSL** cssl) {
  BIO_ADDR* addr = NULL;
 ...
 */
static int create_accept_stream(SSL* serverssl,
                                SSL* clientssl,
