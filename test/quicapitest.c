         ...
         TPARAM_CHECK_DUP(INITIAL_MAX_STREAM_DATA_BIDI_LOCAL,
             ...
             TPARAM_CHECK_DUP(INITIAL_MAX_STREAM_DATA_UNI,
                              ...
                              "times") TPARAM_CHECK_DUP(INITIAL_MAX_STREAMS_BIDI,
                                                        ...
                                                        "times")
                 TPARAM_CHECK_DUP(INITIAL_MAX_STREAMS_UNI, "INITIAL_MAX_"
                                                           "STREAMS_UNI "
                                                           "appears multiple "
                                                           "times") TPARAM_CHECK_DUP(
                     MAX_IDLE_TIMEOUT, "MAX_IDLE_TIMEOUT appears multiple "
                     ...
                     TPARAM_CHECK_DUP(ACTIVE_CONN_ID_LIMIT,
                                      ...
                                      "times") TPARAM_CHECK_DUP(DISABLE_ACTIVE_MIGRATION,
                                                                "DISABLE_"
                                                                "ACTIVE_"
                                                                "MIGRATION "
                                                                "appears "
                         ...
                         TPARAM_CHECK_DROP(INITIAL_SCID,
                             ...
                             TPARAM_CHECK_DROP_INJECT_A(
                                 ...
                                 disable_active_migration_1, "DISABLE_ACTIVE_MIGRATION is malformed") TPARAM_CHECK_INJECT(UNKNOWN_1,
                                                                                                                          NULL, 0, NULL) TPARAM_CHECK_INJECT_RAW_A(malformed_stateless_reset_token_1, "STATELESS_RESET_TOKEN is malformed") TPARAM_CHECK_INJECT_A(STATELESS_RESET_TOKEN, malformed_stateless_reset_token_2, "STATELESS_RESET_TOKEN is malformed") TPARAM_CHECK_INJECT_A(STATELESS_RESET_TOKEN,
                                                                                                                                                                                                                                                                                                                                                                                        malformed_stateless_reset_token_3, "STATELESS_RESET_TOKEN is malformed") TPARAM_CHECK_INJECT_A(STATELESS_RESET_TOKEN,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       malformed_stateless_reset_token_4, "STATELESS_RESET_TOKEN is malformed") TPARAM_CHECK_INJECT(STATELESS_RESET_TOKEN, NULL, 0, "STATELESS_RESET_TOKEN is malformed") TPARAM_CHECK_INJECT_RAW_A(malformed_preferred_addr_1,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    "PREFERRED_ADDR is malformed") TPARAM_CHECK_INJECT_RAW_A(malformed_preferred_addr_2, "PREFERRED_ADDR is malformed") TPARAM_CHECK_INJECT_RAW_A(malformed_preferred_addr_3,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  "PREFERRED_ADDR is malformed") TPARAM_CHECK_INJECT_RAW_A(malformed_preferred_addr_4,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           "PREFERRED_ADDR is malformed") TPARAM_CHECK_INJECT_RAW_A(malformed_unknown_1,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    "bad transport parameter") TPARAM_CHECK_INJECT_RAW_A(malformed_unknown_2,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         "bad transport parameter") TPARAM_CHECK_INJECT_RAW_A(malformed_unknown_3,
                                 ...
                                 TPARAM_CHECK_INJECT_A(ACK_DELAY_EXP, excess_ack_delay_exp, "ACK_DELAY_EXP is malformed") TPARAM_CHECK_INJECT_A(
                                     MAX_ACK_DELAY,
                                     excess_max_ack_delay, "MAX_ACK_DELAY is malformed")
                                     TPARAM_CHECK_DROP_INJECT_A(
                                         INITIAL_MAX_STREAMS_BIDI,
                                         excess_initial_max_streams,
                                         "INITIAL_MAX_STREAMS_BIDI is "
                                         "malformed") TPARAM_CHECK_DROP_INJECT_A(INITIAL_MAX_STREAMS_UNI, excess_initial_max_streams, "INITIAL_MAX_STREAMS_UNI is malformed")
                                         ...
                                         TPARAM_CHECK_DROP_INJECT_A(
                                             ...
                                             TPARAM_CHECK_DROP_INJECT_A(
                                                 ...
                                                 "ACTIVE_CONN_ID_LIMIT is "
                                                 "malformed")

                                                 TPARAM_CHECK_INJECT_TWICE_A(
                                                     ACK_DELAY_EXP,
                                                     ack_delay_exp,
                                                     "ACK_DELAY_EXP appears "
                                                     "multiple times")
                                                     TPARAM_CHECK_INJECT_TWICE_A(
                                                         MAX_ACK_DELAY,
                                                         ack_delay_exp,
                                                         "MAX_ACK_DELAY "
                                                         "appears multiple "
                                                         "times") TPARAM_CHECK_INJECT_TWICE_A(STATELESS_RESET_TOKEN,
                                                         ...
                                                         TPARAM_CHECK_INJECT_TWICE_A(
                                                             ...
                                                             TPARAM_CHECK_MUTATE(
                                                                 ...
                                                                 TPARAM_CHECK_DROP_INJECT_A(
                                                                     ...
                                                                     "DCID is "
                                                                     "malforme"
                                                                     "d") TPARAM_CHECK_DROP_INJECT_A(INITIAL_SCID,
                                                                                                     long_cid, "INITIAL_SCID is malformed")
                                                                     ...
                                                                     TPARAM_CHECK_INT(INITIAL_MAX_DATA, "INITIAL_MAX_DATA is malformed") TPARAM_CHECK_INT(
                                                                         ...
                                                                         TPARAM_CHECK_INT(
                                                                             ...
                                                                             "m"
                                                                             "e"
                                                                             "d") TPARAM_CHECK_INT(INITIAL_MAX_STREAM_DATA_UNI,
