...
#define ENCODE_CASE(n)                                                                                                 \
    {encode_case_##n##_enc, encode_case_##n##_expect, OSSL_NELEM(encode_case_##n##_expect), encode_case_##n##_dec},
...
#define ACK_CASE(n, expect_fail, dec) {ack_case_##n##_input, sizeof(ack_case_##n##_input), (dec), (expect_fail)},
