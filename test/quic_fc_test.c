...
#define RX_OP_INIT_CONN(init_window_size, max_window_size) {RX_OPC_INIT_CONN, 0, (init_window_size), (max_window_size)},
...
#define RX_OP_RX(stream_idx, end, is_fin) {RX_OPC_RX, (stream_idx), (end), (is_fin)},
...
#define RX_OP_CHECK_CWM_STREAM(stream_id, expected) {RX_OPC_CHECK_CWM_STREAM, (stream_id), (expected)},
#define RX_OP_CHECK_SWM_CONN(expected) {RX_OPC_CHECK_SWM_CONN, 0, (expected)},
#define RX_OP_CHECK_SWM_STREAM(stream_id, expected) {RX_OPC_CHECK_SWM_STREAM, (stream_id), (expected)},
#define RX_OP_CHECK_RWM_CONN(expected) {RX_OPC_CHECK_RWM_CONN, 0, (expected)},
#define RX_OP_CHECK_RWM_STREAM(stream_id, expected) {RX_OPC_CHECK_RWM_STREAM, (stream_id), (expected)},
#define RX_OP_CHECK_CHANGED_CONN(expected, clear) {RX_OPC_CHECK_CHANGED_CONN, 0, (expected), (clear)},
#define RX_OP_CHECK_CHANGED_STREAM(stream_id, expected, clear)                                                         \
    {RX_OPC_CHECK_CHANGED_STREAM, (stream_id), (expected), (clear)},
#define RX_OP_CHECK_ERROR_CONN(expected, clear) {RX_OPC_CHECK_ERROR_CONN, 0, (expected), (clear)},
