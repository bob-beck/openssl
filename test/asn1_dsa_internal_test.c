...
static unsigned char t_dsa_sig[] = {
    0x30,
    0x06, /* SEQUENCE tag + length */
    0x02,
    0x01,
    0x01, /* INTEGER tag + length + content */
    0x02,
    0x01,
    0x02 /* INTEGER tag + length + content */
};
...
static unsigned char t_dsa_sig_extra[] = {
    ...
    0x02, /* INTEGER tag + length + content */
    0x05,
    0x00 /* NULL tag + length */
};

static unsigned char t_dsa_sig_msb[] = {
    0x30,
    0x08, /* SEQUENCE tag + length */
    0x02,
    0x02,
    0x00,
    0x81, /* INTEGER tag + length + content */
    0x02,
    0x02,
    0x00,
    0x82 /* INTEGER tag + length + content */
};
...
static unsigned char t_dsa_sig_two[] = {
    ...
    0x02,
    0x01,
    0x00, /* INTEGER tag + length + content */
    0x02,
    0x02,
    0x02,
    0x00 /* INTEGER tag + length + content */
...
static unsigned char t_invalid_int_zero[] = {
    0x30,
    0x05, /* SEQUENCE tag + length */
    0x02,
    0x00, /* INTEGER tag + length */
    0x02,
    0x01,
    0x2a /* INTEGER tag + length */
};
...
static unsigned char t_invalid_int[] = {
    0x30,
    0x07, /* SEQUENCE tag + length */
    0x02,
    0x02,
    0x00,
    0x7f, /* INTEGER tag + length */
    0x02,
    0x01,
    0x2a /* INTEGER tag + length */
};
