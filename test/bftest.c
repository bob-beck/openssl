...
test_bf_cfb64(void)
{
  ...
  n = 0;
  BF_cfb64_encrypt(
    (unsigned char*)cbc_data, cbc_out, (long)13, &key, iv, &n, BF_ENCRYPT);
  BF_cfb64_encrypt((unsigned char*)&(cbc_data[13]),
                   &(cbc_out[13]),
                   len - 13,
                   &key,
                   iv,
  ...
  BF_cfb64_encrypt(
    &(cbc_out[17]), &(cbc_in[17]), len - 17, &key, iv, &n, BF_DECRYPT);
...
test_bf_ofb64(void)
{
  ...
  BF_ofb64_encrypt(
    (unsigned char*)&(cbc_data[13]), &(cbc_out[13]), len - 13, &key, iv, &n);
