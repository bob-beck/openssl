...
#define OP_CALL_PZ(f, x, xl)                                                  \
  OP_U64 (OPK_CALL_PZ) OP_FP (f) OP_P (x) OP_U64 (xl)
...
BEGIN_SCRIPT (u64_18446744073709551615, "serialize u64(18446744073709551615)",
              0)
...
BEGIN_SCRIPT (i64_m9223372036854775807, "serialize i64(-9223372036854775807)",
              0)
OPJ_I64 (-9223372036854775807LL)
END_SCRIPT_EXPECTING_Q (-9223372036854775807)

BEGIN_SCRIPT (i64_m9223372036854775808, "serialize i64(-9223372036854775808)",
              0)
...
BEGIN_SCRIPT (err_obj_multi_key, "error test: object item with repeated key",
              0)
OPJ_BEGIN_O ()
OPJ_KEY ("x")
OP_ASSERT_ERROR (0)
...
static const info_func scripts[] = {
  SCRIPT (null) SCRIPT (obj_empty) SCRIPT (array_empty) SCRIPT (bool_false)
      SCRIPT (bool_true) SCRIPT (u64_0) SCRIPT (u64_1) SCRIPT (u64_10) SCRIPT (
          ...
          SCRIPT (i64_1) SCRIPT (i64_2) SCRIPT (i64_10) SCRIPT (
              i64_12345) SCRIPT (i64_9223372036854775807) SCRIPT (i64_m1)
              SCRIPT (i64_m2) SCRIPT (i64_m10) SCRIPT (i64_m12345) SCRIPT (
                  ...
                  SCRIPT (str_empty) SCRIPT (str_a) SCRIPT (str_abc) SCRIPT (
                      ...
                      SCRIPT (str_len) SCRIPT (str_len0) SCRIPT (
                          str_len_nul) SCRIPT (hex_data0) SCRIPT (hex_data)
                          SCRIPT (array_nest1) SCRIPT (array_nest2) SCRIPT (
                              array_nest3) SCRIPT (array_nest4)
