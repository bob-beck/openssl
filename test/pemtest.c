...
static TESTDATA b64_pem_data[] = {
    ...
    {"a very ooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooong input",
     "YSB2ZXJ5IG9vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb"
     "29vb29vb29vb29vb29uZyBpbnB1dA=="}};
...
static int test_b64(int idx)
{
    ...
    if (!TEST_ptr(b) || !TEST_true(BIO_printf(b, "-----BEGIN %s-----\n", pemtype)) ||
        ...
        goto err;
    if (!TEST_int_eq(memcmp(pemtype, name, strlen(pemtype)), 0) || !TEST_long_eq(len, (long)strlen(raw)) ||
