...
static TESTDATA b64_pem_data[] = {
  ...
  { "a very "
    ...
    "ooooooooooooooooong input",
    "YSB2ZXJ5IG9vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb2"
    "9vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29uZyBpbnB1dA="
    "=" }
};
...
test_invalid(void)
{
  ...
  if (!TEST_ptr(b) ||
      ...
      || TEST_true(PEM_read_bio_ex(
           b, &name, &header, &data, &len, PEM_FLAG_ONLY_B64))) {
    BIO_free(b);
    return 0;
  }
  BIO_free(b);
