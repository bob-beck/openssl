...
static TESTDATA b64_pem_data[] = {
    ...
    {"a very "
     ...
     "oooooooooooooooooong input",
     "YSB2ZXJ5IG9vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb"
     "29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29vb29uZyBpbnB1dA="
     "="}};
...
static int test_cert_key_cert(void) {
  ...
  if (!TEST_ptr(key = load_pkey_pem(pemfile, NULL))) return 0;
...
static int test_empty_payload(void) {
  ...
  if (!TEST_ptr(b)) return 0;

  /* Expected to fail because the payload is empty */
  if (!TEST_false(PEM_read_bio_ex(b, &name, &header, &data, &len, 0))) goto err;
...
int setup_tests(void) {
  if (!TEST_ptr(pemfile = test_get_argument(0))) return 0;
