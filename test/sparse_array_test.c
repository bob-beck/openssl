...
static void
leaf_check_all(ossl_uintmax_t n, char* value, void* arg)
{
...
static void
leaf_delete(ossl_uintmax_t n, char* value, void* arg)
{
  struct doall_st* doall_data = (struct doall_st*)arg;
  const struct index_cases_st* cases = doall_data->cases;
  size_t i;
