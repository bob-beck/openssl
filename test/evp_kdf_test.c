...
static OSSL_PARAM* construct_hkdf_params(char* digest,
                                         char* key,
                                         size_t keylen,
                                         char* salt,
                                         char* info) {
...
static OSSL_PARAM* construct_pbkdf1_params(char* pass,
                                           char* digest,
                                           char* salt,
                                           unsigned int* iter) {
  OSSL_PARAM* params = OPENSSL_malloc_array(5, sizeof(OSSL_PARAM));
...
static OSSL_PARAM* construct_pbkdf2_params(char* pass,
                                           char* digest,
                                           char* salt,
                                           unsigned int* iter,
                                           int* mode) {
...
static OSSL_PARAM* construct_kbkdf_params(char* digest,
                                          char* mac,
                                          unsigned char* key,
                                          size_t keylen,
                                          char* salt,
