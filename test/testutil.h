...
#define OPT_TEST_OPTIONS_WITH_EXTRA_USAGE(usage) {OPT_HELP_STR, 1, '-', "Usage: %s [options] " usage}, OPT_TEST_OPTIONS

/* The Default test OPTIONS common to all tests with an default usage string */
#define OPT_TEST_OPTIONS_DEFAULT_USAGE {OPT_HELP_STR, 1, '-', "Usage: %s [options]\n"}, OPT_TEST_OPTIONS
...
#define OPT_TEST_DECLARE_USAGE(usage_str)                                                                              \
    ...
    {                                                                                                                  \
        ...
        static const OPTIONS options[] = {OPT_TEST_OPTIONS_WITH_EXTRA_USAGE(usage_str), {NULL}};                       \
        return options;                                                                                                \
    }
...
#define DECLARE_COMPARISON(type, name, opname)                                                                         \
    int test_##name##_##opname(const char *, int, const char *, const char *, const type, const type);
