...
/*
 * Simple parameterized tests. Calls test_function(idx) for each 0 <= idx <
 * num.
 */
...
/*
 * Optional Cases that need to be ignored by the test app when using
 * opt_next(), (that are handled internally).
 */
 ...
 * on specific FIPS provider versions.  Without this, bug fixes cannot be
 * tested in later releases.
 *
...
int test_BN_eq_zero (const char *file, int line, const char *s,
                     const BIGNUM *a);
int test_BN_ne_zero (const char *file, int line, const char *s,
                     const BIGNUM *a);
int test_BN_lt_zero (const char *file, int line, const char *s,
                     const BIGNUM *a);
int test_BN_le_zero (const char *file, int line, const char *s,
                     const BIGNUM *a);
int test_BN_gt_zero (const char *file, int line, const char *s,
                     const BIGNUM *a);
int test_BN_ge_zero (const char *file, int line, const char *s,
                     const BIGNUM *a);
int test_BN_eq_one (const char *file, int line, const char *s,
                    const BIGNUM *a);
...
int test_BN_eq_word (const char *file, int line, const char *bns,
...
#define TEST_int64_t_eq(a, b)                                                 \
  test_int64_t_eq (__FILE__, __LINE__, #a, #b, a, b)
#define TEST_int64_t_ne(a, b)                                                 \
  test_int64_t_ne (__FILE__, __LINE__, #a, #b, a, b)
#define TEST_int64_t_lt(a, b)                                                 \
  test_int64_t_lt (__FILE__, __LINE__, #a, #b, a, b)
#define TEST_int64_t_le(a, b)                                                 \
  test_int64_t_le (__FILE__, __LINE__, #a, #b, a, b)
#define TEST_int64_t_gt(a, b)                                                 \
  test_int64_t_gt (__FILE__, __LINE__, #a, #b, a, b)
#define TEST_int64_t_ge(a, b)                                                 \
  test_int64_t_ge (__FILE__, __LINE__, #a, #b, a, b)
...
#define TEST_BN_eq_word(a, w)                                                 \
  test_BN_eq_word (__FILE__, __LINE__, #a, #w, a, w)
