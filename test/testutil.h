...
int test_arg_libctx(OSSL_LIB_CTX** libctx,
                    OSSL_PROVIDER** default_null_prov,
                    OSSL_PROVIDER** provider,
                    int argn,
                    const char* usage);
...
void add_all_tests(const char* test_case_name,
                   int (*test_fn)(int idx),
                   int num,
                   int subtest);
 ...
 */
int fips_provider_version_eq(OSSL_LIB_CTX* libctx,
                             int major,
                             int minor,
                             int patch);
int fips_provider_version_ne(OSSL_LIB_CTX* libctx,
                             int major,
                             int minor,
                             int patch);
int fips_provider_version_le(OSSL_LIB_CTX* libctx,
                             int major,
                             int minor,
                             int patch);
int fips_provider_version_lt(OSSL_LIB_CTX* libctx,
                             int major,
                             int minor,
                             int patch);
int fips_provider_version_gt(OSSL_LIB_CTX* libctx,
                             int major,
                             int minor,
                             int patch);
int fips_provider_version_ge(OSSL_LIB_CTX* libctx,
                             int major,
                             int minor,
                             int patch);
...
typedef int fake_random_generate_cb(unsigned char* out,
                                    size_t outlen,
                                    const char* name,
                                    EVP_RAND_CTX* ctx);
