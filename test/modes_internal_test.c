...
typedef struct
{
  ...
  size_t (*encrypt_block)(const unsigned char* in,
                          ...
                          block128_f block);
  size_t (*encrypt_stream)(const unsigned char* in,
                           unsigned char* out,
                           size_t len,
                           const void* key,
                           unsigned char ivec[16],
  ...
  size_t (*decrypt_block)(const unsigned char* in,
                          ...
                          unsigned char ivec[16],
                          block128_f block);
  size_t (*decrypt_stream)(const unsigned char* in,
                           unsigned char* out,
                           size_t len,
                           const void* key,
                           unsigned char ivec[16],
...
static size_t
last_blocks_correction(const unsigned char* in, unsigned char* out, size_t len)
{
  size_t tail;
...
static size_t
last_blocks_correction_nist(const unsigned char* in,
                            unsigned char* out,
                            size_t len)
{
  size_t tail;
...
static int
execute_cts128(const CTS128_FIXTURE* fixture, int num)
{
  ...
  if (!TEST_size_t_eq(fixture->encrypt_block(test_input,
                                             ciphertext,
                                             len,
  ...
  memcpy(iv, test_iv, test_iv_len);
  size = fixture->decrypt_block(ciphertext,
                                cleartext,
                                len,
  ...
  memcpy(iv, test_iv, test_iv_len);
  if (!TEST_size_t_eq(fixture->encrypt_stream(test_input,
                                              ciphertext,
                                              len,
                                              encrypt_key_schedule,
                                              iv,
  ...
  memcpy(iv, test_iv, test_iv_len);
  if (!TEST_size_t_eq(fixture->decrypt_stream(ciphertext,
                                              cleartext,
                                              len,
                                              decrypt_key_schedule,
                                              iv,
