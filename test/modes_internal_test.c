...
static const unsigned char vector_17[17]
    = { 0xc6, 0x35, 0x35, 0x68, 0xf2, 0xbf, 0x8c, 0xb4, 0xd8,
...
static size_t
last_blocks_correction (const unsigned char *in, unsigned char *out,
                        size_t len)
{
  size_t tail;
...
static size_t
last_blocks_correction_nist (const unsigned char *in, unsigned char *out,
                             size_t len)
{
  size_t tail;
