...
static int fake_rsa_read_der(PROV_FAKE_RSA_CTX *provctx, OSSL_CORE_BIO *cin, unsigned char **data, long *len)
{
    BUF_MEM *mem = NULL;
...
static void *fake_rsa_der2key_decode_p8(const unsigned char **input_der, long input_der_len, struct der2key_ctx_st *ctx,
...
static struct fake_rsa_keydata *fake_rsa_d2i_PUBKEY(struct fake_rsa_keydata **a, const unsigned char **pp, long length)
{
    struct fake_rsa_keydata *key = NULL;
    X509_PUBKEY *xpk;
...
static int fake_rsa_der2key_decode(void *vctx, OSSL_CORE_BIO *cin, int selection, OSSL_CALLBACK *data_cb,
...
static OSSL_FUNC_keymgmt_export_fn *fake_rsa_prov_get_keymgmt_export(const OSSL_DISPATCH *fns)
{
...
static struct fake_rsa_keydata *fake_rsa_key_from_pkcs8(const PKCS8_PRIV_KEY_INFO *p8inf, OSSL_LIB_CTX *libctx,
                                                        const char *propq)
{
...
static void *fake_rsa_d2i_PKCS8(void **key, const unsigned char **der, long der_len, struct der2key_ctx_st *ctx)
{
    return fake_rsa_der2key_decode_p8(der, der_len, ctx, (key_from_pkcs8_t *)fake_rsa_key_from_pkcs8);
}
...
#define DO_PrivateKeyInfo(keytype)                                                                                     \
    "PrivateKeyInfo", keytype##_evp_type, (OSSL_KEYMGMT_SELECT_PRIVATE_KEY), NULL, NULL, NULL, fake_rsa_d2i_PKCS8,     \
        NULL, NULL, fake_rsa_key_adjust, (free_key_fn *)fake_rsa_keymgmt_free

#define DO_SubjectPublicKeyInfo(keytype)                                                                               \
    "SubjectPublicKeyInfo", keytype##_evp_type, (OSSL_KEYMGMT_SELECT_PUBLIC_KEY), NULL, NULL, NULL, NULL,              \
        (d2i_of_void *)fake_rsa_d2i_PUBKEY, NULL, fake_rsa_key_adjust, (free_key_fn *)fake_rsa_keymgmt_free
...
#define MAKE_DECODER(keytype_name, keytype, type, kind)                                                                \
    ...
    static const OSSL_DISPATCH fake_rsa_##kind##_der_to_##keytype##_decoder_functions[] = {                            \
...
static const OSSL_DISPATCH fake_rsa_method[] = {{OSSL_FUNC_PROVIDER_TEARDOWN, (void (*)(void))fake_rsa_prov_teardown},
