...
static const unsigned char sec_1[] =
    {'9', 'p', 'p', '8', '-', 'b', '3', '5', 'i', '-', 'X', 'd', '3', 'Q', '-', 'u', 'd', 'N', 'R'};
...
static void setup_check_update(CMP_VFY_TEST_FIXTURE          **fixture,
                               int                             expected,
...
static int test_msg_check_transaction_id(void)
{
    ...
    const unsigned char trans_id[OSSL_CMP_TRANSACTIONID_LENGTH] =
        {0x39, 0xB6, 0x90, 0x28, 0xC4, 0xBC, 0x7A, 0xF6, 0xBE, 0xC6, 0x4A, 0x88, 0x97, 0xA6, 0x95, 0x0B};
...
static int test_msg_check_recipient_nonce(void)
{
    ...
    const unsigned char rec_nonce[OSSL_CMP_SENDERNONCE_LENGTH] =
        {0x48, 0xF1, 0x71, 0x1F, 0xE5, 0xAF, 0x1C, 0x8B, 0x21, 0x97, 0x5C, 0x84, 0x74, 0x49, 0xBA, 0x32};
