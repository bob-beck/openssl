...
int mempacket_test_inject(BIO* bio,
                          const char* in,
                          int inl,
                          int pktnum,
                          int type) {
...
int create_ssl_ctx_pair(OSSL_LIB_CTX* libctx,
                        const SSL_METHOD* sm,
                        const SSL_METHOD* cm,
...
int create_ssl_objects2(SSL_CTX* serverctx,
                        SSL_CTX* clientctx,
                        SSL** sssl,
                        SSL** cssl,
                        int sfd,
 ...
 */
int create_ssl_objects(SSL_CTX* serverctx,
                       SSL_CTX* clientctx,
                       SSL** sssl,
                       SSL** cssl,
                       BIO* s_to_c_fbio,
 ...
 */
int create_bare_ssl_connection_ex(SSL* serverssl,
                                  SSL* clientssl,
                                  int want,
                                  int read,
                                  int listen,
...
int create_bare_ssl_connection(SSL* serverssl,
                               SSL* clientssl,
                               int want,
                               int read,
                               int listen) {
 ...
 * messages.
 */
int create_ssl_connection_ex(SSL* serverssl,
                             SSL* clientssl,
                             int want,
                             int* cm_count,
                             int* sm_count) {
...
int ssl_ctx_add_large_cert_chain(OSSL_LIB_CTX* libctx,
                                 SSL_CTX* sctx,
