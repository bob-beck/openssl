...
__owur static int parse_enum(const test_enum* enums,
                             size_t num_enums,
                             int* value,
                             const char* name) {
  size_t i;
...
static const char* enum_name(const test_enum* enums,
                             size_t num_enums,
                             int value) {
  size_t i;
  for (i = 0; i < num_enums; i++) {
...
__owur static int parse_client_verify_callback(
    SSL_TEST_CLIENT_CONF* client_conf,
    const char* value) {
  int ret_value;
...
static int parse_client_options(SSL_TEST_CLIENT_CONF* client,
                                const CONF* conf,
...
static int parse_server_options(SSL_TEST_SERVER_CONF* server,
                                const CONF* conf,
...
SSL_TEST_CTX* SSL_TEST_CTX_create(const CONF* conf,
