...
__owur static int
parse_enum (const test_enum *enums, size_t num_enums, int *value,
            const char *name)
{
  size_t i;
...
__owur static int
parse_servername_callback (SSL_TEST_SERVER_CONF *server_conf,
                           const char *value)
{
  int ret_value;
...
IMPLEMENT_SSL_TEST_BOOL_OPTION (SSL_TEST_CTX, test,
...
__owur static int
parse_expected_ca_names (STACK_OF (X509_NAME) **pnames, const char *value,
                         OSSL_LIB_CTX *libctx)
{
  if (value == NULL)
    return 0;
...
IMPLEMENT_SSL_TEST_BOOL_OPTION (SSL_TEST_CLIENT_CONF, client,
                                no_extms_on_reneg)
...
static int
parse_client_options (SSL_TEST_CLIENT_CONF *client, const CONF *conf,
...
static int
parse_server_options (SSL_TEST_SERVER_CONF *server, const CONF *conf,
