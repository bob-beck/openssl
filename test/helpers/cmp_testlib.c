...
OSSL_CMP_MSG *
load_pkimsg (const char *file, OSSL_LIB_CTX *libctx)
{
  OSSL_CMP_MSG *msg;
 ...
 */
int
valid_asn1_encoding (const OSSL_CMP_MSG *msg)
{
 ...
 */
int
STACK_OF_X509_cmp (const STACK_OF (X509) *sk1, const STACK_OF (X509) *sk2)
{
  int i, res;
  X509 *a, *b;
 ...
 */
int
STACK_OF_X509_push1 (STACK_OF (X509) *sk, X509 *cert)
{
  int res;
