...
static size_t bandwidth_limit(struct bw_limiter_st* limit,
                              OSSL_TIME now,
                              BIO_MSG* msg,
                              size_t num_msg) {
  size_t i;
...
static int noisy_dgram_sendmmsg(BIO* bio,
                                BIO_MSG* msg,
                                size_t stride,
                                size_t num_msg,
                                uint64_t flags,
...
static void get_noise(int noise_rate,
                      int long_header,
                      uint64_t* reinject,
                      int* should_drop,
                      uint16_t* flip,
...
static void flip_bits(unsigned char* msg,
                      size_t msg_len,
                      uint16_t flip,
                      size_t flip_offset) {
  if (flip == 0)
...
static int noisy_dgram_recvmmsg(BIO* bio,
                                BIO_MSG* msg,
                                size_t stride,
                                size_t num_msg,
                                uint64_t flags,
