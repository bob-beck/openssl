...
static void noise_msg_callback(int write_p,
                               int version,
                               int content_type,
                               const void* buf,
                               size_t len,
 ...
 * callback
 */
int qtest_fault_prepend_frame(QTEST_FAULT* fault,
...
static int handshake_mutate(const unsigned char* msgin,
                            size_t msginlen,
...
static int pcipher_sendmmsg(BIO* b,
                            BIO_MSG* msg,
                            size_t stride,
                            size_t num_msg,
                            uint64_t flags,
