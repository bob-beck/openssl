...
static unsigned char client_hts_key[]
    = { 0x26, 0x79, 0xa4, 0x3e, 0x1d, 0x76, 0x78, 0x40,
...
static unsigned char server_hts_key[]
    = { 0xc6, 0x6c, 0xb1, 0xae, 0xc5, 0x19, 0xdf, 0x44,
...
static unsigned char client_ats_key[]
    = { 0x88, 0xb9, 0x6a, 0xd6, 0x86, 0xc8, 0x4b, 0xe5,
...
static unsigned char server_ats_key[]
    = { 0xa6, 0x88, 0xeb, 0xb5, 0xac, 0x82, 0x6d, 0x6f,
...
static int
test_secret (SSL_CONNECTION *s, unsigned char *prk, const unsigned char *label,
             size_t labellen, const unsigned char *ref_secret,
...
test_handshake_secrets (void)
{
  ...
  if (!TEST_true (tls13_generate_secret (s, ssl_handshake_md (s), NULL, NULL,
                                         0,
