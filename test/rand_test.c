...
static int
r_random_bytes (ossl_unused void *vprov, ossl_unused int which, void *buf,
                size_t n, ossl_unused unsigned int strength)
{
  while (n-- > 0)
...
static int
r_init (const OSSL_CORE_HANDLE *handle, ossl_unused const OSSL_DISPATCH *oin,
