...
static void
tear_down(CMP_MSG_TEST_FIXTURE* fixture)
{
...
#define EXECUTE_MSG_CREATION_TEST(expr)                                        \
  do {                                                                         \
    ...
    int good = fixture->expected != 0 ? TEST_ptr(msg = (expr)) &&              \
 ...
 */
static int
execute_certreq_create_test(CMP_MSG_TEST_FIXTURE* fixture)
{
...
static int
execute_errormsg_create_test(CMP_MSG_TEST_FIXTURE* fixture)
{
...
static int
execute_rr_create_test(CMP_MSG_TEST_FIXTURE* fixture)
{
  EXECUTE_MSG_CREATION_TEST(ossl_cmp_rr_new(fixture->cmp_ctx));
}

static int
execute_certconf_create_test(CMP_MSG_TEST_FIXTURE* fixture)
{
...
static int
execute_genm_create_test(CMP_MSG_TEST_FIXTURE* fixture)
{
  EXECUTE_MSG_CREATION_TEST(ossl_cmp_genm_new(fixture->cmp_ctx));
}

static int
execute_pollreq_create_test(CMP_MSG_TEST_FIXTURE* fixture)
{
  EXECUTE_MSG_CREATION_TEST(ossl_cmp_pollReq_new(fixture->cmp_ctx, 4711));
}

static int
execute_pkimessage_create_test(CMP_MSG_TEST_FIXTURE* fixture)
{
  EXECUTE_MSG_CREATION_TEST(
...
static int
set1_newPkey(OSSL_CMP_CTX* ctx, EVP_PKEY* pkey)
{
...
static int
test_cmp_create_ir_protection_set(void)
{
  OSSL_CMP_CTX* ctx;
...
static int
test_cmp_create_ir_protection_fails(void)
{
  SETUP_TEST_FIXTURE(CMP_MSG_TEST_FIXTURE, set_up);
  fixture->bodytype = OSSL_CMP_PKIBODY_IR;
  fixture->err_code = -1;
...
static int
test_cmp_create_cr_without_key(void)
{
  SETUP_TEST_FIXTURE(CMP_MSG_TEST_FIXTURE, set_up);
...
static int
test_cmp_create_certreq_with_invalid_bodytype(void)
{
  SETUP_TEST_FIXTURE(CMP_MSG_TEST_FIXTURE, set_up);
...
static int
test_cmp_create_p10cr_null(void)
{
  SETUP_TEST_FIXTURE(CMP_MSG_TEST_FIXTURE, set_up);
  fixture->bodytype = OSSL_CMP_PKIBODY_P10CR;
  fixture->err_code = CMP_R_ERROR_CREATING_CERTREQ;
...
static int
test_cmp_create_kur_without_oldcert(void)
{
  SETUP_TEST_FIXTURE(CMP_MSG_TEST_FIXTURE, set_up);
  fixture->bodytype = OSSL_CMP_PKIBODY_KUR;
  fixture->err_code = -1;
...
static int
test_cmp_create_certconf_badAlg(void)
{
  SETUP_TEST_FIXTURE(CMP_MSG_TEST_FIXTURE, set_up);
...
static int
test_cmp_create_certconf_fail_info_max(void)
{
  SETUP_TEST_FIXTURE(CMP_MSG_TEST_FIXTURE, set_up);
...
static int
test_cmp_create_error_msg(void)
{
  SETUP_TEST_FIXTURE(CMP_MSG_TEST_FIXTURE, set_up);
...
static int
execute_certrep_create(CMP_MSG_TEST_FIXTURE* fixture)
{
...
static int
execute_rp_create(CMP_MSG_TEST_FIXTURE* fixture)
{
  ...
  if (!X509_NAME_add_entry_by_txt(
        issuer, "CN", MBSTRING_ASC, (unsigned char*)"The Issuer", -1, -1, 0) ||
...
static int
execute_pollrep_create(CMP_MSG_TEST_FIXTURE* fixture)
{
...
static int
test_cmp_pkimessage_create(int bodytype)
{
  X509_REQ* p10cr = NULL;
