...
static void* my_realloc(void* const addr,
                        const size_t num,
                        const char* const file,
                        const int line) {
#if CUSTOM_FN_PRINT_CALLS
...
static int test_xalloc(const bool secure,
                       const bool array,
                       const bool zero,
                       const bool macro,
...
static int test_xrealloc(const bool clear,
                         const bool array,
                         const bool macro,
...
static int test_xaligned_alloc(const bool array,
                               const bool macro,
