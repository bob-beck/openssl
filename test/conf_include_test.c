...
test_load_config (void)
{
  ...
  val = 0;
  if (!TEST_int_eq (
          NCONF_get_number (conf, "CA_default", "default_days", &val), 1)
      || !TEST_int_eq (val, 365))
    {
