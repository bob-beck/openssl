...
static int
calculate_digest(const EVP_MD* md,
                 const char* msg,
                 size_t len,
...
test_md(const EVP_MD* md)
{
  ...
  const unsigned char exptd[] = { 0x27, 0x51, 0x8b, 0xa9, 0x68, 0x30, 0x11,
                                  0xf6, 0xb3, 0x96, 0x07, 0x2c, 0x05, 0xf6,
                                  0x65, 0x6d, 0x04, 0xf5, 0xfb, 0xc3, 0x78,
                                  0x7c, 0xf9, 0x24, 0x90, 0xec, 0x60, 0x6e,
                                  0x50, 0x92, 0xe3, 0x26 };
