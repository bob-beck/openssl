...
static int
verify_cookie_cb (SSL *ssl, const unsigned char *cookie,
...
/*
 * We are assuming a ServerKeyExchange message is sent in this test. If we
 * don't have either DH or EC, then it won't be
 */
