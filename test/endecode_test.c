...
#define MAKE_DOMAIN_KEYS(KEYTYPE, KEYTYPEstr, params)                                                                  \
    ok = ok && TEST_ptr(template_##KEYTYPE = make_template(KEYTYPEstr, params)) &&                                     \
...
#define ADD_TEST_SUITE_UNPROTECTED_PVK(KEYTYPE) ADD_TEST(test_unprotected_##KEYTYPE##_via_PVK)
#ifndef OPENSSL_NO_RC4
...
#define ADD_TEST_SUITE_PROTECTED_PVK(KEYTYPE) ADD_TEST(test_protected_##KEYTYPE##_via_PVK)
#endif
