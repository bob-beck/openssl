...
/*
 * Unfortunately, this must be expressed as an array and not a string literal
 * as ANSI C only guarantees support for up to 509 characters in a string
 * literal.
 */
