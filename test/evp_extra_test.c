...
#ifndef OPENSSL_NO_ML_KEM
static int ml_kem_seed_to_priv(const char* alg,
...
static int custom_pmeth_sign(EVP_PKEY_CTX* ctx,
                             unsigned char* out,
                             size_t* outlen,
...
static int custom_pmeth_digestsign(EVP_MD_CTX* ctx,
                                   unsigned char* sig,
                                   size_t* siglen,
...
static int custom_pmeth_derive(EVP_PKEY_CTX* ctx,
                               unsigned char* key,
                               size_t* keylen) {
...
static int custom_ciph_init(EVP_CIPHER_CTX* ctx,
                            const unsigned char* key,
                            const unsigned char* iv,
                            int enc) {
