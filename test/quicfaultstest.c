 ...
 */
static int
add_unknown_frame_cb (QTEST_FAULT *fault, QUIC_PKT_HDR *hdr,
 ...
 */
static int
drop_extensions_cb (QTEST_FAULT *fault, QTEST_ENCRYPTED_EXTENSIONS *ee,
...
static int
on_packet_cipher_cb (QTEST_FAULT *fault, QUIC_PKT_HDR *hdr, unsigned char *buf,
