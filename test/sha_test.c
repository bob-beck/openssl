...
static int test_static_sha_common(const char *input, size_t length, const unsigned char *out,
...
{
    static const unsigned char output[SHA_DIGEST_LENGTH] = {0xa9, 0x99, 0x3e, 0x36, 0x47, 0x06, 0x81, 0x6a, 0xba, 0x3e,
