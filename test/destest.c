...
test_des_cbc (void)
{
  ...
  DES_ncbc_encrypt (cbc_data, cbc_out, (long)(cbc_data_len + 1), &ks, &iv3,
                    DES_ENCRYPT);
  if (!TEST_mem_eq (cbc_out, 32, cbc_ok, 32))
    return 0;

  memcpy (iv3, cbc_iv, sizeof (cbc_iv));
  DES_ncbc_encrypt (cbc_out, cbc_in, (long)(cbc_data_len + 1), &ks, &iv3,
                    DES_DECRYPT);
...
test_des_ede_cbc (void)
{
  ...
  memset (cbc_in, 0, sizeof (cbc_in));
  memcpy (iv3, cbc_iv, sizeof (cbc_iv));
  DES_xcbc_encrypt (cbc_data, cbc_out, (long)n, &ks, &iv3, &cbc2_key,
                    &cbc3_key, DES_ENCRYPT);
...
test_des_ofb (void)
{
  ...
  if (!TEST_mem_eq (ofb_cipher, sizeof (ofb_buf1), ofb_buf1,
                    sizeof (ofb_buf1)))
    return 0;
