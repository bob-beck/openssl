...
static int
test_empty_nonoptional_content (void)
{
  RSA *rsa = NULL;
  BIGNUM *n = NULL;
  BIGNUM *e = NULL;
...
static int
test_unicode (const unsigned char *univ, size_t len, int expected)
{
...
static int
test_obj_create_once (const char *oid, const char *sn, const char *ln)
{
  int nid;
