...
static int
tmpmd_digest(void *provctx, const unsigned char *in, size_t inl, unsigned char *out, size_t *outl, size_t outsz)
{
    return 0;
}
...
enum { DEFAULT_PROPS_FIRST = 0, DEFAULT_PROPS_AFTER_LOAD, DEFAULT_PROPS_AFTER_FETCH, DEFAULT_PROPS_FINAL };
