...
static int test_binary_op(unsigned int (*op)(unsigned int a, unsigned int b),
                          ...
                          int is_true) {
  if (is_true && !TEST_uint_eq(op(a, b), CONSTTIME_TRUE)) return 0;
  if (!is_true && !TEST_uint_eq(op(a, b), CONSTTIME_FALSE)) return 0;
  return 1;
}
...
static int test_binary_op_s(size_t (*op)(size_t a, size_t b),
  ...
  if (!is_true && !TEST_size_t_eq(op(a, b), CONSTTIME_FALSE_S)) return 0;
  return 1;
}
