...
static char*
pt(unsigned char* md, size_t len);
...
test_cmac_run(void)
{
  ...
  if (!TEST_true(CMAC_Init(
        ctx, test[0].key, test[0].key_len, EVP_aes_128_cbc(), NULL)) ||
      !TEST_true(CMAC_Update(ctx, test[0].data, test[0].data_len)) ||
  ...
  if (!TEST_true(CMAC_Init(
        ctx, test[1].key, test[1].key_len, EVP_aes_256_cbc(), NULL)) ||
  ...
  if (!TEST_true(CMAC_Init(
        ctx, test[3].key, test[3].key_len, EVP_aes_128_cbc(), NULL)) ||
  ...
  if (!TEST_true(CMAC_Init(
        ctx, test[4].key, test[4].key_len, EVP_aes_192_cbc(), NULL)) ||
  ...
  if (!TEST_true(CMAC_Init(
        ctx, test[5].key, test[5].key_len, EVP_aes_256_cbc(), NULL)) ||
  ...
  if (!TEST_true(CMAC_Init(
        ctx, test[6].key, test[6].key_len, EVP_des_ede3_cbc(), NULL)) ||
