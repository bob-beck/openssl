...
typedef int   PEM_write_bio_of_void_protected(BIO              *out,
                                              const void       *obj,
...
static struct test_stanza_st {
    ...
    {"DH",
                         {"DH", "type-specific"},
                         EVP_PKEY_DH, NULL, /* No i2d_DHPrivateKey */
    ...
    {"DHX",
                         {"DHX", "type-specific"},
                         EVP_PKEY_DHX, NULL, /* No i2d_DHxPrivateKey */
    ...
    {"DSA",
                         {"DSA", "type-specific"},
                         EVP_PKEY_DSA, (i2d_of_void *)i2d_DSAPrivateKey,
    ...
    {
                         "EC", {"EC", "type-specific"},
                         EVP_PKEY_EC, (i2d_of_void *)i2d_ECPrivateKey,
    ...
    {"RSA",
                         {"RSA", "type-specific"},
                         EVP_PKEY_RSA, (i2d_of_void *)i2d_RSAPrivateKey,
...
static int test_protected_PEM(const char                      *keytype,
                              int                              evp_type,
...
static int test_unprotected_PEM(const char                        *keytype,
                                int                                evp_type,
                                const void                        *legacy_key,
...
static int test_DER(const char        *keytype,
                    int                evp_type,
                    const void        *legacy_key,
                    i2d_of_void       *i2d,
                    d2i_of_void       *d2i,
