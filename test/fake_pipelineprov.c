...
#define IMPLEMENT_aead_cipher_pipeline(alg, lc, UCMODE, flags, kbits, blkbits, ivbits, ciphername)                     \
    ...
    static const OSSL_DISPATCH fake_pipeline_##alg##kbits##lc##_functions[] = {                                        \
        {OSSL_FUNC_CIPHER_NEWCTX, (void (*)(void))fake_pipeline_##alg##_##kbits##_##lc##_newctx},                      \
        {OSSL_FUNC_CIPHER_FREECTX, (void (*)(void))fake_pipeline_freectx},                                             \
        {OSSL_FUNC_CIPHER_PIPELINE_ENCRYPT_INIT, (void (*)(void))fake_pipeline_einit},                                 \
        ...
        {OSSL_FUNC_CIPHER_GET_CTX_PARAMS, (void (*)(void))fake_pipeline_aead_get_ctx_params},                          \
        {OSSL_FUNC_CIPHER_SET_CTX_PARAMS, (void (*)(void))fake_pipeline_aead_set_ctx_params},                          \
        {OSSL_FUNC_CIPHER_GETTABLE_PARAMS, (void (*)(void))ossl_cipher_generic_gettable_params},                       \
        {OSSL_FUNC_CIPHER_GETTABLE_CTX_PARAMS, (void (*)(void))fake_pipeline_aead_gettable_ctx_params},                \
        {OSSL_FUNC_CIPHER_SETTABLE_CTX_PARAMS, (void (*)(void))fake_pipeline_aead_settable_ctx_params},                \
        OSSL_DISPATCH_END}
