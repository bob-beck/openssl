...
static void*
fake_pipeline_newctx(void* provctx,
                     char* ciphername,
                     size_t kbits,
                     size_t ivbits)
{
...
int
fake_pipeline_update(void* vctx,
                     size_t numpipes,
                     unsigned char** out,
                     size_t* outl,
...
#define IMPLEMENT_aead_cipher_pipeline(                                        \
  alg, lc, UCMODE, flags, kbits, blkbits, ivbits, ciphername)                  \
...
IMPLEMENT_aead_cipher_pipeline(aes,
                               gcm,
                               GCM,
                               AEAD_FLAGS,
                               256,
...
fake_pipeline_start(OSSL_LIB_CTX* libctx)
{
  ...
  if (!TEST_true(OSSL_PROVIDER_add_builtin(
        libctx, "fake-pipeline", fake_pipeline_provider_init)) ||
