...
static void *
fake_pipeline_newctx (void *provctx, char *ciphername, size_t kbits,
                      size_t ivbits)
{
...
static void
fake_pipeline_freectx (void *vctx)
{
...
static int
fake_pipeline_init (void *vctx, const unsigned char *key, size_t keylen,
...
int
fake_pipeline_einit (void *vctx, const unsigned char *key, size_t keylen,
                     size_t numpipes, const unsigned char **iv, size_t ivlen,
...
int
fake_pipeline_dinit (void *vctx, const unsigned char *key, size_t keylen,
                     size_t numpipes, const unsigned char **iv, size_t ivlen,
                     const OSSL_PARAM params[])
{
...
int
fake_pipeline_update (void *vctx, size_t numpipes, unsigned char **out,
...
int
fake_pipeline_final (void *vctx, size_t numpipes, unsigned char **out,
                     size_t *outl, const size_t *outsize)
{
  CIPHER_PIPELINE_CTX *ctx = (CIPHER_PIPELINE_CTX *)vctx;
  int ioutl;
...
int
fake_pipeline_aead_get_ctx_params (void *vctx, OSSL_PARAM params[])
{
  CIPHER_PIPELINE_CTX *ctx = (CIPHER_PIPELINE_CTX *)vctx;
  OSSL_PARAM *p;
  size_t taglen, i;
...
int
fake_pipeline_aead_set_ctx_params (void *vctx, const OSSL_PARAM params[])
{
  CIPHER_PIPELINE_CTX *ctx = (CIPHER_PIPELINE_CTX *)vctx;
  const OSSL_PARAM *p;
  size_t taglen, i;
...
#define IMPLEMENT_aead_cipher_pipeline(alg, lc, UCMODE, flags, kbits,         \
                                       blkbits, ivbits, ciphername)           \
...
static int
fake_pipeline_provider_init (const OSSL_CORE_HANDLE *handle,
...
OSSL_PROVIDER *
fake_pipeline_start (OSSL_LIB_CTX *libctx)
{
  OSSL_PROVIDER *p;
...
void
fake_pipeline_finish (OSSL_PROVIDER *p)
{
