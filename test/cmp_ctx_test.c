...
static int
msg_total_size_log_cb (const char *func, const char *file, int line,
...
static int
test_log_cb (const char *func, const char *file, int line,
             OSSL_CMP_severity level, const char *msg)
{
  test_log_cb_res =
#ifndef PEDANTIC
...
DEFINE_SET_GET_TEST_DEFAULT (OSSL_CMP, CTX, 1, 1, 1, secretValue_str, char,
                             IS_0)
