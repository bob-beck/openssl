...
int
ossl_FIPS_IND_callback(OSSL_LIB_CTX* libctx,
                       const char* type,
                       const char* desc);

void
ossl_FIPS_IND_init(OSSL_FIPS_IND* ind);
void
ossl_FIPS_IND_set_approved(OSSL_FIPS_IND* ind);
void
ossl_FIPS_IND_set_settable(OSSL_FIPS_IND* ind, int id, int enable);
int
ossl_FIPS_IND_get_settable(const OSSL_FIPS_IND* ind, int id);
int
ossl_FIPS_IND_on_unapproved(OSSL_FIPS_IND* ind,
                            int id,
                            OSSL_LIB_CTX* libctx,
                            const char* algname,
                            const char* opname,
...
int
ossl_FIPS_IND_set_ctx_param(OSSL_FIPS_IND* ind, int id, const OSSL_PARAM* p);
int
ossl_FIPS_IND_set_ctx_param_locate(OSSL_FIPS_IND* ind,
                                   int id,
                                   const OSSL_PARAM params[],
                                   const char* name);
int
ossl_FIPS_IND_get_ctx_param(const OSSL_FIPS_IND* ind, OSSL_PARAM* p);
int
ossl_FIPS_IND_get_ctx_param_locate(const OSSL_FIPS_IND* ind,
                                   OSSL_PARAM params[]);
void
ossl_FIPS_IND_copy(OSSL_FIPS_IND* dst, const OSSL_FIPS_IND* src);
 ...
 */
#define OSSL_FIPS_IND_ON_UNAPPROVED(                                           \
  ctx, id, libctx, algname, opname, config_check_fn)                           \
  ossl_FIPS_IND_on_unapproved(                                                 \
    &ctx->indicator, id, libctx, algname, opname, config_check_fn)
...
int
ossl_fips_ind_rsa_key_check(OSSL_FIPS_IND* ind,
                            int id,
                            OSSL_LIB_CTX* libctx,
                            const RSA* rsa,
                            const char* desc,
...
int
ossl_fips_ind_ec_key_check(OSSL_FIPS_IND* ind,
                           int id,
                           OSSL_LIB_CTX* libctx,
...
#endif
int
ossl_fips_ind_digest_exch_check(OSSL_FIPS_IND* ind,
                                int id,
                                OSSL_LIB_CTX* libctx,
                                const EVP_MD* md,
                                const char* desc);
int
ossl_fips_ind_digest_sign_check(OSSL_FIPS_IND* ind,
                                int id,
                                OSSL_LIB_CTX* libctx,
                                int nid,
                                int sha1_allowed,
...
#define OSSL_FIPS_IND_SET_APPROVED(ctx)
#define OSSL_FIPS_IND_ON_UNAPPROVED(                                           \
  ctx, id, libctx, algname, opname, configopt_fn)
