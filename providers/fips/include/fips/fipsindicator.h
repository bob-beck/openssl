...
#define OSSL_FIPS_IND_SET_CTX_FROM_PARAM(ctx, id, p) ossl_FIPS_IND_set_ctx_param(&((ctx)->indicator), id, p)

#define OSSL_FIPS_IND_GETTABLE_CTX_PARAM() OSSL_PARAM_int(OSSL_ALG_PARAM_FIPS_APPROVED_INDICATOR, NULL),

#define OSSL_FIPS_IND_GET_CTX_PARAM(ctx, prms) ossl_FIPS_IND_get_ctx_param_locate(&((ctx)->indicator), prms)

#define OSSL_FIPS_IND_GET_CTX_FROM_PARAM(ctx, p) ossl_FIPS_IND_get_ctx_param(&((ctx)->indicator), p)
