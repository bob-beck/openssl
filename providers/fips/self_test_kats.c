...
static int
self_test_digest (const ST_KAT_DIGEST *t, OSSL_SELF_TEST *st,
                  OSSL_LIB_CTX *libctx)
{
  int ok = 0;
 ...
 */
static int
cipher_init (EVP_CIPHER_CTX *ctx, const EVP_CIPHER *cipher,
...
static int
self_test_cipher (const ST_KAT_CIPHER *t, OSSL_SELF_TEST *st,
                  OSSL_LIB_CTX *libctx)
{
...
self_test_ka (const ST_KAT_KAS *t, OSSL_SELF_TEST *st, OSSL_LIB_CTX *libctx)
{
  ...
  params = kat_params_to_ossl_params (libctx, t->key_group, t->key_host_data,
                                      NULL);
...
static int
digest_signature (const uint8_t *sig, size_t sig_len, uint8_t *out,
...
static int
self_test_digest_sign (const ST_KAT_SIGN *t, OSSL_SELF_TEST *st,
                       OSSL_LIB_CTX *libctx)
{
  int ret = 0;
 ...
 */
static int
self_test_asym_keygen (const ST_KAT_ASYM_KEYGEN *t, OSSL_SELF_TEST *st,
                       OSSL_LIB_CTX *libctx)
{
  int ret = 0;
 ...
 */
static int
self_test_kem_encapsulate (const ST_KAT_KEM *t, OSSL_SELF_TEST *st,
 ...
 */
static int
self_test_kem_decapsulate (const ST_KAT_KEM *t, OSSL_SELF_TEST *st,
                           OSSL_LIB_CTX *libctx, EVP_PKEY *pkey, int reject)
{
  int ret = 0;
  EVP_PKEY_CTX *ctx = NULL;
...
static int
set_kat_drbg (OSSL_LIB_CTX *ctx, const unsigned char *entropy,
              size_t entropy_len, const unsigned char *nonce, size_t nonce_len,
