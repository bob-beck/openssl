...
static int self_test_digest(const ST_KAT_DIGEST* t,
                            OSSL_SELF_TEST* st,
                            OSSL_LIB_CTX* libctx) {
  int ok = 0;
...
static int self_test_cipher(const ST_KAT_CIPHER* t,
                            OSSL_SELF_TEST* st,
                            OSSL_LIB_CTX* libctx) {
...
static int add_params(OSSL_PARAM_BLD* bld,
...
static int self_test_kdf(const ST_KAT_KDF* t,
                         OSSL_SELF_TEST* st,
                         OSSL_LIB_CTX* libctx) {
  int ret = 0;
...
static int self_test_drbg(const ST_KAT_DRBG* t,
                          OSSL_SELF_TEST* st,
                          OSSL_LIB_CTX* libctx) {
  int ret = 0;
...
static int digest_signature(const uint8_t* sig,
                            size_t sig_len,
                            uint8_t* out,
                            size_t* out_len,
 ...
 * encapsulation.
 */
static int self_test_kem_encapsulate(const ST_KAT_KEM* t,
                                     OSSL_SELF_TEST* st,
                                     OSSL_LIB_CTX* libctx,
                                     EVP_PKEY* pkey) {
  int ret = 0;
 ...
 */
static int self_test_kem_decapsulate(const ST_KAT_KEM* t,
                                     OSSL_SELF_TEST* st,
                                     OSSL_LIB_CTX* libctx,
                                     EVP_PKEY* pkey,
                                     int reject) {
 ...
 */
static int self_test_kem(const ST_KAT_KEM* t,
                         OSSL_SELF_TEST* st,
                         OSSL_LIB_CTX* libctx) {
  int ret = 0;
  EVP_PKEY* pkey = NULL;
