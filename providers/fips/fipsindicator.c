...
void
ossl_FIPS_IND_set_settable (OSSL_FIPS_IND *ind, int id, int state)
{
 ...
 */
int
ossl_FIPS_IND_on_unapproved (OSSL_FIPS_IND *ind, int id, OSSL_LIB_CTX *libctx,
...
int
ossl_FIPS_IND_set_ctx_param_locate (OSSL_FIPS_IND *ind, int id,
 ...
 */
int
ossl_FIPS_IND_callback (OSSL_LIB_CTX *libctx, const char *type,
                        const char *desc)
{
