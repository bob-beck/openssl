...
int ossl_FIPS_IND_set_ctx_param(OSSL_FIPS_IND* ind,
                                int id,
                                const OSSL_PARAM* p) {
  int in = 0;
...
int ossl_FIPS_IND_set_ctx_param_locate(OSSL_FIPS_IND* ind,
                                       int id,
 ...
 */
int ossl_FIPS_IND_callback(OSSL_LIB_CTX* libctx,
                           const char* type,
                           const char* desc) {
