...
static int
fips_random_bytes (ossl_unused void *vprov, int which, void *buf, size_t n,
...
static const OSSL_ALGORITHM fips_digests[]
    = { FIPS_DIGESTS_COMMON (), { NULL, NULL, NULL } };
...
static const OSSL_ALGORITHM fips_kdfs[]
    = { FIPS_KDFS_COMMON (), { NULL, NULL, NULL } };
...
void *
CRYPTO_clear_realloc (void *addr, size_t old_num, size_t num, const char *file,
                      int line)
{
...
void
OSSL_SELF_TEST_get_callback (OSSL_LIB_CTX *libctx, OSSL_CALLBACK **cb,
                             void **cbarg)
{
  assert (libctx != NULL);
...
void
OSSL_INDICATOR_get_callback (OSSL_LIB_CTX *libctx,
