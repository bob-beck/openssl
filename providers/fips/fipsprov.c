...
#define OSSL_FIPS_PARAM(structname, paramname, initvalue) FIPS_OPTION fips_##structname;
...
#define OSSL_FIPS_PARAM(structname, paramname, initvalue) init_fips_option(&fgbl->fips_##structname, initvalue);
#include "fips_indicator_params.inc"
#undef OSSL_FIPS_PARAM
...
#define OSSL_FIPS_PARAM(structname, paramname)                                                                         \
    *p++ = OSSL_PARAM_construct_utf8_ptr(paramname, (char **)&fgbl->selftest_params.structname,                        \
...
#define OSSL_FIPS_PARAM(structname, paramname, initvalue)                                                              \
    *p++ = OSSL_PARAM_construct_utf8_ptr(OSSL_PROV_PARAM_##paramname, (char **)&fgbl->fips_##structname.option,        \
...
static const OSSL_ALGORITHM fips_digests[] = {FIPS_DIGESTS_COMMON(), {NULL, NULL, NULL}};
static const OSSL_ALGORITHM fips_digests_internal[] = {
    FIPS_DIGESTS_COMMON(),
    /* Used by LMS/HSS */
    {PROV_NAMES_SHA2_256_192, FIPS_DEFAULT_PROPERTIES, ossl_sha256_192_internal_functions},
    /*
...
static const OSSL_ALGORITHM fips_kdfs[] = {FIPS_KDFS_COMMON(), {NULL, NULL, NULL}};
...
#endif
#ifndef OPENSSL_NO_LMS
    {PROV_NAMES_LMS, FIPS_DEFAULT_PROPERTIES, ossl_lms_keymgmt_functions, PROV_DESCS_LMS},
#endif
#ifndef OPENSSL_NO_ML_KEM
...
static const OSSL_ALGORITHM fips_skeymgmt[] = {
    {PROV_NAMES_AES, FIPS_DEFAULT_PROPERTIES, ossl_aes_skeymgmt_functions, PROV_DESCS_AES},
    {PROV_NAMES_GENERIC, FIPS_DEFAULT_PROPERTIES, ossl_generic_skeymgmt_functions, PROV_DESCS_GENERIC},
    {NULL, NULL, NULL}};
