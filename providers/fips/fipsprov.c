...
static int fips_random_bytes(ossl_unused void* vprov,
                             int which,
                             void* buf,
                             size_t n,
...
static const OSSL_ALGORITHM* fips_query(void* provctx,
                                        int operation_id,
                                        int* no_cache) {
  *no_cache = 0;
...
void* CRYPTO_aligned_alloc(size_t num,
                           size_t align,
                           void** freeptr,
                           const char* file,
                           int line) {
...
void OSSL_SELF_TEST_get_callback(OSSL_LIB_CTX* libctx,
                                 OSSL_CALLBACK** cb,
                                 void** cbarg) {
  assert(libctx != NULL);
