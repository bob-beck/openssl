...
#define TLS_GROUP_ENTRY(tlsname, realname, algorithm, idx)                                                             \
    {OSSL_PARAM_utf8_string(OSSL_CAPABILITY_TLS_GROUP_NAME, tlsname, sizeof(tlsname)),                                 \
     ...
     OSSL_PARAM_int(OSSL_CAPABILITY_TLS_GROUP_IS_KEM, (unsigned int *)&group_list[idx].is_kem),                        \
     OSSL_PARAM_END}
...
#define TLS_SIGALG_ENTRY(tlsname, algorithm, oid, idx)                                                                 \
    {OSSL_PARAM_utf8_string(OSSL_CAPABILITY_TLS_SIGALG_IANA_NAME, tlsname, sizeof(tlsname)),                           \
     ...
     OSSL_PARAM_uint(OSSL_CAPABILITY_TLS_SIGALG_CODE_POINT, (unsigned int *)&sigalg_constants_list[idx].code_point),   \
     OSSL_PARAM_uint(OSSL_CAPABILITY_TLS_SIGALG_SECURITY_BITS, (unsigned int *)&sigalg_constants_list[idx].sec_bits),  \
     OSSL_PARAM_int(OSSL_CAPABILITY_TLS_SIGALG_MIN_TLS, (unsigned int *)&sigalg_constants_list[idx].min_tls),          \
     OSSL_PARAM_int(OSSL_CAPABILITY_TLS_SIGALG_MAX_TLS, (unsigned int *)&sigalg_constants_list[idx].max_tls),          \
     OSSL_PARAM_int(OSSL_CAPABILITY_TLS_SIGALG_MIN_DTLS, (unsigned int *)&sigalg_constants_list[idx].min_dtls),        \
     OSSL_PARAM_int(OSSL_CAPABILITY_TLS_SIGALG_MAX_DTLS, (unsigned int *)&sigalg_constants_list[idx].max_dtls),        \
     OSSL_PARAM_END}
