...
int
ossl_prov_cipher_load(PROV_CIPHER* pc,
                      const OSSL_PARAM* cipher,
                      const OSSL_PARAM* propq,
                      const OSSL_PARAM* engine,
                      OSSL_LIB_CTX* ctx)
{
...
int
ossl_prov_cipher_load_from_params(PROV_CIPHER* pc,
...
const EVP_MD*
ossl_prov_digest_fetch(PROV_DIGEST* pd,
                       OSSL_LIB_CTX* libctx,
                       const char* mdname,
                       const char* propquery)
{
...
int
ossl_prov_digest_load(PROV_DIGEST* pd,
                      const OSSL_PARAM* digest,
                      const OSSL_PARAM* propq,
                      const OSSL_PARAM* engine,
                      OSSL_LIB_CTX* ctx)
{
...
int
ossl_prov_digest_load_from_params(PROV_DIGEST* pd,
                                  const OSSL_PARAM params[],
                                  OSSL_LIB_CTX* ctx)
{
...
int
ossl_prov_set_macctx(EVP_MAC_CTX* macctx,
                     ...
                     const char* properties)
{
  ...
  if (ciphername != NULL)
    *mp++ = OSSL_PARAM_construct_utf8_string(
...
int
ossl_prov_macctx_load(EVP_MAC_CTX** macctx,
                      const OSSL_PARAM* pmac,
                      const OSSL_PARAM* pcipher,
                      const OSSL_PARAM* pdigest,
                      const OSSL_PARAM* propq,
                                  ...
                                  OSSL_LIB_CTX* libctx)
{
  return ossl_prov_macctx_load(
    macctx,
    OSSL_PARAM_locate_const(params, OSSL_ALG_PARAM_MAC),
    OSSL_PARAM_locate_const(params, OSSL_ALG_PARAM_CIPHER),
    OSSL_PARAM_locate_const(params, OSSL_ALG_PARAM_DIGEST),
    OSSL_PARAM_locate_const(params, OSSL_ALG_PARAM_PROPERTIES),
    OSSL_PARAM_locate_const(params, OSSL_ALG_PARAM_ENGINE),
...
int
ossl_prov_memdup(const void* src,
                 size_t src_len,
                 unsigned char** dest,
                 size_t* dest_len)
{
