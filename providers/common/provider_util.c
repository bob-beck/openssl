                          ...
                          OSSL_LIB_CTX *ctx)
{
    ...
    EVP_CIPHER_free(pc->alloc_cipher);
    ERR_set_mark();
    pc->cipher = pc->alloc_cipher = EVP_CIPHER_fetch(ctx, cipher->data, propquery);
...
{
    return ossl_prov_cipher_load(pc, OSSL_PARAM_locate_const(params, OSSL_ALG_PARAM_CIPHER),
...
{
    return ossl_prov_digest_load(pd, OSSL_PARAM_locate_const(params, OSSL_ALG_PARAM_DIGEST),
                                 OSSL_PARAM_locate_const(params, OSSL_ALG_PARAM_PROPERTIES),
                                 OSSL_PARAM_locate_const(params, OSSL_ALG_PARAM_ENGINE), ctx);
}
                                      ...
                                      const char *ciphername, const char *mdname, OSSL_LIB_CTX *libctx)
{
    return ossl_prov_macctx_load(
        ...
        OSSL_PARAM_locate_const(params, OSSL_ALG_PARAM_CIPHER), OSSL_PARAM_locate_const(params, OSSL_ALG_PARAM_DIGEST),
        OSSL_PARAM_locate_const(params, OSSL_ALG_PARAM_PROPERTIES),
        OSSL_PARAM_locate_const(params, OSSL_ALG_PARAM_ENGINE), macname, ciphername, mdname, libctx);
}
