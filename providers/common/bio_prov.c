...
int ossl_prov_bio_read_ex(OSSL_CORE_BIO* bio,
                          void* data,
                          size_t data_len,
                          size_t* bytes_read) {
  if (c_bio_read_ex == NULL)
...
int ossl_prov_bio_write_ex(OSSL_CORE_BIO* bio,
                           const void* data,
                           size_t data_len,
                           size_t* written) {
  if (c_bio_write_ex == NULL)
...
static int bio_core_read_ex(BIO* bio,
                            char* data,
                            size_t data_len,
                            size_t* bytes_read) {
...
static int bio_core_write_ex(BIO* bio,
                             const char* data,
                             size_t data_len,
                             size_t* written) {
