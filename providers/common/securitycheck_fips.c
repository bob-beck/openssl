...
int
ossl_fips_ind_rsa_key_check (OSSL_FIPS_IND *ind, int id, OSSL_LIB_CTX *libctx,
...
int
ossl_fips_ind_ec_key_check (OSSL_FIPS_IND *ind, int id, OSSL_LIB_CTX *libctx,
...
int
ossl_fips_ind_digest_exch_check (OSSL_FIPS_IND *ind, int id,
...
int
ossl_fips_ind_digest_sign_check (OSSL_FIPS_IND *ind, int id,
