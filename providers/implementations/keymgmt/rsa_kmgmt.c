...
static int rsa_import(void *keydata, int selection, const OSSL_PARAM params[])
{
    ...
    if ((selection & OSSL_KEYMGMT_SELECT_OTHER_PARAMETERS) != 0)
        ok = ok && pss_params_fromdata(ossl_rsa_get0_pss_params_30(rsa), &pss_defaults_set, params, rsa_type,
    ...
    if (ok > 0 && !ossl_fips_self_testing())
    {
        ...
        if (n != NULL && e != NULL)
            ...
            if (d != NULL || (p != NULL && q != NULL && dp != NULL && dq != NULL && iq != NULL))
...
#define RSA_KEY_TYPES()                                                                                                \
    OSSL_PARAM_BN(OSSL_PKEY_PARAM_RSA_N, NULL, 0), OSSL_PARAM_BN(OSSL_PKEY_PARAM_RSA_E, NULL, 0),                      \
...
#define rsa_gen_basic                                                                                                  \
    OSSL_PARAM_size_t(OSSL_PKEY_PARAM_RSA_BITS, NULL), OSSL_PARAM_size_t(OSSL_PKEY_PARAM_RSA_PRIMES, NULL),            \
