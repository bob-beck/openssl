...
static int
pss_params_fromdata (RSA_PSS_PARAMS_30 *pss_params, int *defaults_set,
...
static int
rsa_export (void *keydata, int selection, OSSL_CALLBACK *param_callback,
            void *cbarg)
{
  RSA *rsa = keydata;
...
static void *
gen_init (void *provctx, int selection, int rsa_type,
...
static const OSSL_PARAM *
rsapss_gen_settable_params (ossl_unused void *genctx,
                            ossl_unused void *provctx)
{
  static OSSL_PARAM settable[]
      = { rsa_gen_basic, rsa_gen_pss, OSSL_PARAM_END };
