...
static int common_import(void* keydata,
                         int selection,
...
static int ec_export(void* keydata,
                     int selection,
...
static void* ec_gen_init(void* provctx,
                         int selection,
                         const OSSL_PARAM params[]) {
...
#ifndef FIPS_MODULE
#ifndef OPENSSL_NO_SM2
static void* sm2_gen_init(void* provctx,
                          int selection,
                          const OSSL_PARAM params[]) {
...
static void* common_load(const void* reference,
                         size_t reference_sz,
                         int sm2_wanted) {
  EC_KEY* ec = NULL;
