...
static int dh_export(void* keydata,
                     int selection,
...
static void* dh_gen_init_base(void* provctx,
                              int selection,
...
static void* dh_gen_init(void* provctx,
                         int selection,
                         const OSSL_PARAM params[]) {
  return dh_gen_init_base(provctx, selection, params, DH_FLAG_TYPE_DH);
}

static void* dhx_gen_init(void* provctx,
                          int selection,
                          const OSSL_PARAM params[]) {
...
static int dh_set_gen_seed(struct dh_gen_ctx* gctx,
                           unsigned char* seed,
                           size_t seedlen) {
