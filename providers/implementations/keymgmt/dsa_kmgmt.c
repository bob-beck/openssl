...
#define DSA_IMEXPORTABLE_PARAMETERS                                                                                    \
    OSSL_PARAM_BN(OSSL_PKEY_PARAM_FFC_P, NULL, 0), OSSL_PARAM_BN(OSSL_PKEY_PARAM_FFC_Q, NULL, 0),                      \
        OSSL_PARAM_BN(OSSL_PKEY_PARAM_FFC_G, NULL, 0), OSSL_PARAM_BN(OSSL_PKEY_PARAM_FFC_COFACTOR, NULL, 0),           \
        OSSL_PARAM_int(OSSL_PKEY_PARAM_FFC_GINDEX, NULL), OSSL_PARAM_int(OSSL_PKEY_PARAM_FFC_PCOUNTER, NULL),          \
        OSSL_PARAM_int(OSSL_PKEY_PARAM_FFC_H, NULL), OSSL_PARAM_octet_string(OSSL_PKEY_PARAM_FFC_SEED, NULL, 0)
...
static void *dsa_gen(void *genctx, OSSL_CALLBACK *osslcb, void *cbarg)
{
    ...
    if ((gctx->selection & OSSL_KEYMGMT_SELECT_DOMAIN_PARAMETERS) != 0)
    {
        ...
        if (ossl_dsa_generate_ffc_parameters(dsa, gctx->gen_type, (int)gctx->pbits, (int)gctx->qbits, gencb) <= 0)
            goto end;
    }
