...
static int
dsa_gen_type_name2id (const char *name)
{
  size_t i;
...
static int
dsa_key_todata (DSA *dsa, OSSL_PARAM_BLD *bld, OSSL_PARAM params[],
                int include_private)
{
...
static void
dsa_freedata (void *keydata)
{
  DSA_free (keydata);
}

static int
dsa_has (const void *keydata, int selection)
{
...
static int
dsa_match (const void *keydata1, const void *keydata2, int selection)
{
...
static int
dsa_import (void *keydata, int selection, const OSSL_PARAM params[])
{
  DSA *dsa = keydata;
  int ok = 1;
...
static int
dsa_export (void *keydata, int selection, OSSL_CALLBACK *param_cb, void *cbarg)
{
  DSA *dsa = keydata;
  OSSL_PARAM_BLD *tmpl;
...
static const OSSL_PARAM dsa_parameter_types[]
    = { DSA_IMEXPORTABLE_PARAMETERS, OSSL_PARAM_END };
static const OSSL_PARAM dsa_key_types[]
    = { DSA_IMEXPORTABLE_PUBLIC_KEY, DSA_IMEXPORTABLE_PRIVATE_KEY,
        OSSL_PARAM_END };
...
dsa_get_params (void *key, OSSL_PARAM params[])
{
  DSA *dsa = key;
  OSSL_PARAM *p;
...
static const OSSL_PARAM *
dsa_gettable_params (void *provctx)
{
  return dsa_params;
}

static int
dsa_validate_domparams (const DSA *dsa, int checktype)
{
  int status = 0;
...
static int
dsa_validate_public (const DSA *dsa)
{
  int status = 0;
...
static int
dsa_validate_private (const DSA *dsa)
{
  int status = 0;
...
static int
dsa_validate (const void *keydata, int selection, int checktype)
{
  const DSA *dsa = keydata;
  int ok = 1;
...
static void *
dsa_gen_init (void *provctx, int selection, const OSSL_PARAM params[])
{
...
static int
dsa_gen_set_template (void *genctx, void *templ)
{
...
static int
dsa_set_gen_seed (struct dsa_gen_ctx *gctx, unsigned char *seed,
                  size_t seedlen)
{
...
static int
dsa_gen_set_params (void *genctx, const OSSL_PARAM params[])
{
  struct dsa_gen_ctx *gctx = genctx;
  const OSSL_PARAM *p;
  int gen_type = -1;
...
static const OSSL_PARAM *
dsa_gen_settable_params (ossl_unused void *genctx, ossl_unused void *provctx)
{
...
static int
dsa_gen_get_params (void *genctx, OSSL_PARAM *params)
{
  struct dsa_gen_ctx *gctx = genctx;
...
static const OSSL_PARAM *
dsa_gen_gettable_params (ossl_unused void *ctx, ossl_unused void *provctx)
{
...
static int
dsa_gencb (int p, int n, BN_GENCB *cb)
{
...
static void *
dsa_gen (void *genctx, OSSL_CALLBACK *osslcb, void *cbarg)
{
  struct dsa_gen_ctx *gctx = genctx;
  DSA *dsa = NULL;
  BN_GENCB *gencb = NULL;
  ...
  if ((gctx->selection & OSSL_KEYMGMT_SELECT_DOMAIN_PARAMETERS) != 0)
    {
      ...
      if (ossl_dsa_generate_ffc_parameters (
              dsa, gctx->gen_type, (int)gctx->pbits, (int)gctx->qbits, gencb)
          <= 0)
        goto end;
    }
...
static void *
dsa_load (const void *reference, size_t reference_sz)
{
  DSA *dsa = NULL;
...
static void *
dsa_dup (const void *keydata_from, int selection)
{
  if (ossl_prov_is_running ())
