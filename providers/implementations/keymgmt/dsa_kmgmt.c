...
static int dsa_key_todata(DSA* dsa,
                          OSSL_PARAM_BLD* bld,
                          OSSL_PARAM params[],
                          int include_private) {
...
static int dsa_match(const void* keydata1,
                     const void* keydata2,
                     int selection) {
...
static int dsa_export(void* keydata,
                      int selection,
...
static void* dsa_gen_init(void* provctx,
                          int selection,
...
static int dsa_set_gen_seed(struct dsa_gen_ctx* gctx,
                            unsigned char* seed,
                            size_t seedlen) {
