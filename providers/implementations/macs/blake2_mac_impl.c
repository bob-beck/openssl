...
static int
blake2_setkey (struct blake2_mac_data_st *macctx, const unsigned char *key,
               size_t keylen)
{
...
static int
blake2_mac_init (void *vmacctx, const unsigned char *key, size_t keylen,
...
static int
blake2_mac_final (void *vmacctx, unsigned char *out, size_t *outl,
                  size_t outsize)
{
  struct blake2_mac_data_st *macctx = vmacctx;
