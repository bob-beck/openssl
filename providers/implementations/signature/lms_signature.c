...
static void *
lms_newctx (void *provctx, const char *propq)
{
  PROV_LMS_CTX *ctx;
...
static int
setdigest (PROV_LMS_CTX *ctx, const char *digestname)
{
  /*
...
static int
lms_verify_msg_init (void *vctx, void *vkey, const OSSL_PARAM params[])
{
  PROV_LMS_CTX *ctx = (PROV_LMS_CTX *)vctx;
...
static int
lms_verify (void *vctx, const unsigned char *sigbuf, size_t sigbuf_len,
