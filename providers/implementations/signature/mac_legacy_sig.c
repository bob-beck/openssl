...
static void *
mac_newctx (void *provctx, const char *propq, const char *macname)
{
...
static int
mac_digest_sign_init (void *vpmacctx, const char *mdname, void *vkey,
...
int
mac_digest_sign_update (void *vpmacctx, const unsigned char *data,
                        size_t datalen)
{
  PROV_MAC_CTX *pmacctx = (PROV_MAC_CTX *)vpmacctx;
...
int
mac_digest_sign_final (void *vpmacctx, unsigned char *mac, size_t *maclen,
                       size_t macsize)
{
  PROV_MAC_CTX *pmacctx = (PROV_MAC_CTX *)vpmacctx;
...
static int
mac_set_ctx_params (void *vpmacctx, const OSSL_PARAM params[])
{
  PROV_MAC_CTX *ctx = (PROV_MAC_CTX *)vpmacctx;
...
mac_settable_ctx_params (ossl_unused void *ctx, void *provctx,
                         const char *macname)
{
