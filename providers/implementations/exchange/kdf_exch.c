...
#define KDF_GETTABLE_CTX_PARAMS(funcname, kdfname)                                                                     \
    static const OSSL_PARAM *kdf_##funcname##_gettable_ctx_params(void *vpkdfctx, void *provctx)                       \
    {                                                                                                                  \
...
#define KDF_KEYEXCH_FUNCTIONS(funcname)                                                                                \
    const OSSL_DISPATCH ossl_kdf_##funcname##_keyexch_functions[] = {                                                  \
        ...
        {OSSL_FUNC_KEYEXCH_SETTABLE_CTX_PARAMS, (void (*)(void))kdf_##funcname##_settable_ctx_params},                 \
        {OSSL_FUNC_KEYEXCH_GETTABLE_CTX_PARAMS, (void (*)(void))kdf_##funcname##_gettable_ctx_params},                 \
        OSSL_DISPATCH_END};
