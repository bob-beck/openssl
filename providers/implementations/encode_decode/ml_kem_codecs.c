...
ML_KEM_KEY* ossl_ml_kem_d2i_PUBKEY(const uint8_t* pubenc,
                                   int publen,
                                   int evp_type,
                                   PROV_CTX* provctx,
                                   const char* propq) {
...
ML_KEM_KEY* ossl_ml_kem_d2i_PKCS8(const uint8_t* prvenc,
                                  int prvlen,
                                  int evp_type,
                                  PROV_CTX* provctx,
                                  const char* propq) {
...
int ossl_ml_kem_i2d_prvkey(const ML_KEM_KEY* key,
                           uint8_t** out,
                           PROV_CTX* provctx) {
