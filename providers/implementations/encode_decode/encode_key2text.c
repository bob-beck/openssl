...
static int ec_param_explicit_curve_to_text(BIO* out,
...
static int ec_param_explicit_gen_to_text(BIO* out,
                                         const EC_GROUP* group,
                                         BN_CTX* ctx) {
  int ret;
  size_t buflen;
...
static int ec_param_explicit_to_text(BIO* out,
                                     const EC_GROUP* group,
                                     OSSL_LIB_CTX* libctx) {
  int ret = 0, tmp_nid;
  BN_CTX* ctx = NULL;
...
static int ec_param_to_text(BIO* out,
                            const EC_GROUP* group,
                            OSSL_LIB_CTX* libctx) {
