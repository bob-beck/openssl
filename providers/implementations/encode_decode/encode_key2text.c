        ...
        case RSA_FLAG_TYPE_RSASSAPSS:
            ...
            else
            {
                ...
                if (BIO_printf(out, "  Mask Algorithm: %s with %s%s\n", ossl_rsa_mgf_nid2name(maskgenalg_nid),
                               ...
                               (maskgenalg_nid == NID_mgf1 && maskgenhashalg_nid == NID_sha1 ? " (default)" : "")) <= 0)
                    goto err;
...
#define MAKE_TEXT_ENCODER(impl, type)                                                                                  \
    ...
    static int impl##2text_encode(void *vctx, OSSL_CORE_BIO *cout, const void *key, const OSSL_PARAM key_abstract[],   \
