...
typedef void*
b2i_of_void_fn(const unsigned char** in, unsigned int bitlen, int ispub);
typedef void
adjust_key_fn(void*, struct msblob2key_ctx_st* ctx);
typedef void
free_key_fn(void*);
...
static int
msblob2key_does_selection(void* provctx, int selection)
{
  if (selection == 0)
    return 1;
...
static void
rsa_adjust(void* key, struct msblob2key_ctx_st* ctx)
{
