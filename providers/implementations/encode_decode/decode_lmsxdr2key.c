...
static void *
lmsxdr2key_newctx (void *provctx)
{
...
static int
lmsxdr2key_does_selection (void *provctx, int selection)
{
  if (selection == 0)
    return 1;
...
static int
lmsxdr2key_decode (void *vctx, OSSL_CORE_BIO *cin, int selection,
...
static int
lmsxdr2key_export_object (void *vctx, const void *reference,
