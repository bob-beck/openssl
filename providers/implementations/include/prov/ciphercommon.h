...
#define IMPLEMENT_var_keylen_cipher_func(alg, UCALG, lcmode, UCMODE, flags, kbits, blkbits, ivbits, typ)               \
    const OSSL_DISPATCH ossl_##alg##kbits##lcmode##_functions[] = {                                                    \
        ...
        {OSSL_FUNC_CIPHER_GETTABLE_PARAMS, (void (*)(void))ossl_cipher_generic_gettable_params},                       \
        {OSSL_FUNC_CIPHER_GETTABLE_CTX_PARAMS, (void (*)(void))ossl_cipher_generic_gettable_ctx_params},               \
        {OSSL_FUNC_CIPHER_SETTABLE_CTX_PARAMS, (void (*)(void))ossl_cipher_var_keylen_settable_ctx_params},            \
        {OSSL_FUNC_CIPHER_ENCRYPT_SKEY_INIT, (void (*)(void))ossl_cipher_generic_skey_einit},                          \
        {OSSL_FUNC_CIPHER_DECRYPT_SKEY_INIT, (void (*)(void))ossl_cipher_generic_skey_dinit},                          \
        OSSL_DISPATCH_END};
...
#define IMPLEMENT_generic_cipher_genfn(alg, UCALG, lcmode, UCMODE, flags, kbits, blkbits, ivbits, typ)                 \
    ...
    {                                                                                                                  \
        ...
        if (ctx != NULL)                                                                                               \
        {                                                                                                              \
            ossl_cipher_generic_initkey(ctx, kbits, blkbits, ivbits, EVP_CIPH_##UCMODE##_MODE, flags,                  \
...
#define IMPLEMENT_CIPHER_HW_OFB(MODE, NAME, CTX_NAME, KEY_NAME, FUNC_PREFIX)                                           \
    static int cipher_hw_##NAME##_##MODE##_cipher(PROV_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in,   \
                                                  size_t len)                                                          \
    {                                                                                                                  \
        int num = ctx->num;                                                                                            \
...
#define CIPHER_DEFAULT_SETTABLE_CTX_PARAMS_START(name)                                                                 \
    static const OSSL_PARAM name##_known_settable_ctx_params[] = {OSSL_PARAM_uint(OSSL_CIPHER_PARAM_PADDING, NULL),    \
