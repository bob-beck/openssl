...
#define IMPLEMENT_aead_cipher(alg, lc, UCMODE, flags, kbits, blkbits, ivbits)                                          \
    ...
    const OSSL_DISPATCH ossl_##alg##kbits##lc##_functions[] = {                                                        \
        ...
        {OSSL_FUNC_CIPHER_GETTABLE_CTX_PARAMS, (void (*)(void))ossl_##lc##_gettable_ctx_params},                       \
        {OSSL_FUNC_CIPHER_SETTABLE_CTX_PARAMS, (void (*)(void))ossl_##lc##_settable_ctx_params},                       \
        OSSL_DISPATCH_END}
