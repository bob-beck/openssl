...
/*
 * These setters are internal and do not check the validity of their
 * parameters. See blake2b_mac_ctrl for validation logic.
 */
...
void ossl_blake2b_param_set_personal (BLAKE2B_PARAM *P,
                                      const uint8_t *personal, size_t length);
