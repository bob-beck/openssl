...
#define PROV_DISPATCH_FUNC_DIGEST_CONSTRUCT_START(name, CTX, blksize, dgstsize, flags, upd, fin)                       \
    ...
    const OSSL_DISPATCH ossl_##name##_functions[] = {                                                                  \
        ...
        {OSSL_FUNC_DIGEST_COPYCTX, (void (*)(void))name##_copyctx}, PROV_DISPATCH_FUNC_DIGEST_GET_PARAMS(name)
...
#define IMPLEMENT_digest_functions(name, CTX, blksize, dgstsize, flags, init, upd, fin)                                \
    ...
    PROV_DISPATCH_FUNC_DIGEST_CONSTRUCT_START(name, CTX, blksize, dgstsize, flags, upd, fin),                          \
        {OSSL_FUNC_DIGEST_INIT, (void (*)(void))name##_internal_init}, PROV_DISPATCH_FUNC_DIGEST_CONSTRUCT_END
...
#define IMPLEMENT_digest_functions_with_settable_ctx(name, CTX, blksize, dgstsize, flags, init, upd, fin,              \
    ...
    PROV_DISPATCH_FUNC_DIGEST_CONSTRUCT_START(name, CTX, blksize, dgstsize, flags, upd, fin),                          \
        ...
        {OSSL_FUNC_DIGEST_SET_CTX_PARAMS, (void (*)(void))set_ctx_params}, PROV_DISPATCH_FUNC_DIGEST_CONSTRUCT_END
