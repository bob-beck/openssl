...
int ossl_gcm_one_shot(PROV_GCM_CTX* ctx,
                      ...
                      unsigned char* tag,
                      size_t tag_len);
int ossl_gcm_cipher_update(PROV_GCM_CTX* ctx,
                           const unsigned char* in,
                           size_t len,
                           unsigned char* out);
