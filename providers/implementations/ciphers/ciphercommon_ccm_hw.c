...
int
ossl_ccm_generic_setiv (PROV_CCM_CTX *ctx, const unsigned char *nonce,
...
int
ossl_ccm_generic_setaad (PROV_CCM_CTX *ctx, const unsigned char *aad,
                         size_t alen)
{
...
int
ossl_ccm_generic_auth_encrypt (PROV_CCM_CTX *ctx, const unsigned char *in,
...
int
ossl_ccm_generic_auth_decrypt (PROV_CCM_CTX *ctx, const unsigned char *in,
                               unsigned char *out, size_t len,
