...
static int
chacha_poly1305_tls_init (PROV_CIPHER_CTX *bctx, unsigned char *aad,
                          size_t alen)
{
  unsigned int len;
...
static int
chacha_poly1305_tls_iv_set_fixed (PROV_CIPHER_CTX *bctx, unsigned char *fixed,
                                  size_t flen)
{
  PROV_CHACHA20_POLY1305_CTX *ctx = (PROV_CHACHA20_POLY1305_CTX *)bctx;
...
static int
chacha20_poly1305_initkey (PROV_CIPHER_CTX *bctx, const unsigned char *key,
                           size_t keylen)
{
  PROV_CHACHA20_POLY1305_CTX *ctx = (PROV_CHACHA20_POLY1305_CTX *)bctx;
...
static int
chacha20_poly1305_tls_cipher (PROV_CIPHER_CTX *bctx, unsigned char *out,
                              size_t *out_padlen, const unsigned char *in,
                              size_t len)
{
  PROV_CHACHA20_POLY1305_CTX *ctx = (PROV_CHACHA20_POLY1305_CTX *)bctx;
...
static int
chacha20_poly1305_aead_cipher (PROV_CIPHER_CTX *bctx, unsigned char *out,
