...
static const OSSL_PARAM chacha20_known_gettable_ctx_params[]
    = { OSSL_PARAM_size_t (OSSL_CIPHER_PARAM_KEYLEN, NULL),
        ...
        OSSL_PARAM_END };
const OSSL_PARAM *
chacha20_gettable_ctx_params (ossl_unused void *cctx,
...
const OSSL_PARAM *
chacha20_settable_ctx_params (ossl_unused void *cctx,
                              ossl_unused void *provctx)
{
...
int
ossl_chacha20_einit (void *vctx, const unsigned char *key, size_t keylen,
...
int
ossl_chacha20_dinit (void *vctx, const unsigned char *key, size_t keylen,
                     const unsigned char *iv, size_t ivlen,
                     const OSSL_PARAM params[])
{
  int ret;
