...
void
ossl_chacha20_initctx(PROV_CHACHA20_CTX* ctx)
{
...
static int
chacha20_get_params(OSSL_PARAM params[])
{
...
static int
chacha20_get_ctx_params(void* vctx, OSSL_PARAM params[])
{
  PROV_CHACHA20_CTX* ctx = (PROV_CHACHA20_CTX*)vctx;
...
const OSSL_PARAM*
chacha20_gettable_ctx_params(ossl_unused void* cctx, ossl_unused void* provctx)
{
  return chacha20_known_gettable_ctx_params;
}

static int
chacha20_set_ctx_params(void* vctx, const OSSL_PARAM params[])
{
  const OSSL_PARAM* p;
  size_t len;
...
const OSSL_PARAM*
chacha20_settable_ctx_params(ossl_unused void* cctx, ossl_unused void* provctx)
{
  return chacha20_known_settable_ctx_params;
}

int
ossl_chacha20_einit(void* vctx,
