...
int asm_aescbc_sha1_hmac (const uint8_t *csrc, uint8_t *cdst, uint64_t clen,
                          ...
                          CIPH_DIGEST *arg);
void asm_sha1_hmac_aescbc_dec (const uint8_t *csrc, uint8_t *cdst,
...
static int
aes_cbc_hmac_sha1_init_key (PROV_CIPHER_CTX *vctx, const unsigned char *key,
                            size_t keylen)
{
  int ret;
...
static int
hwaes_cbc_hmac_sha1_etm (PROV_CIPHER_CTX *vctx, unsigned char *out,
...
static void
aes_cbc_hmac_sha1_set_mac_key (void *vctx, const unsigned char *mac,
                               size_t len)
{
...
static int
aes_cbc_hmac_sha1_cipher (PROV_CIPHER_CTX *vctx, unsigned char *out,
                          const unsigned char *in, size_t len)
{
