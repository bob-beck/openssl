...
static size_t
cts128_cs1_encrypt(PROV_CIPHER_CTX* ctx,
                   ...
                   size_t len)
{
  ...
  if (!ctx->hw->cipher(
        ctx, out - CTS_BLOCK_SIZE + residue, tmp_in.c, CTS_BLOCK_SIZE))
    return 0;
  return len + residue;
}

static void
do_xor(const unsigned char* in1,
...
static size_t
cts128_cs1_decrypt(PROV_CIPHER_CTX* ctx,
                   const unsigned char* in,
                   unsigned char* out,
                   size_t len)
{
...
static size_t
cts128_cs3_encrypt(PROV_CIPHER_CTX* ctx,
                   const unsigned char* in,
                   unsigned char* out,
                   size_t len)
{
 ...
 */
static size_t
cts128_cs3_decrypt(PROV_CIPHER_CTX* ctx,
                   const unsigned char* in,
                   unsigned char* out,
                   size_t len)
{
...
static size_t
cts128_cs2_encrypt(PROV_CIPHER_CTX* ctx,
                   const unsigned char* in,
                   unsigned char* out,
                   size_t len)
{
...
static size_t
cts128_cs2_decrypt(PROV_CIPHER_CTX* ctx,
                   const unsigned char* in,
                   unsigned char* out,
                   size_t len)
{
...
int
ossl_cipher_cbc_cts_block_update(void* vctx,
                                 unsigned char* out,
                                 size_t* outl,
                                 size_t outsize,
                                 const unsigned char* in,
...
int
ossl_cipher_cbc_cts_block_final(void* vctx,
                                unsigned char* out,
                                size_t* outl,
                                size_t outsize)
{
