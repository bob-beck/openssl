...
static int
cipher_hw_desx_cbc_initkey (PROV_CIPHER_CTX *ctx, const unsigned char *key,
                            size_t keylen)
{
...
static void
cipher_hw_desx_copyctx (PROV_CIPHER_CTX *dst, const PROV_CIPHER_CTX *src)
{
...
static int
cipher_hw_desx_cbc (PROV_CIPHER_CTX *ctx, unsigned char *out,
...
static const PROV_CIPHER_HW desx_cbc
    = { cipher_hw_desx_cbc_initkey, cipher_hw_desx_cbc,
