...
#define OCB_SET_KEY_FN(fn_set_enc_key, fn_set_dec_key, fn_block_enc,          \
  ...
  if (!CRYPTO_ocb128_init (                                                   \
          &ctx->ocb, &ctx->ksenc.ks, &ctx->ksdec.ks,                          \
...
#define PROV_CIPHER_HW_declare()                                              \
  static const PROV_CIPHER_HW aesni_ocb                                       \
      = { cipher_hw_aes_ocb_aesni_initkey, NULL };
...
static int
cipher_hw_aes_ocb_t4_initkey (PROV_CIPHER_CTX *vctx, const unsigned char *key,
                              size_t keylen)
{
  PROV_AES_OCB_CTX *ctx = (PROV_AES_OCB_CTX *)vctx;
...
#define PROV_CIPHER_HW_declare()                                              \
  static const PROV_CIPHER_HW aes_t4_ocb                                      \
      = { cipher_hw_aes_ocb_t4_initkey, NULL };
#define PROV_CIPHER_HW_select()                                               \
