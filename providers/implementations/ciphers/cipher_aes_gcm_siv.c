...
static void *
ossl_aes_gcm_siv_newctx (void *provctx, size_t keybits)
{
...
static void
ossl_aes_gcm_siv_freectx (void *vctx)
{
...
static void *
ossl_aes_gcm_siv_dupctx (void *vctx)
{
...
static int
ossl_aes_gcm_siv_init (void *vctx, const unsigned char *key, size_t keylen,
...
static int
ossl_aes_gcm_siv_einit (void *vctx, const unsigned char *key, size_t keylen,
                        const unsigned char *iv, size_t ivlen,
                        const OSSL_PARAM params[])
{
...
static int
ossl_aes_gcm_siv_dinit (void *vctx, const unsigned char *key, size_t keylen,
                        const unsigned char *iv, size_t ivlen,
                        const OSSL_PARAM params[])
{
...
static int
ossl_aes_gcm_siv_cipher (void *vctx, unsigned char *out, size_t *outl,
...
static int
ossl_aes_gcm_siv_stream_final (void *vctx, unsigned char *out, size_t *outl,
                               size_t outsize)
{
  PROV_AES_GCM_SIV_CTX *ctx = (PROV_AES_GCM_SIV_CTX *)vctx;
  int error = 0;
...
static int
ossl_aes_gcm_siv_get_ctx_params (void *vctx, OSSL_PARAM params[])
{
  PROV_AES_GCM_SIV_CTX *ctx = (PROV_AES_GCM_SIV_CTX *)vctx;
  OSSL_PARAM *p;
...
static int
ossl_aes_gcm_siv_set_ctx_params (void *vctx, const OSSL_PARAM params[])
{
  PROV_AES_GCM_SIV_CTX *ctx = (PROV_AES_GCM_SIV_CTX *)vctx;
  const OSSL_PARAM *p;
