...
static int
ossl_aes_gcm_siv_init(void* vctx,
...
static int
ossl_aes_gcm_siv_einit(void* vctx,
                       const unsigned char* key,
                       size_t keylen,
                       const unsigned char* iv,
                       size_t ivlen,
...
static int
ossl_aes_gcm_siv_dinit(void* vctx,
                       const unsigned char* key,
                       size_t keylen,
                       const unsigned char* iv,
                       size_t ivlen,
...
static int
ossl_aes_gcm_siv_cipher(void* vctx,
                        unsigned char* out,
                        size_t* outl,
                        size_t outsize,
...
static int
ossl_aes_gcm_siv_stream_final(void* vctx,
                              unsigned char* out,
                              size_t* outl,
                              size_t outsize)
{
