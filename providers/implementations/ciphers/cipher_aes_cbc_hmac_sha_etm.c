...
base_ctx_init(void* provctx,
              ...
              uint64_t flags)
{
  ossl_cipher_generic_initkey(&ctx->base,
                              kbits,
                              blkbits,
                              ivbits,
                              EVP_CIPH_CBC_MODE,
...
static void*
aes_cbc_hmac_sha1_etm_newctx(void* provctx,
                             size_t kbits,
                             size_t blkbits,
                             size_t ivbits,
                             uint64_t flags)
...
static void*
aes_cbc_hmac_sha256_etm_newctx(void* provctx,
                               size_t kbits,
                               size_t blkbits,
                               size_t ivbits,
                               uint64_t flags)
...
static void*
aes_cbc_hmac_sha512_etm_newctx(void* provctx,
                               size_t kbits,
                               size_t blkbits,
                               size_t ivbits,
                               uint64_t flags)
...
#define IMPLEMENT_CIPHER(nm, sub, kbits, blkbits, ivbits, flags)               \
  ...
  {                                                                            \
    return ossl_cipher_generic_get_params(                                     \
      params, EVP_CIPH_CBC_MODE, flags, kbits, blkbits, ivbits);               \
  }                                                                            \
  const OSSL_DISPATCH ossl_##nm##kbits##sub##_functions[] = {                  \
