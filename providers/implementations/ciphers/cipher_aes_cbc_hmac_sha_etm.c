...
static int
aes_set_ctx_params (void *vctx, const OSSL_PARAM params[])
{
...
static int
aes_einit (void *ctx, const unsigned char *key, size_t keylen,
...
static int
aes_dinit (void *ctx, const unsigned char *key, size_t keylen,
           const unsigned char *iv, size_t ivlen, const OSSL_PARAM params[])
{
...
static int
aes_get_ctx_params (void *vctx, OSSL_PARAM params[])
{
  PROV_AES_HMAC_SHA_ETM_CTX *ctx = (PROV_AES_HMAC_SHA_ETM_CTX *)vctx;
  OSSL_PARAM *p;
  size_t sz;
...
const OSSL_PARAM *
aes_gettable_ctx_params (ossl_unused void *cctx, ossl_unused void *provctx)
{
...
const OSSL_PARAM *
aes_settable_ctx_params (ossl_unused void *cctx, ossl_unused void *provctx)
{
  return cipher_aes_known_settable_ctx_params;
}

static void
base_ctx_init (void *provctx, PROV_AES_HMAC_SHA_ETM_CTX *ctx,
               const PROV_CIPHER_HW_AES_HMAC_SHA_ETM *meths, size_t kbits,
...
static void *
aes_cbc_hmac_sha1_etm_newctx (void *provctx, size_t kbits, size_t blkbits,
...
static void
aes_cbc_hmac_sha1_etm_freectx (void *vctx)
{
...
static void *
aes_cbc_hmac_sha1_etm_dupctx (void *provctx)
{
...
static void *
aes_cbc_hmac_sha256_etm_newctx (void *provctx, size_t kbits, size_t blkbits,
                                size_t ivbits, uint64_t flags)
{
...
static void
aes_cbc_hmac_sha256_etm_freectx (void *vctx)
{
...
static void *
aes_cbc_hmac_sha256_etm_dupctx (void *provctx)
{
...
static void *
aes_cbc_hmac_sha512_etm_newctx (void *provctx, size_t kbits, size_t blkbits,
                                size_t ivbits, uint64_t flags)
{
...
static void
aes_cbc_hmac_sha512_etm_freectx (void *vctx)
{
...
static void *
aes_cbc_hmac_sha512_etm_dupctx (void *provctx)
{
