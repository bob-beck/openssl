...
int
ossl_cipher_capable_aes_cbc_hmac_sha1(void)
{
  return 0;
}

const PROV_CIPHER_HW_AES_HMAC_SHA*
ossl_prov_cipher_hw_aes_cbc_hmac_sha1(void)
{
  return NULL;
}
#else
...
void
sha1_block_data_order(void* c, const void* p, size_t len);
void
aesni_cbc_sha1_enc(const void* inp,
                   void* out,
                   size_t blocks,
                   const AES_KEY* key,
                   unsigned char iv[16],
...
static int
aesni_cbc_hmac_sha1_init_key(PROV_CIPHER_CTX* vctx,
...
void
sha1_multi_block(SHA1_MB_CTX*, const HASH_DESC*, int);
void
...
static int
aesni_cbc_hmac_sha1_cipher(PROV_CIPHER_CTX* vctx,
                           unsigned char* out,
...
static void
aesni_cbc_hmac_sha1_set_mac_key(void* vctx,
...
static int
aesni_cbc_hmac_sha1_set_tls1_aad(void* vctx,
...
static int
aesni_cbc_hmac_sha1_tls1_multiblock_max_bufsize(void* vctx)
{
  PROV_AES_HMAC_SHA_CTX* ctx = (PROV_AES_HMAC_SHA_CTX*)vctx;
