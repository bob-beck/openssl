...
static int
aes_gcm_siv_aad (PROV_AES_GCM_SIV_CTX *ctx, const unsigned char *aad,
                 size_t len)
{
  size_t to_alloc;
  uint8_t *ptr;
...
static int
aes_gcm_siv_encrypt (PROV_AES_GCM_SIV_CTX *ctx, const unsigned char *in,
...
static int
aes_gcm_siv_decrypt (PROV_AES_GCM_SIV_CTX *ctx, const unsigned char *in,
                     unsigned char *out, size_t len)
{
  uint8_t counter_block[TAG_SIZE];
  uint64_t len_blk[2];
...
static int
aes_gcm_siv_cipher (void *vctx, unsigned char *out, const unsigned char *in,
                    size_t len)
{
  PROV_AES_GCM_SIV_CTX *ctx = (PROV_AES_GCM_SIV_CTX *)vctx;
...
aes_gcm_siv_ctr32 (PROV_AES_GCM_SIV_CTX *ctx,
                   const unsigned char *init_counter, unsigned char *out,
