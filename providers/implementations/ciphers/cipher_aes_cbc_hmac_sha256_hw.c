...
static int
aesni_cbc_hmac_sha256_cipher (PROV_CIPHER_CTX *vctx, unsigned char *out,
...
static void
aesni_cbc_hmac_sha256_set_mac_key (void *vctx, const unsigned char *mackey,
                                   size_t len)
{
...
static int
aesni_cbc_hmac_sha256_set_tls1_aad (void *vctx, unsigned char *aad_rec,
                                    int aad_len)
{
  PROV_AES_HMAC_SHA_CTX *ctx = (PROV_AES_HMAC_SHA_CTX *)vctx;
  PROV_AES_HMAC_SHA256_CTX *sctx = (PROV_AES_HMAC_SHA256_CTX *)vctx;
