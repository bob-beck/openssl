...
static int
aes_cbc_hmac_sha256_init_key (PROV_CIPHER_CTX *vctx, const unsigned char *key,
                              size_t keylen)
{
  int ret;
...
static int
hwaes_cbc_hmac_sha256_etm (PROV_CIPHER_CTX *vctx, unsigned char *out,
...
static void
aes_cbc_hmac_sha256_set_mac_key (void *vctx, const unsigned char *mac,
                                 size_t len)
{
...
static int
aes_cbc_hmac_sha256_cipher (PROV_CIPHER_CTX *vctx, unsigned char *out,
                            const unsigned char *in, size_t len)
{
