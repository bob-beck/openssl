...
aes_generic_ocb_setiv (PROV_AES_OCB_CTX *ctx, const unsigned char *iv,
...
static ossl_inline int
aes_generic_ocb_setaad (PROV_AES_OCB_CTX *ctx, const unsigned char *aad,
                        size_t alen)
{
...
static ossl_inline int
aes_generic_ocb_cipher (PROV_AES_OCB_CTX *ctx, const unsigned char *in,
 ...
 */
static int
aes_ocb_init (void *vctx, const unsigned char *key, size_t keylen,
...
static int
aes_ocb_einit (void *vctx, const unsigned char *key, size_t keylen,
...
static int
aes_ocb_dinit (void *vctx, const unsigned char *key, size_t keylen,
               const unsigned char *iv, size_t ivlen,
               const OSSL_PARAM params[])
{
 ...
 */
static int
aes_ocb_block_update_internal (PROV_AES_OCB_CTX *ctx, unsigned char *buf,
                               size_t *bufsz, unsigned char *out, size_t *outl,
...
static int
cipher_updateaad (PROV_AES_OCB_CTX *ctx, const unsigned char *in,
                  unsigned char *out, size_t len)
{
...
static int
aes_ocb_block_update (void *vctx, unsigned char *out, size_t *outl,
...
static int
aes_ocb_block_final (void *vctx, unsigned char *out, size_t *outl,
                     size_t outsize)
{
  PROV_AES_OCB_CTX *ctx = (PROV_AES_OCB_CTX *)vctx;
...
static void *
aes_ocb_newctx (void *provctx, size_t kbits, size_t blkbits, size_t ivbits,
...
static int
aes_ocb_cipher (void *vctx, unsigned char *out, size_t *outl, size_t outsize,
