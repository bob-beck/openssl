...
static int
cipher_hw_sm4_xts_generic_initkey(PROV_CIPHER_CTX* ctx,
                                  ...
                                  size_t keylen)
{
...
#ifdef HWSM4_CAPABLE
  if (HWSM4_CAPABLE) {
    XTS_SET_KEY_FN(HWSM4_set_encrypt_key,
                   HWSM4_set_decrypt_key,
                   HWSM4_encrypt,
                   HWSM4_decrypt,
                   stream,
                   stream_gb);
    ...
    XTS_SET_KEY_FN(vpsm4_set_encrypt_key,
  ...
  {
    XTS_SET_KEY_FN(ossl_sm4_set_key,
                   ossl_sm4_set_key,
                   ossl_sm4_encrypt,
                   ossl_sm4_decrypt,
                   stream,
...
static void
cipher_hw_sm4_xts_copyctx(PROV_CIPHER_CTX* dst, const PROV_CIPHER_CTX* src)
{
...
ossl_prov_cipher_hw_sm4_xts(size_t keybits)
{
