...
static int
ossl_cipher_hw_tdes_ede2_initkey(PROV_CIPHER_CTX* ctx,
...
static int
ossl_cipher_hw_tdes_ofb(PROV_CIPHER_CTX* ctx,
                        unsigned char* out,
...
static int
ossl_cipher_hw_tdes_cfb(PROV_CIPHER_CTX* ctx,
                        unsigned char* out,
                        const unsigned char* in,
                        size_t inl)
{
 ...
 */
static int
ossl_cipher_hw_tdes_cfb1(PROV_CIPHER_CTX* ctx,
                         unsigned char* out,
                         const unsigned char* in,
                         size_t inl)
{
...
static int
ossl_cipher_hw_tdes_cfb8(PROV_CIPHER_CTX* ctx,
                         unsigned char* out,
                         const unsigned char* in,
                         size_t inl)
{
