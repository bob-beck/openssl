 ...
 */
static int
sm4_xts_init (void *vctx, const unsigned char *key, size_t keylen,
...
static int
sm4_xts_einit (void *vctx, const unsigned char *key, size_t keylen,
...
static int
sm4_xts_dinit (void *vctx, const unsigned char *key, size_t keylen,
               const unsigned char *iv, size_t ivlen,
               const OSSL_PARAM params[])
{
...
static void *
sm4_xts_newctx (void *provctx, unsigned int mode, uint64_t flags, size_t kbits,
...
static int
sm4_xts_cipher (void *vctx, unsigned char *out, size_t *outl, size_t outsize,
...
static int
sm4_xts_stream_update (void *vctx, unsigned char *out, size_t *outl,
...
static int
sm4_xts_stream_final (void *vctx, unsigned char *out, size_t *outl,
                      size_t outsize)
{
  if (!ossl_prov_is_running ())
    return 0;
...
static int
sm4_xts_set_ctx_params (void *vxctx, const OSSL_PARAM params[])
{
