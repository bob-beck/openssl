...
#define IMPLEMENT_cipher(lcmode, UCMODE, kbits, flags)                                                                 \
    ...
    {                                                                                                                  \
        return ossl_cipher_generic_get_params(params, EVP_CIPH_##UCMODE##_MODE, flags, 2 * kbits, SM4_XTS_BLOCK_BITS,  \
                                              SM4_XTS_IV_BITS);                                                        \
    }                                                                                                                  \
    static OSSL_FUNC_cipher_newctx_fn sm4_##kbits##_xts_newctx;                                                        \
    static void *sm4_##kbits##_xts_newctx(void *provctx)                                                               \
    {                                                                                                                  \
        return sm4_xts_newctx(provctx, EVP_CIPH_##UCMODE##_MODE, flags, 2 * kbits, SM4_XTS_BLOCK_BITS,                 \
                              SM4_XTS_IV_BITS);                                                                        \
    }                                                                                                                  \
    const OSSL_DISPATCH ossl_sm4##kbits##xts_functions[] = {                                                           \
        ...
        {OSSL_FUNC_CIPHER_GET_PARAMS, (void (*)(void))sm4_##kbits##_##lcmode##_get_params},                            \
        ...
        {OSSL_FUNC_CIPHER_SETTABLE_CTX_PARAMS, (void (*)(void))sm4_xts_settable_ctx_params},                           \
        OSSL_DISPATCH_END}
