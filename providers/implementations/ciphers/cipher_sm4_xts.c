 ...
 */
static int                                     sm4_xts_init(void                *vctx,
...
static int sm4_xts_einit(void                *vctx,
                         const unsigned char *key,
                         size_t               keylen,
                         const unsigned char *iv,
                         size_t               ivlen,
...
static int sm4_xts_dinit(void                *vctx,
                         const unsigned char *key,
                         size_t               keylen,
                         const unsigned char *iv,
                         size_t               ivlen,
...
static void *
sm4_xts_newctx(void *provctx, unsigned int mode, uint64_t flags, size_t kbits, size_t blkbits, size_t ivbits)
{
...
static int
sm4_xts_cipher(void *vctx, unsigned char *out, size_t *outl, size_t outsize, const unsigned char *in, size_t inl)
{
    PROV_SM4_XTS_CTX *ctx = (PROV_SM4_XTS_CTX *)vctx;
...
static int
sm4_xts_stream_update(void *vctx, unsigned char *out, size_t *outl, size_t outsize, const unsigned char *in, size_t inl)
{
    PROV_SM4_XTS_CTX *ctx = (PROV_SM4_XTS_CTX *)vctx;
