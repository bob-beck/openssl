...
static void* sm4_xts_newctx(void* provctx,
                            unsigned int mode,
                            uint64_t flags,
                            size_t kbits,
                            size_t blkbits,
...
static int sm4_xts_cipher(void* vctx,
                          unsigned char* out,
                          size_t* outl,
                          size_t outsize,
...
static int sm4_xts_stream_update(void* vctx,
                                 unsigned char* out,
                                 size_t* outl,
                                 size_t outsize,
                                 const unsigned char* in,
...
static int sm4_xts_stream_final(void* vctx,
                                unsigned char* out,
                                size_t* outl,
                                size_t outsize) {
  if (!ossl_prov_is_running())
...
static const OSSL_PARAM* sm4_xts_settable_ctx_params(
