...
static void *
rc4_hmac_md5_newctx (void *provctx)
{
...
static void
rc4_hmac_md5_freectx (void *vctx)
{
...
static int
rc4_hmac_md5_einit (void *ctx, const unsigned char *key, size_t keylen,
...
static int
rc4_hmac_md5_dinit (void *ctx, const unsigned char *key, size_t keylen,
                    const unsigned char *iv, size_t ivlen,
                    const OSSL_PARAM params[])
{
...
static const OSSL_PARAM rc4_hmac_md5_known_gettable_ctx_params[]
    = { OSSL_PARAM_size_t (OSSL_CIPHER_PARAM_KEYLEN, NULL),
        ...
        OSSL_PARAM_END };
const OSSL_PARAM *
rc4_hmac_md5_gettable_ctx_params (ossl_unused void *cctx,
...
static int
rc4_hmac_md5_get_ctx_params (void *vctx, OSSL_PARAM params[])
{
  PROV_RC4_HMAC_MD5_CTX *ctx = (PROV_RC4_HMAC_MD5_CTX *)vctx;
  OSSL_PARAM *p;
...
static const OSSL_PARAM rc4_hmac_md5_known_settable_ctx_params[]
    = { OSSL_PARAM_size_t (OSSL_CIPHER_PARAM_KEYLEN, NULL),
        ...
        OSSL_PARAM_END };
const OSSL_PARAM *
rc4_hmac_md5_settable_ctx_params (ossl_unused void *cctx,
                                  ossl_unused void *provctx)
{
...
static int
rc4_hmac_md5_set_ctx_params (void *vctx, const OSSL_PARAM params[])
{
  PROV_RC4_HMAC_MD5_CTX *ctx = (PROV_RC4_HMAC_MD5_CTX *)vctx;
  const OSSL_PARAM *p;
  size_t sz;
...
static int
rc4_hmac_md5_get_params (OSSL_PARAM params[])
{
