...
static int des_ede3_unwrap(PROV_CIPHER_CTX* ctx,
                           unsigned char* out,
...
static int des_ede3_wrap(PROV_CIPHER_CTX* ctx,
                         unsigned char* out,
                         const unsigned char* in,
                         size_t inl) {
...
static int tdes_wrap_cipher_internal(PROV_CIPHER_CTX* ctx,
                                     unsigned char* out,
                                     const unsigned char* in,
                                     size_t inl) {
  /*
...
static int tdes_wrap_update(void* vctx,
                            unsigned char* out,
                            size_t* outl,
                            size_t outsize,
                            const unsigned char* in,
