...
static int
des_ede3_unwrap(PROV_CIPHER_CTX* ctx,
                unsigned char* out,
...
static int
des_ede3_wrap(PROV_CIPHER_CTX* ctx,
              unsigned char* out,
              const unsigned char* in,
              size_t inl)
{
...
static int
tdes_wrap_cipher_internal(PROV_CIPHER_CTX* ctx,
                          unsigned char* out,
                          const unsigned char* in,
                          size_t inl)
{
...
#define IMPLEMENT_WRAP_CIPHER(flags, kbits, blkbits, ivbits)                   \
  ...
  {                                                                            \
    return ossl_cipher_generic_get_params(                                     \
      params, EVP_CIPH_WRAP_MODE, flags, kbits, blkbits, ivbits);              \
  }                                                                            \
