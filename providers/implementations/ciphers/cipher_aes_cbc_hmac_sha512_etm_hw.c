...
int
ossl_cipher_capable_aes_cbc_hmac_sha512_etm(void)
{
  return 0;
}
...
void
asm_aescbc_sha512_hmac(const uint8_t* csrc,
                       uint8_t* cdst,
                       uint64_t clen,
                       uint8_t* dsrc,
                       uint8_t* ddst,
                       ...
                       CIPH_DIGEST* arg);
void
asm_sha512_hmac_aescbc_dec(const uint8_t* csrc,
                           uint8_t* cdst,
                           uint64_t clen,
                           uint8_t* dsrc,
                           uint8_t* ddst,
...
static int
hwaes_cbc_hmac_sha512_init_key(PROV_CIPHER_CTX* vctx,
...
void
sha512_block_data_order(void* c, const void* p, size_t len);
...
static int
hwaes_cbc_hmac_sha512_etm(PROV_CIPHER_CTX* vctx,
                          unsigned char* out,
...
static int
hwaes_cbc_hmac_sha512_cipher(PROV_CIPHER_CTX* vctx,
                             unsigned char* out,
                             const unsigned char* in,
                             size_t len)
{
...
static void
hwaes_cbc_hmac_sha512_set_mac_key(void* vctx,
