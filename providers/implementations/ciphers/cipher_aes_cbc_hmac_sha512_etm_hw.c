...
static int
hwaes_cbc_hmac_sha512_etm (PROV_CIPHER_CTX *vctx, unsigned char *out,
...
static int
hwaes_cbc_hmac_sha512_cipher (PROV_CIPHER_CTX *vctx, unsigned char *out,
                              const unsigned char *in, size_t len)
{
...
static void
hwaes_cbc_hmac_sha512_set_mac_key (void *vctx, const unsigned char *mackey,
                                   size_t len)
{
