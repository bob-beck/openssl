...
static int
cipher_hw_des_initkey (PROV_CIPHER_CTX *ctx, const unsigned char *key,
                       size_t keylen)
{
...
static int
cipher_hw_des_ecb_cipher (PROV_CIPHER_CTX *ctx, unsigned char *out,
...
static int
cipher_hw_des_cbc_cipher (PROV_CIPHER_CTX *ctx, unsigned char *out,
                          const unsigned char *in, size_t len)
{
  PROV_DES_CTX *dctx = (PROV_DES_CTX *)ctx;
...
static int
cipher_hw_des_ofb64_cipher (PROV_CIPHER_CTX *ctx, unsigned char *out,
                            const unsigned char *in, size_t len)
{
  int num = ctx->num;
  DES_key_schedule *key = &(((PROV_DES_CTX *)ctx)->dks.ks);
...
static int
cipher_hw_des_cfb64_cipher (PROV_CIPHER_CTX *ctx, unsigned char *out,
                            const unsigned char *in, size_t len)
{
 ...
 */
static int
cipher_hw_des_cfb1_cipher (PROV_CIPHER_CTX *ctx, unsigned char *out,
...
static int
cipher_hw_des_cfb8_cipher (PROV_CIPHER_CTX *ctx, unsigned char *out,
                           const unsigned char *in, size_t inl)
{
  DES_key_schedule *key = &(((PROV_DES_CTX *)ctx)->dks.ks);
