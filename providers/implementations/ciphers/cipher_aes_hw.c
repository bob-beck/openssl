...
#define PROV_CIPHER_HW_aes_mode(mode)                                                                                  \
    static const PROV_CIPHER_HW aes_##mode = {cipher_hw_aes_initkey, ossl_cipher_hw_generic_##mode,                    \
...
PROV_CIPHER_HW_aes_mode(cbc) PROV_CIPHER_HW_aes_mode(ecb) PROV_CIPHER_HW_aes_mode(ofb128) PROV_CIPHER_HW_aes_mode(ctr)
