...
static int
cipher_hw_aesni_xts_initkey (PROV_CIPHER_CTX *ctx, const unsigned char *key,
                             size_t keylen)
{
  PROV_AES_XTS_CTX *xctx = (PROV_AES_XTS_CTX *)ctx;
...
#define PROV_CIPHER_HW_declare_xts()                                          \
  static const PROV_CIPHER_HW aesni_xts                                       \
      = { cipher_hw_aesni_xts_initkey, NULL, cipher_hw_aes_xts_copyctx };
...
static int
cipher_hw_aes_xts_t4_initkey (PROV_CIPHER_CTX *ctx, const unsigned char *key,
                              size_t keylen)
{
  PROV_AES_XTS_CTX *xctx = (PROV_AES_XTS_CTX *)ctx;
  OSSL_xts_stream_fn stream_enc = NULL;
...
PROV_CIPHER_HW_declare_xts () const
    PROV_CIPHER_HW *ossl_prov_cipher_hw_aes_xts (size_t keybits)
{
