...
#define XTS_SET_KEY_FN(fn_set_enc_key,                                         \
                       fn_set_dec_key,                                         \
                       fn_block_enc,                                           \
                       fn_block_dec,                                           \
                       fn_stream_enc,                                          \
                                  ...
                                  size_t keylen)
{
  ...
  if (HWAES_CAPABLE) {
    ...
    XTS_SET_KEY_FN(HWAES_set_encrypt_key,
...
#ifdef VPAES_CAPABLE
    if (VPAES_CAPABLE) {
    XTS_SET_KEY_FN(vpaes_set_encrypt_key,
  ...
  {
    XTS_SET_KEY_FN(AES_set_encrypt_key,
                   AES_set_decrypt_key,
                   AES_encrypt,
                   AES_decrypt,
                   stream_enc,
...
static void
cipher_hw_aes_xts_copyctx(PROV_CIPHER_CTX* dst, const PROV_CIPHER_CTX* src)
{
...
static int
cipher_hw_aesni_xts_initkey(PROV_CIPHER_CTX* ctx,
                            const unsigned char* key,
                            size_t keylen)
{
  PROV_AES_XTS_CTX* xctx = (PROV_AES_XTS_CTX*)ctx;
...
static int
cipher_hw_aes_xts_t4_initkey(PROV_CIPHER_CTX* ctx,
                             const unsigned char* key,
                             size_t keylen)
{
  PROV_AES_XTS_CTX* xctx = (PROV_AES_XTS_CTX*)ctx;
  ...
  XTS_SET_KEY_FN(aes_t4_set_encrypt_key,
...
static int
cipher_hw_aes_xts_rv64i_zknd_zkne_initkey(PROV_CIPHER_CTX* ctx,
                                          const unsigned char* key,
                                          size_t keylen)
{
  PROV_AES_XTS_CTX* xctx = (PROV_AES_XTS_CTX*)ctx;
  ...
  XTS_SET_KEY_FN(rv64i_zkne_set_encrypt_key,
...
static int
cipher_hw_aes_xts_rv64i_zvbb_zvkg_zvkned_initkey(PROV_CIPHER_CTX* ctx,
                                                 const unsigned char* key,
                                                 size_t keylen)
{
  PROV_AES_XTS_CTX* xctx = (PROV_AES_XTS_CTX*)ctx;
...
static int
cipher_hw_aes_xts_rv64i_zvkned_initkey(PROV_CIPHER_CTX* ctx,
                                       const unsigned char* key,
                                       size_t keylen)
{
  PROV_AES_XTS_CTX* xctx = (PROV_AES_XTS_CTX*)ctx;
...
static int
cipher_hw_aes_xts_rv32i_zknd_zkne_initkey(PROV_CIPHER_CTX* ctx,
                                          const unsigned char* key,
                                          size_t keylen)
{
  PROV_AES_XTS_CTX* xctx = (PROV_AES_XTS_CTX*)ctx;
...
static int
cipher_hw_aes_xts_rv32i_zbkb_zknd_zkne_initkey(PROV_CIPHER_CTX* ctx,
                                               const unsigned char* key,
                                               size_t keylen)
{
  PROV_AES_XTS_CTX* xctx = (PROV_AES_XTS_CTX*)ctx;
