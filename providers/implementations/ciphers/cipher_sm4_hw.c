...
#define PROV_CIPHER_HW_sm4_mode(mode)                                                                                  \
    static const PROV_CIPHER_HW sm4_##mode = {cipher_hw_sm4_initkey, ossl_cipher_hw_generic_##mode,                    \
                                              cipher_hw_sm4_copyctx};                                                  \
    PROV_CIPHER_HW_declare(mode) const PROV_CIPHER_HW *ossl_prov_cipher_hw_sm4_##mode(size_t keybits)                  \
    {                                                                                                                  \
