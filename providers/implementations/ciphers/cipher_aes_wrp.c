...
static void *
aes_wrap_newctx (size_t kbits, size_t blkbits, size_t ivbits,
...
static int
aes_wrap_init (void *vctx, const unsigned char *key, size_t keylen,
...
static int
aes_wrap_einit (void *ctx, const unsigned char *key, size_t keylen,
                const unsigned char *iv, size_t ivlen,
...
static int
aes_wrap_dinit (void *ctx, const unsigned char *key, size_t keylen,
                const unsigned char *iv, size_t ivlen,
                const OSSL_PARAM params[])
{
...
static int
aes_wrap_cipher_internal (void *vctx, unsigned char *out,
...
static int
aes_wrap_cipher (void *vctx, unsigned char *out, size_t *outl, size_t outsize,
