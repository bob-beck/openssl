...
static ossl_inline void
byte_reverse16 (uint8_t *out, const uint8_t *in)
{
...
void
ossl_polyval_ghash_init (u128 Htable[16], const uint64_t H[2])
{
  uint64_t tmp[2];
  DECLARE_IS_ENDIAN;
...
void
ossl_polyval_ghash_hash (const u128 Htable[16], uint8_t *tag,
