...
static int
null_einit (void *vctx, const unsigned char *key, size_t keylen,
...
static int
null_dinit (void *vctx, const unsigned char *key, size_t keylen,
            const unsigned char *iv, size_t ivlen, const OSSL_PARAM params[])
{
  if (!ossl_prov_is_running ())
    return 0;
...
static int
null_cipher (void *vctx, unsigned char *out, size_t *outl, size_t outsize,
...
static int
null_final (void *vctx, unsigned char *out, size_t *outl, size_t outsize)
{
  if (!ossl_prov_is_running ())
    return 0;
...
static int
null_get_params (OSSL_PARAM params[])
{
...
null_gettable_ctx_params (ossl_unused void *cctx, ossl_unused void *provctx)
{
...
static int
null_get_ctx_params (void *vctx, OSSL_PARAM params[])
{
  PROV_CIPHER_NULL_CTX *ctx = (PROV_CIPHER_NULL_CTX *)vctx;
  OSSL_PARAM *p;
...
static const OSSL_PARAM *
null_settable_ctx_params (ossl_unused void *cctx, ossl_unused void *provctx)
{
...
static int
null_set_ctx_params (void *vctx, const OSSL_PARAM params[])
{
  PROV_CIPHER_NULL_CTX *ctx = (PROV_CIPHER_NULL_CTX *)vctx;
  const OSSL_PARAM *p;
