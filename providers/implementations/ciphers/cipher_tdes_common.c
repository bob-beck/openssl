...
void *
ossl_tdes_newctx (void *provctx, int mode, size_t kbits, size_t blkbits,
...
#ifdef FIPS_MODULE
static int
tdes_encrypt_check_approved (PROV_TDES_CTX *ctx, int enc)
{
...
static int
tdes_init (void *vctx, const unsigned char *key, size_t keylen,
...
int
ossl_tdes_einit (void *vctx, const unsigned char *key, size_t keylen,
...
int
ossl_tdes_dinit (void *vctx, const unsigned char *key, size_t keylen,
                 const unsigned char *iv, size_t ivlen,
                 const OSSL_PARAM params[])
{
...
int
ossl_tdes_get_ctx_params (void *vctx, OSSL_PARAM params[])
{
  PROV_CIPHER_CTX *ctx = (PROV_CIPHER_CTX *)vctx;
  OSSL_PARAM *p;
...
int
ossl_tdes_set_ctx_params (void *vctx, const OSSL_PARAM params[])
{
...
int
ossl_tdes_get_params (OSSL_PARAM params[], unsigned int md, uint64_t flags,
