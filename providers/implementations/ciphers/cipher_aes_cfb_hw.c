...
static int
cipher_hw_aes_initkey (PROV_CIPHER_CTX *dat, const unsigned char *key,
                       size_t keylen)
{
  int ret;
...
#define PROV_CIPHER_HW_aes_mode(mode)                                         \
  static const PROV_CIPHER_HW aes_##mode                                      \
      = { cipher_hw_aes_initkey, ossl_cipher_hw_generic_##mode,               \
...
PROV_CIPHER_HW_aes_mode (cfb128) PROV_CIPHER_HW_aes_mode (cfb1)
