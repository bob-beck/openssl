...
int
ossl_gcm_setiv (PROV_GCM_CTX *ctx, const unsigned char *iv, size_t ivlen)
{
...
int
ossl_gcm_aad_update (PROV_GCM_CTX *ctx, const unsigned char *aad,
                     size_t aad_len)
{
...
int
ossl_gcm_cipher_update (PROV_GCM_CTX *ctx, const unsigned char *in, size_t len,
                        unsigned char *out)
{
  if (ctx->enc)
    {
...
int
ossl_gcm_cipher_final (PROV_GCM_CTX *ctx, unsigned char *tag)
{
  if (ctx->enc)
    {
...
int
ossl_gcm_one_shot (PROV_GCM_CTX *ctx, unsigned char *aad, size_t aad_len,
