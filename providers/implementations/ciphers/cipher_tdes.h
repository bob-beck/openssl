...
#define IMPLEMENT_tdes_cipher(type, UCTYPE, lcmode, UCMODE, flags, kbits, blkbits, ivbits, block)                      \
    ...
    {                                                                                                                  \
        return ossl_tdes_newctx(provctx, EVP_CIPH_##UCMODE##_MODE, kbits, blkbits, ivbits, flags,                      \
    ...
    {                                                                                                                  \
        return ossl_tdes_get_params(params, EVP_CIPH_##UCMODE##_MODE, flags, kbits, blkbits, ivbits);                  \
    }                                                                                                                  \
    const OSSL_DISPATCH ossl_tdes_##type##_##lcmode##_functions[] = {                                                  \
        ...
        {OSSL_FUNC_CIPHER_UPDATE, (void (*)(void))ossl_cipher_generic_##block##_update},                               \
        ...
        {OSSL_FUNC_CIPHER_SETTABLE_CTX_PARAMS, (void (*)(void))ossl_tdes_settable_ctx_params},                         \
        OSSL_DISPATCH_END}
...
#define PROV_CIPHER_HW_tdes_mode(type, mode)                                                                           \
    static const PROV_CIPHER_HW type##_##mode = {ossl_cipher_hw_tdes_##type##_initkey, ossl_cipher_hw_tdes_##mode,     \
