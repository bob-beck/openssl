...
blake2b_set_lastblock (BLAKE2B_CTX *S)
{
  S->f[0] = -1;
}
...
static void
blake2b_init_param (BLAKE2B_CTX *S, const BLAKE2B_PARAM *P)
{
  size_t i;
...
void
ossl_blake2b_param_set_personal (BLAKE2B_PARAM *P, const uint8_t *personal,
                                 size_t len)
{
...
void
ossl_blake2b_param_set_salt (BLAKE2B_PARAM *P, const uint8_t *salt, size_t len)
{
...
static void
blake2b_compress (BLAKE2B_CTX *S, const uint8_t *blocks, size_t len)
{
  uint64_t m[16];
  uint64_t v[16];
  int i;
