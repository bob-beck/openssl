...
static int
null_init (NULLMD_CTX *ctx)
{
  return 1;
}

static int
null_update (NULLMD_CTX *ctx, const void *data, size_t datalen)
{
  return 1;
}

static int
null_final (unsigned char *md, NULLMD_CTX *ctx)
{
  return 1;
}
...
IMPLEMENT_digest_functions (nullmd, NULLMD_CTX, 0, 0, 0, null_init,
                            null_update, null_final)
