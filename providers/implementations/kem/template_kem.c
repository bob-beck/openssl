...
static int
template_init (void *vctx, int operation, void *vkey, void *vauth,
...
static int
template_encapsulate_init (void *vctx, void *vkey, const OSSL_PARAM params[])
{
  return template_init (vctx, EVP_PKEY_OP_ENCAPSULATE, vkey, NULL, params);
}

static int
template_decapsulate_init (void *vctx, void *vkey, const OSSL_PARAM params[])
{
  return template_init (vctx, EVP_PKEY_OP_DECAPSULATE, vkey, NULL, params);
}

static int
template_set_ctx_params (void *vctx, const OSSL_PARAM params[])
{
  PROV_TEMPLATE_CTX *ctx = (PROV_TEMPLATE_CTX *)vctx;
...
static int
template_encapsulate (void *vctx, unsigned char *out, size_t *outlen,
...
static int
template_decapsulate (void *vctx, unsigned char *out, size_t *outlen,
