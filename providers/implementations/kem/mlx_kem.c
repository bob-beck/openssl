...
static int mlx_kem_init(void* vctx,
                        int op,
                        void* key,
...
static int mlx_kem_encapsulate_init(void* vctx,
                                    void* vkey,
...
static int mlx_kem_decapsulate_init(void* vctx,
                                    void* vkey,
                                    const OSSL_PARAM params[]) {
  MLX_KEY* key = vkey;
...
static const OSSL_PARAM* mlx_kem_settable_ctx_params(
...
static int mlx_kem_encapsulate(void* vctx,
                               unsigned char* ctext,
                               size_t* clen,
                               unsigned char* shsec,
                               size_t* slen) {
...
static int mlx_kem_decapsulate(void* vctx,
                               uint8_t* shsec,
                               size_t* slen,
                               const uint8_t* ctext,
                               size_t clen) {
