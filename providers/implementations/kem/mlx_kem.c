...
static void
mlx_kem_freectx (void *vctx)
{
  OPENSSL_free (vctx);
}

static int
mlx_kem_init (void *vctx, int op, void *key,
...
static int
mlx_kem_encapsulate (void *vctx, unsigned char *ctext, size_t *clen,
...
static int
mlx_kem_decapsulate (void *vctx, uint8_t *shsec, size_t *slen,
