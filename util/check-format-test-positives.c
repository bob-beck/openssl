 ...
 * delimiters and parenthesis-like symbols, e.g., on unexpected/unclosed
 * braces.
 */
 ...
 *X*@ no spc after leading '*' in multi-line comment, reported unless
 *sloppy-spc
...
/*@ comment line is toooooooooooo wide by 1 char, or by 21 chars in case
 * strict-len option is used */
...
#define Y                                                                     \
  1             /*@ extra space before body, reported unless sloppy-spc */    \
    ...
    typedef struct
{ /*@0 extra space in code, reported unless sloppy-spc */
  enum
  {           /*@1 extra space  in intra-line comment, no more reported */
...
#if X /*@0 unclosed #if */
    struct t
    {               /*@0 unclosed brace at decl/block level */
