...
{
    if (ctx == NULL)
    { /* non-leading end-of-line comment */
...
#define m2                                                                                                             \
    do                                                                                                                 \
    { /* should not be confused with function header followed by '{' */                                                \
    } while (0)
...
ASN1_CHOICE(OSSL_CRMF_POPO) = {
    ...
    ASN1_EXP(OSSL_CRMF_POPO, value.keyAgreement, OSSL_CRMF_POPOPRIVKEY, 3)} ASN1_CHOICE_END(OSSL_CRMF_POPO)
...
ASN1_ITEM_TEMPLATE(OSSL_CRMF_MSGS) = ASN1_EX_TEMPLATE_TYPE(ASN1_TFLG_SEQUENCE_OF, 0, OSSL_CRMF_MSGS, OSSL_CRMF_MSG)
