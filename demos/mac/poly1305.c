...
/*
 * Hard coding a nonce must not be done under any circumstances and is done
 * here purely for demonstration purposes. Please note that Poly1305 exhibits
 * catastrophic failure (that is, can be broken) if a nonce is ever reused for
 * a given key.
 */
