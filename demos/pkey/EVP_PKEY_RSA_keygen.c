 ...
 *
 * When generating an RSA key, you must specify the number of bits in the key.
 * A reasonable value would be 4096. Avoid using values below 2048. These
 * values are reasonable as of 2022.
 */
 ...
 * long method above is used. The ability to choose between these two methods
 * is shown here only for demonstration; the results are equivalent.
 */
static EVP_PKEY *
