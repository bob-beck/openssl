 ...
 * output for demonstration purposes. Both public and private keys are
 * accepted.
 *
 ...
 */
static EVP_PKEY *
load_key (OSSL_LIB_CTX *libctx, FILE *f, const char *passphrase)
{
  int ret = 0;
  EVP_PKEY *pkey = NULL;
 ...
 */
static int
store_key (EVP_PKEY *pkey, FILE *f, const char *passphrase)
{
  int ret = 0;
  int selection;
