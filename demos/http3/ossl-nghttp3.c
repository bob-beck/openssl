...
static int
h3_conn_recv_data (nghttp3_conn *h3conn, int64_t stream_id,
...
static int
h3_conn_stream_close (nghttp3_conn *h3conn, int64_t stream_id,
...
static int
h3_conn_stop_sending (nghttp3_conn *h3conn, int64_t stream_id,
                      uint64_t app_error_code, void *conn_user_data,
                      void *stream_user_data)
{
  int ret = 0;
...
static int
h3_conn_reset_stream (nghttp3_conn *h3conn, int64_t stream_id,
                      uint64_t app_error_code, void *conn_user_data,
                      void *stream_user_data)
{
  int ret = 0;
...
static int
h3_conn_deferred_consume (nghttp3_conn *h3conn, int64_t stream_id,
...
OSSL_DEMO_H3_CONN *
OSSL_DEMO_H3_CONN_new_for_addr (SSL_CTX *ctx, const char *addr,
                                const nghttp3_callbacks *callbacks,
                                const nghttp3_settings *settings,
                                void *user_data)
{
