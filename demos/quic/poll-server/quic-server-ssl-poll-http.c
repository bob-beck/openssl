...
static unsigned int rb_null_read_cb(struct response_buffer* rb,
                                    char* buf,
                                    unsigned int buf_sz) {
  return 0;
}
...
static unsigned int rb_read(struct response_buffer* rb,
                            char* buf,
                            unsigned int buf_sz) {
  if (rb != NULL)
...
static unsigned int rb_txt_simple_read_cb(struct response_buffer* rb,
                                          char* buf,
                                          unsigned int buf_sz) {
  struct response_txt_simple* rts = rb_to_txt_simple(rb);
...
static unsigned int rb_txt_full_read_cb(struct response_buffer* rb,
                                        char* buf,
                                        unsigned int buf_sz) {
  struct response_txt_full* rtf = rb_to_txt_full(rb);
  unsigned int i = rb->rb_rpos;
 ...
 */
static ossl_unused const char* err_str_n(unsigned long e,
                                         char* buf,
                                         size_t buf_sz) {
