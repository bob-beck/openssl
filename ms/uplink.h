...
#define UP_fread                                                               \
  (*(size_t (*)(                                                               \
    void*, size_t, size_t, void*))OPENSSL_UplinkTable[APPLINK_FREAD])
#define UP_fwrite                                                              \
  (*(size_t (*)(                                                               \
    const void*, size_t, size_t, void*))OPENSSL_UplinkTable[APPLINK_FWRITE])
...
#define UP_write                                                               \
  (*(ossl_ssize_t (*)(                                                         \
    int, const void*, size_t))OPENSSL_UplinkTable[APPLINK_WRITE])
